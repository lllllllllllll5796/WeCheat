...
namespace hvgt
{
	...
	bool ept_unhook()
	{
		UnHookFunctionArgs args{ true, nullptr, WeDebug_readcr3(), 0 };
	...
	{
		UnHookFunctionArgs args{ false, function_address, WeDebug_readcr3(), 0 };
		KeGenericCallDpc(broadcast_unhook_function, &args);
	...
	{
		HookFunctionArgs args{ target_address, proxy_function, origin_function, WeDebug_readcr3(), 0 };
	...
	{
		HookFunctionArgs args{ target_address, buffer, (void**)buffer_size, WeDebug_readcr3(), 0 };
	...
	{
		HookFunctionArgs args{ vmcallinfo, nullptr, nullptr, WeDebug_readcr3(), 0 };
