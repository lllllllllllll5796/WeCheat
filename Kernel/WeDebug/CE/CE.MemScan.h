...
#define PAGETABLEBASE 0xc0000000
	...
	extern MEMSCANOPTIONS MemscanOptions;
	...
	extern ADDRESSENTRY* AddressList;
	extern unsigned int AddressListSize;
	extern unsigned int AddressListEntries;
	extern KSPIN_LOCK AddressListSpinlock;

	extern PVOID FrozenData; //holds the buffer of all frozen data records
	extern int FrozenDataSize;
	extern LARGE_INTEGER FreezeInterval;
	extern HANDLE addressfile;
	extern HANDLE valuefile;

	extern BOOLEAN HiddenDriver;
