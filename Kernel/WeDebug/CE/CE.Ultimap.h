...
namespace Ultimap
{
	extern "C" VT_InterruptHook::JUMPBACK PerfmonJumpBackLocation;
...
#pragma pack(1)
	...
	*/
	...
	//extern PDS_AREA_MANAGEMENT DS_AREA[256]; //used to store the addresses. (reading the msr that holds the DS_AREA is impossible with dbvm active)
	//extern int DS_AREA_SIZE;
