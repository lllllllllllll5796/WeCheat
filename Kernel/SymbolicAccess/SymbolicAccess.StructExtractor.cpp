...
namespace symbolic_access
{
	...
	eastl::pair<eastl::string, StructMembers> StructExtractor::ParseStructure(StreamReader& Reader)
	{
	...
	eastl::optional<BitfieldData> StructExtractor::GetBitfieldData(StreamReader& Reader, size_t Index)
	{
	...
	bool StructExtractor::SkipStruct(eastl::string_view StructName)
	{
		return StructName.find("<anonymous-tag>") != eastl::string_view::npos ||
			StructName.find("<unnamed-tag>") != eastl::string_view::npos ||
			StructName.find("__unnamed") != eastl::string_view::npos ||
			StructName.find("<unnamed-type-u>") != eastl::string_view::npos;
	}
