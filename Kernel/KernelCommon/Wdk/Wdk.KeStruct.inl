...
//     enum : UINT32
//     {
        #define  ApcStateActualSize    (offsetof(KAPC_STATE, UserApcPending) + sizeof(BOOLEAN))

        #define ApcOffsetToSpareByte0      ( offsetof(KAPC, SpareByte0))
        #define ApcOffsetToSpareByte1      ( offsetof(KAPC, SpareByte1))
        #define ApcOffsetToSpareLong       ( offsetof(KAPC, SpareLong0))
        #define ApcOffsetToSystemArgument1 ( offsetof(KAPC, SystemArgument1))
        #define ApcOffsetToSystemArgument2 ( offsetof(KAPC, SystemArgument2))
        #define ApcOffsetToApcStateIndex   ( offsetof(KAPC, ApcStateIndex))
        #define ApcActualSize              ( offsetof(KAPC, Inserted) + sizeof(BOOLEAN))
//     };
...
#pragma region Semaphore
    //enum : UINT32
    //{
    #define    SemaphoreActualSize (offsetof(KSEMAPHORE, Limit) + sizeof(LONG))
    //};
#pragma endregion
...
#pragma region WaitBlock
    ...
    //{
#ifdef _WIN64
        #define WaitBlockOffsetToLong0 ( offsetof(KWAIT_BLOCK, SpareLong) + sizeof(KWAIT_BLOCK) * 0)
        #define WaitBlockOffsetToLong1 ( offsetof(KWAIT_BLOCK, SpareLong) + sizeof(KWAIT_BLOCK) * 1)
        #define WaitBlockOffsetToLong2 ( offsetof(KWAIT_BLOCK, SpareLong) + sizeof(KWAIT_BLOCK) * 2)
        #define WaitBlockOffsetToLong3 ( offsetof(KWAIT_BLOCK, SpareLong) + sizeof(KWAIT_BLOCK) * 3)
#endif

       #define WaitBlockOffsetToPtr0 ( offsetof(KWAIT_BLOCK, SparePtr) + sizeof(KWAIT_BLOCK) * 0)
       #define WaitBlockOffsetToPtr1 ( offsetof(KWAIT_BLOCK, SparePtr) + sizeof(KWAIT_BLOCK) * 1)
       #define WaitBlockOffsetToPtr2 ( offsetof(KWAIT_BLOCK, SparePtr) + sizeof(KWAIT_BLOCK) * 2)
       #define WaitBlockOffsetToPtr3 ( offsetof(KWAIT_BLOCK, SparePtr) + sizeof(KWAIT_BLOCK) * 3)

       #define WaitBlockOffsetToObject0 ( offsetof(KWAIT_BLOCK, Object) + sizeof(KWAIT_BLOCK) * 0)
       #define WaitBlockOffsetToObject1 ( offsetof(KWAIT_BLOCK, Object) + sizeof(KWAIT_BLOCK) * 1)
       #define WaitBlockOffsetToObject2 ( offsetof(KWAIT_BLOCK, Object) + sizeof(KWAIT_BLOCK) * 2)
       #define WaitBlockOffsetToObject3 ( offsetof(KWAIT_BLOCK, Object) + sizeof(KWAIT_BLOCK) * 3)
    //};
#pragma endregion
