...
#pragma pack()
		...
		LOG_DEBUG("[+] vmx_Add_R3BreakPoint--->����ֵr:0x%X\r\n", r);
...
#pragma pack()
		...
		LOG_DEBUG("[+] vmx_Del_R3BreakPoint--->����ֵr:0x%X\r\n", r);
...
#pragma pack()
	...
	void vmx_Invept()
	{
		KeGenericCallDpc(broadcast_invept_all_contexts, NULL);   //��Ҫ��lambdaʵ��
	}
...
#pragma pack()
	...
	�ڸ�����ַ����һ�� int3 bp������ִ��ʱ��״̬����Ϊ����״̬
	�������һ������ҳ�棬BP ����ִ��ҳ��������

	���û�и�������ҳ�棬�������������û�н��� IP ���ģ�����Ҫ����ִ�У�
