...
#define VMCALL_DISABLE_EPT  58
#define VMCALL_GET_STATISTICS  59
#define VMCALL_WATCH_EXECUTES 60   //从DBVM里挪进来的
...
//自己加的
#define VMCALL_TEST 777

#define VMCALL_ADD_R0HOOK    888
#define VMCALL_DEL_R0HOOK    889

#define VMCALL_ADD_BREAKPOINT 900
#define VMCALL_DEL_BREAKPOINT 901

#define VMCALL_INVEPT_CONTEXT 999
	...
	extern DOVMCALL* DoVmcall;

	extern "C" unsigned int   vmxusable;
	extern "C" UINT64   vmx_password1;
	extern "C" unsigned int vmx_password2;
	extern "C" UINT64   vmx_password3;
	extern "C" unsigned int vmx_version;
	...
	void vmx_Invept(BOOL invept_all);
