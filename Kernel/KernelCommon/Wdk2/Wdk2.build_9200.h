...
//////////////////
	...
	typedef enum ___2016091401320F02FA8D3DC41796E34FB_RecordType  // 2 elements, 0x4 bytes
	{
		KTMOH_CommitTransaction_Result = 1 /*0x1*/,
		KTMOH_RollbackTransaction_Result = 2 /*0x2*/
	}__2016091401320F02FA8D3DC41796E34FB_RecordType, * P__2016091401320F02FA8D3DC41796E34FB_RecordType;
	...
	typedef enum _DPFLTR_TYPE  // 151 elements, 0x4 bytes
	{
		...
		DPFLTR_REFS_ID = 149 /*0x95*/,
		DPFLTR_ENDOFTABLE_ID = 150 /*0x96*/
	...
	typedef enum _FILE_INFORMATION_CLASS  // 61 elements, 0x4 bytes
	{
		...
		FileMaximumInformation = 61 /*0x3D*/
	...
	typedef enum _JOBOBJECTINFOCLASS  // 34 elements, 0x4 bytes
	{
	...
	typedef enum _PNP_DEVICE_ACTION_REQUEST  // 23 elements, 0x4 bytes
	{
	...
	typedef enum _POWER_REQUEST_TYPE_INTERNAL  // 10 elements, 0x4 bytes
	{
		...
		PowerRequestAudioAnyInternal = 5 /*0x5*/,
		PowerRequestAudioOffloadInternal = 6 /*0x6*/,
		PowerRequestVideoBatchingInternal = 7 /*0x7*/,
		PowerRequestFullScreenVideoInternal = 8 /*0x8*/,
		PowerRequestInternalInvalid = 9 /*0x9*/
	...
	typedef enum _TRACE_INFORMATION_CLASS  // 19 elements, 0x4 bytes
	{
		TraceIdClass = 0 /*0x0*/,
		...
		HypervisorStackwalkRoutineClass = 14 /*0xE*/,
	...
	typedef VOID(NEAR CDECL FUNCT_00BC_00BB_CleanupGroupCancelCallback_DeRefSecurityDescriptor_PostRoutine) (VOID*, VOID*);
	typedef VOID(NEAR CDECL FUNCT_00BC_00C3_FinalizationCallback) (struct _TP_CALLBACK_INSTANCE*, VOID*);
	typedef enum _EXCEPTION_DISPOSITION(NEAR CDECL FUNCT_014E_014D_Handler) (struct _EXCEPTION_RECORD*, VOID*, struct _CONTEXT*, VOID*);
	typedef VOID(NEAR CDECL FUNCT_00BC_027C_PostProcessInitRoutine_DispatchAddress_FinishRoutine) ();
	typedef VOID(NEAR CDECL FUNCT_00BC_0531_DeferredRoutine) (struct _KDPC*, VOID*, VOID*, VOID*);
	typedef VOID(NEAR CDECL FUNCT_00BC_06C2_NormalRoutine) (VOID*, VOID*, VOID*);
	typedef VOID(NEAR CDECL FUNCT_00BC_06B9_KernelRoutine) (struct _KAPC*, FUNCT_00BC_06C2_NormalRoutine**, VOID**, VOID**, VOID**);
	typedef VOID(NEAR CDECL FUNCT_00BC_06C2_NormalRoutine) (VOID*, VOID*, VOID*);
	typedef VOID(NEAR CDECL FUNCT_00BC_06C7_RundownRoutine) (struct _KAPC*);
	typedef VOID* (NEAR CDECL FUNCT_00BF_0740_AllocateEx) (enum _POOL_TYPE, UINT64, ULONG32, struct _LOOKASIDE_LIST_EX*);
	typedef VOID* (NEAR CDECL FUNCT_00BF_074A_Allocate) (enum _POOL_TYPE, UINT64, ULONG32);
	typedef VOID(NEAR CDECL FUNCT_00BC_074F_FreeEx) (VOID*, struct _LOOKASIDE_LIST_EX*);
	typedef VOID(NEAR CDECL FUNCT_00BC_0753_Free_IdleComplete_WorkerRoutine_InterfaceReference_InterfaceDereference_DeleteProcedure_DevicePowerRequired_DevicePowerNotRequired_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead) (VOID*);
	typedef VOID(NEAR CDECL FUNCT_00BC_07C2_IdlePrepare) (struct _PROCESSOR_IDLE_PREPARE_INFO*);
	typedef LONG32(NEAR CDECL FUNCT_0072_07DF_IdleExecute_DestroyProcedure) (VOID*);
	typedef VOID(NEAR CDECL FUNCT_00BC_07E1_IdleCancel_Free_ComponentActive_ComponentIdle) (VOID*, ULONG32);
	typedef UINT8(NEAR CDECL FUNCT_007B_07E5_IdleIsHalted_IdleInitiateWake) (VOID*);
	typedef VOID(NEAR CDECL FUNCT_00BC_0845_InstantaneousRead) (UINT64, ULONG32*);
	typedef VOID(NEAR CDECL FUNCT_00BC_0849_DifferentialRead) (UINT64, UINT8, UINT64*, UINT64*);
	typedef VOID(NEAR CDECL FUNCT_00BC_0899_GetFFHThrottleState) (UINT64*);
	typedef VOID(NEAR CDECL FUNCT_00BC_089C_BoostPolicyHandler_BoostModeHandler_StallRoutine) (ULONG32);
	typedef ULONG32(NEAR CDECL FUNCT_0009_089F_PerfSelectionHandler) (UINT64, ULONG32, ULONG32, ULONG32, ULONG32, ULONG32*, UINT64*);
	typedef VOID(NEAR CDECL FUNCT_00BC_08A8_PerfControlHandler) (UINT64, UINT64, ULONG32, ULONG32, ULONG32, ULONG32, UINT8, UINT8);
	typedef VOID(NEAR CDECL FUNCT_00BC_092F_WorkerRoutine) (VOID*, VOID*, VOID*, VOID*);
	typedef LONG32(NEAR CDECL FUNCT_0072_0A52_AddDevice) (struct _DRIVER_OBJECT*, struct _DEVICE_OBJECT*);
	typedef LONG32(NEAR CDECL FUNCT_0072_0A6A_PreAcquireForSectionSynchronization_PreReleaseForSectionSynchronization_PreAcquireForCcFlush_PreReleaseForCcFlush_PreAcquireForModifiedPageWriter_PreReleaseForModifiedPageWriter) (struct _FS_FILTER_CALLBACK_DATA*, VOID**);
	typedef VOID(NEAR CDECL FUNCT_00BC_0AE5_PostAcquireForSectionSynchronization_PostReleaseForSectionSynchronization_PostAcquireForCcFlush_PostReleaseForCcFlush_PostAcquireForModifiedPageWriter_PostReleaseForModifiedPageWriter) (struct _FS_FILTER_CALLBACK_DATA*, LONG32, VOID*);
	typedef UINT8(NEAR CDECL FUNCT_007B_0B09_FastIoCheckIfPossible) (struct _FILE_OBJECT*, union _LARGE_INTEGER*, ULONG32, UINT8, ULONG32, UINT8, struct _IO_STATUS_BLOCK*, struct _DEVICE_OBJECT*);
	typedef UINT8(NEAR CDECL FUNCT_007B_0B14_FastIoRead_FastIoWrite) (struct _FILE_OBJECT*, union _LARGE_INTEGER*, ULONG32, UINT8, ULONG32, VOID*, struct _IO_STATUS_BLOCK*, struct _DEVICE_OBJECT*);
	typedef UINT8(NEAR CDECL FUNCT_007B_0B1E_FastIoQueryBasicInfo) (struct _FILE_OBJECT*, UINT8, struct _FILE_BASIC_INFORMATION*, struct _IO_STATUS_BLOCK*, struct _DEVICE_OBJECT*);
	typedef UINT8(NEAR CDECL FUNCT_007B_0B2C_FastIoQueryStandardInfo) (struct _FILE_OBJECT*, UINT8, struct _FILE_STANDARD_INFORMATION*, struct _IO_STATUS_BLOCK*, struct _DEVICE_OBJECT*);
	typedef UINT8(NEAR CDECL FUNCT_007B_0B3A_FastIoLock) (struct _FILE_OBJECT*, union _LARGE_INTEGER*, union _LARGE_INTEGER*, struct _EPROCESS*, ULONG32, UINT8, UINT8, struct _IO_STATUS_BLOCK*, struct _DEVICE_OBJECT*);
	typedef VOID(NEAR CDECL FUNCT_00BC_0C71_MiniPacketCallback) (struct _IO_MINI_COMPLETION_PACKET_USER*, VOID*);
	typedef struct _IMAGE_RUNTIME_FUNCTION_ENTRY* (NEAR CDECL FUNCT_0D64_0D78_Callback) (UINT64, VOID*);
	typedef UINT8(NEAR CDECL FUNCT_007B_0D82_FastIoUnlockSingle) (struct _FILE_OBJECT*, union _LARGE_INTEGER*, union _LARGE_INTEGER*, struct _EPROCESS*, ULONG32, struct _IO_STATUS_BLOCK*, struct _DEVICE_OBJECT*);
	typedef UINT8(NEAR CDECL FUNCT_007B_0D8B_FastIoUnlockAll) (struct _FILE_OBJECT*, struct _EPROCESS*, struct _IO_STATUS_BLOCK*, struct _DEVICE_OBJECT*);
	typedef UINT8(NEAR CDECL FUNCT_007B_0D91_FastIoUnlockAllByKey) (struct _FILE_OBJECT*, VOID*, ULONG32, struct _IO_STATUS_BLOCK*, struct _DEVICE_OBJECT*);
	typedef UINT8(NEAR CDECL FUNCT_007B_0D98_FastIoDeviceControl) (struct _FILE_OBJECT*, UINT8, VOID*, ULONG32, VOID*, ULONG32, ULONG32, struct _IO_STATUS_BLOCK*, struct _DEVICE_OBJECT*);
	typedef VOID(NEAR CDECL FUNCT_00BC_0DA3_AcquireFileForNtCreateSection_ReleaseFileForNtCreateSection) (struct _FILE_OBJECT*);
	typedef VOID(NEAR CDECL FUNCT_00BC_0DA6_FastIoDetachDevice) (struct _DEVICE_OBJECT*, struct _DEVICE_OBJECT*);
	typedef UINT8(NEAR CDECL FUNCT_007B_0DAA_FastIoQueryNetworkOpenInfo) (struct _FILE_OBJECT*, UINT8, struct _FILE_NETWORK_OPEN_INFORMATION*, struct _IO_STATUS_BLOCK*, struct _DEVICE_OBJECT*);
	typedef LONG32(NEAR CDECL FUNCT_0072_0DBA_AcquireForModWrite) (struct _FILE_OBJECT*, union _LARGE_INTEGER*, struct _ERESOURCE**, struct _DEVICE_OBJECT*);
	typedef UINT8(NEAR CDECL FUNCT_007B_0DC0_MdlRead_PrepareMdlWrite) (struct _FILE_OBJECT*, union _LARGE_INTEGER*, ULONG32, ULONG32, struct _MDL**, struct _IO_STATUS_BLOCK*, struct _DEVICE_OBJECT*);
	typedef UINT8(NEAR CDECL FUNCT_007B_0DD6_MdlReadComplete_MdlReadCompleteCompressed) (struct _FILE_OBJECT*, struct _MDL*, struct _DEVICE_OBJECT*);
	typedef UINT8(NEAR CDECL FUNCT_007B_0DDB_MdlWriteComplete_MdlWriteCompleteCompressed) (struct _FILE_OBJECT*, union _LARGE_INTEGER*, struct _MDL*, struct _DEVICE_OBJECT*);
	typedef UINT8(NEAR CDECL FUNCT_007B_0DE1_FastIoReadCompressed_FastIoWriteCompressed) (struct _FILE_OBJECT*, union _LARGE_INTEGER*, ULONG32, ULONG32, VOID*, struct _MDL**, struct _IO_STATUS_BLOCK*, struct _COMPRESSED_DATA_INFO*, ULONG32, struct _DEVICE_OBJECT*);
	typedef UINT8(NEAR CDECL FUNCT_007B_0DF6_FastIoQueryOpen) (struct _IRP*, struct _FILE_NETWORK_OPEN_INFORMATION*, struct _DEVICE_OBJECT*);
	typedef VOID(NEAR CDECL FUNCT_00BC_0E1F_UserApcRoutine) (VOID*, struct _IO_STATUS_BLOCK*, ULONG32);
	typedef VOID(NEAR CDECL FUNCT_00BC_0E24_DriverStartIo_CancelRoutine) (struct _DEVICE_OBJECT*, struct _IRP*);
	typedef LONG32(NEAR CDECL FUNCT_0072_10C8_CompletionRoutine) (struct _DEVICE_OBJECT*, struct _IRP*, VOID*);
	typedef LONG32(NEAR CDECL FUNCT_0072_10CD_ReleaseForModWrite) (struct _FILE_OBJECT*, struct _ERESOURCE*, struct _DEVICE_OBJECT*);
	typedef LONG32(NEAR CDECL FUNCT_0072_10D2_AcquireForCcFlush_ReleaseForCcFlush) (struct _FILE_OBJECT*, struct _DEVICE_OBJECT*);
	typedef LONG32(NEAR CDECL FUNCT_0072_10D6_DriverInit) (struct _DRIVER_OBJECT*, struct _UNICODE_STRING*);
	typedef VOID(NEAR CDECL FUNCT_00BC_10DA_DriverUnload_Function) (struct _DRIVER_OBJECT*);
	typedef LONG32(NEAR CDECL FUNCT_0072_10DE_MajorFunction) (struct _DEVICE_OBJECT*, struct _IRP*);
	typedef VOID(NEAR CDECL FUNCT_00BC_10E8_TimerRoutine) (struct _DEVICE_OBJECT*, VOID*);
	typedef enum _IO_ALLOCATION_ACTION(NEAR CDECL FUNCT_10FD_10FC_DeviceRoutine) (struct _DEVICE_OBJECT*, struct _IRP*, VOID*, VOID*);
	typedef VOID(NEAR CDECL FUNCT_00BC_11A7_DumpProcedure) (VOID*, struct _OBJECT_DUMP_CONTROL*);
	typedef LONG32(NEAR CDECL FUNCT_0072_11AF_OpenProcedure) (enum _OB_OPEN_REASON, CHAR, struct _EPROCESS*, VOID*, ULONG32*, ULONG32);
	typedef VOID(NEAR CDECL FUNCT_00BC_11BD_CloseProcedure) (struct _EPROCESS*, VOID*, UINT64, UINT64);
	typedef LONG32(NEAR CDECL FUNCT_0072_11C3_ParseProcedure) (VOID*, VOID*, struct _ACCESS_STATE*, CHAR, ULONG32, struct _UNICODE_STRING*, struct _UNICODE_STRING*, VOID*, struct _SECURITY_QUALITY_OF_SERVICE*, VOID**);
	typedef LONG32(NEAR CDECL FUNCT_0072_11CF_SecurityProcedure) (VOID*, enum _SECURITY_OPERATION_CODE, ULONG32*, VOID*, ULONG32*, VOID**, enum _POOL_TYPE, struct _GENERIC_MAPPING*, CHAR);
	typedef LONG32(NEAR CDECL FUNCT_0072_11E0_QueryNameProcedure) (VOID*, UINT8, struct _OBJECT_NAME_INFORMATION*, ULONG32, ULONG32*, CHAR);
	typedef UINT8(NEAR CDECL FUNCT_007B_11E8_OkayToCloseProcedure) (struct _EPROCESS*, VOID*, VOID*, CHAR);
	typedef struct _CELL_DATA* (NEAR CDECL FUNCT_1512_1511_GetCellRoutine) (struct _HHIVE*, ULONG32);
	typedef VOID* (NEAR CDECL FUNCT_00BF_155F_Allocate) (ULONG32, UINT8, ULONG32);
	typedef UINT8(NEAR CDECL FUNCT_007B_1564_FileWrite) (struct _HHIVE*, ULONG32, struct _CMP_OFFSET_ARRAY*, ULONG32, ULONG32*, ULONG32);
	typedef UINT8(NEAR CDECL FUNCT_007B_1571_FileRead) (struct _HHIVE*, ULONG32, ULONG32*, VOID*, ULONG32);
	typedef LONG32(NEAR CDECL FUNCT_0072_161B_Callback) (enum _PCW_CALLBACK_TYPE, union _PCW_CALLBACK_INFORMATION*, VOID*);
	typedef UINT8(NEAR CDECL FUNCT_007B_1735_AcceptDeviceNotification) (ULONG32, VOID*);
	typedef UINT8(NEAR CDECL FUNCT_007B_1739_AcceptProcessorNotification) (struct _PEPHANDLE__*, ULONG32, VOID*);
	typedef VOID(NEAR CDECL FUNCT_00BC_1749_ComponentIdleState) (VOID*, ULONG32, ULONG32);
	typedef LONG32(NEAR CDECL FUNCT_0072_174E_PowerControl) (VOID*, struct _GUID*, VOID*, UINT64, VOID*, UINT64, UINT64*);
	typedef VOID(NEAR CDECL FUNCT_00BC_1757_ComponentCriticalTransition) (VOID*, ULONG32, UINT8);
	typedef VOID(NEAR CDECL FUNCT_00BC_1786_NextIrpCallerCompletion_CallerCompletion) (struct _DEVICE_OBJECT*, UINT8, union _POWER_STATE, VOID*, struct _IO_STATUS_BLOCK*);
	typedef ULONG32(NEAR CDECL FUNCT_0009_186E_ProfileDepartureSetMode) (VOID*, enum _PROFILE_DEPARTURE_STYLE);
	typedef ULONG32(NEAR CDECL FUNCT_0009_1877_ProfileDepartureUpdate) (VOID*);
	typedef VOID(NEAR CDECL FUNCT_00BC_19FA_FlushToLsnRoutine) (VOID*, union _LARGE_INTEGER);
	typedef VOID(NEAR CDECL FUNCT_00BC_19FE_QueryLogHandleInfoRoutine) (VOID*, UINT16*);
	typedef UINT8(NEAR CDECL FUNCT_007B_1A63_AcquireForLazyWrite_AcquireForReadAhead) (VOID*, UINT8);
	typedef VOID(NEAR CDECL FUNCT_00BC_1AA4_Callback) (VOID*, UINT64, ULONG32);
	typedef LONG32(NEAR CDECL FUNCT_0072_1B2B_CommitRoutine) (VOID*, VOID**, UINT64*);
	typedef INT64(NEAR CDECL FUNCT_008C_1E95_GetCpuClock) ();
	typedef VOID(NEAR CDECL FUNCT_00BC_1FE4_WorkRoutine) (struct _WHEAP_WORK_QUEUE*, struct _LIST_ENTRY*);
	typedef UINT8(NEAR CDECL FUNCT_007B_20EB_ServiceRoutine) (struct _KINTERRUPT*, VOID*);
	typedef UINT8(NEAR CDECL FUNCT_007B_20EF_MessageServiceRoutine) (struct _KINTERRUPT*, VOID*, ULONG32);
	typedef LONG32(NEAR CDECL FUNCT_0072_2285_NotificationRoutine) (struct _KENLISTMENT*, VOID*, VOID*, ULONG32, union _LARGE_INTEGER*, ULONG32, VOID*);
	typedef enum _RTL_GENERIC_COMPARE_RESULTS(NEAR CDECL FUNCT_22CB_22CA_CompareRoutine) (struct _RTL_AVL_TABLE*, VOID*, VOID*);
	typedef VOID* (NEAR CDECL FUNCT_00BF_22D4_AllocateRoutine) (struct _RTL_AVL_TABLE*, ULONG32);
	typedef VOID(NEAR CDECL FUNCT_00BC_22D8_FreeRoutine) (struct _RTL_AVL_TABLE*, VOID*);
	typedef VOID(NEAR CDECL FUNCT_00BC_2478_Routine) (VOID*, VOID*, struct _IO_WORKITEM*);
	typedef LONG32(NEAR CDECL FUNCT_0072_2754_ArbiterHandler) (VOID*, enum _ARBITER_ACTION, struct _ARBITER_PARAMETERS*);
	typedef LONG32(NEAR CDECL FUNCT_0072_27B6_UnpackRequirement) (struct _IO_RESOURCE_DESCRIPTOR*, UINT64*, UINT64*, UINT64*, UINT64*);
	typedef LONG32(NEAR CDECL FUNCT_0072_27BD_PackResource) (struct _IO_RESOURCE_DESCRIPTOR*, UINT64, struct _CM_PARTIAL_RESOURCE_DESCRIPTOR*);
	typedef LONG32(NEAR CDECL FUNCT_0072_27C2_UnpackResource) (struct _CM_PARTIAL_RESOURCE_DESCRIPTOR*, UINT64*, UINT64*);
	typedef LONG32(NEAR CDECL FUNCT_0072_27C7_ScoreRequirement) (struct _IO_RESOURCE_DESCRIPTOR*);
	typedef LONG32(NEAR CDECL FUNCT_0072_27CA_TestAllocation) (struct _ARBITER_INSTANCE*, struct _ARBITER_TEST_ALLOCATION_PARAMETERS*);
	typedef LONG32(NEAR CDECL FUNCT_0072_27D0_RetestAllocation) (struct _ARBITER_INSTANCE*, struct _ARBITER_RETEST_ALLOCATION_PARAMETERS*);
	typedef LONG32(NEAR CDECL FUNCT_0072_27D5_CommitAllocation_RollbackAllocation) (struct _ARBITER_INSTANCE*);
	typedef LONG32(NEAR CDECL FUNCT_0072_27D8_BootAllocation) (struct _ARBITER_INSTANCE*, struct _ARBITER_BOOT_ALLOCATION_PARAMETERS*);
	typedef LONG32(NEAR CDECL FUNCT_0072_27DD_QueryArbitrate) (struct _ARBITER_INSTANCE*, struct _ARBITER_QUERY_ARBITRATE_PARAMETERS*);
	typedef LONG32(NEAR CDECL FUNCT_0072_27E2_QueryConflict) (struct _ARBITER_INSTANCE*, struct _ARBITER_QUERY_CONFLICT_PARAMETERS*);
	typedef LONG32(NEAR CDECL FUNCT_0072_27E7_AddReserved) (struct _ARBITER_INSTANCE*, struct _ARBITER_ADD_RESERVED_PARAMETERS*);
	typedef LONG32(NEAR CDECL FUNCT_0072_27EC_StartArbiter) (struct _ARBITER_INSTANCE*, struct _CM_RESOURCE_LIST*);
	typedef LONG32(NEAR CDECL FUNCT_0072_27F0_PreprocessEntry_AllocateEntry) (struct _ARBITER_INSTANCE*, struct _ARBITER_ALLOCATION_STATE*);
	typedef UINT8(NEAR CDECL FUNCT_007B_27F4_GetNextAllocationRange_FindSuitableRange_OverrideConflict) (struct _ARBITER_INSTANCE*, struct _ARBITER_ALLOCATION_STATE*);
	typedef VOID(NEAR CDECL FUNCT_00BC_27F6_AddAllocation_BacktrackAllocation) (struct _ARBITER_INSTANCE*, struct _ARBITER_ALLOCATION_STATE*);
	typedef LONG32(NEAR CDECL FUNCT_0072_27F8_InitializeRangeList) (struct _ARBITER_INSTANCE*, ULONG32, struct _CM_PARTIAL_RESOURCE_DESCRIPTOR*, struct _RTL_RANGE_LIST*);
	typedef UINT8(NEAR CDECL FUNCT_007B_27FE_ConflictCallback) (VOID*, struct _RTL_RANGE*);
	typedef UINT8(NEAR CDECL FUNCT_007B_2B9E_OpenRoutine) (union _LARGE_INTEGER);
	typedef LONG32(NEAR CDECL FUNCT_0072_2BA1_WriteRoutine) (union _LARGE_INTEGER*, struct _MDL*);
	typedef LONG32(NEAR CDECL FUNCT_0072_2BA7_WritePendingRoutine) (LONG32, union _LARGE_INTEGER*, struct _MDL*, VOID*);
	typedef LONG32(NEAR CDECL FUNCT_0072_2BB5_ReadRoutine) (LONG32, union _LARGE_INTEGER*, struct _MDL*);
	typedef LONG32(NEAR CDECL FUNCT_0072_2BBA_GetDriveTelemetryRoutine) (ULONG32, ULONG32, VOID*, ULONG32);
	typedef VOID(NEAR CDECL FUNCT_00BC_2BC0_GetTransferSizesRoutine) (ULONG32*, ULONG32*);
	typedef VOID(NEAR CDECL FUNCT_00BC_2BC4_DumpNotifyRoutine) (enum _DUMP_EVENTS, VOID*, ULONG32);
	...
	typedef struct _ARBITER_INSTANCE                                                                       // 43 elements, 0x698 bytes (sizeof)
	{
		...
		/*0x078*/     FUNCT_0072_27B6_UnpackRequirement* UnpackRequirement;
		/*0x080*/     FUNCT_0072_27BD_PackResource* PackResource;
		/*0x088*/     FUNCT_0072_27C2_UnpackResource* UnpackResource;
		/*0x090*/     FUNCT_0072_27C7_ScoreRequirement* ScoreRequirement;
		/*0x098*/     FUNCT_0072_27CA_TestAllocation* TestAllocation;
		/*0x0A0*/     FUNCT_0072_27D0_RetestAllocation* RetestAllocation;
		/*0x0A8*/     FUNCT_0072_27D5_CommitAllocation_RollbackAllocation* CommitAllocation;
		/*0x0B0*/     FUNCT_0072_27D5_CommitAllocation_RollbackAllocation* RollbackAllocation;
		/*0x0B8*/     FUNCT_0072_27D8_BootAllocation* BootAllocation;
		/*0x0C0*/     FUNCT_0072_27DD_QueryArbitrate* QueryArbitrate;
		/*0x0C8*/     FUNCT_0072_27E2_QueryConflict* QueryConflict;
		/*0x0D0*/     FUNCT_0072_27E7_AddReserved* AddReserved;
		/*0x0D8*/     FUNCT_0072_27EC_StartArbiter* StartArbiter;
		/*0x0E0*/     FUNCT_0072_27F0_PreprocessEntry_AllocateEntry* PreprocessEntry;
		/*0x0E8*/     FUNCT_0072_27F0_PreprocessEntry_AllocateEntry* AllocateEntry;
		/*0x0F0*/     FUNCT_007B_27F4_GetNextAllocationRange_FindSuitableRange_OverrideConflict* GetNextAllocationRange;
		/*0x0F8*/     FUNCT_007B_27F4_GetNextAllocationRange_FindSuitableRange_OverrideConflict* FindSuitableRange;
		/*0x100*/     FUNCT_00BC_27F6_AddAllocation_BacktrackAllocation* AddAllocation;
		/*0x108*/     FUNCT_00BC_27F6_AddAllocation_BacktrackAllocation* BacktrackAllocation;
		/*0x110*/     FUNCT_007B_27F4_GetNextAllocationRange_FindSuitableRange_OverrideConflict* OverrideConflict;
		/*0x118*/     FUNCT_0072_27F8_InitializeRangeList* InitializeRangeList;
		...
		/*0x148*/     FUNCT_007B_27FE_ConflictCallback* ConflictCallback;
	...
	typedef struct _ARBITER_INTERFACE                                                                                                                                                                                                // 7 elements, 0x30 bytes (sizeof)
	{
		...
		/*0x004*/     UINT8        _PADDING0_[0x4];
		/*0x008*/     VOID* Context;
		/*0x010*/     FUNCT_00BC_0753_Free_IdleComplete_WorkerRoutine_InterfaceReference_InterfaceDereference_DeleteProcedure_DevicePowerRequired_DevicePowerNotRequired_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead* InterfaceReference;
		/*0x018*/     FUNCT_00BC_0753_Free_IdleComplete_WorkerRoutine_InterfaceReference_InterfaceDereference_DeleteProcedure_DevicePowerRequired_DevicePowerNotRequired_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead* InterfaceDereference;
		/*0x020*/     FUNCT_0072_2754_ArbiterHandler* ArbiterHandler;
		/*0x028*/     ULONG32      Flags;
	...
	typedef struct _AUX_ACCESS_DATA                                                                              // 12 elements, 0xE0 bytes (sizeof)
	{
		...
		/*0x048*/     FUNCT_00BC_00BB_CleanupGroupCancelCallback_DeRefSecurityDescriptor_PostRoutine* DeRefSecurityDescriptor;
		/*0x050*/     VOID* SDLock;
	...
	typedef struct _BLOB_TYPE                                                                                                                                                                                                   // 8 elements, 0x30 bytes (sizeof)
	{
		...
		/*0x018*/     FUNCT_00BC_0753_Free_IdleComplete_WorkerRoutine_InterfaceReference_InterfaceDereference_DeleteProcedure_DevicePowerRequired_DevicePowerNotRequired_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead* DeleteProcedure;
		/*0x020*/     FUNCT_0072_07DF_IdleExecute_DestroyProcedure* DestroyProcedure;
	...
	{
		/*0x000*/     FUNCT_007B_1A63_AcquireForLazyWrite_AcquireForReadAhead* AcquireForLazyWrite;
		/*0x008*/     FUNCT_00BC_0753_Free_IdleComplete_WorkerRoutine_InterfaceReference_InterfaceDereference_DeleteProcedure_DevicePowerRequired_DevicePowerNotRequired_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead* ReleaseFromLazyWrite;
		/*0x010*/     FUNCT_007B_1A63_AcquireForLazyWrite_AcquireForReadAhead* AcquireForReadAhead;
		/*0x018*/     FUNCT_00BC_0753_Free_IdleComplete_WorkerRoutine_InterfaceReference_InterfaceDereference_DeleteProcedure_DevicePowerRequired_DevicePowerNotRequired_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead* ReleaseFromReadAhead;
	}CACHE_MANAGER_CALLBACKS, * PCACHE_MANAGER_CALLBACKS;

	typedef struct _DISPATCHER_HEADER                           // 30 elements, 0x18 bytes (sizeof)
	{
	...
	{
		/*0x000*/     struct _DISPATCHER_HEADER Header; // 30 elements, 0x18 bytes (sizeof)
	}KEVENT, * PKEVENT;
	...
	{
		/*0x000*/     FUNCT_00BC_1AA4_Callback* Callback;
	...
	typedef struct _CM_WORKITEM                                                                                                                                                                                               // 4 elements, 0x28 bytes (sizeof)
	{
		...
		/*0x014*/     UINT8        _PADDING0_[0x4];
		/*0x018*/     FUNCT_00BC_0753_Free_IdleComplete_WorkerRoutine_InterfaceReference_InterfaceDereference_DeleteProcedure_DevicePowerRequired_DevicePowerNotRequired_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead* WorkerRoutine;
	...
	typedef struct _HHIVE                                                    // 27 elements, 0x580 bytes (sizeof)
	{
		/*0x000*/     ULONG32      Signature;
		/*0x004*/     UINT8        _PADDING0_[0x4];
		/*0x008*/     FUNCT_1512_1511_GetCellRoutine* GetCellRoutine;
		/*0x010*/     FUNCT_00BF_155F_Allocate* Allocate;
		/*0x018*/     FUNCT_00BC_07E1_IdleCancel_Free_ComponentActive_ComponentIdle* Free;
		/*0x020*/     FUNCT_007B_1564_FileWrite* FileWrite;
		/*0x028*/     FUNCT_007B_1571_FileRead* FileRead;
	...
	typedef struct _CMHIVE                                  // 71 elements, 0xDD8 bytes (sizeof)
	{
		...
		/*0x604*/     UINT8        _PADDING0_[0x4];
		/*0x608*/     struct _CM_KEY_HASH_TABLE_ENTRY* DeletedKcbTable;
		/*0x610*/     ULONG32      DeletedKcbTableSize;
		/*0x614*/     ULONG32      Identity;
		/*0x618*/     struct _FAST_MUTEX* HiveLock;
		/*0x620*/     struct _FAST_MUTEX* WriterLock;
		/*0x628*/     struct _ERESOURCE* FlusherLock;
		/*0x630*/     struct _RTL_BITMAP FlushDirtyVector;                // 2 elements, 0x10 bytes (sizeof)
		/*0x640*/     struct _CMP_OFFSET_ARRAY* FlushOffsetArray;
		/*0x648*/     ULONG32      FlushOffsetArrayCount;
		/*0x64C*/     UINT8        _PADDING1_[0x4];
		/*0x650*/     struct _HBASE_BLOCK* FlushBaseBlock;
		/*0x658*/     ULONG32      FlushHiveTruncated;
		/*0x65C*/     UINT8        _PADDING2_[0x4];
		/*0x660*/     struct _EX_PUSH_LOCK SecurityLock;                  // 7 elements, 0x8 bytes (sizeof)
		/*0x668*/     ULONG32      UseCount;
		/*0x66C*/     ULONG32      LastShrinkHiveSize;
		/*0x670*/     union _LARGE_INTEGER ActualFileSize;                // 4 elements, 0x8 bytes (sizeof)
		/*0x678*/     union _LARGE_INTEGER LogFileSizes[2];
		/*0x688*/     struct _UNICODE_STRING FileFullPath;                // 3 elements, 0x10 bytes (sizeof)
		/*0x698*/     struct _UNICODE_STRING FileUserName;                // 3 elements, 0x10 bytes (sizeof)
		/*0x6A8*/     struct _UNICODE_STRING HiveRootPath;                // 3 elements, 0x10 bytes (sizeof)
		/*0x6B8*/     ULONG32      SecurityCount;
		/*0x6BC*/     ULONG32      SecurityCacheSize;
		/*0x6C0*/     LONG32       SecurityHitHint;
		/*0x6C4*/     UINT8        _PADDING3_[0x4];
		/*0x6C8*/     struct _CM_KEY_SECURITY_CACHE_ENTRY* SecurityCache;
		/*0x6D0*/     struct _LIST_ENTRY SecurityHash[64];
		/*0xAD0*/     ULONG32      UnloadEventCount;
		/*0xAD4*/     UINT8        _PADDING4_[0x4];
		/*0xAD8*/     struct _KEVENT** UnloadEventArray;
		/*0xAE0*/     struct _CM_KEY_CONTROL_BLOCK* RootKcb;
		/*0xAE8*/     UINT8        Frozen;
		/*0xAE9*/     UINT8        _PADDING5_[0x7];
		/*0xAF0*/     struct _CM_WORKITEM* UnloadWorkItem;
		/*0xAF8*/     struct _CM_WORKITEM UnloadWorkItemHolder;           // 4 elements, 0x28 bytes (sizeof)
		/*0xB20*/     UINT8        GrowOnlyMode;
		/*0xB21*/     UINT8        _PADDING6_[0x3];
		/*0xB24*/     ULONG32      GrowOffset;
		/*0xB28*/     struct _LIST_ENTRY KcbConvertListHead;              // 2 elements, 0x10 bytes (sizeof)
		/*0xB38*/     struct _LIST_ENTRY KnodeConvertListHead;            // 2 elements, 0x10 bytes (sizeof)
		/*0xB48*/     struct _CM_CELL_REMAP_BLOCK* CellRemapArray;
		/*0xB50*/     ULONG32      Flags;
		/*0xB54*/     UINT8        _PADDING7_[0x4];
		/*0xB58*/     struct _LIST_ENTRY TrustClassEntry;                 // 2 elements, 0x10 bytes (sizeof)
		/*0xB68*/     UINT64       DirtyTime;
		/*0xB70*/     struct _CM_RM* CmRm;
		/*0xB78*/     ULONG32      CmRmInitFailPoint;
		/*0xB7C*/     LONG32       CmRmInitFailStatus;
		/*0xB80*/     struct _KTHREAD* CreatorOwner;
		/*0xB88*/     struct _KTHREAD* RundownThread;
		/*0xB90*/     struct _ETHREAD* ActiveFlushThread;
		/*0xB98*/     struct _EX_PUSH_LOCK FlushBoostLock;                // 7 elements, 0x8 bytes (sizeof)
		/*0xBA0*/     union _LARGE_INTEGER LastWriteTime;                 // 4 elements, 0x8 bytes (sizeof)
		/*0xBA8*/     LONG32       ReferenceCount;
		union                                               // 2 elements, 0x4 bytes (sizeof)
		{
			/*0xBAC*/         ULONG32      FlushFlags;
			struct                                          // 5 elements, 0x4 bytes (sizeof)
			{
				/*0xBAC*/             ULONG32      FlushActive : 1;               // 0 BitPosition
				/*0xBAC*/             ULONG32      DiskFileBad : 1;               // 1 BitPosition
				/*0xBAC*/             ULONG32      FlushBoosted : 1;              // 2 BitPosition
				/*0xBAC*/             ULONG32      PrimaryWritePending : 1;       // 3 BitPosition
				/*0xBAC*/             ULONG32      PriorPurgeComplete : 1;        // 4 BitPosition
			};
		};
		/*0xBB0*/     struct _HIVE_WAIT_PACKET* FlushWaitList;
		/*0xBB8*/     LONG32       UnloadHistoryIndex;
		/*0xBBC*/     ULONG32      UnloadHistory[128];
		/*0xDBC*/     ULONG32      BootStart;
		/*0xDC0*/     ULONG32      UnaccessedStart;
		/*0xDC4*/     ULONG32      UnaccessedEnd;
		/*0xDC8*/     ULONG32      LoadedKeyCount;
		/*0xDCC*/     ULONG32      HandleClosePending;
		/*0xDD0*/     struct _EX_PUSH_LOCK HandleClosePendingEvent;       // 7 elements, 0x8 bytes (sizeof)
	}CMHIVE, * PCMHIVE;
	...
	typedef struct _CONTROL_AREA                                      // 14 elements, 0x70 bytes (sizeof)
	{
			...
			struct                                                    // 9 elements, 0x10 bytes (sizeof)
			{
				...
				union                                                 // 2 elements, 0x4 bytes (sizeof)
				{
					...
					struct                                            // 4 elements, 0x4 bytes (sizeof)
					{
						...
						/*0x05C*/                     ULONG32      Unused : 13;                     // 16 BitPosition
				...
				union                                                 // 2 elements, 0x8 bytes (sizeof)
				{
					/*0x060*/                 struct _MM_AVL_TABLE* SubsectionRoot;
	...
	typedef struct _DEFERRED_WRITE                                                                   // 9 elements, 0x48 bytes (sizeof)
	{
		...
		/*0x030*/     FUNCT_00BC_00BB_CleanupGroupCancelCallback_DeRefSecurityDescriptor_PostRoutine* PostRoutine;
		/*0x038*/     VOID* Context1;
		/*0x040*/     VOID* Context2;
	...
	typedef struct _DEVICE_NODE                                      // 66 elements, 0x2C8 bytes (sizeof)
	{
		...
		/*0x050*/     ULONG32      Level;
		/*0x054*/     union _POWER_STATE CurrentPowerState;                        // 2 elements, 0x4 bytes (sizeof)
		...
		/*0x0F0*/     struct _KEVENT FxRemoveEvent;                                // 1 elements, 0x18 bytes (sizeof)
		/*0x108*/     LONG32       FxActivationCount;
		/*0x10C*/     LONG32       FxSleepCount;
		/*0x110*/     struct _POP_FX_PLUGIN* Plugin;
	...
	typedef struct _WAIT_CONTEXT_BLOCK                  // 12 elements, 0x48 bytes (sizeof)
	{
		...
		/*0x018*/     FUNCT_10FD_10FC_DeviceRoutine* DeviceRoutine;
	...
	typedef struct _KDPC                                  // 9 elements, 0x40 bytes (sizeof)
	{
		...
		/*0x018*/     FUNCT_00BC_0531_DeferredRoutine* DeferredRoutine;
	...
	typedef struct _DOCK_INTERFACE                                                                                                                                                                                                   // 7 elements, 0x30 bytes (sizeof)
	{
		...
		/*0x010*/     FUNCT_00BC_0753_Free_IdleComplete_WorkerRoutine_InterfaceReference_InterfaceDereference_DeleteProcedure_DevicePowerRequired_DevicePowerNotRequired_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead* InterfaceReference;
		/*0x018*/     FUNCT_00BC_0753_Free_IdleComplete_WorkerRoutine_InterfaceReference_InterfaceDereference_DeleteProcedure_DevicePowerRequired_DevicePowerNotRequired_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead* InterfaceDereference;
		/*0x020*/     FUNCT_0009_186E_ProfileDepartureSetMode* ProfileDepartureSetMode;
		/*0x028*/     FUNCT_0009_1877_ProfileDepartureUpdate* ProfileDepartureUpdate;
	...
	typedef struct _DRIVER_EXTENSION                        // 8 elements, 0x48 bytes (sizeof)
	{
		...
		/*0x008*/     FUNCT_0072_0A52_AddDevice* AddDevice;
		/*0x010*/     ULONG32      Count;
		/*0x014*/     UINT8        _PADDING0_[0x4];
	...
	typedef struct _DRIVER_OBJECT                                   // 15 elements, 0x150 bytes (sizeof)
	{
		...
		/*0x058*/     FUNCT_0072_10D6_DriverInit* DriverInit;
		/*0x060*/     FUNCT_00BC_0E24_DriverStartIo_CancelRoutine* DriverStartIo;
		/*0x068*/     FUNCT_00BC_10DA_DriverUnload_Function* DriverUnload;
		/*0x070*/     FUNCT_0072_10DE_MajorFunction* MajorFunction[28];
	...
	typedef struct _OBJECT_HEADER                                // 15 elements, 0x38 bytes (sizeof)
	{
	...
	{
		/*0x000*/     struct _OBJECT_HEADER ObjectHeader; // 15 elements, 0x38 bytes (sizeof)
	...
	typedef struct _DUMP_INITIALIZATION_CONTEXT                                              // 28 elements, 0x108 bytes (sizeof)
	{
		...
		/*0x030*/     FUNCT_00BC_089C_BoostPolicyHandler_BoostModeHandler_StallRoutine* StallRoutine;
		/*0x038*/     FUNCT_007B_2B9E_OpenRoutine* OpenRoutine;
		/*0x040*/     FUNCT_0072_2BA1_WriteRoutine* WriteRoutine;
		/*0x048*/     FUNCT_00BC_027C_PostProcessInitRoutine_DispatchAddress_FinishRoutine* FinishRoutine;
		...
		/*0x080*/     FUNCT_0072_2BA7_WritePendingRoutine* WritePendingRoutine;
		...
		/*0x0A0*/     FUNCT_0072_2BB5_ReadRoutine* ReadRoutine;
		/*0x0A8*/     FUNCT_0072_2BBA_GetDriveTelemetryRoutine* GetDriveTelemetryRoutine;
		/*0x0B0*/     ULONG32      LogSectionTruncateSize;
		/*0x0B4*/     ULONG32      Parameters[16];
		/*0x0F4*/     UINT8        _PADDING1_[0x4];
		/*0x0F8*/     FUNCT_00BC_2BC0_GetTransferSizesRoutine* GetTransferSizesRoutine;
		/*0x100*/     FUNCT_00BC_2BC4_DumpNotifyRoutine* DumpNotifyRoutine;
	...
	typedef struct _DYNAMIC_FUNCTION_TABLE                   // 11 elements, 0x58 bytes (sizeof)
	{
		...
		/*0x038*/     FUNCT_0D64_0D78_Callback* Callback;
		/*0x040*/     VOID* Context;
	...
	typedef struct _PS_WAKE_INFORMATION   // 2 elements, 0x48 bytes (sizeof)
	{
		/*0x000*/     UINT64       NotificationChannel;
		/*0x008*/     UINT64       WakeCounters[8];
	...
	typedef struct _EJOB                                            // 107 elements, 0x4A8 bytes (sizeof)
	{
		...
		union                                                       // 2 elements, 0x48 bytes (sizeof)
		{
			...
			/*0x358*/         struct _PS_WAKE_INFORMATION WakeInfo;                   // 2 elements, 0x48 bytes (sizeof)
		};
		/*0x3A0*/     struct _JOBOBJECT_WAKE_FILTER WakeFilter;                   // 2 elements, 0x8 bytes (sizeof)
		/*0x3A8*/     ULONG32      LowEdgeLatchFilter;
		/*0x3AC*/     ULONG32      OwnedHighEdgeFilters;
		/*0x3B0*/     struct _EJOB* NotificationLink;
		/*0x3B8*/     UINT64       CurrentJobMemoryUsed;
		/*0x3C0*/     struct _JOB_NOTIFICATION_INFORMATION* NotificationInfo;
		/*0x3C8*/     VOID* NotificationInfoQuotaReference;
		/*0x3D0*/     struct _IO_MINI_COMPLETION_PACKET_USER* NotificationPacket;
		/*0x3D8*/     struct _JOB_CPU_RATE_CONTROL* CpuRateControl;
		/*0x3E0*/     VOID* EffectiveSchedulingGroup;
		/*0x3E8*/     struct _EX_PUSH_LOCK MemoryLimitsLock;                      // 7 elements, 0x8 bytes (sizeof)
		/*0x3F0*/     struct _LIST_ENTRY SiblingJobLinks;                         // 2 elements, 0x10 bytes (sizeof)
		/*0x400*/     struct _LIST_ENTRY ChildJobListHead;                        // 2 elements, 0x10 bytes (sizeof)
		/*0x410*/     struct _EJOB* ParentJob;
		/*0x418*/     struct _EJOB* RootJob;
		/*0x420*/     struct _LIST_ENTRY IteratorListHead;                        // 2 elements, 0x10 bytes (sizeof)
		/*0x430*/     struct _EPROCESS_VALUES Accounting;                         // 10 elements, 0x50 bytes (sizeof)
		/*0x480*/     ULONG32      ShadowActiveProcessCount;
		/*0x484*/     ULONG32      SequenceNumber;
		/*0x488*/     UINT64       TimerListLock;
		/*0x490*/     struct _LIST_ENTRY TimerListHead;                           // 2 elements, 0x10 bytes (sizeof)
		union                                                       // 2 elements, 0x4 bytes (sizeof)
		{
			/*0x4A0*/         ULONG32      JobFlags;
			struct                                                  // 24 elements, 0x4 bytes (sizeof)
			{
				/*0x4A0*/             ULONG32      CloseDone : 1;                         // 0 BitPosition
				/*0x4A0*/             ULONG32      MultiGroup : 1;                        // 1 BitPosition
				/*0x4A0*/             ULONG32      OutstandingNotification : 1;           // 2 BitPosition
				/*0x4A0*/             ULONG32      NotificationInProgress : 1;            // 3 BitPosition
				/*0x4A0*/             ULONG32      UILimits : 1;                          // 4 BitPosition
				/*0x4A0*/             ULONG32      CpuRateControlActive : 1;              // 5 BitPosition
				/*0x4A0*/             ULONG32      OwnCpuRateControl : 1;                 // 6 BitPosition
				/*0x4A0*/             ULONG32      Terminating : 1;                       // 7 BitPosition
				/*0x4A0*/             ULONG32      WorkingSetLock : 1;                    // 8 BitPosition
				/*0x4A0*/             ULONG32      JobFrozen : 1;                         // 9 BitPosition
				/*0x4A0*/             ULONG32      Background : 1;                        // 10 BitPosition
				/*0x4A0*/             ULONG32      WakeNotificationAllocated : 1;         // 11 BitPosition
				/*0x4A0*/             ULONG32      WakeNotificationEnabled : 1;           // 12 BitPosition
				/*0x4A0*/             ULONG32      WakeNotificationPending : 1;           // 13 BitPosition
				/*0x4A0*/             ULONG32      LimitNotificationRequired : 1;         // 14 BitPosition
				/*0x4A0*/             ULONG32      ZeroCountNotificationRequired : 1;     // 15 BitPosition
				/*0x4A0*/             ULONG32      CycleTimeNotificationRequired : 1;     // 16 BitPosition
				/*0x4A0*/             ULONG32      CycleTimeNotificationPending : 1;      // 17 BitPosition
				/*0x4A0*/             ULONG32      TimersVirtualized : 1;                 // 18 BitPosition
				/*0x4A0*/             ULONG32      JobSwapped : 1;                        // 19 BitPosition
				/*0x4A0*/             ULONG32      ViolationDetected : 1;                 // 20 BitPosition
				/*0x4A0*/             ULONG32      EmptyJobNotified : 1;                  // 21 BitPosition
				/*0x4A0*/             ULONG32      NoSystemCharge : 1;                    // 22 BitPosition
				/*0x4A0*/             ULONG32      SpareJobFlags : 9;                     // 23 BitPosition
			};
		};
		/*0x4A4*/     ULONG32      EffectiveHighEdgeFilters;
	}EJOB, * PEJOB;
	...
	typedef struct _KNODE                // 16 elements, 0xC0 bytes (sizeof)
	{
	...
	typedef struct _EX_WORK_QUEUE                // 5 elements, 0x50 bytes (sizeof)
	{
		...
		/*0x048*/     LONG32       ThreadCount;
		/*0x04C*/     UINT8        TryFailed;
		/*0x04D*/     UINT8        _PADDING0_[0x3];
	}EX_WORK_QUEUE, * PEX_WORK_QUEUE;

	typedef struct _ENODE                                  // 8 elements, 0x340 bytes (sizeof)
	{
		/*0x000*/     struct _KNODE Ncb;                                 // 16 elements, 0xC0 bytes (sizeof)
		/*0x0C0*/     struct _EX_WORK_QUEUE ExWorkerQueues[7];
		/*0x2F0*/     struct _KEVENT ExpThreadSetManagerEvent;           // 1 elements, 0x18 bytes (sizeof)
		/*0x308*/     struct _ETHREAD* ExpWorkerThreadBalanceManagerPtr;
		/*0x310*/     ULONG32      ExpWorkerSeed;
		union                                              // 2 elements, 0x2C bytes (sizeof)
		{
			struct                                         // 2 elements, 0x4 bytes (sizeof)
			{
				/*0x314*/             ULONG32      ExWorkerFullInit : 1;         // 0 BitPosition
				/*0x314*/             ULONG32      ExWorkerStructInit : 1;       // 1 BitPosition
			};
			/*0x314*/         ULONG32      ExWorkerFlags;
		};
	}ENODE, * PENODE;
	...
	typedef struct _KPROCESS                          // 41 elements, 0x2C8 bytes (sizeof)
	{
		/*0x000*/     struct _DISPATCHER_HEADER Header;             // 30 elements, 0x18 bytes (sizeof)
		...
		union                                         // 2 elements, 0x4 bytes (sizeof)
		{
			struct                                    // 8 elements, 0x4 bytes (sizeof)
			{
				...
				/*0x1B0*/             ULONG32      ActiveGroupsMask : 20;   // 6 BitPosition
				/*0x1B0*/             LONG32       ReservedFlags : 6;       // 26 BitPosition
			};
	...
	typedef struct _MMSUPPORT_FLAGS                 // 13 elements, 0x4 bytes (sizeof)
	{
		struct                                      // 4 elements, 0x1 bytes (sizeof)
		{
	...
	typedef struct _MMSUPPORT                        // 23 elements, 0x90 bytes (sizeof)
	{
		...
		/*0x084*/     struct _MMSUPPORT_FLAGS Flags;               // 13 elements, 0x4 bytes (sizeof)
		/*0x088*/     VOID* WsSwapSupport;
	}MMSUPPORT, * PMMSUPPORT;

	typedef struct _MM_AVL_NODE          // 3 elements, 0x18 bytes (sizeof)
	{
		union                            // 2 elements, 0x8 bytes (sizeof)
		{
			/*0x000*/         INT64        Balance : 2;    // 0 BitPosition
			/*0x000*/         struct _MM_AVL_NODE* Parent;
		}u1;
		/*0x008*/     struct _MM_AVL_NODE* LeftChild;
		/*0x010*/     struct _MM_AVL_NODE* RightChild;
	}MM_AVL_NODE, * PMM_AVL_NODE;

	typedef struct _MM_AVL_TABLE                          // 6 elements, 0x30 bytes (sizeof)
	{
		/*0x000*/     struct _MM_AVL_NODE BalancedRoot;                 // 3 elements, 0x18 bytes (sizeof)
		struct                                            // 3 elements, 0x8 bytes (sizeof)
		{
			/*0x018*/         UINT64       DepthOfTree : 5;                 // 0 BitPosition
			/*0x018*/         UINT64       TableType : 3;                   // 5 BitPosition
			/*0x018*/         UINT64       NumberGenericTableElements : 56; // 8 BitPosition
		};
		/*0x020*/     VOID* NodeHint;
		/*0x028*/     VOID* NodeFreeHint;
	}MM_AVL_TABLE, * PMM_AVL_TABLE;

	typedef struct _EPROCESS                                               // 152 elements, 0x660 bytes (sizeof)
	{
		/*0x000*/     struct _KPROCESS Pcb;                                              // 41 elements, 0x2C8 bytes (sizeof)
		...
		union                                                              // 2 elements, 0x4 bytes (sizeof)
		{
			...
			struct                                                         // 28 elements, 0x4 bytes (sizeof)
			{
				...
				/*0x2F8*/             ULONG32      NoWakeCharge : 1;                             // 6 BitPosition
				/*0x2F8*/             ULONG32      HandleTableRundown : 1;                       // 7 BitPosition
				/*0x2F8*/             ULONG32      NeedsHandleRundown : 1;                       // 8 BitPosition
				/*0x2F8*/             ULONG32      RefTraceEnabled : 1;                          // 9 BitPosition
				/*0x2F8*/             ULONG32      NumaAware : 1;                                // 10 BitPosition
		...
		union                                                              // 2 elements, 0x4 bytes (sizeof)
		{
			...
			struct                                                         // 29 elements, 0x4 bytes (sizeof)
			{
				...
				/*0x2FC*/             ULONG32      Wow64SplitPages : 1;                          // 4 BitPosition
				...
				/*0x2FC*/             ULONG32      CrossSessionCreate : 1;                       // 25 BitPosition
		...
		/*0x360*/     struct _ETHREAD* RotateInProgress;
		/*0x368*/     struct _ETHREAD* ForkInProgress;
		/*0x370*/     UINT64       HardwareTrigger;
		/*0x378*/     struct _EJOB* CommitChargeJob;
		/*0x380*/     struct _MM_AVL_TABLE* CloneRoot;
		...
		union                                                              // 2 elements, 0x8 bytes (sizeof)
		{
			/*0x3E0*/         struct _EPROCESS* CreatorProcess;
			/*0x3E0*/         UINT64       ConsoleHostProcess;
		};
		...
		/*0x498*/     struct _MM_AVL_TABLE* LockedPagesList;
		...
		/*0x4D0*/     UINT64       CommitChargeLimit;
		/*0x4D8*/     UINT64       CommitCharge;
		/*0x4E0*/     UINT64       CommitChargePeak;
		/*0x4E8*/     struct _MMSUPPORT Vm;                                              // 23 elements, 0x90 bytes (sizeof)
		/*0x578*/     struct _LIST_ENTRY MmProcessLinks;                                 // 2 elements, 0x10 bytes (sizeof)
		/*0x588*/     ULONG32      ModifiedPageCount;
		/*0x58C*/     LONG32       ExitStatus;
		/*0x590*/     struct _MM_AVL_TABLE VadRoot;                                      // 6 elements, 0x30 bytes (sizeof)
		/*0x5C0*/     UINT64       VadPhysicalPages;
		/*0x5C8*/     UINT64       VadPhysicalPagesLimit;
		/*0x5D0*/     struct _ALPC_PROCESS_CONTEXT AlpcContext;                          // 3 elements, 0x20 bytes (sizeof)
		/*0x5F0*/     struct _LIST_ENTRY TimerResolutionLink;                            // 2 elements, 0x10 bytes (sizeof)
		/*0x600*/     struct _PO_DIAG_STACK_RECORD* TimerResolutionStackRecord;
		/*0x608*/     ULONG32      RequestedTimerResolution;
		/*0x60C*/     ULONG32      SmallestTimerResolution;
		/*0x610*/     union _LARGE_INTEGER ExitTime;                                     // 4 elements, 0x8 bytes (sizeof)
		/*0x618*/     struct _INVERTED_FUNCTION_TABLE* InvertedFunctionTable;
		/*0x620*/     struct _EX_PUSH_LOCK InvertedFunctionTableLock;                    // 7 elements, 0x8 bytes (sizeof)
		/*0x628*/     ULONG32      ActiveThreadsHighWatermark;
		/*0x62C*/     ULONG32      LargePrivateVadCount;
		/*0x630*/     struct _EX_PUSH_LOCK ThreadListLock;                               // 7 elements, 0x8 bytes (sizeof)
		/*0x638*/     VOID* WnfContext;
		/*0x640*/     UINT64       SectionMappingSize;
		/*0x648*/     UINT8        SignatureLevel;
		/*0x649*/     UINT8        SectionSignatureLevel;
		/*0x64A*/     UINT8        SpareByte20[2];
		/*0x64C*/     ULONG32      KeepAliveCounter;
		/*0x650*/     struct _PROCESS_DISK_COUNTERS* DiskCounters;
		/*0x658*/     UINT64       LastFreezeInterruptTime;
	}EPROCESS, * PEPROCESS;
	...
	typedef struct _KAPC                                        // 17 elements, 0x58 bytes (sizeof)
	{
		...
		union                                                   // 2 elements, 0x18 bytes (sizeof)
		{
			struct                                              // 3 elements, 0x18 bytes (sizeof)
			{
				/*0x020*/             FUNCT_00BC_06B9_KernelRoutine* KernelRoutine;
				/*0x028*/             FUNCT_00BC_06C7_RundownRoutine* RundownRoutine;
				/*0x030*/             FUNCT_00BC_06C2_NormalRoutine* NormalRoutine;
			};
	...
	typedef struct _KTHREAD                                // 144 elements, 0x348 bytes (sizeof)
	{
		/*0x000*/     struct _DISPATCHER_HEADER Header;                  // 30 elements, 0x18 bytes (sizeof)
		...
		union                                              // 2 elements, 0x4 bytes (sizeof)
		{
			struct                                         // 20 elements, 0x4 bytes (sizeof)
			{
				...
				/*0x074*/             ULONG32      Reserved : 13;                // 19 BitPosition
			};
		...
		/*0x21C*/     ULONG32      DeferredProcessor;
		...
		union                                              // 2 elements, 0x30 bytes (sizeof)
		{
			/*0x258*/         struct _KAPC_STATE SavedApcState;              // 5 elements, 0x30 bytes (sizeof)
		...
		/*0x318*/     INT64        ReadOperationCount;
		/*0x320*/     INT64        WriteOperationCount;
		/*0x328*/     INT64        OtherOperationCount;
		/*0x330*/     INT64        ReadTransferCount;
		/*0x338*/     INT64        WriteTransferCount;
		/*0x340*/     INT64        OtherTransferCount;
	}KTHREAD, * PKTHREAD;
	...
	typedef struct _ETHREAD                                              // 94 elements, 0x4D0 bytes (sizeof)
	{
		/*0x000*/     struct _KTHREAD Tcb;                                             // 144 elements, 0x348 bytes (sizeof)
		...
		union                                                            // 2 elements, 0x10 bytes (sizeof)
		{
			...
			/*0x350*/         struct _LIST_ENTRY KeyedWaitChain;                           // 2 elements, 0x10 bytes (sizeof)
		};
		/*0x360*/     VOID* ChargeOnlySession;
		union                                                            // 2 elements, 0x10 bytes (sizeof)
		{
			/*0x368*/         struct _LIST_ENTRY PostBlockList;                            // 2 elements, 0x10 bytes (sizeof)
			struct                                                       // 2 elements, 0x10 bytes (sizeof)
			{
				/*0x368*/             VOID* ForwardLinkShadow;
				/*0x370*/             VOID* StartAddress;
			};
		};
		union                                                            // 3 elements, 0x8 bytes (sizeof)
		{
			/*0x378*/         struct _TERMINATION_PORT* TerminationPort;
			/*0x378*/         struct _ETHREAD* ReaperLink;
			/*0x378*/         VOID* KeyedWaitValue;
		};
		/*0x380*/     UINT64       ActiveTimerListLock;
		/*0x388*/     struct _LIST_ENTRY ActiveTimerListHead;                          // 2 elements, 0x10 bytes (sizeof)
		/*0x398*/     struct _CLIENT_ID Cid;                                           // 2 elements, 0x10 bytes (sizeof)
		union                                                            // 2 elements, 0x20 bytes (sizeof)
		{
			/*0x3A8*/         struct _KSEMAPHORE KeyedWaitSemaphore;                       // 2 elements, 0x20 bytes (sizeof)
			/*0x3A8*/         struct _KSEMAPHORE AlpcWaitSemaphore;                        // 2 elements, 0x20 bytes (sizeof)
		};
		/*0x3C8*/     union _PS_CLIENT_SECURITY_CONTEXT ClientSecurity;                // 4 elements, 0x8 bytes (sizeof)
		/*0x3D0*/     struct _LIST_ENTRY IrpList;                                      // 2 elements, 0x10 bytes (sizeof)
		/*0x3E0*/     UINT64       TopLevelIrp;
		/*0x3E8*/     struct _DEVICE_OBJECT* DeviceToVerify;
		...
		/*0x470*/     struct _LIST_ENTRY BoostList;                                    // 2 elements, 0x10 bytes (sizeof)
		/*0x480*/     struct _LIST_ENTRY DeboostList;                                  // 2 elements, 0x10 bytes (sizeof)
		/*0x490*/     UINT64       BoostListLock;
		/*0x498*/     UINT64       IrpListLock;
		/*0x4A0*/     VOID* ReservedForSynchTracking;
		/*0x4A8*/     struct _SINGLE_LIST_ENTRY CmCallbackListHead;                    // 1 elements, 0x8 bytes (sizeof)
		/*0x4B0*/     struct _GUID* ActivityId;
		/*0x4B8*/     VOID* WnfContext;
		/*0x4C0*/     struct _SINGLE_LIST_ENTRY SeLearningModeListHead;                // 1 elements, 0x8 bytes (sizeof)
		/*0x4C8*/     ULONG32      KernelStackReference;
		/*0x4CC*/     UINT8        _PADDING2_[0x4];
	}ETHREAD, * PETHREAD;
	...
	typedef struct _ETW_GUID_ENTRY                    // 10 elements, 0x178 bytes (sizeof)
	{
		...
		/*0x170*/     struct _EVENT_FILTER_HEADER** FilterData;
	...
	typedef struct _EXCEPTION_REGISTRATION_RECORD    // 2 elements, 0x10 bytes (sizeof)
	{
		...
		/*0x008*/     FUNCT_014E_014D_Handler* Handler;
	...
	typedef struct _FAST_IO_DISPATCH                                                                                // 28 elements, 0xE0 bytes (sizeof)
	{
		...
		/*0x004*/     UINT8        _PADDING0_[0x4];
		/*0x008*/     FUNCT_007B_0B09_FastIoCheckIfPossible* FastIoCheckIfPossible;
		/*0x010*/     FUNCT_007B_0B14_FastIoRead_FastIoWrite* FastIoRead;
		/*0x018*/     FUNCT_007B_0B14_FastIoRead_FastIoWrite* FastIoWrite;
		/*0x020*/     FUNCT_007B_0B1E_FastIoQueryBasicInfo* FastIoQueryBasicInfo;
		/*0x028*/     FUNCT_007B_0B2C_FastIoQueryStandardInfo* FastIoQueryStandardInfo;
		/*0x030*/     FUNCT_007B_0B3A_FastIoLock* FastIoLock;
		/*0x038*/     FUNCT_007B_0D82_FastIoUnlockSingle* FastIoUnlockSingle;
		/*0x040*/     FUNCT_007B_0D8B_FastIoUnlockAll* FastIoUnlockAll;
		/*0x048*/     FUNCT_007B_0D91_FastIoUnlockAllByKey* FastIoUnlockAllByKey;
		/*0x050*/     FUNCT_007B_0D98_FastIoDeviceControl* FastIoDeviceControl;
		/*0x058*/     FUNCT_00BC_0DA3_AcquireFileForNtCreateSection_ReleaseFileForNtCreateSection* AcquireFileForNtCreateSection;
		/*0x060*/     FUNCT_00BC_0DA3_AcquireFileForNtCreateSection_ReleaseFileForNtCreateSection* ReleaseFileForNtCreateSection;
		/*0x068*/     FUNCT_00BC_0DA6_FastIoDetachDevice* FastIoDetachDevice;
		/*0x070*/     FUNCT_007B_0DAA_FastIoQueryNetworkOpenInfo* FastIoQueryNetworkOpenInfo;
		/*0x078*/     FUNCT_0072_0DBA_AcquireForModWrite* AcquireForModWrite;
		/*0x080*/     FUNCT_007B_0DC0_MdlRead_PrepareMdlWrite* MdlRead;
		/*0x088*/     FUNCT_007B_0DD6_MdlReadComplete_MdlReadCompleteCompressed* MdlReadComplete;
		/*0x090*/     FUNCT_007B_0DC0_MdlRead_PrepareMdlWrite* PrepareMdlWrite;
		/*0x098*/     FUNCT_007B_0DDB_MdlWriteComplete_MdlWriteCompleteCompressed* MdlWriteComplete;
		/*0x0A0*/     FUNCT_007B_0DE1_FastIoReadCompressed_FastIoWriteCompressed* FastIoReadCompressed;
		/*0x0A8*/     FUNCT_007B_0DE1_FastIoReadCompressed_FastIoWriteCompressed* FastIoWriteCompressed;
		/*0x0B0*/     FUNCT_007B_0DD6_MdlReadComplete_MdlReadCompleteCompressed* MdlReadCompleteCompressed;
		/*0x0B8*/     FUNCT_007B_0DDB_MdlWriteComplete_MdlWriteCompleteCompressed* MdlWriteCompleteCompressed;
		/*0x0C0*/     FUNCT_007B_0DF6_FastIoQueryOpen* FastIoQueryOpen;
		/*0x0C8*/     FUNCT_0072_10CD_ReleaseForModWrite* ReleaseForModWrite;
		/*0x0D0*/     FUNCT_0072_10D2_AcquireForCcFlush_ReleaseForCcFlush* AcquireForCcFlush;
		/*0x0D8*/     FUNCT_0072_10D2_AcquireForCcFlush_ReleaseForCcFlush* ReleaseForCcFlush;
	...
	typedef struct _FS_FILTER_CALLBACKS                                                                                                                                                                                                                // 14 elements, 0x68 bytes (sizeof)
	{
		...
		/*0x004*/     ULONG32      Reserved;
		/*0x008*/     FUNCT_0072_0A6A_PreAcquireForSectionSynchronization_PreReleaseForSectionSynchronization_PreAcquireForCcFlush_PreReleaseForCcFlush_PreAcquireForModifiedPageWriter_PreReleaseForModifiedPageWriter* PreAcquireForSectionSynchronization;
		/*0x010*/     FUNCT_00BC_0AE5_PostAcquireForSectionSynchronization_PostReleaseForSectionSynchronization_PostAcquireForCcFlush_PostReleaseForCcFlush_PostAcquireForModifiedPageWriter_PostReleaseForModifiedPageWriter* PostAcquireForSectionSynchronization;
		/*0x018*/     FUNCT_0072_0A6A_PreAcquireForSectionSynchronization_PreReleaseForSectionSynchronization_PreAcquireForCcFlush_PreReleaseForCcFlush_PreAcquireForModifiedPageWriter_PreReleaseForModifiedPageWriter* PreReleaseForSectionSynchronization;
		/*0x020*/     FUNCT_00BC_0AE5_PostAcquireForSectionSynchronization_PostReleaseForSectionSynchronization_PostAcquireForCcFlush_PostReleaseForCcFlush_PostAcquireForModifiedPageWriter_PostReleaseForModifiedPageWriter* PostReleaseForSectionSynchronization;
		/*0x028*/     FUNCT_0072_0A6A_PreAcquireForSectionSynchronization_PreReleaseForSectionSynchronization_PreAcquireForCcFlush_PreReleaseForCcFlush_PreAcquireForModifiedPageWriter_PreReleaseForModifiedPageWriter* PreAcquireForCcFlush;
		/*0x030*/     FUNCT_00BC_0AE5_PostAcquireForSectionSynchronization_PostReleaseForSectionSynchronization_PostAcquireForCcFlush_PostReleaseForCcFlush_PostAcquireForModifiedPageWriter_PostReleaseForModifiedPageWriter* PostAcquireForCcFlush;
		/*0x038*/     FUNCT_0072_0A6A_PreAcquireForSectionSynchronization_PreReleaseForSectionSynchronization_PreAcquireForCcFlush_PreReleaseForCcFlush_PreAcquireForModifiedPageWriter_PreReleaseForModifiedPageWriter* PreReleaseForCcFlush;
		/*0x040*/     FUNCT_00BC_0AE5_PostAcquireForSectionSynchronization_PostReleaseForSectionSynchronization_PostAcquireForCcFlush_PostReleaseForCcFlush_PostAcquireForModifiedPageWriter_PostReleaseForModifiedPageWriter* PostReleaseForCcFlush;
		/*0x048*/     FUNCT_0072_0A6A_PreAcquireForSectionSynchronization_PreReleaseForSectionSynchronization_PreAcquireForCcFlush_PreReleaseForCcFlush_PreAcquireForModifiedPageWriter_PreReleaseForModifiedPageWriter* PreAcquireForModifiedPageWriter;
		/*0x050*/     FUNCT_00BC_0AE5_PostAcquireForSectionSynchronization_PostReleaseForSectionSynchronization_PostAcquireForCcFlush_PostReleaseForCcFlush_PostAcquireForModifiedPageWriter_PostReleaseForModifiedPageWriter* PostAcquireForModifiedPageWriter;
		/*0x058*/     FUNCT_0072_0A6A_PreAcquireForSectionSynchronization_PreReleaseForSectionSynchronization_PreAcquireForCcFlush_PreReleaseForCcFlush_PreAcquireForModifiedPageWriter_PreReleaseForModifiedPageWriter* PreReleaseForModifiedPageWriter;
		/*0x060*/     FUNCT_00BC_0AE5_PostAcquireForSectionSynchronization_PostReleaseForSectionSynchronization_PostAcquireForCcFlush_PostReleaseForCcFlush_PostAcquireForModifiedPageWriter_PostReleaseForModifiedPageWriter* PostReleaseForModifiedPageWriter;
	...
	typedef struct _GENERAL_LOOKASIDE                                                                                                                                                                                    // 22 elements, 0x80 bytes (sizeof)
	{
		...
		union                                                                                                                                                                                                            // 2 elements, 0x8 bytes (sizeof)
		{
			/*0x030*/         FUNCT_00BF_0740_AllocateEx* AllocateEx;
			/*0x030*/         FUNCT_00BF_074A_Allocate* Allocate;
		};
		union                                                                                                                                                                                                            // 2 elements, 0x8 bytes (sizeof)
		{
			/*0x038*/         FUNCT_00BC_074F_FreeEx* FreeEx;
			/*0x038*/         FUNCT_00BC_0753_Free_IdleComplete_WorkerRoutine_InterfaceReference_InterfaceDereference_DeleteProcedure_DevicePowerRequired_DevicePowerNotRequired_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead* Free;
		};
	...
	typedef struct _HEAP                                 // 56 elements, 0x298 bytes (sizeof)
	{
		...
		/*0x168*/     FUNCT_0072_1B2B_CommitRoutine* CommitRoutine;
	...
	typedef struct __2016091401320F02638D3DC4179572A34_Locations_RecoverableLocations // 3 elements, 0xC bytes (sizeof)
	{
		/*0x000*/     enum _CM_LOAD_FAILURE_TYPE Failure;
		/*0x004*/     LONG32       Status;
		/*0x008*/     ULONG32      Point;
	}_2016091401320F02638D3DC4179572A34_Locations_RecoverableLocations, * P_2016091401320F02638D3DC4179572A34_Locations_RecoverableLocations;
	...
	typedef struct _HIVE_LOAD_FAILURE                                                                      // 13 elements, 0x160 bytes (sizeof)
	{
		...
		/*0x010*/     struct __2016091401320F02638D3DC4179572A34_Locations_RecoverableLocations Locations[8];
		/*0x070*/     struct __2016091401320F02638D3DC4179572A34_Locations_RecoverableLocations RecoverableLocations[8];
		struct                                                                                             // 3 elements, 0x18 bytes (sizeof)
		{
	...
	typedef struct _HIVE_WAIT_PACKET     // 4 elements, 0x30 bytes (sizeof)
	{
		/*0x000*/     struct _KEVENT WakeEvent;        // 1 elements, 0x18 bytes (sizeof)
		/*0x018*/     LONG32       Status;
		/*0x01C*/     UINT8        _PADDING0_[0x4];
		/*0x020*/     struct _HIVE_WAIT_PACKET* Next;
		/*0x028*/     UINT8        PrimaryFileWritten;
		/*0x029*/     UINT8        _PADDING1_[0x7];
	...
	typedef struct _IO_MINI_COMPLETION_PACKET_USER              // 9 elements, 0x50 bytes (sizeof)
	{
		...
		/*0x038*/     FUNCT_00BC_0C71_MiniPacketCallback* MiniPacketCallback;
		/*0x040*/     VOID* Context;
	...
	typedef struct _IO_STACK_LOCATION                                             // 9 elements, 0x48 bytes (sizeof)
	{
		...
		/*0x038*/     FUNCT_0072_10C8_CompletionRoutine* CompletionRoutine;
		/*0x040*/     VOID* Context;
	...
	typedef struct _IO_TIMER                        // 6 elements, 0x30 bytes (sizeof)
	{
		...
		/*0x018*/     FUNCT_00BC_10E8_TimerRoutine* TimerRoutine;
		/*0x020*/     VOID* Context;
		/*0x028*/     struct _DEVICE_OBJECT* DeviceObject;
	}IO_TIMER, * PIO_TIMER;
	...
	typedef struct _WORK_QUEUE_ITEM                                                                                                                                                                                           // 3 elements, 0x20 bytes (sizeof)
	{
		...
		/*0x010*/     FUNCT_00BC_0753_Free_IdleComplete_WorkerRoutine_InterfaceReference_InterfaceDereference_DeleteProcedure_DevicePowerRequired_DevicePowerNotRequired_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead* WorkerRoutine;
	...
	typedef struct _IO_WORKITEM           // 6 elements, 0x50 bytes (sizeof)
	{
		...
		/*0x020*/     FUNCT_00BC_2478_Routine* Routine;
		/*0x028*/     VOID* IoObject;
		/*0x030*/     VOID* Context;
		/*0x038*/     ULONG32      Type;
	...
	typedef struct _IOP_IRP_EXTENSION         // 8 elements, 0x20 bytes (sizeof)
	{
		union                                 // 2 elements, 0x2 bytes (sizeof)
		{
			...
			struct                            // 4 elements, 0x2 bytes (sizeof)
			{
				...
				/*0x000*/             UINT16       SpareBits : 5;   // 3 BitPosition
			};
		};
		/*0x002*/     UINT16       TypesAllocated;
		/*0x004*/     struct _GUID ActivityId;              // 4 elements, 0x10 bytes (sizeof)
		/*0x014*/     UINT8        _PADDING0_[0x4];
		/*0x018*/     union _LARGE_INTEGER Timestamp;       // 4 elements, 0x8 bytes (sizeof)
	...
	typedef struct _IRP                                              // 23 elements, 0xD0 bytes (sizeof)
	{
		...
		union                                                        // 2 elements, 0x10 bytes (sizeof)
		{
			struct                                                   // 3 elements, 0x10 bytes (sizeof)
			{
				union                                                // 2 elements, 0x8 bytes (sizeof)
				{
					/*0x058*/                 FUNCT_00BC_0E1F_UserApcRoutine* UserApcRoutine;
		...
		/*0x068*/     FUNCT_00BC_0E24_DriverStartIo_CancelRoutine* CancelRoutine;
	...
	typedef struct _KENTROPY_TIMING_STATE // 4 elements, 0x150 bytes (sizeof)
	{
		...
		/*0x108*/     struct _KDPC Dpc;                 // 9 elements, 0x40 bytes (sizeof)
	...
	typedef struct _KINTERRUPT                                                                 // 29 elements, 0xB0 bytes (sizeof)
	{
		/*0x000*/     INT16        Type;
		/*0x002*/     INT16        Size;
		/*0x004*/     UINT8        _PADDING0_[0x4];
		/*0x008*/     struct _LIST_ENTRY InterruptListEntry;                                                 // 2 elements, 0x10 bytes (sizeof)
		/*0x018*/     FUNCT_007B_20EB_ServiceRoutine* ServiceRoutine;
		/*0x020*/     FUNCT_007B_20EF_MessageServiceRoutine* MessageServiceRoutine;
		...
		/*0x050*/     FUNCT_00BC_027C_PostProcessInitRoutine_DispatchAddress_FinishRoutine* DispatchAddress;
	...
	typedef struct _PROCESSOR_POWER_STATE                         // 33 elements, 0x1C8 bytes (sizeof)
	{
		/*0x000*/     struct _PPM_IDLE_STATES* IdleStates;
		/*0x008*/     struct _PROC_IDLE_ACCOUNTING* IdleAccounting;
		/*0x010*/     struct _PLATFORM_IDLE_ACCOUNTING* PlatformIdleAccounting;
		/*0x018*/     UINT64       IdleTimeLast;
		/*0x020*/     UINT64       IdleTimeTotal;
		/*0x028*/     UINT64       IdleTimeEntry;
		/*0x030*/     UINT64       Reserved;
		/*0x038*/     struct _PROC_IDLE_POLICY IdlePolicy;                      // 5 elements, 0x5 bytes (sizeof)
		/*0x03D*/     UINT8        _PADDING0_[0x3];
		/*0x040*/     union _PPM_IDLE_SYNCHRONIZATION_STATE Synchronization;    // 3 elements, 0x4 bytes (sizeof)
		/*0x044*/     UINT8        _PADDING1_[0x4];
		/*0x048*/     struct _PROC_FEEDBACK PerfFeedback;                       // 13 elements, 0x70 bytes (sizeof)
		/*0x0B8*/     enum _PROC_HYPERVISOR_STATE Hypervisor;
		/*0x0BC*/     ULONG32      LastSysTime;
		/*0x0C0*/     UINT64       WmiDispatchPtr;
		/*0x0C8*/     LONG32       WmiInterfaceEnabled;
		/*0x0CC*/     UINT8        _PADDING2_[0x4];
		/*0x0D0*/     struct _PPM_FFH_THROTTLE_STATE_INFO FFHThrottleStateInfo; // 5 elements, 0x20 bytes (sizeof)
		/*0x0F0*/     struct _KDPC PerfActionDpc;                               // 9 elements, 0x40 bytes (sizeof)
		/*0x130*/     LONG32       PerfActionMask;
		/*0x134*/     UINT8        _PADDING3_[0x4];
		/*0x138*/     struct _PROC_IDLE_SNAP HvIdleCheck;                       // 2 elements, 0x10 bytes (sizeof)
		/*0x148*/     struct _PROC_PERF_SNAP PerfCheck;                         // 8 elements, 0x40 bytes (sizeof)
		/*0x188*/     struct _PROC_PERF_DOMAIN* Domain;
		/*0x190*/     struct _PROC_PERF_CONSTRAINT* PerfConstraint;
		/*0x198*/     struct _PPM_CONCURRENCY_ACCOUNTING* Concurrency;
		/*0x1A0*/     struct _PROC_PERF_LOAD* Load;
		/*0x1A8*/     struct _PROC_PERF_HISTORY* PerfHistory;
		/*0x1B0*/     UINT8        GuaranteedPerformancePercent;
		/*0x1B1*/     UINT8        HvTargetState;
		/*0x1B2*/     UINT8        Parked;
		/*0x1B3*/     UINT8        OverUtilized;
		/*0x1B4*/     ULONG32      LatestPerformancePercent;
		/*0x1B8*/     ULONG32      AveragePerformancePercent;
		/*0x1BC*/     ULONG32      LatestAffinitizedPercent;
		/*0x1C0*/     ULONG32      Utility;
		/*0x1C4*/     ULONG32      AffinitizedUtility;
	...
	typedef struct _KREQUEST_PACKET                   // 2 elements, 0x20 bytes (sizeof)
	{
		...
		/*0x018*/     FUNCT_00BC_092F_WorkerRoutine* WorkerRoutine;
	...
	typedef struct _KPRCB                                                    // 226 elements, 0x5B80 bytes (sizeof)
	{
		/*0x000*/      ULONG32      MxCsr;
		...
		union                                                                // 4 elements, 0x4 bytes (sizeof)
		{
			...
			struct                                                           // 10 elements, 0x4 bytes (sizeof)
			{
				/*0x2DDC*/             ULONG32      DpcNormalProcessingActive : 1;                  // 0 BitPosition
				/*0x2DDC*/             ULONG32      DpcNormalProcessingRequested : 1;               // 1 BitPosition
				/*0x2DDC*/             ULONG32      DpcNormalThreadSignal : 1;                      // 2 BitPosition
				/*0x2DDC*/             ULONG32      DpcNormalTimerExpiration : 1;                   // 3 BitPosition
				/*0x2DDC*/             ULONG32      DpcNormalDpcPresent : 1;                        // 4 BitPosition
				/*0x2DDC*/             ULONG32      DpcNormalLocalInterrupt : 1;                    // 5 BitPosition
				/*0x2DDC*/             ULONG32      DpcNormalSpare : 10;                            // 6 BitPosition
				/*0x2DDC*/             ULONG32      DpcThreadActive : 1;                            // 16 BitPosition
				/*0x2DDC*/             ULONG32      DpcThreadRequested : 1;                         // 17 BitPosition
				/*0x2DDC*/             ULONG32      DpcThreadSpare : 14;                            // 18 BitPosition
			};
		};
		/*0x2DE0*/     ULONG32      LastTimerHand;
		/*0x2DE4*/     ULONG32      LastTick;
		/*0x2DE8*/     ULONG32      ClockInterrupts;
		/*0x2DEC*/     ULONG32      ReadyScanTick;
		/*0x2DF0*/     UINT8        BalanceState;
		/*0x2DF1*/     UINT8        PrcbPad50[7];
		/*0x2DF8*/     ULONG32      InterruptLastCount;
		/*0x2DFC*/     ULONG32      InterruptRate;
		...
		/*0x50A0*/     ULONG32      ReadyQueueWeight;
		/*0x50A4*/     ULONG32      PrcbPad75;
		/*0x50A8*/     struct _KDPC TimerExpirationDpc;                                     // 9 elements, 0x40 bytes (sizeof)
		...
		/*0x5350*/     UINT64       AffinitizedCycles;
		/*0x5358*/     UINT64       PrcbPad81;
		...
		/*0x5400*/     struct _PROCESSOR_POWER_STATE PowerState;                            // 33 elements, 0x1C8 bytes (sizeof)
		/*0x55C8*/     struct _LIST_ENTRY ScbList;                                          // 2 elements, 0x10 bytes (sizeof)
		/*0x55D8*/     ULONG32      PrcbPad92[22];
		/*0x5630*/     ULONG32      KeAlignmentFixupCount;
		/*0x5634*/     UINT8        _PADDING2_[0x4];
		/*0x5638*/     struct _KDPC DpcWatchdogDpc;                                         // 9 elements, 0x40 bytes (sizeof)
		/*0x5678*/     struct _KTIMER DpcWatchdogTimer;                                     // 6 elements, 0x40 bytes (sizeof)
		/*0x56B8*/     struct _CACHE_DESCRIPTOR Cache[5];
		/*0x56F4*/     ULONG32      CacheCount;
		/*0x56F8*/     ULONG32      CachedCommit;
		/*0x56FC*/     ULONG32      CachedResidentAvailable;
		/*0x5700*/     VOID* HyperPte;
		/*0x5708*/     VOID* WheaInfo;
		/*0x5710*/     VOID* EtwSupport;
		/*0x5718*/     UINT8        _PADDING3_[0x8];
		/*0x5720*/     union _SLIST_HEADER InterruptObjectPool;                             // 4 elements, 0x10 bytes (sizeof)
		/*0x5730*/     union _SLIST_HEADER HypercallPageList;                               // 4 elements, 0x10 bytes (sizeof)
		...
		/*0x5800*/     UINT64       CacheProcessorMask[5];
		/*0x5828*/     UINT64       ScanSiblingMask;
		/*0x5830*/     ULONG32      ScanSiblingIndex;
		/*0x5834*/     ULONG32      LLCLevel;
		/*0x5838*/     UINT64       CoreProcessorSet;
		/*0x5840*/     struct _PROCESSOR_PROFILE_CONTROL_AREA* ProcessorProfileControlArea;
		/*0x5848*/     VOID* ProfileEventIndexAddress;
		/*0x5850*/     UINT64       PrcbPad94[6];
		/*0x5880*/     struct _SYNCH_COUNTERS SynchCounters;                                // 46 elements, 0xB8 bytes (sizeof)
		/*0x5938*/     struct _FILESYSTEM_DISK_COUNTERS FsCounters;                         // 2 elements, 0x10 bytes (sizeof)
		/*0x5948*/     UINT8        VendorString[13];
		/*0x5955*/     UINT8        PrcbPad10[3];
		/*0x5958*/     ULONG32      FeatureBits;
		/*0x595C*/     UINT8        _PADDING4_[0x4];
		/*0x5960*/     union _LARGE_INTEGER UpdateSignature;                                // 4 elements, 0x8 bytes (sizeof)
		/*0x5968*/     struct _CONTEXT* Context;
		/*0x5970*/     ULONG32      ContextFlagsInit;
		/*0x5974*/     UINT8        _PADDING5_[0x4];
		/*0x5978*/     struct _XSAVE_AREA* ExtendedState;
		/*0x5980*/     struct _KENTROPY_TIMING_STATE EntropyTimingState;                    // 4 elements, 0x150 bytes (sizeof)
		/*0x5AD0*/     UINT8        _PADDING6_[0x30];
		/*0x5B00*/     struct _REQUEST_MAILBOX* Mailbox;
		/*0x5B08*/     UINT8        _PADDING7_[0x38];
		/*0x5B40*/     struct _REQUEST_MAILBOX RequestMailbox[1];
	}KPRCB, * PKPRCB;

	typedef struct _KPCR                             // 27 elements, 0x5D00 bytes (sizeof)
	{
		...
		/*0x180*/     struct _KPRCB Prcb;                          // 226 elements, 0x5B80 bytes (sizeof)
	}KPCR, * PKPCR;
	...
	typedef struct _RTL_AVL_TABLE                         // 11 elements, 0x68 bytes (sizeof)
	{
		...
		/*0x044*/     UINT8        _PADDING1_[0x4];
		/*0x048*/     FUNCT_22CB_22CA_CompareRoutine* CompareRoutine;
		/*0x050*/     FUNCT_00BF_22D4_AllocateRoutine* AllocateRoutine;
		/*0x058*/     FUNCT_00BC_22D8_FreeRoutine* FreeRoutine;
	...
	typedef struct _KRESOURCEMANAGER                                   // 20 elements, 0x250 bytes (sizeof)
	{
		...
		/*0x128*/     FUNCT_0072_2285_NotificationRoutine* NotificationRoutine;
		/*0x130*/     VOID* Key;
	...
	{
		/*0x000*/     enum ___2016091401320F02FA8D3DC41796E34FB_RecordType RecordType;
	...
	typedef struct _KUSER_SHARED_DATA                                // 92 elements, 0x5F0 bytes (sizeof)
	{
		...
		union                                                        // 2 elements, 0x2 bytes (sizeof)
		{
			/*0x3C6*/         UINT16       TscQpcData;
			struct                                                   // 2 elements, 0x2 bytes (sizeof)
			{
				/*0x3C6*/             UINT8        TscQpcEnabled;
				/*0x3C7*/             UINT8        TscQpcShift;
			};
		};
	...
	typedef struct _LDR_DATA_TABLE_ENTRY                         // 54 elements, 0x110 bytes (sizeof)
	{
	...
	typedef struct _LOG_HANDLE_CONTEXT                                        // 12 elements, 0x80 bytes (sizeof)
	{
		/*0x000*/     VOID* LogHandle;
		/*0x008*/     FUNCT_00BC_19FA_FlushToLsnRoutine* FlushToLsnRoutine;
		/*0x010*/     FUNCT_00BC_19FE_QueryLogHandleInfoRoutine* QueryLogHandleInfoRoutine;
		...
		/*0x060*/     struct _FILE_OBJECT* RelatedFileObject;
		/*0x068*/     UINT64       LargestLsnFileObjectKey;
		/*0x070*/     union _LARGE_INTEGER LastLWTimeStamp;                                 // 4 elements, 0x8 bytes (sizeof)
		/*0x078*/     ULONG32      Flags;
	...
	typedef struct _SEGMENT_FLAGS                    // 14 elements, 0x4 bytes (sizeof)
	{
		struct                                       // 7 elements, 0x2 bytes (sizeof)
		{
			...
			/*0x000*/         UINT16       Spare1 : 1;                 // 12 BitPosition
		...
		struct                                       // 3 elements, 0x1 bytes (sizeof)
		{
			...
			/*0x003*/         UINT8        Spare : 3;                  // 1 BitPosition
	...
	typedef struct _MAPPED_FILE_SEGMENT        // 8 elements, 0x30 bytes (sizeof)
	{
		...
		/*0x00C*/     struct _SEGMENT_FLAGS SegmentFlags;    // 14 elements, 0x4 bytes (sizeof)
	...
	typedef struct _MI_SESSION_DRIVER_UNLOAD                 // 2 elements, 0x8 bytes (sizeof)
	{
		union                                                // 2 elements, 0x8 bytes (sizeof)
		{
			/*0x000*/         FUNCT_00BC_10DA_DriverUnload_Function* Function;
	...
	typedef struct _MI_TRIAGE_DUMP_DATA                 // 7 elements, 0x20 bytes (sizeof)
	{
		...
		/*0x018*/     ULONG32      FeatureBits;
		/*0x01C*/     ULONG32      TimeZoneId;
	}MI_TRIAGE_DUMP_DATA, * PMI_TRIAGE_DUMP_DATA;

	typedef struct _MI_USER_VA_INFO                    // 20 elements, 0x478 bytes (sizeof)
	{
		...
		/*0x050*/     UINT64       PrivateFixupVadCount;
		/*0x058*/     VOID* FreeUmsTebHint;
		/*0x060*/     ULONG32* CommittedPageTables;
		/*0x068*/     ULONG32      PageTableBitmapPages;
		/*0x06C*/     UINT8        _PADDING1_[0x4];
		/*0x070*/     UINT64       CommittedPageDirectories[128];
		/*0x470*/     UINT64       CommittedPageDirectoryParents[1];
	...
	typedef struct _MM_SESSION_SPACE                   // 43 elements, 0x1F80 bytes (sizeof)
	{
		...
		/*0xBF8*/      struct _MMSUPPORT Vm;                          // 23 elements, 0x90 bytes (sizeof)
		/*0xC88*/      struct _MMWSLE* Wsle;
		/*0xC90*/      struct _MI_SESSION_DRIVER_UNLOAD DriverUnload; // 2 elements, 0x8 bytes (sizeof)
		/*0xC98*/      UINT8        _PADDING1_[0x28];
	...
	typedef struct _MMINPAGE_FLAGS                    // 20 elements, 0x4 bytes (sizeof)
	{
		struct                                        // 2 elements, 0x1 bytes (sizeof)
		{
		...
		struct                                        // 7 elements, 0x1 bytes (sizeof)
		{
			...
			/*0x003*/         UINT8        Spare1 : 2;                  // 6 BitPosition
		};
	}MMINPAGE_FLAGS, * PMMINPAGE_FLAGS;

	typedef struct _MMINPAGE_SUPPORT       // 22 elements, 0x178 bytes (sizeof)
	{
		/*0x000*/     struct _LIST_ENTRY ListEntry;      // 2 elements, 0x10 bytes (sizeof)
		/*0x010*/     struct _ETHREAD* Thread;
		/*0x018*/     struct _LIST_ENTRY ListHead;       // 2 elements, 0x10 bytes (sizeof)
		/*0x028*/     struct _KEVENT Event;              // 1 elements, 0x18 bytes (sizeof)
		/*0x040*/     struct _KEVENT CollidedEvent;      // 1 elements, 0x18 bytes (sizeof)
		/*0x058*/     struct _IO_STATUS_BLOCK IoStatus;  // 3 elements, 0x10 bytes (sizeof)
		/*0x068*/     union _LARGE_INTEGER ReadOffset;   // 4 elements, 0x8 bytes (sizeof)
		/*0x070*/     struct _MMPTE PteContents;         // 1 elements, 0x8 bytes (sizeof)
		...
		union                              // 2 elements, 0x4 bytes (sizeof)
		{
			/*0x08C*/         struct _MMINPAGE_FLAGS e1;     // 20 elements, 0x4 bytes (sizeof)
			/*0x08C*/         ULONG32      LongFlags;
		}u1;
		/*0x090*/     struct _FILE_OBJECT* FilePointer;
		/*0x098*/     struct _CONTROL_AREA* ControlArea;
		/*0x0A0*/     VOID* FaultingAddress;
		/*0x0A8*/     struct _MMPTE* PointerPte;
		/*0x0B0*/     struct _MMPTE* BasePte;
		/*0x0B8*/     struct _MMPFN* Pfn;
		/*0x0C0*/     struct _MDL* PrefetchMdl;
		/*0x0C8*/     struct _MDL  Mdl;                  // 10 elements, 0x30 bytes (sizeof)
		/*0x0F8*/     UINT64       Page[16];
	...
	typedef struct _MMMOD_WRITER_MDL_ENTRY    // 14 elements, 0xA0 bytes (sizeof)
	{
		...
		/*0x068*/     struct _MDL  Mdl;                     // 10 elements, 0x30 bytes (sizeof)
		/*0x098*/     UINT64       Page[1];
	}MMMOD_WRITER_MDL_ENTRY, * PMMMOD_WRITER_MDL_ENTRY;

	typedef struct _MMPAGING_FILE                      // 30 elements, 0xA8 bytes (sizeof)
	{
		/*0x000*/     UINT64       Size;
		...
		struct                                         // 5 elements, 0x2 bytes (sizeof)
		{
			...
			/*0x08C*/         UINT16       WsSwapPagefile : 1;           // 5 BitPosition
			/*0x08C*/         UINT16       NoReservations : 1;           // 6 BitPosition
			/*0x08C*/         UINT16       Spare0 : 9;                   // 7 BitPosition
		};
		struct                                         // 2 elements, 0x1 bytes (sizeof)
		{
	...
	typedef struct _MMPFN                                // 14 elements, 0x30 bytes (sizeof)
	{
		...
		union                                            // 8 elements, 0x8 bytes (sizeof)
		{
			struct                                       // 7 elements, 0x8 bytes (sizeof)
			{
				...
				/*0x028*/             UINT64       PageIdentity : 2;           // 55 BitPosition
	...
	{
		/*0x000*/     struct _MM_AVL_NODE VadNode;           // 3 elements, 0x18 bytes (sizeof)
		/*0x018*/     ULONG32      StartingVpn;
		/*0x01C*/     ULONG32      EndingVpn;
		/*0x020*/     struct _EX_PUSH_LOCK PushLock;         // 7 elements, 0x8 bytes (sizeof)
		union                                  // 2 elements, 0x4 bytes (sizeof)
		{
			/*0x028*/         ULONG32      LongFlags;
			/*0x028*/         struct _MMVAD_FLAGS VadFlags;      // 9 elements, 0x4 bytes (sizeof)
		}u;
		union                                  // 2 elements, 0x4 bytes (sizeof)
		{
			/*0x02C*/         ULONG32      LongFlags1;
			/*0x02C*/         struct _MMVAD_FLAGS1 VadFlags1;    // 2 elements, 0x4 bytes (sizeof)
		}u1;
		/*0x030*/     struct _MI_VAD_EVENT_BLOCK* EventList;
	...
	{
		/*0x000*/     struct _MMVAD_SHORT Core;                        // 8 elements, 0x40 bytes (sizeof)
		union                                            // 2 elements, 0x4 bytes (sizeof)
		{
	...
	typedef struct _MMWSL                                 // 19 elements, 0x530 bytes (sizeof)
	{
		...
		/*0x018*/     ULONG32      NextAccessClearingSlot;
		/*0x01C*/     ULONG32      LastAccessClearingRemainder;
		/*0x020*/     ULONG32      LastAgingRemainder;
		/*0x024*/     ULONG32      WsleSize;
		/*0x028*/     ULONG32      NonDirectCount;
		/*0x02C*/     UINT8        _PADDING0_[0x4];
		/*0x030*/     VOID* LowestPagableAddress;
		/*0x038*/     struct _MMWSLE_NONDIRECT_HASH* NonDirectHash;
		/*0x040*/     struct _MMWSLE_HASH* HashTableStart;
		/*0x048*/     struct _MMWSLE_HASH* HighestPermittedHashAddress;
		/*0x050*/     ULONG32      ActiveWsleCounts[8];
		/*0x070*/     struct _MI_ACTIVE_WSLE ActiveWsles[8];
		/*0x0B0*/     struct _MMWSLE* Wsle;
		/*0x0B8*/     struct _MI_USER_VA_INFO UserVaInfo;               // 20 elements, 0x478 bytes (sizeof)
	}MMWSL, * PMMWSL;
	...
	typedef struct _MSUBSECTION                         // 14 elements, 0x70 bytes (sizeof)
	{
		/*0x000*/     struct _CONTROL_AREA* ControlArea;
		...
		/*0x038*/     struct _MM_AVL_NODE SubsectionNode;             // 3 elements, 0x18 bytes (sizeof)
		/*0x050*/     struct _LIST_ENTRY DereferenceList;             // 2 elements, 0x10 bytes (sizeof)
		/*0x060*/     UINT64       NumberOfMappedViews;
		/*0x068*/     UINT64       NumberOfPfnReferences;
	...
	typedef struct _OBJECT_TYPE_INITIALIZER                                                                                                                                                                                     // 29 elements, 0x78 bytes (sizeof)
	{
		...
		/*0x030*/     FUNCT_00BC_11A7_DumpProcedure* DumpProcedure;
		/*0x038*/     FUNCT_0072_11AF_OpenProcedure* OpenProcedure;
		/*0x040*/     FUNCT_00BC_11BD_CloseProcedure* CloseProcedure;
		/*0x048*/     FUNCT_00BC_0753_Free_IdleComplete_WorkerRoutine_InterfaceReference_InterfaceDereference_DeleteProcedure_DevicePowerRequired_DevicePowerNotRequired_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead* DeleteProcedure;
		/*0x050*/     FUNCT_0072_11C3_ParseProcedure* ParseProcedure;
		/*0x058*/     FUNCT_0072_11CF_SecurityProcedure* SecurityProcedure;
		/*0x060*/     FUNCT_0072_11E0_QueryNameProcedure* QueryNameProcedure;
		/*0x068*/     FUNCT_007B_11E8_OkayToCloseProcedure* OkayToCloseProcedure;
	...
	typedef struct _PCW_REGISTRATION_INFORMATION  // 6 elements, 0x30 bytes (sizeof)
	{
		...
		/*0x020*/     FUNCT_0072_161B_Callback* Callback;
		/*0x028*/     VOID* CallbackContext;
	}PCW_REGISTRATION_INFORMATION, * PPCW_REGISTRATION_INFORMATION;

	typedef struct _PEB                                                                               // 95 elements, 0x388 bytes (sizeof)
	{
		...
		union                                                                                         // 2 elements, 0x1 bytes (sizeof)
		{
			...
			struct                                                                                    // 8 elements, 0x1 bytes (sizeof)
			{
				...
				/*0x003*/             UINT8        IsPackagedProcess : 1;                                                   // 5 BitPosition
				/*0x003*/             UINT8        IsAppContainer : 1;                                                      // 6 BitPosition
		...
		/*0x230*/     FUNCT_00BC_027C_PostProcessInitRoutine_DispatchAddress_FinishRoutine* PostProcessInitRoutine;
	...
	typedef struct _PEB64                                      // 95 elements, 0x388 bytes (sizeof)
	{
		/*0x000*/     UINT8        InheritedAddressSpace;
		/*0x001*/     UINT8        ReadImageFileExecOptions;
		/*0x002*/     UINT8        BeingDebugged;
	...
	typedef struct _PLATFORM_IDLE_STATE_ACCOUNTING          // 8 elements, 0x370 bytes (sizeof)
	{
		...
		/*0x02C*/     UINT8        _PADDING1_[0x4];
		/*0x030*/     struct _PROC_IDLE_STATE_BUCKET IdleTimeBuckets[26];
	}PLATFORM_IDLE_STATE_ACCOUNTING, * PPLATFORM_IDLE_STATE_ACCOUNTING;

	typedef struct _PLATFORM_IDLE_ACCOUNTING             // 5 elements, 0x388 bytes (sizeof)
	{
		/*0x000*/     ULONG32      ResetCount;
		/*0x004*/     ULONG32      StateCount;
		/*0x008*/     enum _PPM_IDLE_BUCKET_TIME_TYPE TimeUnit;
		/*0x00C*/     UINT8        _PADDING0_[0x4];
	...
	typedef struct _PNP_DEVICE_EVENT_ENTRY                                                                                                                                                                               // 12 elements, 0xA8 bytes (sizeof)
	{
		...
		/*0x020*/     FUNCT_00BC_0753_Free_IdleComplete_WorkerRoutine_InterfaceReference_InterfaceDereference_DeleteProcedure_DevicePowerRequired_DevicePowerNotRequired_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead* Callback;
		/*0x028*/     VOID* Context;
		/*0x030*/     enum _PNP_VETO_TYPE* VetoType;
	...
	typedef struct _PNP_PROVIDER_INFO                                // 5 elements, 0x20 bytes (sizeof)
	{
		/*0x000*/     struct _LIST_ENTRY ListEntry;                                // 2 elements, 0x10 bytes (sizeof)
		/*0x010*/     UINT8        ProviderType;
		/*0x011*/     UINT8        Satisfied;
		/*0x012*/     UINT16       Flags;
		/*0x014*/     UINT8        _PADDING0_[0x4];
		union                                                        // 2 elements, 0x8 bytes (sizeof)
		{
			/*0x018*/         struct _DEVICE_OBJECT* ProviderPdo;
			/*0x018*/         struct _PNP_RESERVED_PROVIDER_INFO* ProviderReservation;
		}u;
	}PNP_PROVIDER_INFO, * PPNP_PROVIDER_INFO;

	typedef struct _PNP_RESERVED_PROVIDER_INFO // 4 elements, 0x38 bytes (sizeof)
	{
		/*0x000*/     struct _LIST_ENTRY ListEntry;          // 2 elements, 0x10 bytes (sizeof)
		/*0x010*/     struct _LIST_ENTRY DependentList;      // 2 elements, 0x10 bytes (sizeof)
		/*0x020*/     struct _UNICODE_STRING ReservationId;  // 3 elements, 0x10 bytes (sizeof)
		/*0x030*/     LONG32       ReferenceCount;
		/*0x034*/     UINT8        _PADDING0_[0x4];
	...
	typedef struct _POP_FX_COMPONENT           // 20 elements, 0xB8 bytes (sizeof)
	{
		...
		/*0x048*/     union _POP_FX_COMPONENT_FLAGS Flags;   // 8 elements, 0x8 bytes (sizeof)
		/*0x050*/     LONG32       Resident;
		/*0x054*/     UINT8        _PADDING1_[0x4];
		/*0x058*/     struct _KEVENT ActiveEvent;            // 1 elements, 0x18 bytes (sizeof)
		/*0x070*/     UINT64       IdleLock;
		/*0x078*/     LONG32       IdleConditionComplete;
		/*0x07C*/     LONG32       IdleStateComplete;
		/*0x080*/     UINT64       IdleStamp;
		/*0x088*/     ULONG32      CurrentIdleState;
		/*0x08C*/     ULONG32      IdleStateCount;
		/*0x090*/     struct _POP_FX_IDLE_STATE* IdleStates;
		/*0x098*/     ULONG32      DeepestWakeableIdleState;
		/*0x09C*/     ULONG32      ProviderCount;
		/*0x0A0*/     struct _POP_FX_PROVIDER* Providers;
		/*0x0A8*/     ULONG32      IdleProviderCount;
		/*0x0AC*/     ULONG32      DependentCount;
		/*0x0B0*/     struct _POP_FX_DEPENDENT* Dependents;
	...
	{
		/*0x000*/     FUNCT_00BC_07E1_IdleCancel_Free_ComponentActive_ComponentIdle* ComponentActive;
		/*0x008*/     FUNCT_00BC_07E1_IdleCancel_Free_ComponentActive_ComponentIdle* ComponentIdle;
		/*0x010*/     FUNCT_00BC_1749_ComponentIdleState* ComponentIdleState;
		/*0x018*/     FUNCT_00BC_0753_Free_IdleComplete_WorkerRoutine_InterfaceReference_InterfaceDereference_DeleteProcedure_DevicePowerRequired_DevicePowerNotRequired_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead* DevicePowerRequired;
		/*0x020*/     FUNCT_00BC_0753_Free_IdleComplete_WorkerRoutine_InterfaceReference_InterfaceDereference_DeleteProcedure_DevicePowerRequired_DevicePowerNotRequired_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead* DevicePowerNotRequired;
		/*0x028*/     FUNCT_0072_174E_PowerControl* PowerControl;
		/*0x030*/     FUNCT_00BC_1757_ComponentCriticalTransition* ComponentCriticalTransition;
	...
	typedef struct _POP_FX_DEVICE                                                          // 29 elements, 0x1D0 bytes (sizeof)
	{
		/*0x000*/     struct _LIST_ENTRY Link;                                                           // 2 elements, 0x10 bytes (sizeof)
		/*0x010*/     struct _POP_FX_PLUGIN* Plugin;
		/*0x018*/     struct _PEPHANDLE__* PluginHandle;
		/*0x020*/     struct _POP_FX_PLUGIN* MiniPlugin;
		/*0x028*/     struct _PEPHANDLE__* MiniPluginHandle;
		/*0x030*/     struct _DEVICE_NODE* DevNode;
		/*0x038*/     struct _DEVICE_OBJECT* DeviceObject;
		/*0x040*/     struct _DEVICE_OBJECT* TargetDevice;
		/*0x048*/     struct _POP_FX_DRIVER_CALLBACKS Callbacks;                                         // 7 elements, 0x38 bytes (sizeof)
		/*0x080*/     VOID* DriverContext;
		/*0x088*/     struct _IO_REMOVE_LOCK RemoveLock;                                                 // 1 elements, 0x20 bytes (sizeof)
		/*0x0A8*/     struct _POP_FX_WORK_ORDER WorkOrder;                                               // 2 elements, 0x28 bytes (sizeof)
		/*0x0D0*/     union _POP_FX_DEVICE_STATUS Status;                                                // 10 elements, 0x4 bytes (sizeof)
		/*0x0D4*/     LONG32       PowerReqCall;
		/*0x0D8*/     LONG32       PowerNotReqCall;
		/*0x0DC*/     UINT8        _PADDING0_[0x4];
		/*0x0E0*/     UINT64       IdleLock;
		/*0x0E8*/     struct _KTIMER IdleTimer;                                                          // 6 elements, 0x40 bytes (sizeof)
		/*0x128*/     struct _KDPC IdleDpc;                                                              // 9 elements, 0x40 bytes (sizeof)
		/*0x168*/     UINT64       IdleTimeout;
		/*0x170*/     UINT64       IdleStamp;
		/*0x178*/     struct _IRP* Irp;
		/*0x180*/     struct _POP_IRP_DATA* IrpData;
		/*0x188*/     struct _DEVICE_OBJECT* NextIrpDeviceObject;
		/*0x190*/     union _POWER_STATE NextIrpPowerState;                                              // 2 elements, 0x4 bytes (sizeof)
		/*0x194*/     UINT8        _PADDING1_[0x4];
		/*0x198*/     FUNCT_00BC_1786_NextIrpCallerCompletion_CallerCompletion* NextIrpCallerCompletion;
		/*0x1A0*/     VOID* NextIrpCallerContext;
		/*0x1A8*/     struct _KEVENT IrpCompleteEvent;                                                   // 1 elements, 0x18 bytes (sizeof)
		/*0x1C0*/     ULONG32      ComponentCount;
		/*0x1C4*/     UINT8        _PADDING2_[0x4];
		/*0x1C8*/     struct _POP_FX_COMPONENT* Components[1];
	...
	typedef struct _POP_FX_PLUGIN                                                 // 7 elements, 0x98 bytes (sizeof)
	{
		/*0x000*/     struct _LIST_ENTRY Link;                                                  // 2 elements, 0x10 bytes (sizeof)
		/*0x010*/     ULONG32      Version;
		/*0x014*/     UINT8        _PADDING0_[0x4];
		/*0x018*/     UINT64       Flags;
		/*0x020*/     struct _POP_FX_WORK_ORDER WorkOrder;                                      // 2 elements, 0x28 bytes (sizeof)
		/*0x048*/     struct _KQUEUE WorkQueue;                                                 // 5 elements, 0x40 bytes (sizeof)
		/*0x088*/     FUNCT_007B_1735_AcceptDeviceNotification* AcceptDeviceNotification;
		/*0x090*/     FUNCT_007B_1739_AcceptProcessorNotification* AcceptProcessorNotification;
	...
	typedef struct _POP_IRP_DATA                                                            // 17 elements, 0xF8 bytes (sizeof)
	{
		...
		/*0x078*/     struct _KDPC WatchdogDpc;                                                           // 9 elements, 0x40 bytes (sizeof)
		...
		union                                                                               // 2 elements, 0x20 bytes (sizeof)
		{
			struct                                                                          // 4 elements, 0x20 bytes (sizeof)
			{
				/*0x0D8*/             FUNCT_00BC_1786_NextIrpCallerCompletion_CallerCompletion* CallerCompletion;
	...
	typedef struct __2016091401320F03728D3DC41798084BF_WakeAlarm // 2 elements, 0x10 bytes (sizeof)
	{
		/*0x000*/     UINT64       ProgrammedTime;
		/*0x008*/     struct _DIAGNOSTIC_BUFFER* TimerInfo;
	}_2016091401320F03728D3DC41798084BF_WakeAlarm, * P_2016091401320F03728D3DC41798084BF_WakeAlarm;
	...
	typedef struct _POP_POWER_ACTION                                       // 23 elements, 0xE0 bytes (sizeof)
	{
		...
		/*0x05C*/     UINT8        _PADDING2_[0x4];
		/*0x060*/     struct __2016091401320F03728D3DC41798084BF_WakeAlarm WakeAlarm[3];
	...
	typedef struct _THERMAL_INFORMATION_EX  // 10 elements, 0x4C bytes (sizeof)
	{
	...
	typedef struct _POP_THERMAL_ZONE              // 21 elements, 0x1D0 bytes (sizeof)
	{
		/*0x000*/     struct _LIST_ENTRY Link;                  // 2 elements, 0x10 bytes (sizeof)
		/*0x010*/     UINT8        State;
		/*0x011*/     UINT8        Flags;
		...
		/*0x016*/     UINT8        _PADDING0_[0x2];
		/*0x018*/     LONG32       HighPrecisionThrottle;
		/*0x01C*/     LONG32       Throttle;
		/*0x020*/     LONG32       PendingThrottle;
		/*0x024*/     UINT8        _PADDING1_[0x4];
		/*0x028*/     UINT64       ThrottleStartTime;
		/*0x030*/     UINT64       LastTime;
		/*0x038*/     ULONG32      SampleRate;
		/*0x03C*/     ULONG32      LastTemp;
		/*0x040*/     struct _KTIMER PassiveTimer;              // 6 elements, 0x40 bytes (sizeof)
		/*0x080*/     struct _KDPC PassiveDpc;                  // 9 elements, 0x40 bytes (sizeof)
		/*0x0C0*/     struct _POP_ACTION_TRIGGER OverThrottled; // 5 elements, 0x18 bytes (sizeof)
		/*0x0D8*/     struct _IRP* Irp;
		/*0x0E0*/     struct _THERMAL_INFORMATION_EX Info;      // 10 elements, 0x4C bytes (sizeof)
		/*0x12C*/     UINT8        _PADDING2_[0x4];
		/*0x130*/     union _LARGE_INTEGER InfoLastUpdateTime;  // 4 elements, 0x8 bytes (sizeof)
		/*0x138*/     struct _POP_THERMAL_ZONE_METRICS Metrics; // 8 elements, 0x98 bytes (sizeof)
	...
	typedef struct _PPM_IDLE_STATE          // 9 elements, 0xC0 bytes (sizeof)
	{
		/*0x000*/     struct _KAFFINITY_EX DomainMembers; // 4 elements, 0xA8 bytes (sizeof)
		/*0x0A8*/     ULONG32      Latency;
		/*0x0AC*/     ULONG32      Power;
		/*0x0B0*/     ULONG32      StateFlags;
		/*0x0B4*/     UINT8        StateType;
		/*0x0B5*/     UINT8        InterruptsEnabled;
		/*0x0B6*/     UINT8        Interruptible;
		/*0x0B7*/     UINT8        ContextRetained;
		/*0x0B8*/     UINT8        CacheCoherent;
		/*0x0B9*/     UINT8        _PADDING0_[0x7];
	}PPM_IDLE_STATE, * PPPM_IDLE_STATE;

	typedef struct _PROCESSOR_IDLE_CONSTRAINTS // 11 elements, 0x30 bytes (sizeof)
	{
		/*0x000*/     UINT64       TotalTime;
		/*0x008*/     UINT64       IdleTime;
		/*0x010*/     UINT64       ExpectedIdleDuration;
		/*0x018*/     ULONG32      MaxIdleDuration;
		/*0x01C*/     ULONG32      OverrideState;
		/*0x020*/     ULONG32      TimeCheck;
		/*0x024*/     UINT8        PromotePercent;
		/*0x025*/     UINT8        DemotePercent;
		/*0x026*/     UINT8        Parked;
		/*0x027*/     UINT8        Interruptible;
		/*0x028*/     UINT8        PlatformIdle;
		/*0x029*/     UINT8        _PADDING0_[0x7];
	...
	{
		/*0x000*/     VOID* Context;
		/*0x008*/     struct _PROCESSOR_IDLE_CONSTRAINTS Constraints;     // 11 elements, 0x30 bytes (sizeof)
	...
	typedef struct _PPM_IDLE_STATES                                                                                                                                                                                          // 25 elements, 0x2D8 bytes (sizeof)
	{
		/*0x000*/     UINT8        ForceIdle;
		/*0x001*/     UINT8        EstimateIdleDuration;
		/*0x002*/     UINT8        ExitLatencyTraceEnabled;
		/*0x003*/     UINT8        _PADDING0_[0x1];
		/*0x004*/     ULONG32      ExitLatencyCountdown;
		/*0x008*/     ULONG32      TargetState;
		/*0x00C*/     ULONG32      ActualState;
		/*0x010*/     ULONG32      ActualPlatformState;
		/*0x014*/     ULONG32      OldState;
		/*0x018*/     ULONG32      OverrideIndex;
		/*0x01C*/     ULONG32      PlatformIdleCount;
		/*0x020*/     ULONG32      ProcessorIdleCount;
		/*0x024*/     ULONG32      Type;
		/*0x028*/     ULONG32      ReasonFlags;
		/*0x02C*/     UINT8        _PADDING1_[0x4];
		/*0x030*/     INT64        InitiateWakeStamp;
		/*0x038*/     LONG32       PreviousStatus;
		/*0x03C*/     UINT8        _PADDING2_[0x4];
		/*0x040*/     struct _KAFFINITY_EX PrimaryProcessorMask;                                                                                                                                                                           // 4 elements, 0xA8 bytes (sizeof)
		/*0x0E8*/     struct _KAFFINITY_EX SecondaryProcessorMask;                                                                                                                                                                         // 4 elements, 0xA8 bytes (sizeof)
		/*0x190*/     FUNCT_00BC_07C2_IdlePrepare* IdlePrepare;
		/*0x198*/     FUNCT_0072_07DF_IdleExecute_DestroyProcedure* IdleExecute;
		/*0x1A0*/     FUNCT_00BC_0753_Free_IdleComplete_WorkerRoutine_InterfaceReference_InterfaceDereference_DeleteProcedure_DevicePowerRequired_DevicePowerNotRequired_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead* IdleComplete;
		/*0x1A8*/     FUNCT_00BC_07E1_IdleCancel_Free_ComponentActive_ComponentIdle* IdleCancel;
		/*0x1B0*/     FUNCT_007B_07E5_IdleIsHalted_IdleInitiateWake* IdleIsHalted;
		/*0x1B8*/     FUNCT_007B_07E5_IdleIsHalted_IdleInitiateWake* IdleInitiateWake;
		/*0x1C0*/     struct _PROCESSOR_IDLE_PREPARE_INFO PrepareInfo;                                                                                                                                                                     // 8 elements, 0x58 bytes (sizeof)
		/*0x218*/     struct _PPM_IDLE_STATE State[1];
	...
	typedef struct _PROC_FEEDBACK_COUNTER                         // 9 elements, 0x30 bytes (sizeof)
	{
		union                                                     // 2 elements, 0x8 bytes (sizeof)
		{
			/*0x000*/         FUNCT_00BC_0845_InstantaneousRead* InstantaneousRead;
			/*0x000*/         FUNCT_00BC_0849_DifferentialRead* DifferentialRead;
		};
	...
	typedef struct _PROC_IDLE_STATE_ACCOUNTING              // 8 elements, 0x368 bytes (sizeof)
	{
		/*0x000*/     UINT64       TotalTime;
		...
		/*0x028*/     struct _PROC_IDLE_STATE_BUCKET IdleTimeBuckets[26];
	}PROC_IDLE_STATE_ACCOUNTING, * PPROC_IDLE_STATE_ACCOUNTING;

	typedef struct _PROC_IDLE_ACCOUNTING             // 8 elements, 0x390 bytes (sizeof)
	{
	...
	typedef struct _PROC_PERF_DOMAIN                                                          // 31 elements, 0x158 bytes (sizeof)
	{
		...
		/*0x0D0*/     FUNCT_00BC_0899_GetFFHThrottleState* GetFFHThrottleState;
		/*0x0D8*/     FUNCT_00BC_089C_BoostPolicyHandler_BoostModeHandler_StallRoutine* BoostPolicyHandler;
		/*0x0E0*/     FUNCT_00BC_089C_BoostPolicyHandler_BoostModeHandler_StallRoutine* BoostModeHandler;
		/*0x0E8*/     FUNCT_0009_089F_PerfSelectionHandler* PerfSelectionHandler;
		/*0x0F0*/     FUNCT_00BC_08A8_PerfControlHandler* PerfControlHandler;
	...
	typedef struct _tagSWITCH_CONTEXT_DATA  // 6 elements, 0x40 bytes (sizeof)
	{
		...
		/*0x024*/     UINT16       ulContextMinimum;
		/*0x026*/     UINT8        _PADDING0_[0x2];
		/*0x028*/     UINT64       ullOsMaxVersionTested;
		/*0x030*/     struct _GUID guElements[1];
	}tagSWITCH_CONTEXT_DATA, * PtagSWITCH_CONTEXT_DATA;

	typedef struct _tagSWITCH_CONTEXT                  // 2 elements, 0x58 bytes (sizeof)
	{
		/*0x000*/     struct _tagSWITCH_CONTEXT_ATTRIBUTE Attribute; // 4 elements, 0x18 bytes (sizeof)
		/*0x018*/     struct _tagSWITCH_CONTEXT_DATA Data;           // 6 elements, 0x40 bytes (sizeof)
	}tagSWITCH_CONTEXT, * PtagSWITCH_CONTEXT;

	typedef struct _TEB                                                  // 104 elements, 0x1820 bytes (sizeof)
	{
		/*0x000*/      struct _NT_TIB NtTib;                                            // 8 elements, 0x38 bytes (sizeof)
	...
	typedef struct _TEB64                                   // 104 elements, 0x1820 bytes (sizeof)
	{
	...
	typedef struct _TP_CALLBACK_ENVIRON_V3                                                                          // 10 elements, 0x48 bytes (sizeof)
	{
		...
		/*0x018*/     FUNCT_00BC_00BB_CleanupGroupCancelCallback_DeRefSecurityDescriptor_PostRoutine* CleanupGroupCancelCallback;
		/*0x020*/     VOID* RaceDll;
		/*0x028*/     struct _ACTIVATION_CONTEXT* ActivationContext;
		/*0x030*/     FUNCT_00BC_00C3_FinalizationCallback* FinalizationCallback;
		union                                                                                                       // 2 elements, 0x4 bytes (sizeof)
		{
			/*0x038*/         ULONG32      Flags;
			struct                                                                                                  // 3 elements, 0x4 bytes (sizeof)
	...
	typedef struct _VOLUME_CACHE_MAP                 // 10 elements, 0xB8 bytes (sizeof)
	{
		/*0x000*/     INT16        NodeTypeCode;
		...
		/*0x028*/     struct _LOG_HANDLE_CONTEXT LogHandleContext; // 12 elements, 0x80 bytes (sizeof)
		/*0x0A8*/     ULONG32      Flags;
		/*0x0AC*/     ULONG32      PagesQueuedToDisk;
		/*0x0B0*/     ULONG32      LoggedPagesQueuedToDisk;
	...
	typedef struct _WHEAP_WORK_QUEUE              // 6 elements, 0x88 bytes (sizeof)
	{
		...
		/*0x01C*/     UINT8        _PADDING0_[0x4];
		/*0x020*/     struct _KDPC Dpc;                         // 9 elements, 0x40 bytes (sizeof)
		/*0x060*/     struct _WORK_QUEUE_ITEM WorkItem;         // 3 elements, 0x20 bytes (sizeof)
		/*0x080*/     FUNCT_00BC_1FE4_WorkRoutine* WorkRoutine;
	...
	typedef struct _WMI_LOGGER_CONTEXT                         // 108 elements, 0x378 bytes (sizeof)
	{
		/*0x000*/     ULONG32      LoggerId;
		...
		/*0x024*/     UINT8        _PADDING0_[0x4];
		/*0x028*/     FUNCT_008C_1E95_GetCpuClock* GetCpuClock;
		...
		/*0x104*/     ULONG32      BuffersWritten;
		/*0x108*/     ULONG32      LogBuffersLost;
		/*0x10C*/     ULONG32      RealTimeBuffersDelivered;
		/*0x110*/     ULONG32      RealTimeBuffersLost;
		...
		/*0x248*/     struct _KDPC LoggerDpc;                                // 9 elements, 0x40 bytes (sizeof)
