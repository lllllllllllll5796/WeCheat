...
//////////////////
	...
	typedef enum ___2016091401173703558D3DC3DCBBB5273_RecordType  // 2 elements, 0x4 bytes
	{
		KTMOH_CommitTransaction_Result = 1 /*0x1*/,
		KTMOH_RollbackTransaction_Result = 2 /*0x2*/
	}__2016091401173703558D3DC3DCBBB5273_RecordType, * P__2016091401173703558D3DC3DCBBB5273_RecordType;
	...
	typedef enum _CM_LOAD_FAILURE_TYPE  // 21 elements, 0x4 bytes
	{
		_None = 0 /*0x0*/,
	...
	{
		DeviceRelation = 0 /*0x0*/,
		Dependent = 1 /*0x1*/,
		DirectDescendant = 2 /*0x2*/
	...
	typedef enum _DEVPROP_OPERATOR  // 39 elements, 0x4 bytes
	{
	...
	typedef enum _ETW_NOTIFICATION_TYPE  // 11 elements, 0x4 bytes
	{
	...
	typedef enum _FSINFOCLASS  // 13 elements, 0x4 bytes
	{
		...
		FileFsMaximumInformation = 13 /*0xD*/
	...
	typedef enum _HEAP_FAILURE_TYPE  // 17 elements, 0x4 bytes
	{
	...
	typedef enum _HV_CPUID_FUNCTION  // 9 elements, 0x4 bytes
	{
		HvCpuIdFunctionVersionAndFeatures = 1 /*0x1*/,
		HvCpuIdFunctionHvVendorAndMaxFunction = 1073741824 /*0x40000000*/,
		HvCpuIdFunctionHvInterface = 1073741825 /*0x40000001*/,
		HvCpuIdFunctionMsHvVersion = 1073741826 /*0x40000002*/,
		HvCpuIdFunctionMsHvFeatures = 1073741827 /*0x40000003*/,
		HvCpuIdFunctionMsHvEnlightenmentInformation = 1073741828 /*0x40000004*/,
		HvCpuIdFunctionMsHvImplementationLimits = 1073741829 /*0x40000005*/,
		HvCpuIdFunctionMsHvHardwareFeatures = 1073741830 /*0x40000006*/,
		HvCpuIdFunctionMaxReserved = 1073741830 /*0x40000006*/
	}HV_CPUID_FUNCTION, * PHV_CPUID_FUNCTION;

	typedef enum _HV_HYPERVISOR_INTERFACE  // 1 elements, 0x4 bytes
	{
		HvMicrosoftHypervisorInterface = 824407624 /*0x31237648*/
	...
	typedef enum _JOBOBJECTINFOCLASS  // 36 elements, 0x4 bytes
	{
	...
	typedef enum _KERNEL_STACK_LIMITS  // 8 elements, 0x4 bytes
	{
	...
	typedef enum _KTIMER2_TYPE  // 7 elements, 0x4 bytes
	{
		KTimer2TypeMin = 0 /*0x0*/,
		KTimer2Plain = 0 /*0x0*/,
		KTimer2IdleResilient = 1 /*0x1*/,
		KTimer2HighResolution = 2 /*0x2*/,
		KTimer2NoWake = 3 /*0x3*/,
		KTimer2NoWakeFinite = 4 /*0x4*/,
		KTimer2TypeMax = 5 /*0x5*/
	...
	typedef enum _KWAIT_STATE  // 9 elements, 0x4 bytes
	{
		...
		WaitLastSuspendState = 5 /*0x5*/,
		MaximumWaitState = 6 /*0x6*/
	...
	typedef enum _MI_CFG_BITMAP_TYPE  // 4 elements, 0x4 bytes
	{
		CfgBitMapNative = 0 /*0x0*/,
		CfgBitMapWow64 = 1 /*0x1*/,
		CfgBitMapWow64NativeLow = 2 /*0x2*/,
		CfgBitMapMax = 3 /*0x3*/
	}MI_CFG_BITMAP_TYPE, * PMI_CFG_BITMAP_TYPE;

	typedef enum _MI_DYNAMICBASE_BITMAP  // 4 elements, 0x4 bytes
	{
		DynamicBaseBitMap32 = 0 /*0x0*/,
		DynamicBaseBitMap64Low = 1 /*0x1*/,
		DynamicBaseBitMap64High = 2 /*0x2*/,
		LastDynamicBaseBitMap = 3 /*0x3*/
	...
	typedef enum _MI_SYSTEM_VA_TYPE  // 16 elements, 0x4 bytes
	{
		MiVaUnused = 0 /*0x0*/,
	...
	typedef enum _PNP_DEVICE_ACTION_REQUEST  // 24 elements, 0x4 bytes
	{
	...
	typedef enum _POP_SPM_STATUS  // 8 elements, 0x4 bytes
	{
		PopSpmStatusUninitialized = 0 /*0x0*/,
		PopSpmStatusFailedNoMemory = 1 /*0x1*/,
		PopSpmStatusFailedNoPoliciesFound = 2 /*0x2*/,
		PopSpmStatusFailedToOpenExtHandle = 3 /*0x3*/,
		PopSpmStatusFailedToOpenIntHandle = 4 /*0x4*/,
		PopSpmStatusWaitingForRegistration = 5 /*0x5*/,
		PopSpmStatusInitialized = 6 /*0x6*/,
		PopSpmStatusInvalid = 7 /*0x7*/
	...
	typedef enum _POWER_POLICY_DEVICE_TYPE  // 12 elements, 0x4 bytes
	{
	...
	typedef enum _POWER_REQUEST_TYPE_INTERNAL  // 6 elements, 0x4 bytes
	{
		...
		PowerRequestInternalInvalid = 5 /*0x5*/
	...
	typedef enum _PROC_PERF_UTILITY_TYPE  // 4 elements, 0x4 bytes
	{
		ProcPerfUtilityTypeIncrease = 0 /*0x0*/,
		ProcPerfUtilityTypeDecrease = 1 /*0x1*/,
		ProcPerfUtilityTypeCoreParking = 2 /*0x2*/,
		ProcPerfUtilityTypeMax = 3 /*0x3*/
	...
	typedef enum _SE_WS_APPX_SIGNATURE_ORIGIN  // 4 elements, 0x4 bytes
	{
	...
	typedef enum _TOKEN_INFORMATION_CLASS  // 42 elements, 0x4 bytes
	{
		TokenUser = 1 /*0x1*/,
		TokenGroups = 2 /*0x2*/,
		...
		TokenProcessTrustLevel = 41 /*0x29*/,
		MaxTokenInfoClass = 42 /*0x2A*/
	...
	typedef enum _WOW64_SHARED_INFORMATION  // 12 elements, 0x4 bytes
	{
		...
		SharedNtdll32ExpInterlockedPopEntrySListFault = 4 /*0x4*/,
		SharedNtdll32ExpInterlockedPopEntrySListResume = 5 /*0x5*/,
		SharedNtdll32ExpInterlockedPopEntrySListEnd = 6 /*0x6*/,
		SharedNtdll32RtlUserThreadStart = 7 /*0x7*/,
		SharedNtdll32pQueryProcessDebugInformationRemote = 8 /*0x8*/,
		SharedNtdll32BaseAddress = 9 /*0x9*/,
		SharedNtdll32LdrSystemDllInitBlock = 10 /*0xA*/,
		Wow64SharedPageEntriesCount = 11 /*0xB*/
	...
	typedef VOID(NEAR CDECL FUNCT_00BD_00BC_CleanupGroupCancelCallback_DeRefSecurityDescriptor_PostRoutine) (VOID*, VOID*);
	typedef VOID(NEAR CDECL FUNCT_00BD_00C4_FinalizationCallback) (struct _TP_CALLBACK_INSTANCE*, VOID*);
	typedef enum _EXCEPTION_DISPOSITION(NEAR CDECL FUNCT_0157_0156_Handler) (struct _EXCEPTION_RECORD*, VOID*, struct _CONTEXT*, VOID*);
	typedef VOID(NEAR CDECL FUNCT_00BD_028D_PostProcessInitRoutine_DispatchAddress_FinishRoutine) ();
	typedef VOID(NEAR CDECL FUNCT_00BD_0586_DeferredRoutine) (struct _KDPC*, VOID*, VOID*, VOID*);
	typedef VOID(NEAR CDECL FUNCT_00BD_071B_NormalRoutine) (VOID*, VOID*, VOID*);
	typedef VOID(NEAR CDECL FUNCT_00BD_0712_KernelRoutine) (struct _KAPC*, FUNCT_00BD_071B_NormalRoutine**, VOID**, VOID**, VOID**);
	typedef VOID(NEAR CDECL FUNCT_00BD_071B_NormalRoutine) (VOID*, VOID*, VOID*);
	typedef VOID(NEAR CDECL FUNCT_00BD_0720_RundownRoutine) (struct _KAPC*);
	typedef VOID* (NEAR CDECL FUNCT_00C0_07CD_AllocateEx) (enum _POOL_TYPE, UINT64, ULONG32, struct _LOOKASIDE_LIST_EX*);
	typedef VOID* (NEAR CDECL FUNCT_00C0_07D7_Allocate) (enum _POOL_TYPE, UINT64, ULONG32);
	typedef VOID(NEAR CDECL FUNCT_00BD_07DC_FreeEx) (VOID*, struct _LOOKASIDE_LIST_EX*);
	typedef VOID(NEAR CDECL FUNCT_00BD_07E0_Free_IdleComplete_WorkerRoutine_DeleteCallback_InterfaceReference_InterfaceDereference_DeleteProcedure_DevicePowerRequired_DevicePowerNotRequired_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead) (VOID*);
	typedef VOID(NEAR CDECL FUNCT_00BD_083E_IdlePrepare) (struct _PROCESSOR_IDLE_PREPARE_INFO*);
	typedef LONG32(NEAR CDECL FUNCT_0073_0860_IdleExecute) (VOID*, ULONG32, ULONG32);
	typedef ULONG32(NEAR CDECL FUNCT_0009_0865_IdlePreselect) (VOID*, struct _PROCESSOR_IDLE_CONSTRAINTS*);
	typedef ULONG32(NEAR CDECL FUNCT_0009_086A_IdleTest) (VOID*, ULONG32, ULONG32);
	typedef VOID(NEAR CDECL FUNCT_00BD_086C_IdleCancel_Free_ComponentActive_ComponentIdle) (VOID*, ULONG32);
	typedef UINT8(NEAR CDECL FUNCT_007C_0870_IdleIsHalted_IdleInitiateWake) (VOID*);
	typedef LONG32(NEAR CDECL FUNCT_0073_0872_QueryPlatformStateResidency) (VOID*, struct _PROCESSOR_PLATFORM_STATE_RESIDENCIES*);
	typedef VOID(NEAR CDECL FUNCT_00BD_08E7_InstantaneousRead) (UINT64, ULONG32*);
	typedef VOID(NEAR CDECL FUNCT_00BD_08EB_DifferentialRead) (UINT64, UINT8, UINT64*, UINT64*);
	typedef VOID(NEAR CDECL FUNCT_00BD_093A_GetFFHThrottleState) (UINT64*);
	typedef VOID(NEAR CDECL FUNCT_00BD_093D_BoostPolicyHandler_BoostModeHandler_StallRoutine) (ULONG32);
	typedef ULONG32(NEAR CDECL FUNCT_0009_0940_PerfSelectionHandler) (UINT64, ULONG32, ULONG32, ULONG32, ULONG32, ULONG32*, UINT64*);
	typedef VOID(NEAR CDECL FUNCT_00BD_0949_PerfControlHandler) (UINT64, UINT64, ULONG32, ULONG32, ULONG32, ULONG32, UINT8, UINT8);
	typedef VOID(NEAR CDECL FUNCT_00BD_09E4_WorkerRoutine) (VOID*, VOID*, VOID*, VOID*);
	typedef LONG32(NEAR CDECL FUNCT_0073_0B29_AddDevice) (struct _DRIVER_OBJECT*, struct _DEVICE_OBJECT*);
	typedef LONG32(NEAR CDECL FUNCT_0073_0B41_PreAcquireForSectionSynchronization_PreReleaseForSectionSynchronization_PreAcquireForCcFlush_PreReleaseForCcFlush_PreAcquireForModifiedPageWriter_PreReleaseForModifiedPageWriter) (struct _FS_FILTER_CALLBACK_DATA*, VOID**);
	typedef VOID(NEAR CDECL FUNCT_00BD_0BBC_PostAcquireForSectionSynchronization_PostReleaseForSectionSynchronization_PostAcquireForCcFlush_PostReleaseForCcFlush_PostAcquireForModifiedPageWriter_PostReleaseForModifiedPageWriter) (struct _FS_FILTER_CALLBACK_DATA*, LONG32, VOID*);
	typedef UINT8(NEAR CDECL FUNCT_007C_0BE0_FastIoCheckIfPossible) (struct _FILE_OBJECT*, union _LARGE_INTEGER*, ULONG32, UINT8, ULONG32, UINT8, struct _IO_STATUS_BLOCK*, struct _DEVICE_OBJECT*);
	typedef UINT8(NEAR CDECL FUNCT_007C_0BEB_FastIoRead_FastIoWrite) (struct _FILE_OBJECT*, union _LARGE_INTEGER*, ULONG32, UINT8, ULONG32, VOID*, struct _IO_STATUS_BLOCK*, struct _DEVICE_OBJECT*);
	typedef UINT8(NEAR CDECL FUNCT_007C_0BF5_FastIoQueryBasicInfo) (struct _FILE_OBJECT*, UINT8, struct _FILE_BASIC_INFORMATION*, struct _IO_STATUS_BLOCK*, struct _DEVICE_OBJECT*);
	typedef UINT8(NEAR CDECL FUNCT_007C_0C03_FastIoQueryStandardInfo) (struct _FILE_OBJECT*, UINT8, struct _FILE_STANDARD_INFORMATION*, struct _IO_STATUS_BLOCK*, struct _DEVICE_OBJECT*);
	typedef UINT8(NEAR CDECL FUNCT_007C_0C11_FastIoLock) (struct _FILE_OBJECT*, union _LARGE_INTEGER*, union _LARGE_INTEGER*, struct _EPROCESS*, ULONG32, UINT8, UINT8, struct _IO_STATUS_BLOCK*, struct _DEVICE_OBJECT*);
	typedef VOID(NEAR CDECL FUNCT_00BD_0D59_MiniPacketCallback) (struct _IO_MINI_COMPLETION_PACKET_USER*, VOID*);
	typedef struct _IMAGE_RUNTIME_FUNCTION_ENTRY* (NEAR CDECL FUNCT_1055_1069_Callback) (UINT64, VOID*);
	typedef UINT8(NEAR CDECL FUNCT_007C_1078_FastIoUnlockSingle) (struct _FILE_OBJECT*, union _LARGE_INTEGER*, union _LARGE_INTEGER*, struct _EPROCESS*, ULONG32, struct _IO_STATUS_BLOCK*, struct _DEVICE_OBJECT*);
	typedef UINT8(NEAR CDECL FUNCT_007C_1081_FastIoUnlockAll) (struct _FILE_OBJECT*, struct _EPROCESS*, struct _IO_STATUS_BLOCK*, struct _DEVICE_OBJECT*);
	typedef UINT8(NEAR CDECL FUNCT_007C_1087_FastIoUnlockAllByKey) (struct _FILE_OBJECT*, VOID*, ULONG32, struct _IO_STATUS_BLOCK*, struct _DEVICE_OBJECT*);
	typedef UINT8(NEAR CDECL FUNCT_007C_108E_FastIoDeviceControl) (struct _FILE_OBJECT*, UINT8, VOID*, ULONG32, VOID*, ULONG32, ULONG32, struct _IO_STATUS_BLOCK*, struct _DEVICE_OBJECT*);
	typedef VOID(NEAR CDECL FUNCT_00BD_1099_AcquireFileForNtCreateSection_ReleaseFileForNtCreateSection) (struct _FILE_OBJECT*);
	typedef VOID(NEAR CDECL FUNCT_00BD_109C_FastIoDetachDevice) (struct _DEVICE_OBJECT*, struct _DEVICE_OBJECT*);
	typedef UINT8(NEAR CDECL FUNCT_007C_10A0_FastIoQueryNetworkOpenInfo) (struct _FILE_OBJECT*, UINT8, struct _FILE_NETWORK_OPEN_INFORMATION*, struct _IO_STATUS_BLOCK*, struct _DEVICE_OBJECT*);
	typedef LONG32(NEAR CDECL FUNCT_0073_10B0_AcquireForModWrite) (struct _FILE_OBJECT*, union _LARGE_INTEGER*, struct _ERESOURCE**, struct _DEVICE_OBJECT*);
	typedef UINT8(NEAR CDECL FUNCT_007C_10B6_MdlRead_PrepareMdlWrite) (struct _FILE_OBJECT*, union _LARGE_INTEGER*, ULONG32, ULONG32, struct _MDL**, struct _IO_STATUS_BLOCK*, struct _DEVICE_OBJECT*);
	typedef UINT8(NEAR CDECL FUNCT_007C_10C0_MdlReadComplete_MdlReadCompleteCompressed) (struct _FILE_OBJECT*, struct _MDL*, struct _DEVICE_OBJECT*);
	typedef UINT8(NEAR CDECL FUNCT_007C_10C5_MdlWriteComplete_MdlWriteCompleteCompressed) (struct _FILE_OBJECT*, union _LARGE_INTEGER*, struct _MDL*, struct _DEVICE_OBJECT*);
	typedef UINT8(NEAR CDECL FUNCT_007C_10CB_FastIoReadCompressed_FastIoWriteCompressed) (struct _FILE_OBJECT*, union _LARGE_INTEGER*, ULONG32, ULONG32, VOID*, struct _MDL**, struct _IO_STATUS_BLOCK*, struct _COMPRESSED_DATA_INFO*, ULONG32, struct _DEVICE_OBJECT*);
	typedef UINT8(NEAR CDECL FUNCT_007C_10E0_FastIoQueryOpen) (struct _IRP*, struct _FILE_NETWORK_OPEN_INFORMATION*, struct _DEVICE_OBJECT*);
	typedef VOID(NEAR CDECL FUNCT_00BD_1109_UserApcRoutine) (VOID*, struct _IO_STATUS_BLOCK*, ULONG32);
	typedef VOID(NEAR CDECL FUNCT_00BD_110E_DriverStartIo_CancelRoutine) (struct _DEVICE_OBJECT*, struct _IRP*);
	typedef LONG32(NEAR CDECL FUNCT_0073_13B5_CompletionRoutine) (struct _DEVICE_OBJECT*, struct _IRP*, VOID*);
	typedef LONG32(NEAR CDECL FUNCT_0073_13BA_ReleaseForModWrite) (struct _FILE_OBJECT*, struct _ERESOURCE*, struct _DEVICE_OBJECT*);
	typedef LONG32(NEAR CDECL FUNCT_0073_13BF_AcquireForCcFlush_ReleaseForCcFlush) (struct _FILE_OBJECT*, struct _DEVICE_OBJECT*);
	typedef LONG32(NEAR CDECL FUNCT_0073_13C3_DriverInit) (struct _DRIVER_OBJECT*, struct _UNICODE_STRING*);
	typedef VOID(NEAR CDECL FUNCT_00BD_13C7_DriverUnload_Function) (struct _DRIVER_OBJECT*);
	typedef LONG32(NEAR CDECL FUNCT_0073_13CB_MajorFunction) (struct _DEVICE_OBJECT*, struct _IRP*);
	typedef VOID(NEAR CDECL FUNCT_00BD_13D5_TimerRoutine) (struct _DEVICE_OBJECT*, VOID*);
	typedef enum _IO_ALLOCATION_ACTION(NEAR CDECL FUNCT_13EA_13E9_DeviceRoutine) (struct _DEVICE_OBJECT*, struct _IRP*, VOID*, VOID*);
	typedef VOID(NEAR CDECL FUNCT_00BD_1494_DumpProcedure) (VOID*, struct _OBJECT_DUMP_CONTROL*);
	typedef LONG32(NEAR CDECL FUNCT_0073_149C_OpenProcedure) (enum _OB_OPEN_REASON, CHAR, struct _EPROCESS*, VOID*, ULONG32*, ULONG32);
	typedef VOID(NEAR CDECL FUNCT_00BD_14AA_CloseProcedure) (struct _EPROCESS*, VOID*, UINT64, UINT64);
	typedef LONG32(NEAR CDECL FUNCT_0073_14B0_ParseProcedure) (VOID*, VOID*, struct _ACCESS_STATE*, CHAR, ULONG32, struct _UNICODE_STRING*, struct _UNICODE_STRING*, VOID*, struct _SECURITY_QUALITY_OF_SERVICE*, VOID**);
	typedef LONG32(NEAR CDECL FUNCT_0073_14BC_SecurityProcedure) (VOID*, enum _SECURITY_OPERATION_CODE, ULONG32*, VOID*, ULONG32*, VOID**, enum _POOL_TYPE, struct _GENERIC_MAPPING*, CHAR);
	typedef LONG32(NEAR CDECL FUNCT_0073_14CD_QueryNameProcedure) (VOID*, UINT8, struct _OBJECT_NAME_INFORMATION*, ULONG32, ULONG32*, CHAR);
	typedef UINT8(NEAR CDECL FUNCT_007C_14D5_OkayToCloseProcedure) (struct _EPROCESS*, VOID*, VOID*, CHAR);
	typedef struct _CELL_DATA* (NEAR CDECL FUNCT_16F9_16F8_GetCellRoutine) (struct _HHIVE*, ULONG32);
	typedef VOID* (NEAR CDECL FUNCT_00C0_1746_Allocate) (ULONG32, UINT8, ULONG32);
	typedef UINT8(NEAR CDECL FUNCT_007C_174B_FileWrite) (struct _HHIVE*, ULONG32, struct _CMP_OFFSET_ARRAY*, ULONG32, ULONG32*, ULONG32);
	typedef UINT8(NEAR CDECL FUNCT_007C_1758_FileRead) (struct _HHIVE*, ULONG32, ULONG32*, VOID*, ULONG32);
	typedef LONG32(NEAR CDECL FUNCT_0073_1805_Callback) (enum _PCW_CALLBACK_TYPE, union _PCW_CALLBACK_INFORMATION*, VOID*);
	typedef VOID(NEAR CDECL FUNCT_00BD_19A3_NextIrpCallerCompletion_CallerCompletion) (struct _DEVICE_OBJECT*, UINT8, union _POWER_STATE, VOID*, struct _IO_STATUS_BLOCK*);
	typedef UINT8(NEAR CDECL FUNCT_007C_19D0_AcceptDeviceNotification) (ULONG32, VOID*);
	typedef UINT8(NEAR CDECL FUNCT_007C_19D4_AcceptProcessorNotification) (struct _PEPHANDLE__*, ULONG32, VOID*);
	typedef VOID(NEAR CDECL FUNCT_00BD_19F0_ComponentIdleState) (VOID*, ULONG32, ULONG32);
	typedef LONG32(NEAR CDECL FUNCT_0073_19F2_PowerControl) (VOID*, struct _GUID*, VOID*, UINT64, VOID*, UINT64, UINT64*);
	typedef VOID(NEAR CDECL FUNCT_00BD_19FB_ComponentCriticalTransition) (VOID*, ULONG32, UINT8);
	typedef UINT8(NEAR CDECL FUNCT_007C_1A07_PowerOnDumpDeviceCallback) (struct _PEP_CRASHDUMP_INFORMATION*);
	typedef ULONG32(NEAR CDECL FUNCT_0009_1B06_ProfileDepartureSetMode) (VOID*, enum _PROFILE_DEPARTURE_STYLE);
	typedef ULONG32(NEAR CDECL FUNCT_0009_1B0F_ProfileDepartureUpdate) (VOID*);
	typedef VOID(NEAR CDECL FUNCT_00BD_1CF5_FlushToLsnRoutine) (VOID*, union _LARGE_INTEGER);
	typedef VOID(NEAR CDECL FUNCT_00BD_1CF9_QueryLogHandleInfoRoutine) (VOID*, UINT16*);
	typedef UINT8(NEAR CDECL FUNCT_007C_1D61_AcquireForLazyWrite_AcquireForReadAhead) (VOID*, UINT8);
	typedef VOID(NEAR CDECL FUNCT_00BD_1DA8_Callback) (VOID*, UINT64, ULONG32);
	typedef LONG32(NEAR CDECL FUNCT_0073_1E30_CommitRoutine) (VOID*, VOID**, UINT64*);
	typedef LONG32(NEAR CDECL FUNCT_0073_1ED3_DestroyProcedure) (VOID*);
	typedef INT64(NEAR CDECL FUNCT_008D_21A7_GetCpuClock) ();
	typedef VOID(NEAR CDECL FUNCT_00BD_2307_WorkRoutine) (struct _WHEAP_WORK_QUEUE*, struct _LIST_ENTRY*);
	typedef UINT8(NEAR CDECL FUNCT_007C_2412_ServiceRoutine) (struct _KINTERRUPT*, VOID*);
	typedef UINT8(NEAR CDECL FUNCT_007C_2416_MessageServiceRoutine) (struct _KINTERRUPT*, VOID*, ULONG32);
	typedef LONG32(NEAR CDECL FUNCT_0073_263B_NotificationRoutine) (struct _KENLISTMENT*, VOID*, VOID*, ULONG32, union _LARGE_INTEGER*, ULONG32, VOID*);
	typedef enum _RTL_GENERIC_COMPARE_RESULTS(NEAR CDECL FUNCT_2681_2680_CompareRoutine) (struct _RTL_AVL_TABLE*, VOID*, VOID*);
	typedef VOID* (NEAR CDECL FUNCT_00C0_268A_AllocateRoutine) (struct _RTL_AVL_TABLE*, ULONG32);
	typedef VOID(NEAR CDECL FUNCT_00BD_268E_FreeRoutine) (struct _RTL_AVL_TABLE*, VOID*);
	typedef VOID(NEAR CDECL FUNCT_00BD_2835_Routine) (VOID*, VOID*, struct _IO_WORKITEM*);
	typedef LONG32(NEAR CDECL FUNCT_0073_2A96_ArbiterHandler) (VOID*, enum _ARBITER_ACTION, struct _ARBITER_PARAMETERS*);
	typedef LONG32(NEAR CDECL FUNCT_0073_2AF8_UnpackRequirement) (struct _IO_RESOURCE_DESCRIPTOR*, UINT64*, UINT64*, UINT64*, UINT64*);
	typedef LONG32(NEAR CDECL FUNCT_0073_2AFF_PackResource) (struct _IO_RESOURCE_DESCRIPTOR*, UINT64, struct _CM_PARTIAL_RESOURCE_DESCRIPTOR*);
	typedef LONG32(NEAR CDECL FUNCT_0073_2B04_UnpackResource) (struct _CM_PARTIAL_RESOURCE_DESCRIPTOR*, UINT64*, UINT64*);
	typedef LONG32(NEAR CDECL FUNCT_0073_2B09_ScoreRequirement) (struct _IO_RESOURCE_DESCRIPTOR*);
	typedef LONG32(NEAR CDECL FUNCT_0073_2B0C_TestAllocation) (struct _ARBITER_INSTANCE*, struct _ARBITER_TEST_ALLOCATION_PARAMETERS*);
	typedef LONG32(NEAR CDECL FUNCT_0073_2B12_RetestAllocation) (struct _ARBITER_INSTANCE*, struct _ARBITER_RETEST_ALLOCATION_PARAMETERS*);
	typedef LONG32(NEAR CDECL FUNCT_0073_2B17_CommitAllocation_RollbackAllocation) (struct _ARBITER_INSTANCE*);
	typedef LONG32(NEAR CDECL FUNCT_0073_2B1A_BootAllocation) (struct _ARBITER_INSTANCE*, struct _ARBITER_BOOT_ALLOCATION_PARAMETERS*);
	typedef LONG32(NEAR CDECL FUNCT_0073_2B1F_QueryArbitrate) (struct _ARBITER_INSTANCE*, struct _ARBITER_QUERY_ARBITRATE_PARAMETERS*);
	typedef LONG32(NEAR CDECL FUNCT_0073_2B24_QueryConflict) (struct _ARBITER_INSTANCE*, struct _ARBITER_QUERY_CONFLICT_PARAMETERS*);
	typedef LONG32(NEAR CDECL FUNCT_0073_2B29_AddReserved) (struct _ARBITER_INSTANCE*, struct _ARBITER_ADD_RESERVED_PARAMETERS*);
	typedef LONG32(NEAR CDECL FUNCT_0073_2B2E_StartArbiter) (struct _ARBITER_INSTANCE*, struct _CM_RESOURCE_LIST*);
	typedef LONG32(NEAR CDECL FUNCT_0073_2B32_PreprocessEntry_AllocateEntry) (struct _ARBITER_INSTANCE*, struct _ARBITER_ALLOCATION_STATE*);
	typedef UINT8(NEAR CDECL FUNCT_007C_2B36_GetNextAllocationRange_FindSuitableRange_OverrideConflict) (struct _ARBITER_INSTANCE*, struct _ARBITER_ALLOCATION_STATE*);
	typedef VOID(NEAR CDECL FUNCT_00BD_2B38_AddAllocation_BacktrackAllocation) (struct _ARBITER_INSTANCE*, struct _ARBITER_ALLOCATION_STATE*);
	typedef LONG32(NEAR CDECL FUNCT_0073_2B3A_InitializeRangeList) (struct _ARBITER_INSTANCE*, ULONG32, struct _CM_PARTIAL_RESOURCE_DESCRIPTOR*, struct _RTL_RANGE_LIST*);
	typedef UINT8(NEAR CDECL FUNCT_007C_2B40_ConflictCallback) (VOID*, struct _RTL_RANGE*);
	typedef VOID(NEAR CDECL FUNCT_00BD_2CD6_CompletionRoutine) (VOID*, struct _IRP*);
	typedef UINT8(NEAR CDECL FUNCT_007C_2E68_OpenRoutine) (union _LARGE_INTEGER);
	typedef LONG32(NEAR CDECL FUNCT_0073_2E6B_WriteRoutine) (union _LARGE_INTEGER*, struct _MDL*);
	typedef LONG32(NEAR CDECL FUNCT_0073_2E71_WritePendingRoutine) (LONG32, union _LARGE_INTEGER*, struct _MDL*, VOID*);
	typedef LONG32(NEAR CDECL FUNCT_0073_2E7F_ReadRoutine) (LONG32, union _LARGE_INTEGER*, struct _MDL*);
	typedef LONG32(NEAR CDECL FUNCT_0073_2E84_GetDriveTelemetryRoutine) (ULONG32, ULONG32, VOID*, ULONG32);
	typedef VOID(NEAR CDECL FUNCT_00BD_2E8A_GetTransferSizesRoutine) (ULONG32*, ULONG32*);
	typedef VOID(NEAR CDECL FUNCT_00BD_2E8E_DumpNotifyRoutine) (enum _DUMP_EVENTS, VOID*, ULONG32);
	...
	typedef struct _ALPC_PORT                                                // 37 elements, 0x1C0 bytes (sizeof)
	{
		...
		/*0x158*/     struct _CALLBACK_OBJECT* CallbackObject;
		/*0x160*/     VOID* CallbackContext;
		/*0x168*/     struct _LIST_ENTRY CanceledQueue;                                    // 2 elements, 0x10 bytes (sizeof)
		/*0x178*/     LONG32       SequenceNo;
		/*0x17C*/     LONG32       ReferenceNo;
		/*0x180*/     struct _PALPC_PORT_REFERENCE_WAIT_BLOCK* ReferenceNoWait;
		union                                                                // 2 elements, 0x4 bytes (sizeof)
		{
			struct                                                           // 16 elements, 0x4 bytes (sizeof)
			{
				/*0x188*/             ULONG32      Initialized : 1;                                // 0 BitPosition
				/*0x188*/             ULONG32      Type : 2;                                       // 1 BitPosition
				/*0x188*/             ULONG32      ConnectionPending : 1;                          // 3 BitPosition
				/*0x188*/             ULONG32      ConnectionRefused : 1;                          // 4 BitPosition
				/*0x188*/             ULONG32      Disconnected : 1;                               // 5 BitPosition
				/*0x188*/             ULONG32      Closed : 1;                                     // 6 BitPosition
				/*0x188*/             ULONG32      NoFlushOnClose : 1;                             // 7 BitPosition
				/*0x188*/             ULONG32      ReturnExtendedInfo : 1;                         // 8 BitPosition
				/*0x188*/             ULONG32      Waitable : 1;                                   // 9 BitPosition
				/*0x188*/             ULONG32      DynamicSecurity : 1;                            // 10 BitPosition
				/*0x188*/             ULONG32      Wow64CompletionList : 1;                        // 11 BitPosition
				/*0x188*/             ULONG32      Lpc : 1;                                        // 12 BitPosition
				/*0x188*/             ULONG32      LpcToLpc : 1;                                   // 13 BitPosition
				/*0x188*/             ULONG32      HasCompletionList : 1;                          // 14 BitPosition
				/*0x188*/             ULONG32      HadCompletionList : 1;                          // 15 BitPosition
				/*0x188*/             ULONG32      EnableCompletionList : 1;                       // 16 BitPosition
			}s1;
			/*0x188*/         ULONG32      State;
		}u1;
		/*0x190*/     struct _ALPC_PORT* TargetQueuePort;
		/*0x198*/     struct _ALPC_PORT* TargetSequencePort;
		/*0x1A0*/     struct _KALPC_MESSAGE* CachedMessage;
		/*0x1A8*/     ULONG32      MainQueueLength;
		/*0x1AC*/     ULONG32      LargeMessageQueueLength;
		/*0x1B0*/     ULONG32      PendingQueueLength;
		/*0x1B4*/     ULONG32      CanceledQueueLength;
		/*0x1B8*/     ULONG32      WaitQueueLength;
		/*0x1BC*/     UINT8        _PADDING0_[0x4];
	...
	typedef struct _ARBITER_INSTANCE                                                                       // 40 elements, 0x150 bytes (sizeof)
	{
		...
		/*0x078*/     FUNCT_0073_2AF8_UnpackRequirement* UnpackRequirement;
		/*0x080*/     FUNCT_0073_2AFF_PackResource* PackResource;
		/*0x088*/     FUNCT_0073_2B04_UnpackResource* UnpackResource;
		/*0x090*/     FUNCT_0073_2B09_ScoreRequirement* ScoreRequirement;
		/*0x098*/     FUNCT_0073_2B0C_TestAllocation* TestAllocation;
		/*0x0A0*/     FUNCT_0073_2B12_RetestAllocation* RetestAllocation;
		/*0x0A8*/     FUNCT_0073_2B17_CommitAllocation_RollbackAllocation* CommitAllocation;
		/*0x0B0*/     FUNCT_0073_2B17_CommitAllocation_RollbackAllocation* RollbackAllocation;
		/*0x0B8*/     FUNCT_0073_2B1A_BootAllocation* BootAllocation;
		/*0x0C0*/     FUNCT_0073_2B1F_QueryArbitrate* QueryArbitrate;
		/*0x0C8*/     FUNCT_0073_2B24_QueryConflict* QueryConflict;
		/*0x0D0*/     FUNCT_0073_2B29_AddReserved* AddReserved;
		/*0x0D8*/     FUNCT_0073_2B2E_StartArbiter* StartArbiter;
		/*0x0E0*/     FUNCT_0073_2B32_PreprocessEntry_AllocateEntry* PreprocessEntry;
		/*0x0E8*/     FUNCT_0073_2B32_PreprocessEntry_AllocateEntry* AllocateEntry;
		/*0x0F0*/     FUNCT_007C_2B36_GetNextAllocationRange_FindSuitableRange_OverrideConflict* GetNextAllocationRange;
		/*0x0F8*/     FUNCT_007C_2B36_GetNextAllocationRange_FindSuitableRange_OverrideConflict* FindSuitableRange;
		/*0x100*/     FUNCT_00BD_2B38_AddAllocation_BacktrackAllocation* AddAllocation;
		/*0x108*/     FUNCT_00BD_2B38_AddAllocation_BacktrackAllocation* BacktrackAllocation;
		/*0x110*/     FUNCT_007C_2B36_GetNextAllocationRange_FindSuitableRange_OverrideConflict* OverrideConflict;
		/*0x118*/     FUNCT_0073_2B3A_InitializeRangeList* InitializeRangeList;
		...
		/*0x148*/     FUNCT_007C_2B40_ConflictCallback* ConflictCallback;
	...
	typedef struct _ARBITER_INTERFACE                                                                                                                                                                                                               // 7 elements, 0x30 bytes (sizeof)
	{
		...
		/*0x004*/     UINT8        _PADDING0_[0x4];
		/*0x008*/     VOID* Context;
		/*0x010*/     FUNCT_00BD_07E0_Free_IdleComplete_WorkerRoutine_DeleteCallback_InterfaceReference_InterfaceDereference_DeleteProcedure_DevicePowerRequired_DevicePowerNotRequired_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead* InterfaceReference;
		/*0x018*/     FUNCT_00BD_07E0_Free_IdleComplete_WorkerRoutine_DeleteCallback_InterfaceReference_InterfaceDereference_DeleteProcedure_DevicePowerRequired_DevicePowerNotRequired_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead* InterfaceDereference;
		/*0x020*/     FUNCT_0073_2A96_ArbiterHandler* ArbiterHandler;
		/*0x028*/     ULONG32      Flags;
	...
	typedef struct _AUX_ACCESS_DATA                                                                              // 12 elements, 0xE0 bytes (sizeof)
	{
		...
		/*0x048*/     FUNCT_00BD_00BC_CleanupGroupCancelCallback_DeRefSecurityDescriptor_PostRoutine* DeRefSecurityDescriptor;
		/*0x050*/     VOID* SDLock;
	...
	typedef struct _BLOB_TYPE                                                                                                                                                                                                                  // 8 elements, 0x30 bytes (sizeof)
	{
		...
		/*0x018*/     FUNCT_00BD_07E0_Free_IdleComplete_WorkerRoutine_DeleteCallback_InterfaceReference_InterfaceDereference_DeleteProcedure_DevicePowerRequired_DevicePowerNotRequired_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead* DeleteProcedure;
		/*0x020*/     FUNCT_0073_1ED3_DestroyProcedure* DestroyProcedure;
	...
	{
		/*0x000*/     FUNCT_007C_1D61_AcquireForLazyWrite_AcquireForReadAhead* AcquireForLazyWrite;
		/*0x008*/     FUNCT_00BD_07E0_Free_IdleComplete_WorkerRoutine_DeleteCallback_InterfaceReference_InterfaceDereference_DeleteProcedure_DevicePowerRequired_DevicePowerNotRequired_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead* ReleaseFromLazyWrite;
		/*0x010*/     FUNCT_007C_1D61_AcquireForLazyWrite_AcquireForReadAhead* AcquireForReadAhead;
		/*0x018*/     FUNCT_00BD_07E0_Free_IdleComplete_WorkerRoutine_DeleteCallback_InterfaceReference_InterfaceDereference_DeleteProcedure_DevicePowerRequired_DevicePowerNotRequired_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead* ReleaseFromReadAhead;
	}CACHE_MANAGER_CALLBACKS, * PCACHE_MANAGER_CALLBACKS;

	typedef struct _DISPATCHER_HEADER                                // 55 elements, 0x18 bytes (sizeof)
	{
			...
			struct                                                   // 4 elements, 0x4 bytes (sizeof)
			{
				...
				union                                                // 2 elements, 0x1 bytes (sizeof)
				{
					...
					struct                                           // 5 elements, 0x1 bytes (sizeof)
					{
						...
						/*0x002*/                     UINT8        ThreadReservedControlFlags : 4; // 4 BitPosition
					};
				};
				union                                                // 2 elements, 0x1 bytes (sizeof)
				{
	...
	{
		/*0x000*/     struct _DISPATCHER_HEADER Header; // 55 elements, 0x18 bytes (sizeof)
	}KEVENT, * PKEVENT;
	...
	{
		/*0x000*/     FUNCT_00BD_1DA8_Callback* Callback;
	...
	typedef struct _CM_DIRTY_VECTOR_LOG_ENTRY      // 4 elements, 0x50 bytes (sizeof)
	{
	...
	typedef struct _CM_DIRTY_VECTOR_LOG            // 3 elements, 0x508 bytes (sizeof)
	{
		/*0x000*/     ULONG32      Next;
		/*0x004*/     ULONG32      Size;
	...
	typedef struct _CM_WORKITEM                                                                                                                                                                                                              // 4 elements, 0x28 bytes (sizeof)
	{
		...
		/*0x014*/     UINT8        _PADDING0_[0x4];
		/*0x018*/     FUNCT_00BD_07E0_Free_IdleComplete_WorkerRoutine_DeleteCallback_InterfaceReference_InterfaceDereference_DeleteProcedure_DevicePowerRequired_DevicePowerNotRequired_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead* WorkerRoutine;
	...
	typedef struct _HHIVE                                                    // 43 elements, 0x5A8 bytes (sizeof)
	{
		/*0x000*/     ULONG32      Signature;
		/*0x004*/     UINT8        _PADDING0_[0x4];
		/*0x008*/     FUNCT_16F9_16F8_GetCellRoutine* GetCellRoutine;
		/*0x010*/     FUNCT_00C0_1746_Allocate* Allocate;
		/*0x018*/     FUNCT_00BD_086C_IdleCancel_Free_ComponentActive_ComponentIdle* Free;
		/*0x020*/     FUNCT_007C_174B_FileWrite* FileWrite;
		/*0x028*/     FUNCT_007C_1758_FileRead* FileRead;
		...
		/*0x058*/     struct _RTL_BITMAP UnreconciledVector;                               // 2 elements, 0x10 bytes (sizeof)
		/*0x068*/     ULONG32      UnreconciledCount;
		/*0x06C*/     ULONG32      BaseBlockAlloc;
		/*0x070*/     ULONG32      Cluster;
		struct                                                               // 3 elements, 0x1 bytes (sizeof)
		{
			/*0x074*/         UINT8        Flat : 1;                                           // 0 BitPosition
			/*0x074*/         UINT8        ReadOnly : 1;                                       // 1 BitPosition
			/*0x074*/         UINT8        Reserved : 6;                                       // 2 BitPosition
		};
		/*0x075*/     UINT8        DirtyFlag;
		/*0x076*/     UINT8        _PADDING1_[0x2];
		/*0x078*/     ULONG32      HvBinHeadersUse;
		/*0x07C*/     ULONG32      HvFreeCellsUse;
		/*0x080*/     ULONG32      HvUsedCellsUse;
		/*0x084*/     ULONG32      CmUsedCellsUse;
		/*0x088*/     ULONG32      HiveFlags;
		/*0x08C*/     ULONG32      CurrentLog;
		/*0x090*/     ULONG32      CurrentLogSequence;
		/*0x094*/     ULONG32      CurrentLogOffset;
		/*0x098*/     ULONG32      MinimumLogSequence;
		/*0x09C*/     ULONG32      LogFileSizeCap;
		/*0x0A0*/     UINT8        LogDataPresent[2];
		/*0x0A2*/     UINT8        PrimaryFileValid;
		/*0x0A3*/     UINT8        BaseBlockDirty;
		union                                                                // 2 elements, 0x2 bytes (sizeof)
		{
			struct                                                           // 5 elements, 0x2 bytes (sizeof)
			{
				/*0x0A4*/             UINT16       FirstLogFile : 3;                               // 0 BitPosition
				/*0x0A4*/             UINT16       SecondLogFile : 3;                              // 3 BitPosition
				/*0x0A4*/             UINT16       HeaderRecovered : 1;                            // 6 BitPosition
				/*0x0A4*/             UINT16       LegacyRecoveryIndicated : 1;                    // 7 BitPosition
				/*0x0A4*/             UINT16       RecoveryInformationReserved : 8;                // 8 BitPosition
			};
			/*0x0A4*/         UINT16       RecoveryInformation;
		};
		/*0x0A6*/     UINT8        LogEntriesRecovered[2];
		/*0x0A8*/     ULONG32      RefreshCount;
		/*0x0AC*/     ULONG32      StorageTypeCount;
		/*0x0B0*/     ULONG32      Version;
		/*0x0B4*/     UINT8        _PADDING2_[0x4];
		/*0x0B8*/     struct _DUAL Storage[2];
	}HHIVE, * PHHIVE;
	...
	typedef struct _CMHIVE                                  // 78 elements, 0x1360 bytes (sizeof)
	{
		/*0x000*/      struct _HHIVE Hive;                                 // 43 elements, 0x5A8 bytes (sizeof)
		/*0x5A8*/      VOID* FileHandles[6];
		/*0x5D8*/      struct _LIST_ENTRY NotifyList;                      // 2 elements, 0x10 bytes (sizeof)
		/*0x5E8*/      struct _LIST_ENTRY HiveList;                        // 2 elements, 0x10 bytes (sizeof)
		/*0x5F8*/      struct _LIST_ENTRY PreloadedHiveList;               // 2 elements, 0x10 bytes (sizeof)
		/*0x608*/      struct _EX_RUNDOWN_REF HiveRundown;                 // 2 elements, 0x8 bytes (sizeof)
		/*0x610*/      struct _LIST_ENTRY ParseCacheEntries;               // 2 elements, 0x10 bytes (sizeof)
		/*0x620*/      struct _CM_KEY_HASH_TABLE_ENTRY* KcbCacheTable;
		/*0x628*/      ULONG32      KcbCacheTableSize;
		/*0x62C*/      UINT8        _PADDING0_[0x4];
		/*0x630*/      struct _CM_KEY_HASH_TABLE_ENTRY* DeletedKcbTable;
		/*0x638*/      ULONG32      DeletedKcbTableSize;
		/*0x63C*/      ULONG32      Identity;
		/*0x640*/      struct _FAST_MUTEX* HiveLock;
		/*0x648*/      struct _FAST_MUTEX* WriterLock;
		/*0x650*/      struct _ERESOURCE* FlusherLock;
		/*0x658*/      struct _RTL_BITMAP FlushDirtyVector;                // 2 elements, 0x10 bytes (sizeof)
		/*0x668*/      ULONG32      FlushDirtyVectorSize;
		/*0x66C*/      UINT8        _PADDING1_[0x4];
		/*0x670*/      UINT8* FlushLogEntry;
		/*0x678*/      ULONG32      FlushLogEntrySize;
		/*0x67C*/      ULONG32      FlushHiveTruncated;
		/*0x680*/      UINT8        FlushBaseBlockDirty;
		/*0x681*/      UINT8        _PADDING2_[0x7];
		/*0x688*/      struct _RTL_BITMAP CapturedUnreconciledVector;      // 2 elements, 0x10 bytes (sizeof)
		/*0x698*/      ULONG32      CapturedUnreconciledVectorSize;
		/*0x69C*/      UINT8        _PADDING3_[0x4];
		/*0x6A0*/      struct _CMP_OFFSET_ARRAY* UnreconciledOffsetArray;
		/*0x6A8*/      ULONG32      UnreconciledOffsetArrayCount;
		/*0x6AC*/      UINT8        _PADDING4_[0x4];
		/*0x6B0*/      struct _HBASE_BLOCK* UnreconciledBaseBlock;
		/*0x6B8*/      struct _EX_PUSH_LOCK SecurityLock;                  // 7 elements, 0x8 bytes (sizeof)
		/*0x6C0*/      ULONG32      UseCount;
		/*0x6C4*/      ULONG32      LastShrinkHiveSize;
		/*0x6C8*/      union _LARGE_INTEGER ActualFileSize;                // 4 elements, 0x8 bytes (sizeof)
		/*0x6D0*/      union _LARGE_INTEGER LogFileSizes[2];
		/*0x6E0*/      struct _UNICODE_STRING FileFullPath;                // 3 elements, 0x10 bytes (sizeof)
		/*0x6F0*/      struct _UNICODE_STRING FileUserName;                // 3 elements, 0x10 bytes (sizeof)
		/*0x700*/      struct _UNICODE_STRING HiveRootPath;                // 3 elements, 0x10 bytes (sizeof)
		/*0x710*/      ULONG32      SecurityCount;
		/*0x714*/      ULONG32      SecurityCacheSize;
		/*0x718*/      LONG32       SecurityHitHint;
		/*0x71C*/      UINT8        _PADDING5_[0x4];
		/*0x720*/      struct _CM_KEY_SECURITY_CACHE_ENTRY* SecurityCache;
		/*0x728*/      struct _LIST_ENTRY SecurityHash[64];
		/*0xB28*/      ULONG32      UnloadEventCount;
		/*0xB2C*/      UINT8        _PADDING6_[0x4];
		/*0xB30*/      struct _KEVENT** UnloadEventArray;
		/*0xB38*/      struct _CM_KEY_CONTROL_BLOCK* RootKcb;
		/*0xB40*/      UINT8        Frozen;
		/*0xB41*/      UINT8        _PADDING7_[0x7];
		/*0xB48*/      struct _CM_WORKITEM* UnloadWorkItem;
		/*0xB50*/      struct _CM_WORKITEM UnloadWorkItemHolder;           // 4 elements, 0x28 bytes (sizeof)
		/*0xB78*/      UINT8        GrowOnlyMode;
		/*0xB79*/      UINT8        _PADDING8_[0x3];
		/*0xB7C*/      ULONG32      GrowOffset;
		/*0xB80*/      struct _LIST_ENTRY KcbConvertListHead;              // 2 elements, 0x10 bytes (sizeof)
		/*0xB90*/      struct _LIST_ENTRY KnodeConvertListHead;            // 2 elements, 0x10 bytes (sizeof)
		/*0xBA0*/      struct _CM_CELL_REMAP_BLOCK* CellRemapArray;
		/*0xBA8*/      struct _CM_DIRTY_VECTOR_LOG DirtyVectorLog;         // 3 elements, 0x508 bytes (sizeof)
		/*0x10B0*/     ULONG32      Flags;
		/*0x10B4*/     UINT8        _PADDING9_[0x4];
		/*0x10B8*/     struct _LIST_ENTRY TrustClassEntry;                 // 2 elements, 0x10 bytes (sizeof)
		/*0x10C8*/     UINT64       DirtyTime;
		/*0x10D0*/     UINT64       UnreconciledTime;
		/*0x10D8*/     struct _CM_RM* CmRm;
		/*0x10E0*/     ULONG32      CmRmInitFailPoint;
		/*0x10E4*/     LONG32       CmRmInitFailStatus;
		/*0x10E8*/     struct _KTHREAD* CreatorOwner;
		/*0x10F0*/     struct _KTHREAD* RundownThread;
		/*0x10F8*/     union _LARGE_INTEGER LastWriteTime;                 // 4 elements, 0x8 bytes (sizeof)
		/*0x1100*/     struct _HIVE_WRITE_WAIT_QUEUE FlushQueue;           // 3 elements, 0x18 bytes (sizeof)
		/*0x1118*/     struct _HIVE_WRITE_WAIT_QUEUE ReconcileQueue;       // 3 elements, 0x18 bytes (sizeof)
		union                                               // 2 elements, 0x4 bytes (sizeof)
		{
			/*0x1130*/         ULONG32      FlushFlags;
			struct                                          // 4 elements, 0x4 bytes (sizeof)
			{
				/*0x1130*/             ULONG32      FlushActive : 1;               // 0 BitPosition
				/*0x1130*/             ULONG32      ReconcileActive : 1;           // 1 BitPosition
				/*0x1130*/             ULONG32      PrimaryFilePurged : 1;         // 2 BitPosition
				/*0x1130*/             ULONG32      DiskFileBad : 1;               // 3 BitPosition
			};
		};
		/*0x1134*/     ULONG32      PrimaryFileSizeBeforeLastFlush;
		/*0x1138*/     LONG32       ReferenceCount;
		/*0x113C*/     LONG32       UnloadHistoryIndex;
		/*0x1140*/     ULONG32      UnloadHistory[128];
		/*0x1340*/     ULONG32      BootStart;
		/*0x1344*/     ULONG32      UnaccessedStart;
		/*0x1348*/     ULONG32      UnaccessedEnd;
		/*0x134C*/     ULONG32      LoadedKeyCount;
		/*0x1350*/     ULONG32      HandleClosePending;
		/*0x1354*/     UINT8        _PADDING10_[0x4];
		/*0x1358*/     struct _EX_PUSH_LOCK HandleClosePendingEvent;       // 7 elements, 0x8 bytes (sizeof)
	}CMHIVE, * PCMHIVE;
	...
	typedef struct _MMSECTION_FLAGS            // 24 elements, 0x4 bytes (sizeof)
	{
		...
		/*0x000*/     UINT32       Spare : 4;                // 28 BitPosition
	...
	typedef struct _CONTROL_AREA                                      // 14 elements, 0x78 bytes (sizeof)
	{
		...
		union                                                         // 2 elements, 0x4 bytes (sizeof)
		{
			...
			/*0x038*/         struct _MMSECTION_FLAGS Flags;                            // 24 elements, 0x4 bytes (sizeof)
		}u;
		...
		{
			struct                                                    // 11 elements, 0x10 bytes (sizeof)
			{
				union                                                 // 2 elements, 0x4 bytes (sizeof)
				{
				...
				union                                                 // 2 elements, 0x4 bytes (sizeof)
				{
					...
					struct                                            // 5 elements, 0x4 bytes (sizeof)
					{
						...
						/*0x05C*/                     ULONG32      Unused : 12;                     // 16 BitPosition
		...
		/*0x068*/     UINT64       LockedPages;
		/*0x070*/     struct _EX_PUSH_LOCK FileObjectLock;                          // 7 elements, 0x8 bytes (sizeof)
	...
	typedef struct _DEFERRED_WRITE                                                                   // 9 elements, 0x48 bytes (sizeof)
	{
		...
		/*0x030*/     FUNCT_00BD_00BC_CleanupGroupCancelCallback_DeRefSecurityDescriptor_PostRoutine* PostRoutine;
		/*0x038*/     VOID* Context1;
		/*0x040*/     VOID* Context2;
	...
	typedef struct _DEVICE_NODE                                      // 66 elements, 0x2C8 bytes (sizeof)
	{
	...
	typedef struct _WAIT_CONTEXT_BLOCK                  // 12 elements, 0x48 bytes (sizeof)
	{
		...
		/*0x018*/     FUNCT_13EA_13E9_DeviceRoutine* DeviceRoutine;
	...
	typedef struct _KDPC                                  // 11 elements, 0x40 bytes (sizeof)
	{
		...
		/*0x018*/     FUNCT_00BD_0586_DeferredRoutine* DeferredRoutine;
	...
	typedef struct _DEVICE_OBJECT_LIST_ENTRY       // 3 elements, 0x10 bytes (sizeof)
	{
	...
	typedef struct _DEVOBJ_EXTENSION                 // 14 elements, 0x60 bytes (sizeof)
	{
		/*0x000*/     INT16        Type;
		/*0x002*/     UINT16       Size;
		/*0x004*/     UINT8        _PADDING0_[0x4];
	...
	typedef struct _DOCK_INTERFACE                                                                                                                                                                                                                  // 7 elements, 0x30 bytes (sizeof)
	{
		...
		/*0x010*/     FUNCT_00BD_07E0_Free_IdleComplete_WorkerRoutine_DeleteCallback_InterfaceReference_InterfaceDereference_DeleteProcedure_DevicePowerRequired_DevicePowerNotRequired_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead* InterfaceReference;
		/*0x018*/     FUNCT_00BD_07E0_Free_IdleComplete_WorkerRoutine_DeleteCallback_InterfaceReference_InterfaceDereference_DeleteProcedure_DevicePowerRequired_DevicePowerNotRequired_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead* InterfaceDereference;
		/*0x020*/     FUNCT_0009_1B06_ProfileDepartureSetMode* ProfileDepartureSetMode;
		/*0x028*/     FUNCT_0009_1B0F_ProfileDepartureUpdate* ProfileDepartureUpdate;
	...
	typedef struct _DRIVER_EXTENSION                        // 9 elements, 0x50 bytes (sizeof)
	{
		...
		/*0x008*/     FUNCT_0073_0B29_AddDevice* AddDevice;
		/*0x010*/     ULONG32      Count;
		/*0x014*/     UINT8        _PADDING0_[0x4];
	...
	typedef struct _DRIVER_OBJECT                                   // 15 elements, 0x150 bytes (sizeof)
	{
		...
		/*0x058*/     FUNCT_0073_13C3_DriverInit* DriverInit;
		/*0x060*/     FUNCT_00BD_110E_DriverStartIo_CancelRoutine* DriverStartIo;
		/*0x068*/     FUNCT_00BD_13C7_DriverUnload_Function* DriverUnload;
		/*0x070*/     FUNCT_0073_13CB_MajorFunction* MajorFunction[28];
	...
	typedef struct _DUMP_INITIALIZATION_CONTEXT                                              // 28 elements, 0x108 bytes (sizeof)
	{
		...
		/*0x030*/     FUNCT_00BD_093D_BoostPolicyHandler_BoostModeHandler_StallRoutine* StallRoutine;
		/*0x038*/     FUNCT_007C_2E68_OpenRoutine* OpenRoutine;
		/*0x040*/     FUNCT_0073_2E6B_WriteRoutine* WriteRoutine;
		/*0x048*/     FUNCT_00BD_028D_PostProcessInitRoutine_DispatchAddress_FinishRoutine* FinishRoutine;
		...
		/*0x080*/     FUNCT_0073_2E71_WritePendingRoutine* WritePendingRoutine;
		...
		/*0x0A0*/     FUNCT_0073_2E7F_ReadRoutine* ReadRoutine;
		/*0x0A8*/     FUNCT_0073_2E84_GetDriveTelemetryRoutine* GetDriveTelemetryRoutine;
		/*0x0B0*/     ULONG32      LogSectionTruncateSize;
		/*0x0B4*/     ULONG32      Parameters[16];
		/*0x0F4*/     UINT8        _PADDING1_[0x4];
		/*0x0F8*/     FUNCT_00BD_2E8A_GetTransferSizesRoutine* GetTransferSizesRoutine;
		/*0x100*/     FUNCT_00BD_2E8E_DumpNotifyRoutine* DumpNotifyRoutine;
	...
	typedef struct _DUMP_STACK_CONTEXT                  // 11 elements, 0x178 bytes (sizeof)
	{
		...
		/*0x118*/     ULONG32      PointersLength;
		/*0x11C*/     UINT8        _PADDING0_[0x4];
		/*0x120*/     UINT16* ModulePrefix;
	...
	typedef struct _DYNAMIC_FUNCTION_TABLE                   // 11 elements, 0x58 bytes (sizeof)
	{
		...
		/*0x038*/     FUNCT_1055_1069_Callback* Callback;
		/*0x040*/     VOID* Context;
	...
	typedef struct _EJOB                                            // 112 elements, 0x4B0 bytes (sizeof)
	{
		...
		/*0x250*/     UINT64       PeakProcessMemoryUsed;
		/*0x258*/     UINT64       PeakJobMemoryUsed;
		/*0x260*/     struct _KAFFINITY_EX EffectiveAffinity;                     // 4 elements, 0xA8 bytes (sizeof)
		/*0x308*/     union _LARGE_INTEGER EffectivePerProcessUserTimeLimit;      // 4 elements, 0x8 bytes (sizeof)
		/*0x310*/     UINT64       EffectiveMinimumWorkingSetSize;
		/*0x318*/     UINT64       EffectiveMaximumWorkingSetSize;
		/*0x320*/     UINT64       EffectiveProcessMemoryLimit;
		/*0x328*/     struct _EJOB* EffectiveProcessMemoryLimitJob;
		/*0x330*/     struct _EJOB* EffectivePerProcessUserTimeLimitJob;
		/*0x338*/     ULONG32      EffectiveLimitFlags;
		/*0x33C*/     ULONG32      EffectiveSchedulingClass;
		/*0x340*/     ULONG32      EffectiveFreezeCount;
		/*0x344*/     ULONG32      EffectiveBackgroundCount;
		/*0x348*/     ULONG32      EffectiveSwapCount;
		/*0x34C*/     ULONG32      EffectiveNotificationLimitCount;
		/*0x350*/     UINT8        EffectivePriorityClass;
		/*0x351*/     UINT8        PriorityClass;
		/*0x352*/     UINT8        Reserved1[2];
		/*0x354*/     ULONG32      CompletionFilter;
		union                                                       // 2 elements, 0x38 bytes (sizeof)
		{
			/*0x358*/         struct _WNF_STATE_NAME WakeChannel;                     // 1 elements, 0x8 bytes (sizeof)
			/*0x358*/         struct _PS_WAKE_INFORMATION WakeInfo;                   // 3 elements, 0x38 bytes (sizeof)
		};
		/*0x390*/     struct _JOBOBJECT_WAKE_FILTER WakeFilter;                   // 2 elements, 0x8 bytes (sizeof)
		/*0x398*/     ULONG32      LowEdgeLatchFilter;
		/*0x39C*/     ULONG32      OwnedHighEdgeFilters;
		/*0x3A0*/     struct _EJOB* NotificationLink;
		/*0x3A8*/     UINT64       CurrentJobMemoryUsed;
		/*0x3B0*/     struct _JOB_NOTIFICATION_INFORMATION* NotificationInfo;
		/*0x3B8*/     VOID* NotificationInfoQuotaReference;
		/*0x3C0*/     struct _IO_MINI_COMPLETION_PACKET_USER* NotificationPacket;
		/*0x3C8*/     struct _JOB_CPU_RATE_CONTROL* CpuRateControl;
		/*0x3D0*/     VOID* EffectiveSchedulingGroup;
		/*0x3D8*/     UINT64       ReadyTime;
		/*0x3E0*/     struct _EX_PUSH_LOCK MemoryLimitsLock;                      // 7 elements, 0x8 bytes (sizeof)
		/*0x3E8*/     struct _LIST_ENTRY SiblingJobLinks;                         // 2 elements, 0x10 bytes (sizeof)
		/*0x3F8*/     struct _LIST_ENTRY ChildJobListHead;                        // 2 elements, 0x10 bytes (sizeof)
		/*0x408*/     struct _EJOB* ParentJob;
		/*0x410*/     struct _EJOB* RootJob;
		/*0x418*/     struct _LIST_ENTRY IteratorListHead;                        // 2 elements, 0x10 bytes (sizeof)
		/*0x428*/     UINT64       AncestorCount;
		/*0x430*/     struct _EJOB** Ancestors;
		/*0x438*/     struct _EPROCESS_VALUES Accounting;                         // 10 elements, 0x50 bytes (sizeof)
		/*0x488*/     ULONG32      ShadowActiveProcessCount;
		/*0x48C*/     ULONG32      SequenceNumber;
		/*0x490*/     UINT64       TimerListLock;
		/*0x498*/     struct _LIST_ENTRY TimerListHead;                           // 2 elements, 0x10 bytes (sizeof)
		union                                                       // 2 elements, 0x4 bytes (sizeof)
		{
			/*0x4A8*/         ULONG32      JobFlags;
			struct                                                  // 26 elements, 0x4 bytes (sizeof)
			{
				/*0x4A8*/             ULONG32      CloseDone : 1;                         // 0 BitPosition
				/*0x4A8*/             ULONG32      MultiGroup : 1;                        // 1 BitPosition
				/*0x4A8*/             ULONG32      OutstandingNotification : 1;           // 2 BitPosition
				/*0x4A8*/             ULONG32      NotificationInProgress : 1;            // 3 BitPosition
				/*0x4A8*/             ULONG32      UILimits : 1;                          // 4 BitPosition
				/*0x4A8*/             ULONG32      CpuRateControlActive : 1;              // 5 BitPosition
				/*0x4A8*/             ULONG32      OwnCpuRateControl : 1;                 // 6 BitPosition
				/*0x4A8*/             ULONG32      Terminating : 1;                       // 7 BitPosition
				/*0x4A8*/             ULONG32      WorkingSetLock : 1;                    // 8 BitPosition
				/*0x4A8*/             ULONG32      JobFrozen : 1;                         // 9 BitPosition
				/*0x4A8*/             ULONG32      Background : 1;                        // 10 BitPosition
				/*0x4A8*/             ULONG32      WakeNotificationAllocated : 1;         // 11 BitPosition
				/*0x4A8*/             ULONG32      WakeNotificationEnabled : 1;           // 12 BitPosition
				/*0x4A8*/             ULONG32      WakeNotificationPending : 1;           // 13 BitPosition
				/*0x4A8*/             ULONG32      LimitNotificationRequired : 1;         // 14 BitPosition
				/*0x4A8*/             ULONG32      ZeroCountNotificationRequired : 1;     // 15 BitPosition
				/*0x4A8*/             ULONG32      CycleTimeNotificationRequired : 1;     // 16 BitPosition
				/*0x4A8*/             ULONG32      CycleTimeNotificationPending : 1;      // 17 BitPosition
				/*0x4A8*/             ULONG32      TimersVirtualized : 1;                 // 18 BitPosition
				/*0x4A8*/             ULONG32      JobSwapped : 1;                        // 19 BitPosition
				/*0x4A8*/             ULONG32      ViolationDetected : 1;                 // 20 BitPosition
				/*0x4A8*/             ULONG32      EmptyJobNotified : 1;                  // 21 BitPosition
				/*0x4A8*/             ULONG32      NoSystemCharge : 1;                    // 22 BitPosition
				/*0x4A8*/             ULONG32      DropNoWakeCharges : 1;                 // 23 BitPosition
				/*0x4A8*/             ULONG32      NoWakeChargePolicyDecided : 1;         // 24 BitPosition
				/*0x4A8*/             ULONG32      SpareJobFlags : 7;                     // 25 BitPosition
			};
		};
		/*0x4AC*/     ULONG32      EffectiveHighEdgeFilters;
	}EJOB, * PEJOB;
	...
	typedef struct _KNODE                     // 17 elements, 0xC0 bytes (sizeof)
	{
		...
		/*0x008*/     UINT64       SharedReadyQueueLeaders;
		...
		/*0x070*/     UINT8        _PADDING2_[0x10];
		/*0x080*/     UINT64       NonParkedSet;
		/*0x088*/     ULONG32      Seed;
		/*0x08C*/     ULONG32      Lowest;
		/*0x090*/     ULONG32      Highest;
		/*0x094*/     LONG32       ParkLock;
		/*0x098*/     UINT8        _PADDING3_[0x28];
	}KNODE, * PKNODE;
	...
	typedef struct _EX_WORK_QUEUE                    // 9 elements, 0x2D0 bytes (sizeof)
	{
		/*0x000*/     struct _KPRIQUEUE WorkPriQueue;              // 5 elements, 0x2B0 bytes (sizeof)
		/*0x2B0*/     struct _ENODE* Node;
		/*0x2B8*/     ULONG32      WorkItemsProcessed;
		/*0x2BC*/     ULONG32      WorkItemsProcessedLastPass;
		/*0x2C0*/     LONG32       ThreadCount;
		/*0x2C4*/     LONG32       MinThreads : 31;                // 0 BitPosition
		///*0x2C8*/     UINT8        _PADDING0_[0xFFFFFFFFFFFFFFFC];
		/*0x2C4*/     ULONG32      TryFailed : 1;                  // 31 BitPosition
		/*0x2C8*/     LONG32       MaxThreads;
		/*0x2CC*/     enum _EXQUEUEINDEX QueueIndex;
	...
	typedef struct _ENODE                                  // 12 elements, 0x500 bytes (sizeof)
	{
		/*0x000*/     struct _KNODE Ncb;                                 // 17 elements, 0xC0 bytes (sizeof)
		/*0x0C0*/     struct _EX_WORK_QUEUE* ExWorkQueues[8];
		/*0x100*/     struct _EX_WORK_QUEUE ExWorkQueue;                 // 9 elements, 0x2D0 bytes (sizeof)
		/*0x3D0*/     struct _KEVENT ExpThreadSetManagerEvent;           // 1 elements, 0x18 bytes (sizeof)
		/*0x3E8*/     struct _KTIMER ExpDeadlockTimer;                   // 6 elements, 0x40 bytes (sizeof)
		/*0x428*/     struct _KEVENT ExpThreadReaperEvent;               // 1 elements, 0x18 bytes (sizeof)
		/*0x440*/     struct _KWAIT_BLOCK WaitBlocks[3];
		/*0x4D0*/     struct _ETHREAD* ExpWorkerThreadBalanceManagerPtr;
		/*0x4D8*/     ULONG32      ExpWorkerSeed;
		union                                              // 2 elements, 0x24 bytes (sizeof)
		{
			struct                                         // 2 elements, 0x4 bytes (sizeof)
			{
				/*0x4DC*/             ULONG32      ExWorkerFullInit : 1;         // 0 BitPosition
				/*0x4DC*/             ULONG32      ExWorkerStructInit : 1;       // 1 BitPosition
			};
			/*0x4DC*/         ULONG32      ExWorkerFlags;
		};
	}ENODE, * PENODE;
	...
	typedef struct _KPROCESS                          // 42 elements, 0x2C8 bytes (sizeof)
	{
		...
		/*0x048*/     struct _KAFFINITY_EX Affinity;                // 4 elements, 0xA8 bytes (sizeof)
		/*0x0F0*/     struct _LIST_ENTRY ReadyListHead;             // 2 elements, 0x10 bytes (sizeof)
		/*0x100*/     struct _SINGLE_LIST_ENTRY SwapListEntry;      // 1 elements, 0x8 bytes (sizeof)
		/*0x108*/     struct _KAFFINITY_EX ActiveProcessors;        // 4 elements, 0xA8 bytes (sizeof)
		union                                         // 2 elements, 0x4 bytes (sizeof)
		{
			struct                                    // 9 elements, 0x4 bytes (sizeof)
			{
				/*0x1B0*/             LONG32       AutoAlignment : 1;       // 0 BitPosition
				/*0x1B0*/             LONG32       DisableBoost : 1;        // 1 BitPosition
				/*0x1B0*/             LONG32       DisableQuantum : 1;      // 2 BitPosition
				/*0x1B0*/             LONG32       AffinitySet : 1;         // 3 BitPosition
				/*0x1B0*/             ULONG32      DeepFreeze : 1;          // 4 BitPosition
				/*0x1B0*/             ULONG32      TimerVirtualization : 1; // 5 BitPosition
				/*0x1B0*/             ULONG32      CheckStackExtents : 1;   // 6 BitPosition
				/*0x1B0*/             ULONG32      ActiveGroupsMask : 20;   // 7 BitPosition
				/*0x1B0*/             LONG32       ReservedFlags : 5;       // 27 BitPosition
			};
			/*0x1B0*/         LONG32       ProcessFlags;
		};
		/*0x1B4*/     CHAR         BasePriority;
		/*0x1B5*/     CHAR         QuantumReset;
		/*0x1B6*/     UINT8        Visited;
		/*0x1B7*/     union _KEXECUTE_OPTIONS Flags;                // 10 elements, 0x1 bytes (sizeof)
		/*0x1B8*/     ULONG32      ThreadSeed[20];
		/*0x208*/     UINT16       IdealNode[20];
		/*0x230*/     UINT16       IdealGlobalNode;
		/*0x232*/     UINT16       Spare1;
		/*0x234*/     union _KSTACK_COUNT StackCount;               // 3 elements, 0x4 bytes (sizeof)
		/*0x238*/     struct _LIST_ENTRY ProcessListEntry;          // 2 elements, 0x10 bytes (sizeof)
		/*0x248*/     UINT64       CycleTime;
		...
		/*0x268*/     ULONG32      UserTime;
		/*0x26C*/     UINT16       LdtFreeSelectorHint;
		/*0x26E*/     UINT16       LdtTableLength;
		/*0x270*/     union _KGDTENTRY64 LdtSystemDescriptor;       // 8 elements, 0x10 bytes (sizeof)
		/*0x280*/     VOID* LdtBaseAddress;
		/*0x288*/     struct _FAST_MUTEX LdtProcessLock;            // 5 elements, 0x38 bytes (sizeof)
	...
	typedef struct _MMSUPPORT_FLAGS                 // 14 elements, 0x4 bytes (sizeof)
	{
		struct                                      // 4 elements, 0x1 bytes (sizeof)
		{
			...
			/*0x000*/         UINT8        ForceCredits : 3;          // 3 BitPosition
		...
		struct                                      // 5 elements, 0x1 bytes (sizeof)
		{
			...
			/*0x003*/         UINT8        Available : 4;             // 4 BitPosition
		};
	}MMSUPPORT_FLAGS, * PMMSUPPORT_FLAGS;

	typedef struct _MMSUPPORT                        // 24 elements, 0xE8 bytes (sizeof)
	{
		/*0x000*/     struct _KGATE* ExitGate;
		/*0x008*/     VOID* AccessLog;
		/*0x010*/     struct _EX_PUSH_LOCK WorkingSetMutex;        // 7 elements, 0x8 bytes (sizeof)
		/*0x018*/     struct _LIST_ENTRY WorkingSetExpansionLinks; // 2 elements, 0x10 bytes (sizeof)
		/*0x028*/     UINT64       AgeDistribution[7];
		/*0x060*/     UINT64       MinimumWorkingSetSize;
		/*0x068*/     UINT64       WorkingSetLeafSize;
		/*0x070*/     UINT64       WorkingSetLeafPrivateSize;
		/*0x078*/     UINT64       WorkingSetSize;
		/*0x080*/     UINT64       WorkingSetPrivateSize;
		/*0x088*/     UINT64       MaximumWorkingSetSize;
		/*0x090*/     UINT64       ChargedWslePages;
		/*0x098*/     UINT64       ActualWslePages;
		/*0x0A0*/     UINT64       WorkingSetSizeOverhead;
		/*0x0A8*/     UINT64       PeakWorkingSetSize;
		/*0x0B0*/     ULONG32      HardFaultCount;
		/*0x0B4*/     UINT8        _PADDING0_[0x4];
		/*0x0B8*/     struct _MMWSL* VmWorkingSetList;
		/*0x0C0*/     UINT16       NextPageColor;
		/*0x0C2*/     UINT16       LastTrimStamp;
		/*0x0C4*/     ULONG32      PageFaultCount;
		/*0x0C8*/     UINT64       TrimmedPageCount;
		/*0x0D0*/     UINT64       ForceTrimPages;
		/*0x0D8*/     struct _MMSUPPORT_FLAGS Flags;               // 14 elements, 0x4 bytes (sizeof)
		/*0x0DC*/     UINT8        _PADDING1_[0x4];
		/*0x0E0*/     VOID* WsSwapSupport;
	...
	typedef struct _EPROCESS                                               // 163 elements, 0x6D8 bytes (sizeof)
	{
		/*0x000*/     struct _KPROCESS Pcb;                                              // 42 elements, 0x2C8 bytes (sizeof)
		/*0x2C8*/     struct _EX_PUSH_LOCK ProcessLock;                                  // 7 elements, 0x8 bytes (sizeof)
		/*0x2D0*/     union _LARGE_INTEGER CreateTime;                                   // 4 elements, 0x8 bytes (sizeof)
		/*0x2D8*/     struct _EX_RUNDOWN_REF RundownProtect;                             // 2 elements, 0x8 bytes (sizeof)
		...
		union                                                              // 2 elements, 0x4 bytes (sizeof)
		{
			...
			{
				/*0x2F8*/             ULONG32      JobNotReallyActive : 1;                       // 0 BitPosition
				/*0x2F8*/             ULONG32      AccountingFolded : 1;                         // 1 BitPosition
				/*0x2F8*/             ULONG32      NewProcessReported : 1;                       // 2 BitPosition
				/*0x2F8*/             ULONG32      ExitProcessReported : 1;                      // 3 BitPosition
				/*0x2F8*/             ULONG32      ReportCommitChanges : 1;                      // 4 BitPosition
				/*0x2F8*/             ULONG32      LastReportMemory : 1;                         // 5 BitPosition
				/*0x2F8*/             ULONG32      ForceWakeCharge : 1;                          // 6 BitPosition
				/*0x2F8*/             ULONG32      CrossSessionCreate : 1;                       // 7 BitPosition
				/*0x2F8*/             ULONG32      NeedsHandleRundown : 1;                       // 8 BitPosition
				/*0x2F8*/             ULONG32      RefTraceEnabled : 1;                          // 9 BitPosition
				/*0x2F8*/             ULONG32      DisableDynamicCode : 1;                       // 10 BitPosition
				/*0x2F8*/             ULONG32      EmptyJobEvaluated : 1;                        // 11 BitPosition
				/*0x2F8*/             ULONG32      DefaultPagePriority : 3;                      // 12 BitPosition
				/*0x2F8*/             ULONG32      PrimaryTokenFrozen : 1;                       // 15 BitPosition
				/*0x2F8*/             ULONG32      ProcessVerifierTarget : 1;                    // 16 BitPosition
				/*0x2F8*/             ULONG32      StackRandomizationDisabled : 1;               // 17 BitPosition
				/*0x2F8*/             ULONG32      AffinityPermanent : 1;                        // 18 BitPosition
				/*0x2F8*/             ULONG32      AffinityUpdateEnable : 1;                     // 19 BitPosition
				/*0x2F8*/             ULONG32      PropagateNode : 1;                            // 20 BitPosition
				/*0x2F8*/             ULONG32      ExplicitAffinity : 1;                         // 21 BitPosition
				/*0x2F8*/             ULONG32      ProcessExecutionState : 2;                    // 22 BitPosition
				/*0x2F8*/             ULONG32      DisallowStrippedImages : 1;                   // 24 BitPosition
				/*0x2F8*/             ULONG32      HighEntropyASLREnabled : 1;                   // 25 BitPosition
				/*0x2F8*/             ULONG32      ExtensionPointDisable : 1;                    // 26 BitPosition
				/*0x2F8*/             ULONG32      ForceRelocateImages : 1;                      // 27 BitPosition
				/*0x2F8*/             ULONG32      ProcessStateChangeRequest : 2;                // 28 BitPosition
				/*0x2F8*/             ULONG32      ProcessStateChangeInProgress : 1;             // 30 BitPosition
				/*0x2F8*/             ULONG32      DisallowWin32kSystemCalls : 1;                // 31 BitPosition
			};
		};
		union                                                              // 2 elements, 0x4 bytes (sizeof)
		{
			...
			{
				/*0x2FC*/             ULONG32      CreateReported : 1;                           // 0 BitPosition
				/*0x2FC*/             ULONG32      NoDebugInherit : 1;                           // 1 BitPosition
				/*0x2FC*/             ULONG32      ProcessExiting : 1;                           // 2 BitPosition
				/*0x2FC*/             ULONG32      ProcessDelete : 1;                            // 3 BitPosition
				/*0x2FC*/             ULONG32      ControlFlowGuardEnabled : 1;                  // 4 BitPosition
				/*0x2FC*/             ULONG32      VmDeleted : 1;                                // 5 BitPosition
				/*0x2FC*/             ULONG32      OutswapEnabled : 1;                           // 6 BitPosition
				/*0x2FC*/             ULONG32      Outswapped : 1;                               // 7 BitPosition
				/*0x2FC*/             ULONG32      ForkFailed : 1;                               // 8 BitPosition
				/*0x2FC*/             ULONG32      Wow64VaSpace4Gb : 1;                          // 9 BitPosition
				/*0x2FC*/             ULONG32      AddressSpaceInitialized : 2;                  // 10 BitPosition
				/*0x2FC*/             ULONG32      SetTimerResolution : 1;                       // 12 BitPosition
				/*0x2FC*/             ULONG32      BreakOnTermination : 1;                       // 13 BitPosition
				/*0x2FC*/             ULONG32      DeprioritizeViews : 1;                        // 14 BitPosition
				/*0x2FC*/             ULONG32      WriteWatch : 1;                               // 15 BitPosition
				/*0x2FC*/             ULONG32      ProcessInSession : 1;                         // 16 BitPosition
				/*0x2FC*/             ULONG32      OverrideAddressSpace : 1;                     // 17 BitPosition
				/*0x2FC*/             ULONG32      HasAddressSpace : 1;                          // 18 BitPosition
				/*0x2FC*/             ULONG32      LaunchPrefetched : 1;                         // 19 BitPosition
				/*0x2FC*/             ULONG32      Background : 1;                               // 20 BitPosition
				/*0x2FC*/             ULONG32      VmTopDown : 1;                                // 21 BitPosition
				/*0x2FC*/             ULONG32      ImageNotifyDone : 1;                          // 22 BitPosition
				/*0x2FC*/             ULONG32      PdeUpdateNeeded : 1;                          // 23 BitPosition
				/*0x2FC*/             ULONG32      VdmAllowed : 1;                               // 24 BitPosition
				/*0x2FC*/             ULONG32      ProcessRundown : 1;                           // 25 BitPosition
				/*0x2FC*/             ULONG32      ProcessInserted : 1;                          // 26 BitPosition
				/*0x2FC*/             ULONG32      DefaultIoPriority : 3;                        // 27 BitPosition
				/*0x2FC*/             ULONG32      ProcessSelfDelete : 1;                        // 30 BitPosition
				/*0x2FC*/             ULONG32      SetTimerResolutionLink : 1;                   // 31 BitPosition
			};
		};
		/*0x300*/     UINT64       ProcessQuotaUsage[2];
		/*0x310*/     UINT64       ProcessQuotaPeak[2];
		/*0x320*/     UINT64       PeakVirtualSize;
		/*0x328*/     UINT64       VirtualSize;
		/*0x330*/     struct _LIST_ENTRY SessionProcessLinks;                            // 2 elements, 0x10 bytes (sizeof)
		union                                                              // 3 elements, 0x8 bytes (sizeof)
		{
			/*0x340*/         VOID* ExceptionPortData;
			/*0x340*/         UINT64       ExceptionPortValue;
			/*0x340*/         UINT64       ExceptionPortState : 3;                           // 0 BitPosition
		};
		/*0x348*/     struct _EX_FAST_REF Token;                                         // 3 elements, 0x8 bytes (sizeof)
		/*0x350*/     UINT64       WorkingSetPage;
		/*0x358*/     struct _EX_PUSH_LOCK AddressCreationLock;                          // 7 elements, 0x8 bytes (sizeof)
		/*0x360*/     struct _EX_PUSH_LOCK PageTableCommitmentLock;                      // 7 elements, 0x8 bytes (sizeof)
		/*0x368*/     struct _ETHREAD* RotateInProgress;
		/*0x370*/     struct _ETHREAD* ForkInProgress;
		/*0x378*/     struct _EJOB* CommitChargeJob;
		/*0x380*/     struct _RTL_AVL_TREE CloneRoot;                                    // 1 elements, 0x8 bytes (sizeof)
		/*0x388*/     UINT64       NumberOfPrivatePages;
		/*0x390*/     UINT64       NumberOfLockedPages;
		/*0x398*/     VOID* Win32Process;
		/*0x3A0*/     struct _EJOB* Job;
		/*0x3A8*/     VOID* SectionObject;
		/*0x3B0*/     VOID* SectionBaseAddress;
		/*0x3B8*/     ULONG32      Cookie;
		/*0x3BC*/     UINT8        _PADDING0_[0x4];
		/*0x3C0*/     struct _PAGEFAULT_HISTORY* WorkingSetWatch;
		/*0x3C8*/     VOID* Win32WindowStation;
		/*0x3D0*/     VOID* InheritedFromUniqueProcessId;
		/*0x3D8*/     VOID* LdtInformation;
		/*0x3E0*/     UINT64       OwnerProcessId;
		/*0x3E8*/     struct _PEB* Peb;
		/*0x3F0*/     VOID* Session;
		/*0x3F8*/     VOID* AweInfo;
		/*0x400*/     struct _EPROCESS_QUOTA_BLOCK* QuotaBlock;
		/*0x408*/     struct _HANDLE_TABLE* ObjectTable;
		/*0x410*/     VOID* DebugPort;
		/*0x418*/     VOID* WoW64Process;
		/*0x420*/     VOID* DeviceMap;
		/*0x428*/     VOID* EtwDataSource;
		/*0x430*/     UINT64       PageDirectoryPte;
		/*0x438*/     UINT8        ImageFileName[15];
		/*0x447*/     UINT8        PriorityClass;
		/*0x448*/     VOID* SecurityPort;
		/*0x450*/     struct _SE_AUDIT_PROCESS_CREATION_INFO SeAuditProcessCreationInfo; // 1 elements, 0x8 bytes (sizeof)
		/*0x458*/     struct _LIST_ENTRY JobLinks;                                       // 2 elements, 0x10 bytes (sizeof)
		/*0x468*/     VOID* HighestUserAddress;
		/*0x470*/     struct _LIST_ENTRY ThreadListHead;                                 // 2 elements, 0x10 bytes (sizeof)
		/*0x480*/     ULONG32      ActiveThreads;
		/*0x484*/     ULONG32      ImagePathHash;
		/*0x488*/     ULONG32      DefaultHardErrorProcessing;
		/*0x48C*/     LONG32       LastThreadExitStatus;
		/*0x490*/     struct _EX_FAST_REF PrefetchTrace;                                 // 3 elements, 0x8 bytes (sizeof)
		/*0x498*/     VOID* LockedPagesList;
		/*0x4A0*/     union _LARGE_INTEGER ReadOperationCount;                           // 4 elements, 0x8 bytes (sizeof)
		/*0x4A8*/     union _LARGE_INTEGER WriteOperationCount;                          // 4 elements, 0x8 bytes (sizeof)
		/*0x4B0*/     union _LARGE_INTEGER OtherOperationCount;                          // 4 elements, 0x8 bytes (sizeof)
		/*0x4B8*/     union _LARGE_INTEGER ReadTransferCount;                            // 4 elements, 0x8 bytes (sizeof)
		/*0x4C0*/     union _LARGE_INTEGER WriteTransferCount;                           // 4 elements, 0x8 bytes (sizeof)
		/*0x4C8*/     union _LARGE_INTEGER OtherTransferCount;                           // 4 elements, 0x8 bytes (sizeof)
		/*0x4D0*/     UINT64       CommitCharge;
		/*0x4D8*/     struct _MMSUPPORT Vm;                                              // 24 elements, 0xE8 bytes (sizeof)
		/*0x5C0*/     struct _LIST_ENTRY MmProcessLinks;                                 // 2 elements, 0x10 bytes (sizeof)
		/*0x5D0*/     ULONG32      ModifiedPageCount;
		/*0x5D4*/     LONG32       ExitStatus;
		/*0x5D8*/     struct _RTL_AVL_TREE VadRoot;                                      // 1 elements, 0x8 bytes (sizeof)
		/*0x5E0*/     VOID* VadHint;
		/*0x5E8*/     UINT64       VadCount;
		/*0x5F0*/     UINT64       VadPhysicalPages;
		/*0x5F8*/     UINT64       VadPhysicalPagesLimit;
		/*0x600*/     struct _ALPC_PROCESS_CONTEXT AlpcContext;                          // 3 elements, 0x20 bytes (sizeof)
		/*0x620*/     struct _LIST_ENTRY TimerResolutionLink;                            // 2 elements, 0x10 bytes (sizeof)
		...
		/*0x640*/     union _LARGE_INTEGER ExitTime;                                     // 4 elements, 0x8 bytes (sizeof)
		/*0x648*/     struct _INVERTED_FUNCTION_TABLE* InvertedFunctionTable;
		/*0x650*/     struct _EX_PUSH_LOCK InvertedFunctionTableLock;                    // 7 elements, 0x8 bytes (sizeof)
		/*0x658*/     ULONG32      ActiveThreadsHighWatermark;
		/*0x65C*/     ULONG32      LargePrivateVadCount;
		/*0x660*/     struct _EX_PUSH_LOCK ThreadListLock;                               // 7 elements, 0x8 bytes (sizeof)
		/*0x668*/     VOID* WnfContext;
		/*0x670*/     UINT64       Spare0;
		/*0x678*/     UINT8        SignatureLevel;
		/*0x679*/     UINT8        SectionSignatureLevel;
		/*0x67A*/     struct _PS_PROTECTION Protection;                                  // 4 elements, 0x1 bytes (sizeof)
		/*0x67B*/     UINT8        SpareByte20[1];
		union                                                              // 2 elements, 0x4 bytes (sizeof)
		{
			/*0x67C*/         ULONG32      Flags3;
			/*0x67C*/         ULONG32      Minimal : 1;                                      // 0 BitPosition
		};
		...
		/*0x6B8*/     UINT64       DeepFreezeStartTime;
		/*0x6C0*/     UINT64       CommitChargeLimit;
		/*0x6C8*/     UINT64       CommitChargePeak;
		/*0x6D0*/     ULONG32      HighPriorityFaultsAllowed;
		/*0x6D4*/     UINT8        _PADDING2_[0x4];
	}EPROCESS, * PEPROCESS;
	...
	typedef struct _KAPC_STATE                         // 7 elements, 0x30 bytes (sizeof)
	{
	...
	typedef struct _KAPC                                        // 17 elements, 0x58 bytes (sizeof)
	{
		...
		union                                                   // 2 elements, 0x18 bytes (sizeof)
		{
			struct                                              // 3 elements, 0x18 bytes (sizeof)
			{
				/*0x020*/             FUNCT_00BD_0712_KernelRoutine* KernelRoutine;
				/*0x028*/             FUNCT_00BD_0720_RundownRoutine* RundownRoutine;
				/*0x030*/             FUNCT_00BD_071B_NormalRoutine* NormalRoutine;
			};
	...
	typedef struct _KLOCK_ENTRY_LOCK_STATE // 8 elements, 0x10 bytes (sizeof)
	{
		union                              // 2 elements, 0x8 bytes (sizeof)
		{
			...
			{
				/*0x000*/             UINT64       Waiting : 1;  // 0 BitPosition
				/*0x000*/             UINT64       Busy : 1;     // 1 BitPosition
				/*0x000*/             UINT64       Spare : 61;   // 2 BitPosition
	...
	typedef struct _KLOCK_ENTRY                       // 25 elements, 0x60 bytes (sizeof)
	{
		union                                         // 2 elements, 0x18 bytes (sizeof)
		{
		...
		union                                         // 2 elements, 0x8 bytes (sizeof)
		{
			/*0x018*/         VOID* ThreadUnsafe;
			struct                                    // 3 elements, 0x8 bytes (sizeof)
			{
				/*0x018*/             UINT8        HeadNodeByte;
				/*0x019*/             UINT8        Reserved1[6];
				/*0x01F*/             UINT8        AcquiredByte;
			};
		};
		union                                         // 3 elements, 0x10 bytes (sizeof)
		{
			...
			struct                                    // 4 elements, 0x10 bytes (sizeof)
			{
				/*0x020*/             UINT8        WaitingAndBusyByte;
		...
		union                                         // 2 elements, 0x20 bytes (sizeof)
		{
			...
			{
				/*0x030*/             struct _RTL_RB_TREE OwnerTree;        // 2 elements, 0x10 bytes (sizeof)
				/*0x040*/             struct _RTL_RB_TREE WaiterTree;       // 2 elements, 0x10 bytes (sizeof)
			};
		...
		union                                         // 2 elements, 0x2 bytes (sizeof)
		{
			/*0x058*/         UINT16       AllBoosts;
			struct                                    // 2 elements, 0x2 bytes (sizeof)
			{
				/*0x058*/             UINT16       IoBoost : 1;             // 0 BitPosition
				/*0x058*/             UINT16       CpuBoostsBitmap : 15;    // 1 BitPosition
			};
		};
		/*0x05A*/     UINT16       IoNormalPriorityWaiterCount;
		struct                                        // 2 elements, 0x1 bytes (sizeof)
		{
			/*0x05C*/         UINT8        IoPriorityBit : 1;           // 0 BitPosition
			/*0x05C*/         UINT8        AbSpare : 7;                 // 1 BitPosition
		};
		/*0x05D*/     UINT8        SparePad[3];
	}KLOCK_ENTRY, * PKLOCK_ENTRY;

	typedef struct _KTHREAD                                            // 165 elements, 0x5D0 bytes (sizeof)
	{
		/*0x000*/     struct _DISPATCHER_HEADER Header;                              // 55 elements, 0x18 bytes (sizeof)
		...
		union                                                          // 2 elements, 0x4 bytes (sizeof)
		{
			...
			{
				/*0x074*/             ULONG32      SpareMiscFlag0 : 1;                       // 0 BitPosition
				...
				/*0x074*/             ULONG32      UserStackWalkActive : 1;                  // 6 BitPosition
				/*0x074*/             ULONG32      ApcInterruptRequest : 1;                  // 7 BitPosition
				/*0x074*/             ULONG32      QuantumEndMigrate : 1;                    // 8 BitPosition
				/*0x074*/             ULONG32      UmsDirectedSwitchEnable : 1;              // 9 BitPosition
				/*0x074*/             ULONG32      TimerActive : 1;                          // 10 BitPosition
				/*0x074*/             ULONG32      SystemThread : 1;                         // 11 BitPosition
				/*0x074*/             ULONG32      ProcessDetachActive : 1;                  // 12 BitPosition
				/*0x074*/             ULONG32      CalloutActive : 1;                        // 13 BitPosition
				/*0x074*/             ULONG32      ScbReadyQueue : 1;                        // 14 BitPosition
				/*0x074*/             ULONG32      ApcQueueable : 1;                         // 15 BitPosition
				/*0x074*/             ULONG32      ReservedStackInUse : 1;                   // 16 BitPosition
				/*0x074*/             ULONG32      UmsPerformingSyscall : 1;                 // 17 BitPosition
				/*0x074*/             ULONG32      ApcPendingReload : 1;                     // 18 BitPosition
				/*0x074*/             ULONG32      TimerSuspended : 1;                       // 19 BitPosition
				/*0x074*/             ULONG32      SuspendedWaitMode : 1;                    // 20 BitPosition
		...
		union                                                          // 2 elements, 0x4 bytes (sizeof)
		{
			struct                                                     // 19 elements, 0x4 bytes (sizeof)
			{
				...
				/*0x078*/             ULONG32      ChargeOnlySchedulingGroup : 1;            // 8 BitPosition
				...
				/*0x078*/             ULONG32      SharedReadyQueueAffinity : 1;             // 12 BitPosition
				/*0x078*/             ULONG32      FreezeCount : 1;                          // 13 BitPosition
				/*0x078*/             ULONG32      TerminationApcRequest : 1;                // 14 BitPosition
				/*0x078*/             ULONG32      AutoBoostEntriesExhausted : 1;            // 15 BitPosition
				/*0x078*/             ULONG32      KernelStackResident : 1;                  // 16 BitPosition
				/*0x078*/             ULONG32      EtwStackTraceApcInserted : 8;             // 17 BitPosition
				/*0x078*/             ULONG32      ReservedFlags : 7;                        // 25 BitPosition
			};
		...
		{
			/*0x098*/         struct _KAPC_STATE ApcState;                               // 7 elements, 0x30 bytes (sizeof)
		...
		union                                                          // 2 elements, 0x10 bytes (sizeof)
		{
			/*0x238*/         struct _GROUP_AFFINITY Affinity;                           // 3 elements, 0x10 bytes (sizeof)
			struct                                                     // 4 elements, 0x10 bytes (sizeof)
			{
				/*0x238*/             UINT8        AffinityFill[10];
				/*0x242*/             UINT8        ApcStateIndex;
				/*0x243*/             UINT8        WaitBlockCount;
				/*0x244*/             ULONG32      IdealProcessor;
			};
		};
		/*0x248*/     struct _KAPC_STATE* ApcStatePointer[2];
		union                                                          // 2 elements, 0x30 bytes (sizeof)
		{
			/*0x258*/         struct _KAPC_STATE SavedApcState;                          // 7 elements, 0x30 bytes (sizeof)
		...
		/*0x318*/     struct _SINGLE_LIST_ENTRY LockEntriesFreeList;                 // 1 elements, 0x8 bytes (sizeof)
		...
		union                                                          // 2 elements, 0x10 bytes (sizeof)
		{
			/*0x590*/         struct _LIST_ENTRY GlobalForegroundListEntry;              // 2 elements, 0x10 bytes (sizeof)
			struct                                                     // 2 elements, 0x10 bytes (sizeof)
			{
				/*0x590*/             struct _SINGLE_LIST_ENTRY ForegroundDpcStackListEntry; // 1 elements, 0x8 bytes (sizeof)
				/*0x598*/             UINT64       InGlobalForegroundList;
			};
		};
		/*0x5A0*/     INT64        ReadOperationCount;
	...
	{
		/*0x000*/     struct _KTHREAD Tcb;                                             // 165 elements, 0x5D0 bytes (sizeof)
		/*0x5D0*/     union _LARGE_INTEGER CreateTime;                                 // 4 elements, 0x8 bytes (sizeof)
		union                                                            // 2 elements, 0x10 bytes (sizeof)
		{
			/*0x5D8*/         union _LARGE_INTEGER ExitTime;                               // 4 elements, 0x8 bytes (sizeof)
			/*0x5D8*/         struct _LIST_ENTRY KeyedWaitChain;                           // 2 elements, 0x10 bytes (sizeof)
		};
		/*0x5E8*/     VOID* ChargeOnlySession;
		union                                                            // 2 elements, 0x10 bytes (sizeof)
		{
			/*0x5F0*/         struct _LIST_ENTRY PostBlockList;                            // 2 elements, 0x10 bytes (sizeof)
			struct                                                       // 2 elements, 0x10 bytes (sizeof)
			{
				/*0x5F0*/             VOID* ForwardLinkShadow;
				/*0x5F8*/             VOID* StartAddress;
			};
		};
		union                                                            // 3 elements, 0x8 bytes (sizeof)
		{
			/*0x600*/         struct _TERMINATION_PORT* TerminationPort;
			/*0x600*/         struct _ETHREAD* ReaperLink;
			/*0x600*/         VOID* KeyedWaitValue;
		};
		/*0x608*/     UINT64       ActiveTimerListLock;
		/*0x610*/     struct _LIST_ENTRY ActiveTimerListHead;                          // 2 elements, 0x10 bytes (sizeof)
		/*0x620*/     struct _CLIENT_ID Cid;                                           // 2 elements, 0x10 bytes (sizeof)
		union                                                            // 2 elements, 0x20 bytes (sizeof)
		{
			/*0x630*/         struct _KSEMAPHORE KeyedWaitSemaphore;                       // 2 elements, 0x20 bytes (sizeof)
			/*0x630*/         struct _KSEMAPHORE AlpcWaitSemaphore;                        // 2 elements, 0x20 bytes (sizeof)
		};
		/*0x650*/     union _PS_CLIENT_SECURITY_CONTEXT ClientSecurity;                // 4 elements, 0x8 bytes (sizeof)
		/*0x658*/     struct _LIST_ENTRY IrpList;                                      // 2 elements, 0x10 bytes (sizeof)
		/*0x668*/     UINT64       TopLevelIrp;
		/*0x670*/     struct _DEVICE_OBJECT* DeviceToVerify;
		/*0x678*/     VOID* Win32StartAddress;
		/*0x680*/     VOID* LegacyPowerObject;
		/*0x688*/     struct _LIST_ENTRY ThreadListEntry;                              // 2 elements, 0x10 bytes (sizeof)
		/*0x698*/     struct _EX_RUNDOWN_REF RundownProtect;                           // 2 elements, 0x8 bytes (sizeof)
		/*0x6A0*/     struct _EX_PUSH_LOCK ThreadLock;                                 // 7 elements, 0x8 bytes (sizeof)
		/*0x6A8*/     ULONG32      ReadClusterSize;
		/*0x6AC*/     LONG32       MmLockOrdering;
		/*0x6B0*/     LONG32       CmLockOrdering;
		union                                                            // 2 elements, 0x4 bytes (sizeof)
		{
			/*0x6B4*/         ULONG32      CrossThreadFlags;
			struct                                                       // 14 elements, 0x4 bytes (sizeof)
			{
				/*0x6B4*/             ULONG32      Terminated : 1;                             // 0 BitPosition
				/*0x6B4*/             ULONG32      ThreadInserted : 1;                         // 1 BitPosition
				/*0x6B4*/             ULONG32      HideFromDebugger : 1;                       // 2 BitPosition
				/*0x6B4*/             ULONG32      ActiveImpersonationInfo : 1;                // 3 BitPosition
				/*0x6B4*/             ULONG32      HardErrorsAreDisabled : 1;                  // 4 BitPosition
				/*0x6B4*/             ULONG32      BreakOnTermination : 1;                     // 5 BitPosition
				/*0x6B4*/             ULONG32      SkipCreationMsg : 1;                        // 6 BitPosition
				/*0x6B4*/             ULONG32      SkipTerminationMsg : 1;                     // 7 BitPosition
				/*0x6B4*/             ULONG32      CopyTokenOnOpen : 1;                        // 8 BitPosition
				/*0x6B4*/             ULONG32      ThreadIoPriority : 3;                       // 9 BitPosition
				/*0x6B4*/             ULONG32      ThreadPagePriority : 3;                     // 12 BitPosition
				/*0x6B4*/             ULONG32      RundownFail : 1;                            // 15 BitPosition
				/*0x6B4*/             ULONG32      UmsForceQueueTermination : 1;               // 16 BitPosition
				/*0x6B4*/             ULONG32      ReservedCrossThreadFlags : 15;              // 17 BitPosition
			};
		};
		union                                                            // 2 elements, 0x4 bytes (sizeof)
		{
			/*0x6B8*/         ULONG32      SameThreadPassiveFlags;
			struct                                                       // 5 elements, 0x4 bytes (sizeof)
			{
				/*0x6B8*/             ULONG32      ActiveExWorker : 1;                         // 0 BitPosition
				/*0x6B8*/             ULONG32      MemoryMaker : 1;                            // 1 BitPosition
				/*0x6B8*/             ULONG32      ClonedThread : 1;                           // 2 BitPosition
				/*0x6B8*/             ULONG32      KeyedEventInUse : 1;                        // 3 BitPosition
				/*0x6B8*/             ULONG32      SelfTerminate : 1;                          // 4 BitPosition
			};
		};
		union                                                            // 2 elements, 0x4 bytes (sizeof)
		{
			/*0x6BC*/         ULONG32      SameThreadApcFlags;
			struct                                                       // 4 elements, 0x4 bytes (sizeof)
			{
				struct                                                   // 8 elements, 0x1 bytes (sizeof)
				{
					/*0x6BC*/                 UINT8        HardFaultBehavior : 1;                  // 0 BitPosition
					/*0x6BC*/                 UINT8        StartAddressInvalid : 1;                // 1 BitPosition
					/*0x6BC*/                 UINT8        EtwCalloutActive : 1;                   // 2 BitPosition
					/*0x6BC*/                 UINT8        OwnsProcessWorkingSetExclusive : 1;     // 3 BitPosition
					/*0x6BC*/                 UINT8        OwnsProcessWorkingSetShared : 1;        // 4 BitPosition
					/*0x6BC*/                 UINT8        OwnsSystemCacheWorkingSetExclusive : 1; // 5 BitPosition
					/*0x6BC*/                 UINT8        OwnsSystemCacheWorkingSetShared : 1;    // 6 BitPosition
					/*0x6BC*/                 UINT8        OwnsSessionWorkingSetExclusive : 1;     // 7 BitPosition
				};
				struct                                                   // 8 elements, 0x1 bytes (sizeof)
				{
					/*0x6BD*/                 UINT8        OwnsSessionWorkingSetShared : 1;        // 0 BitPosition
					/*0x6BD*/                 UINT8        OwnsProcessAddressSpaceExclusive : 1;   // 1 BitPosition
					/*0x6BD*/                 UINT8        OwnsProcessAddressSpaceShared : 1;      // 2 BitPosition
					/*0x6BD*/                 UINT8        SuppressSymbolLoad : 1;                 // 3 BitPosition
					/*0x6BD*/                 UINT8        Prefetching : 1;                        // 4 BitPosition
					/*0x6BD*/                 UINT8        OwnsVadExclusive : 1;                   // 5 BitPosition
					/*0x6BD*/                 UINT8        OwnsChangeControlAreaExclusive : 1;     // 6 BitPosition
					/*0x6BD*/                 UINT8        OwnsChangeControlAreaShared : 1;        // 7 BitPosition
				};
				struct                                                   // 6 elements, 0x1 bytes (sizeof)
				{
					/*0x6BE*/                 UINT8        OwnsPagedPoolWorkingSetExclusive : 1;   // 0 BitPosition
					/*0x6BE*/                 UINT8        OwnsPagedPoolWorkingSetShared : 1;      // 1 BitPosition
					/*0x6BE*/                 UINT8        OwnsSystemPtesWorkingSetExclusive : 1;  // 2 BitPosition
					/*0x6BE*/                 UINT8        OwnsSystemPtesWorkingSetShared : 1;     // 3 BitPosition
					/*0x6BE*/                 UINT8        TrimTrigger : 2;                        // 4 BitPosition
					/*0x6BE*/                 UINT8        Spare2 : 2;                             // 6 BitPosition
				};
				struct                                                   // 3 elements, 0x1 bytes (sizeof)
				{
					/*0x6BF*/                 UINT8        SystemPagePriorityActive : 1;           // 0 BitPosition
					/*0x6BF*/                 UINT8        SystemPagePriority : 3;                 // 1 BitPosition
					/*0x6BF*/                 UINT8        Spare3 : 4;                             // 4 BitPosition
				};
			};
		};
		/*0x6C0*/     UINT8        CacheManagerActive;
		/*0x6C1*/     UINT8        DisablePageFaultClustering;
		/*0x6C2*/     UINT8        ActiveFaultCount;
		...
		/*0x6D8*/     LONG32       ExitStatus;
		/*0x6DC*/     UINT8        _PADDING1_[0x4];
		/*0x6E0*/     struct _LIST_ENTRY AlpcWaitListEntry;                            // 2 elements, 0x10 bytes (sizeof)
		/*0x6F0*/     ULONG32      CacheManagerCount;
		/*0x6F4*/     ULONG32      IoBoostCount;
		/*0x6F8*/     struct _LIST_ENTRY BoostList;                                    // 2 elements, 0x10 bytes (sizeof)
		/*0x708*/     struct _LIST_ENTRY DeboostList;                                  // 2 elements, 0x10 bytes (sizeof)
		/*0x718*/     UINT64       BoostListLock;
		/*0x720*/     UINT64       IrpListLock;
		/*0x728*/     VOID* ReservedForSynchTracking;
		/*0x730*/     struct _SINGLE_LIST_ENTRY CmCallbackListHead;                    // 1 elements, 0x8 bytes (sizeof)
		/*0x738*/     struct _GUID* ActivityId;
		/*0x740*/     struct _SINGLE_LIST_ENTRY SeLearningModeListHead;                // 1 elements, 0x8 bytes (sizeof)
		/*0x748*/     VOID* VerifierContext;
		/*0x750*/     ULONG32      KernelStackReference;
		/*0x754*/     UINT8        _PADDING2_[0x4];
		/*0x758*/     VOID* AdjustedClientToken;
		/*0x760*/     ULONG32      UserFsBase;
		/*0x764*/     UINT8        _PADDING3_[0x4];
		/*0x768*/     UINT64       UserGsBase;
	...
	typedef struct _ETW_FILTER_HEADER                       // 9 elements, 0x48 bytes (sizeof)
	{
		...
		/*0x028*/     struct _ETW_PERFECT_HASH_FUNCTION* StackWalkFilter;
		/*0x030*/     struct _ETW_PERFECT_HASH_FUNCTION* EventIdFilter;
		/*0x038*/     struct _ETW_PAYLOAD_FILTER* PayloadFilter;
		/*0x040*/     struct _EVENT_FILTER_HEADER* ProviderSideFilter;
	...
	typedef struct _ETW_REALTIME_CONSUMER              // 25 elements, 0x98 bytes (sizeof)
	{
		/*0x000*/     struct _LIST_ENTRY Links;                      // 2 elements, 0x10 bytes (sizeof)
	...
	typedef struct _ETW_REG_ENTRY                             // 20 elements, 0x50 bytes (sizeof)
	{
		...
		{
			/*0x018*/         struct _ETW_REPLY_QUEUE* ReplyQueue;
			/*0x018*/         struct _ETW_QUEUE_ENTRY* ReplySlot[4];
			struct                                            // 2 elements, 0x20 bytes (sizeof)
			{
				/*0x018*/             VOID* Caller;
				/*0x020*/             ULONG32      SessionId;
				/*0x024*/             UINT8        _PADDING0_[0x14];
			};
		};
		union                                                 // 2 elements, 0x8 bytes (sizeof)
		{
			/*0x038*/         struct _EPROCESS* Process;
			/*0x038*/         VOID* CallbackContext;
		};
		/*0x040*/     VOID* Callback;
		/*0x048*/     UINT16       Index;
		union                                                 // 2 elements, 0x1 bytes (sizeof)
		{
			...
			struct                                            // 8 elements, 0x1 bytes (sizeof)
			{
				/*0x04A*/             UINT8        DbgKernelRegistration : 1;       // 0 BitPosition
				/*0x04A*/             UINT8        DbgUserRegistration : 1;         // 1 BitPosition
				/*0x04A*/             UINT8        DbgReplyRegistration : 1;        // 2 BitPosition
				/*0x04A*/             UINT8        DbgClassicRegistration : 1;      // 3 BitPosition
				/*0x04A*/             UINT8        DbgSessionSpaceRegistration : 1; // 4 BitPosition
				/*0x04A*/             UINT8        DbgModernRegistration : 1;       // 5 BitPosition
				/*0x04A*/             UINT8        DbgClosed : 1;                   // 6 BitPosition
				/*0x04A*/             UINT8        DbgInserted : 1;                 // 7 BitPosition
			};
		};
		/*0x04B*/     UINT8        EnableMask;
		/*0x04C*/     UINT8        _PADDING1_[0x4];
	...
	typedef struct _EXCEPTION_REGISTRATION_RECORD    // 2 elements, 0x10 bytes (sizeof)
	{
		...
		/*0x008*/     FUNCT_0157_0156_Handler* Handler;
	...
	typedef struct _EXT_DELETE_PARAMETERS                                                                                                                                                                                                     // 4 elements, 0x18 bytes (sizeof)
	{
		/*0x000*/     ULONG32      Version;
		/*0x004*/     ULONG32      Reserved;
		/*0x008*/     FUNCT_00BD_07E0_Free_IdleComplete_WorkerRoutine_DeleteCallback_InterfaceReference_InterfaceDereference_DeleteProcedure_DevicePowerRequired_DevicePowerNotRequired_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead* DeleteCallback;
	...
	typedef struct _FAST_IO_DISPATCH                                                                                // 28 elements, 0xE0 bytes (sizeof)
	{
		...
		/*0x004*/     UINT8        _PADDING0_[0x4];
		/*0x008*/     FUNCT_007C_0BE0_FastIoCheckIfPossible* FastIoCheckIfPossible;
		/*0x010*/     FUNCT_007C_0BEB_FastIoRead_FastIoWrite* FastIoRead;
		/*0x018*/     FUNCT_007C_0BEB_FastIoRead_FastIoWrite* FastIoWrite;
		/*0x020*/     FUNCT_007C_0BF5_FastIoQueryBasicInfo* FastIoQueryBasicInfo;
		/*0x028*/     FUNCT_007C_0C03_FastIoQueryStandardInfo* FastIoQueryStandardInfo;
		/*0x030*/     FUNCT_007C_0C11_FastIoLock* FastIoLock;
		/*0x038*/     FUNCT_007C_1078_FastIoUnlockSingle* FastIoUnlockSingle;
		/*0x040*/     FUNCT_007C_1081_FastIoUnlockAll* FastIoUnlockAll;
		/*0x048*/     FUNCT_007C_1087_FastIoUnlockAllByKey* FastIoUnlockAllByKey;
		/*0x050*/     FUNCT_007C_108E_FastIoDeviceControl* FastIoDeviceControl;
		/*0x058*/     FUNCT_00BD_1099_AcquireFileForNtCreateSection_ReleaseFileForNtCreateSection* AcquireFileForNtCreateSection;
		/*0x060*/     FUNCT_00BD_1099_AcquireFileForNtCreateSection_ReleaseFileForNtCreateSection* ReleaseFileForNtCreateSection;
		/*0x068*/     FUNCT_00BD_109C_FastIoDetachDevice* FastIoDetachDevice;
		/*0x070*/     FUNCT_007C_10A0_FastIoQueryNetworkOpenInfo* FastIoQueryNetworkOpenInfo;
		/*0x078*/     FUNCT_0073_10B0_AcquireForModWrite* AcquireForModWrite;
		/*0x080*/     FUNCT_007C_10B6_MdlRead_PrepareMdlWrite* MdlRead;
		/*0x088*/     FUNCT_007C_10C0_MdlReadComplete_MdlReadCompleteCompressed* MdlReadComplete;
		/*0x090*/     FUNCT_007C_10B6_MdlRead_PrepareMdlWrite* PrepareMdlWrite;
		/*0x098*/     FUNCT_007C_10C5_MdlWriteComplete_MdlWriteCompleteCompressed* MdlWriteComplete;
		/*0x0A0*/     FUNCT_007C_10CB_FastIoReadCompressed_FastIoWriteCompressed* FastIoReadCompressed;
		/*0x0A8*/     FUNCT_007C_10CB_FastIoReadCompressed_FastIoWriteCompressed* FastIoWriteCompressed;
		/*0x0B0*/     FUNCT_007C_10C0_MdlReadComplete_MdlReadCompleteCompressed* MdlReadCompleteCompressed;
		/*0x0B8*/     FUNCT_007C_10C5_MdlWriteComplete_MdlWriteCompleteCompressed* MdlWriteCompleteCompressed;
		/*0x0C0*/     FUNCT_007C_10E0_FastIoQueryOpen* FastIoQueryOpen;
		/*0x0C8*/     FUNCT_0073_13BA_ReleaseForModWrite* ReleaseForModWrite;
		/*0x0D0*/     FUNCT_0073_13BF_AcquireForCcFlush_ReleaseForCcFlush* AcquireForCcFlush;
		/*0x0D8*/     FUNCT_0073_13BF_AcquireForCcFlush_ReleaseForCcFlush* ReleaseForCcFlush;
	...
	typedef struct _FS_FILTER_CALLBACKS                                                                                                                                                                                                                // 14 elements, 0x68 bytes (sizeof)
	{
		...
		/*0x004*/     ULONG32      Reserved;
		/*0x008*/     FUNCT_0073_0B41_PreAcquireForSectionSynchronization_PreReleaseForSectionSynchronization_PreAcquireForCcFlush_PreReleaseForCcFlush_PreAcquireForModifiedPageWriter_PreReleaseForModifiedPageWriter* PreAcquireForSectionSynchronization;
		/*0x010*/     FUNCT_00BD_0BBC_PostAcquireForSectionSynchronization_PostReleaseForSectionSynchronization_PostAcquireForCcFlush_PostReleaseForCcFlush_PostAcquireForModifiedPageWriter_PostReleaseForModifiedPageWriter* PostAcquireForSectionSynchronization;
		/*0x018*/     FUNCT_0073_0B41_PreAcquireForSectionSynchronization_PreReleaseForSectionSynchronization_PreAcquireForCcFlush_PreReleaseForCcFlush_PreAcquireForModifiedPageWriter_PreReleaseForModifiedPageWriter* PreReleaseForSectionSynchronization;
		/*0x020*/     FUNCT_00BD_0BBC_PostAcquireForSectionSynchronization_PostReleaseForSectionSynchronization_PostAcquireForCcFlush_PostReleaseForCcFlush_PostAcquireForModifiedPageWriter_PostReleaseForModifiedPageWriter* PostReleaseForSectionSynchronization;
		/*0x028*/     FUNCT_0073_0B41_PreAcquireForSectionSynchronization_PreReleaseForSectionSynchronization_PreAcquireForCcFlush_PreReleaseForCcFlush_PreAcquireForModifiedPageWriter_PreReleaseForModifiedPageWriter* PreAcquireForCcFlush;
		/*0x030*/     FUNCT_00BD_0BBC_PostAcquireForSectionSynchronization_PostReleaseForSectionSynchronization_PostAcquireForCcFlush_PostReleaseForCcFlush_PostAcquireForModifiedPageWriter_PostReleaseForModifiedPageWriter* PostAcquireForCcFlush;
		/*0x038*/     FUNCT_0073_0B41_PreAcquireForSectionSynchronization_PreReleaseForSectionSynchronization_PreAcquireForCcFlush_PreReleaseForCcFlush_PreAcquireForModifiedPageWriter_PreReleaseForModifiedPageWriter* PreReleaseForCcFlush;
		/*0x040*/     FUNCT_00BD_0BBC_PostAcquireForSectionSynchronization_PostReleaseForSectionSynchronization_PostAcquireForCcFlush_PostReleaseForCcFlush_PostAcquireForModifiedPageWriter_PostReleaseForModifiedPageWriter* PostReleaseForCcFlush;
		/*0x048*/     FUNCT_0073_0B41_PreAcquireForSectionSynchronization_PreReleaseForSectionSynchronization_PreAcquireForCcFlush_PreReleaseForCcFlush_PreAcquireForModifiedPageWriter_PreReleaseForModifiedPageWriter* PreAcquireForModifiedPageWriter;
		/*0x050*/     FUNCT_00BD_0BBC_PostAcquireForSectionSynchronization_PostReleaseForSectionSynchronization_PostAcquireForCcFlush_PostReleaseForCcFlush_PostAcquireForModifiedPageWriter_PostReleaseForModifiedPageWriter* PostAcquireForModifiedPageWriter;
		/*0x058*/     FUNCT_0073_0B41_PreAcquireForSectionSynchronization_PreReleaseForSectionSynchronization_PreAcquireForCcFlush_PreReleaseForCcFlush_PreAcquireForModifiedPageWriter_PreReleaseForModifiedPageWriter* PreReleaseForModifiedPageWriter;
		/*0x060*/     FUNCT_00BD_0BBC_PostAcquireForSectionSynchronization_PostReleaseForSectionSynchronization_PostAcquireForCcFlush_PostReleaseForCcFlush_PostAcquireForModifiedPageWriter_PostReleaseForModifiedPageWriter* PostReleaseForModifiedPageWriter;
	...
	typedef struct _GENERAL_LOOKASIDE                                                                                                                                                                                                   // 22 elements, 0x80 bytes (sizeof)
	{
		...
		union                                                                                                                                                                                                                           // 2 elements, 0x8 bytes (sizeof)
		{
			/*0x030*/         FUNCT_00C0_07CD_AllocateEx* AllocateEx;
			/*0x030*/         FUNCT_00C0_07D7_Allocate* Allocate;
		};
		union                                                                                                                                                                                                                           // 2 elements, 0x8 bytes (sizeof)
		{
			/*0x038*/         FUNCT_00BD_07DC_FreeEx* FreeEx;
			/*0x038*/         FUNCT_00BD_07E0_Free_IdleComplete_WorkerRoutine_DeleteCallback_InterfaceReference_InterfaceDereference_DeleteProcedure_DevicePowerRequired_DevicePowerNotRequired_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead* Free;
		};
	...
	typedef struct _HANDLE_TABLE_ENTRY                       // 14 elements, 0x10 bytes (sizeof)
	{
		...
		union                                                // 5 elements, 0x8 bytes (sizeof)
		{
			...
			struct                                           // 3 elements, 0x4 bytes (sizeof)
			{
				...
				/*0x008*/             ULONG32      Spare : 6;                      // 26 BitPosition
			};
	...
	typedef struct _HEAP_ENTRY                          // 24 elements, 0x10 bytes (sizeof)
	{
		union                                           // 3 elements, 0x10 bytes (sizeof)
		{
			struct                                      // 2 elements, 0x10 bytes (sizeof)
	...
	{
		/*0x000*/     struct _HEAP_ENTRY Entry;                        // 24 elements, 0x10 bytes (sizeof)
		...
		/*0x080*/     struct _HEAP_ENTRY Encoding;                     // 24 elements, 0x10 bytes (sizeof)
		...
		/*0x168*/     FUNCT_0073_1E30_CommitRoutine* CommitRoutine;
	...
	typedef struct _HEAP_FREE_ENTRY                     // 25 elements, 0x20 bytes (sizeof)
	{
		union                                           // 3 elements, 0x10 bytes (sizeof)
		{
			struct                                      // 2 elements, 0x10 bytes (sizeof)
	...
	typedef struct _HEAP_VIRTUAL_ALLOC_ENTRY // 5 elements, 0x40 bytes (sizeof)
	{
		...
		/*0x030*/     struct _HEAP_ENTRY BusyBlock;        // 24 elements, 0x10 bytes (sizeof)
	...
	typedef struct __2016091401173702A58D3DC3DCBA0770E_Locations_RecoverableLocations // 3 elements, 0xC bytes (sizeof)
	{
		/*0x000*/     enum _CM_LOAD_FAILURE_TYPE Failure;
		/*0x004*/     LONG32       Status;
		/*0x008*/     ULONG32      Point;
	}_2016091401173702A58D3DC3DCBA0770E_Locations_RecoverableLocations, * P_2016091401173702A58D3DC3DCBA0770E_Locations_RecoverableLocations;
	...
	typedef struct _HIVE_LOAD_FAILURE                                                                      // 13 elements, 0x160 bytes (sizeof)
	{
		...
		/*0x010*/     struct __2016091401173702A58D3DC3DCBA0770E_Locations_RecoverableLocations Locations[8];
		/*0x070*/     struct __2016091401173702A58D3DC3DCBA0770E_Locations_RecoverableLocations RecoverableLocations[8];
		struct                                                                                             // 3 elements, 0x18 bytes (sizeof)
		{
	...
	typedef struct _HV_VENDOR_AND_MAX_FUNCTION // 2 elements, 0x10 bytes (sizeof)
	{
		/*0x000*/     UINT32       MaxFunction;
		/*0x004*/     UINT8        VendorName[12];
	}HV_VENDOR_AND_MAX_FUNCTION, * PHV_VENDOR_AND_MAX_FUNCTION;

	typedef struct _HV_HYPERVISOR_INTERFACE_INFO // 4 elements, 0x10 bytes (sizeof)
	{
		/*0x000*/     UINT32       Interface;
		/*0x004*/     UINT32       ReservedEbx;
		/*0x008*/     UINT32       ReservedEcx;
		/*0x00C*/     UINT32       ReservedEdx;
	}HV_HYPERVISOR_INTERFACE_INFO, * PHV_HYPERVISOR_INTERFACE_INFO;

	typedef struct _HV_HYPERVISOR_VERSION_INFO // 6 elements, 0x10 bytes (sizeof)
	{
		/*0x000*/     UINT32       BuildNumber;
		struct                                 // 2 elements, 0x4 bytes (sizeof)
		{
			/*0x004*/         UINT32       MinorVersion : 16;    // 0 BitPosition
			/*0x004*/         UINT32       MajorVersion : 16;    // 16 BitPosition
		};
		/*0x008*/     UINT32       ServicePack;
		struct                                 // 2 elements, 0x4 bytes (sizeof)
		{
			/*0x00C*/         UINT32       ServiceNumber : 24;   // 0 BitPosition
			/*0x00C*/         UINT32       ServiceBranch : 8;    // 24 BitPosition
		};
	}HV_HYPERVISOR_VERSION_INFO, * PHV_HYPERVISOR_VERSION_INFO;

	typedef union _HV_PARTITION_PRIVILEGE_MASK                // 30 elements, 0x8 bytes (sizeof)
	{
		/*0x000*/     UINT64       AsUINT64;
		struct                                                // 29 elements, 0x8 bytes (sizeof)
		{
			/*0x000*/         UINT64       AccessVpRunTimeMsr : 1;              // 0 BitPosition
			/*0x000*/         UINT64       AccessPartitionReferenceCounter : 1; // 1 BitPosition
			/*0x000*/         UINT64       AccessSynicMsrs : 1;                 // 2 BitPosition
			/*0x000*/         UINT64       AccessSyntheticTimerMsrs : 1;        // 3 BitPosition
			/*0x000*/         UINT64       AccessApicMsrs : 1;                  // 4 BitPosition
			/*0x000*/         UINT64       AccessHypercallMsrs : 1;             // 5 BitPosition
			/*0x000*/         UINT64       AccessVpIndex : 1;                   // 6 BitPosition
			/*0x000*/         UINT64       AccessResetMsr : 1;                  // 7 BitPosition
			/*0x000*/         UINT64       AccessStatsMsr : 1;                  // 8 BitPosition
			/*0x000*/         UINT64       AccessPartitionReferenceTsc : 1;     // 9 BitPosition
			/*0x000*/         UINT64       AccessGuestIdleMsr : 1;              // 10 BitPosition
			/*0x000*/         UINT64       AccessFrequencyMsrs : 1;             // 11 BitPosition
			/*0x000*/         UINT64       AccessDebugMsrs : 1;                 // 12 BitPosition
			/*0x000*/         UINT64       Reserved1 : 19;                      // 13 BitPosition
			...
			/*0x000*/         UINT64       EnableExpandedStackwalking : 1;      // 46 BitPosition
			/*0x000*/         UINT64       Reserved3 : 17;                      // 47 BitPosition
		};
	}HV_PARTITION_PRIVILEGE_MASK, * PHV_PARTITION_PRIVILEGE_MASK;

	typedef struct _HV_HYPERVISOR_FEATURES                          // 19 elements, 0x10 bytes (sizeof)
	{
		/*0x000*/     union _HV_PARTITION_PRIVILEGE_MASK PartitionPrivileges;     // 30 elements, 0x8 bytes (sizeof)
		struct                                                      // 3 elements, 0x4 bytes (sizeof)
		{
			/*0x008*/         UINT32       MaxSupportedCState : 4;                    // 0 BitPosition
			/*0x008*/         UINT32       HpetNeededForC3PowerState : 1;             // 4 BitPosition
			/*0x008*/         UINT32       Reserved : 27;                             // 5 BitPosition
		};
		struct                                                      // 15 elements, 0x4 bytes (sizeof)
		{
			/*0x00C*/         UINT32       MwaitAvailable : 1;                        // 0 BitPosition
			...
			/*0x00C*/         UINT32       FrequencyMsrsAvailable : 1;                // 8 BitPosition
			/*0x00C*/         UINT32       SyntheticMachineCheckAvailable : 1;        // 9 BitPosition
			/*0x00C*/         UINT32       GuestCrashMsrsAvailable : 1;               // 10 BitPosition
			/*0x00C*/         UINT32       DebugMsrsAvailable : 1;                    // 11 BitPosition
			/*0x00C*/         UINT32       Npiep1Available : 1;                       // 12 BitPosition
			/*0x00C*/         UINT32       DisableHypervisorAvailable : 1;            // 13 BitPosition
			/*0x00C*/         UINT32       Reserved1 : 18;                            // 14 BitPosition
		};
	}HV_HYPERVISOR_FEATURES, * PHV_HYPERVISOR_FEATURES;

	typedef struct _HV_ENLIGHTENMENT_INFORMATION                // 14 elements, 0x10 bytes (sizeof)
	{
		struct                                                  // 11 elements, 0x4 bytes (sizeof)
		{
			/*0x000*/         UINT32       UseHypercallForAddressSpaceSwitch : 1; // 0 BitPosition
			/*0x000*/         UINT32       UseHypercallForLocalFlush : 1;         // 1 BitPosition
			/*0x000*/         UINT32       UseHypercallForRemoteFlush : 1;        // 2 BitPosition
			/*0x000*/         UINT32       UseApicMsrs : 1;                       // 3 BitPosition
			/*0x000*/         UINT32       UseMsrForReset : 1;                    // 4 BitPosition
			/*0x000*/         UINT32       UseRelaxedTiming : 1;                  // 5 BitPosition
			/*0x000*/         UINT32       UseDmaRemapping : 1;                   // 6 BitPosition
			/*0x000*/         UINT32       UseInterruptRemapping : 1;             // 7 BitPosition
			/*0x000*/         UINT32       UseX2ApicMsrs : 1;                     // 8 BitPosition
			/*0x000*/         UINT32       DeprecateAutoEoi : 1;                  // 9 BitPosition
			/*0x000*/         UINT32       Reserved : 22;                         // 10 BitPosition
		};
		/*0x004*/     UINT32       LongSpinWaitCount;
		/*0x008*/     UINT32       ReservedEcx;
		/*0x00C*/     UINT32       ReservedEdx;
	}HV_ENLIGHTENMENT_INFORMATION, * PHV_ENLIGHTENMENT_INFORMATION;

	typedef struct _HV_IMPLEMENTATION_LIMITS   // 4 elements, 0x10 bytes (sizeof)
	{
		/*0x000*/     UINT32       MaxVirtualProcessorCount;
		/*0x004*/     UINT32       MaxLogicalProcessorCount;
		/*0x008*/     UINT32       MaxInterruptMappingCount;
		/*0x00C*/     UINT32       ReservedEdx;
	}HV_IMPLEMENTATION_LIMITS, * PHV_IMPLEMENTATION_LIMITS;

	typedef struct _HV_HYPERVISOR_HARDWARE_FEATURES                 // 11 elements, 0x10 bytes (sizeof)
	{
		struct                                                      // 8 elements, 0x4 bytes (sizeof)
		{
			/*0x000*/         UINT32       ApicOverlayAssistInUse : 1;                // 0 BitPosition
			/*0x000*/         UINT32       MsrBitmapsInUse : 1;                       // 1 BitPosition
			/*0x000*/         UINT32       ArchitecturalPerformanceCountersInUse : 1; // 2 BitPosition
			/*0x000*/         UINT32       SecondLevelAddressTranslationInUse : 1;    // 3 BitPosition
			/*0x000*/         UINT32       DmaRemappingInUse : 1;                     // 4 BitPosition
			/*0x000*/         UINT32       InterruptRemappingInUse : 1;               // 5 BitPosition
			/*0x000*/         UINT32       MemoryPatrolScrubberPresent : 1;           // 6 BitPosition
			/*0x000*/         UINT32       Reserved : 25;                             // 7 BitPosition
		};
		/*0x004*/     UINT32       ReservedEbx;
		/*0x008*/     UINT32       ReservedEcx;
		/*0x00C*/     UINT32       ReservedEdx;
	...
	typedef union _HV_CPUID_RESULT                                         // 13 elements, 0x10 bytes (sizeof)
	{
		struct                                                             // 4 elements, 0x10 bytes (sizeof)
		{
			/*0x000*/         UINT32       Eax;
		...
		{
			/*0x000*/         UINT32       ReservedEax;
			struct                                                         // 2 elements, 0x4 bytes (sizeof)
			{
				/*0x004*/             UINT32       ReservedEbx : 24;                             // 0 BitPosition
				/*0x004*/             UINT32       InitialApicId : 8;                            // 24 BitPosition
			};
			struct                                                         // 2 elements, 0x4 bytes (sizeof)
			{
				/*0x008*/             UINT32       ReservedEcx : 31;                             // 0 BitPosition
				/*0x008*/             UINT32       HypervisorPresent : 1;                        // 31 BitPosition
			};
			/*0x00C*/         UINT32       ReservedEdx;
		}VersionAndFeatures;
		/*0x000*/     struct _HV_VENDOR_AND_MAX_FUNCTION HvVendorAndMaxFunction;         // 2 elements, 0x10 bytes (sizeof)
		/*0x000*/     struct _HV_HYPERVISOR_INTERFACE_INFO HvInterface;                  // 4 elements, 0x10 bytes (sizeof)
		/*0x000*/     struct _HV_HYPERVISOR_VERSION_INFO MsHvVersion;                    // 6 elements, 0x10 bytes (sizeof)
		/*0x000*/     struct _HV_HYPERVISOR_FEATURES MsHvFeatures;                       // 19 elements, 0x10 bytes (sizeof)
		/*0x000*/     struct _HV_ENLIGHTENMENT_INFORMATION MsHvEnlightenmentInformation; // 14 elements, 0x10 bytes (sizeof)
		/*0x000*/     struct _HV_IMPLEMENTATION_LIMITS MsHvImplementationLimits;         // 4 elements, 0x10 bytes (sizeof)
		/*0x000*/     struct _HV_HYPERVISOR_HARDWARE_FEATURES MsHvHardwareFeatures;      // 11 elements, 0x10 bytes (sizeof)
	...
	typedef struct _INTERRUPT_VECTOR_DATA                        // 12 elements, 0x48 bytes (sizeof)
	{
		...
		union                                                    // 5 elements, 0x10 bytes (sizeof)
		{
			...
			struct                                               // 2 elements, 0x10 bytes (sizeof)
			{
				/*0x038*/             union _LARGE_INTEGER Address;                    // 4 elements, 0x8 bytes (sizeof)
				/*0x040*/             ULONG32      DataPayload;
				/*0x044*/             UINT8        _PADDING2_[0x4];
			}XapicMessage;
			struct                                               // 1 elements, 0x8 bytes (sizeof)
			{
				/*0x038*/             struct _INTERRUPT_HT_INTR_INFO IntrInfo;         // 2 elements, 0x8 bytes (sizeof)
			}Hypertransport;
			struct                                               // 2 elements, 0x10 bytes (sizeof)
			{
				/*0x038*/             union _LARGE_INTEGER Address;                    // 4 elements, 0x8 bytes (sizeof)
			...
			struct                                               // 1 elements, 0x4 bytes (sizeof)
			{
				/*0x038*/             enum _HAL_APIC_DESTINATION_MODE DestinationMode;
			}MessageRequest;
		};
	}INTERRUPT_VECTOR_DATA, * PINTERRUPT_VECTOR_DATA;

	typedef struct _INTERRUPT_CONNECTION_DATA      // 12 elements, 0xA8 bytes (sizeof)
	{
		/*0x000*/     ULONG32      Count;
		/*0x004*/     UINT8        _PADDING0_[0x4];
		/*0x008*/     struct _GROUP_AFFINITY OriginalAffinity;   // 3 elements, 0x10 bytes (sizeof)
		/*0x018*/     struct _LIST_ENTRY SteeringListEntry;      // 2 elements, 0x10 bytes (sizeof)
		/*0x028*/     VOID* SteeringListRoot;
		/*0x030*/     UINT64       IsrTime;
		/*0x038*/     UINT64       DpcTime;
		/*0x040*/     ULONG32      IsrLoad;
		/*0x044*/     ULONG32      DpcLoad;
		/*0x048*/     UINT8        IsPrimaryInterrupt;
		/*0x049*/     UINT8        _PADDING1_[0x7];
		/*0x050*/     struct _KINTERRUPT** InterruptObjectArray;
		/*0x058*/     ULONG32      InterruptObjectCount;
		/*0x05C*/     UINT8        _PADDING2_[0x4];
		/*0x060*/     struct _INTERRUPT_VECTOR_DATA Vectors[1];
	...
	typedef struct _IO_MINI_COMPLETION_PACKET_USER              // 9 elements, 0x50 bytes (sizeof)
	{
		...
		/*0x038*/     FUNCT_00BD_0D59_MiniPacketCallback* MiniPacketCallback;
		/*0x040*/     VOID* Context;
	...
	typedef struct _IO_STACK_LOCATION                                             // 9 elements, 0x48 bytes (sizeof)
	{
		...
		/*0x038*/     FUNCT_0073_13B5_CompletionRoutine* CompletionRoutine;
		/*0x040*/     VOID* Context;
	...
	typedef struct _IO_TIMER                        // 6 elements, 0x30 bytes (sizeof)
	{
		...
		/*0x018*/     FUNCT_00BD_13D5_TimerRoutine* TimerRoutine;
		/*0x020*/     VOID* Context;
		/*0x028*/     struct _DEVICE_OBJECT* DeviceObject;
	}IO_TIMER, * PIO_TIMER;
	...
	typedef struct _WORK_QUEUE_ITEM                                                                                                                                                                                                          // 3 elements, 0x20 bytes (sizeof)
	{
		...
		/*0x010*/     FUNCT_00BD_07E0_Free_IdleComplete_WorkerRoutine_DeleteCallback_InterfaceReference_InterfaceDereference_DeleteProcedure_DevicePowerRequired_DevicePowerNotRequired_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead* WorkerRoutine;
	...
	typedef struct _IO_WORKITEM           // 6 elements, 0x50 bytes (sizeof)
	{
		...
		/*0x020*/     FUNCT_00BD_2835_Routine* Routine;
		/*0x028*/     VOID* IoObject;
		/*0x030*/     VOID* Context;
		/*0x038*/     ULONG32      Type;
	...
	typedef struct _IOP_IRP_EXTENSION         // 10 elements, 0x28 bytes (sizeof)
	{
		union                                 // 2 elements, 0x2 bytes (sizeof)
		{
			...
			struct                            // 4 elements, 0x2 bytes (sizeof)
			{
				...
				/*0x000*/             UINT16       TimeStamped : 1; // 2 BitPosition
				/*0x000*/             UINT16       SpareBits : 13;  // 3 BitPosition
			};
		};
		/*0x002*/     UINT16       TypesAllocated;
		/*0x004*/     UINT8        GenericExtension[4];
		/*0x008*/     VOID* VerifierContext;
		/*0x010*/     struct _GUID ActivityId;              // 4 elements, 0x10 bytes (sizeof)
		/*0x020*/     union _LARGE_INTEGER Timestamp;       // 4 elements, 0x8 bytes (sizeof)
	...
	typedef struct _IRP                                              // 23 elements, 0xD0 bytes (sizeof)
	{
		...
		union                                                        // 2 elements, 0x10 bytes (sizeof)
		{
			struct                                                   // 3 elements, 0x10 bytes (sizeof)
			{
				union                                                // 2 elements, 0x8 bytes (sizeof)
				{
					/*0x058*/                 FUNCT_00BD_1109_UserApcRoutine* UserApcRoutine;
		...
		/*0x068*/     FUNCT_00BD_110E_DriverStartIo_CancelRoutine* CancelRoutine;
	...
	typedef struct _KALPC_MESSAGE                           // 22 elements, 0x100 bytes (sizeof)
	{
		...
		/*0x0A8*/     struct _ALPC_COMMUNICATION_INFO* CommunicationInfo;
		/*0x0B0*/     struct _ALPC_PORT* ConnectionPort;
		/*0x0B8*/     struct _ETHREAD* ServerThread;
		/*0x0C0*/     VOID* WakeReference;
		/*0x0C8*/     VOID* ExtensionBuffer;
		/*0x0D0*/     UINT64       ExtensionBufferSize;
	...
	typedef struct _KINTERRUPT                                                                 // 33 elements, 0x100 bytes (sizeof)
	{
		/*0x000*/     INT16        Type;
		/*0x002*/     INT16        Size;
		/*0x004*/     UINT8        _PADDING0_[0x4];
		/*0x008*/     struct _LIST_ENTRY InterruptListEntry;                                                 // 2 elements, 0x10 bytes (sizeof)
		/*0x018*/     FUNCT_007C_2412_ServiceRoutine* ServiceRoutine;
		/*0x020*/     FUNCT_007C_2416_MessageServiceRoutine* MessageServiceRoutine;
		...
		/*0x050*/     FUNCT_00BD_028D_PostProcessInitRoutine_DispatchAddress_FinishRoutine* DispatchAddress;
		...
		/*0x0A0*/     VOID* DisconnectData;
		/*0x0A8*/     struct _KTHREAD* ServiceThread;
		/*0x0B0*/     struct _ISRDPCSTATS IsrDpcStats;                                                       // 8 elements, 0x40 bytes (sizeof)
		/*0x0F0*/     struct _INTERRUPT_CONNECTION_DATA* ConnectionData;
	...
	typedef struct _PROC_IDLE_POLICY     // 5 elements, 0x5 bytes (sizeof)
	{
	...
	typedef struct _PROC_FEEDBACK                   // 13 elements, 0x70 bytes (sizeof)
	{
		/*0x000*/     UINT64       Lock;
	...
	typedef struct _PROC_PERF_SNAP            // 8 elements, 0x40 bytes (sizeof)
	{
		/*0x000*/     UINT64       Time;
		/*0x008*/     UINT64       LastTime;
		/*0x010*/     UINT64       Active;
		/*0x018*/     UINT64       LastActive;
		/*0x020*/     UINT64       FrequencyScaledActive;
		/*0x028*/     UINT64       PerformanceScaledActive;
		/*0x030*/     UINT64       CyclesActive;
		/*0x038*/     UINT64       CyclesAffinitized;
	}PROC_PERF_SNAP, * PPROC_PERF_SNAP;

	typedef struct _PROC_PERF_UTILITY // 3 elements, 0xC bytes (sizeof)
	{
		/*0x000*/     ULONG32      Affinitized;
		/*0x004*/     ULONG32      Performance;
		/*0x008*/     ULONG32      Total;
	}PROC_PERF_UTILITY, * PPROC_PERF_UTILITY;

	typedef struct _PROCESSOR_POWER_STATE                         // 31 elements, 0x1E0 bytes (sizeof)
	{
		...
		/*0x028*/     UINT64       Reserved;
		/*0x030*/     struct _PROC_IDLE_POLICY IdlePolicy;                      // 5 elements, 0x5 bytes (sizeof)
		/*0x035*/     UINT8        _PADDING0_[0x3];
		/*0x038*/     union _PPM_IDLE_SYNCHRONIZATION_STATE Synchronization;    // 3 elements, 0x4 bytes (sizeof)
		/*0x03C*/     UINT8        _PADDING1_[0x4];
		/*0x040*/     struct _PROC_FEEDBACK PerfFeedback;                       // 13 elements, 0x70 bytes (sizeof)
		/*0x0B0*/     enum _PROC_HYPERVISOR_STATE Hypervisor;
		/*0x0B4*/     ULONG32      LastSysTime;
		/*0x0B8*/     UINT64       WmiDispatchPtr;
		/*0x0C0*/     LONG32       WmiInterfaceEnabled;
		/*0x0C4*/     UINT8        _PADDING2_[0x4];
		/*0x0C8*/     struct _PPM_FFH_THROTTLE_STATE_INFO FFHThrottleStateInfo; // 5 elements, 0x20 bytes (sizeof)
		/*0x0E8*/     struct _KDPC PerfActionDpc;                               // 11 elements, 0x40 bytes (sizeof)
		/*0x128*/     LONG32       PerfActionMask;
		/*0x12C*/     UINT8        _PADDING3_[0x4];
		/*0x130*/     struct _PROC_IDLE_SNAP HvIdleCheck;                       // 2 elements, 0x10 bytes (sizeof)
		/*0x140*/     struct _PROC_PERF_SNAP PerfCheck;                         // 8 elements, 0x40 bytes (sizeof)
		/*0x180*/     struct _PROC_PERF_DOMAIN* Domain;
		/*0x188*/     struct _PROC_PERF_CONSTRAINT* PerfConstraint;
		/*0x190*/     struct _PPM_CONCURRENCY_ACCOUNTING* Concurrency;
		/*0x198*/     struct _PROC_PERF_LOAD* Load;
		/*0x1A0*/     struct _PROC_PERF_HISTORY* PerfHistory;
		/*0x1A8*/     UINT8        GuaranteedPerformancePercent;
		/*0x1A9*/     UINT8        HvTargetState;
		/*0x1AA*/     UINT8        Parked;
		/*0x1AB*/     UINT8        OverUtilized;
		/*0x1AC*/     ULONG32      LatestPerformancePercent;
		/*0x1B0*/     ULONG32      LatestAffinitizedPercent;
		/*0x1B4*/     ULONG32      ExpectedUtility;
		/*0x1B8*/     struct _PROC_PERF_UTILITY Utility[3];
		/*0x1DC*/     UINT8        _PADDING4_[0x4];
	...
	typedef struct _KREQUEST_PACKET                   // 2 elements, 0x20 bytes (sizeof)
	{
		...
		/*0x018*/     FUNCT_00BD_09E4_WorkerRoutine* WorkerRoutine;
	...
	typedef struct _KPRCB                                                    // 243 elements, 0x5D80 bytes (sizeof)
	{
		/*0x000*/      ULONG32      MxCsr;
		...
		/*0x640*/      struct _KNODE* ParentNode;
		/*0x648*/      UINT64       GroupSetMember;
		/*0x650*/      UINT8        Group;
		/*0x651*/      UINT8        GroupIndex;
		/*0x652*/      UINT8        PrcbPad05[2];
		/*0x654*/      ULONG32      ApicMask;
		/*0x658*/      ULONG32      CFlushSize;
		/*0x65C*/      UINT8        _PADDING0_[0x4];
		/*0x660*/      VOID* AcpiReserved;
		/*0x668*/      ULONG32      InitialApicId;
		/*0x66C*/      UINT8        _PADDING1_[0x4];
		...
		/*0x2CC0*/     UINT16       LdtSelector;
		/*0x2CC2*/     UINT16       PrcbPad40;
		/*0x2CC4*/     ULONG32      CcFastReadNoWait;
		/*0x2CC8*/     ULONG32      CcFastReadWait;
		/*0x2CCC*/     ULONG32      CcFastReadNotPossible;
		/*0x2CD0*/     ULONG32      CcCopyReadNoWait;
		/*0x2CD4*/     ULONG32      CcCopyReadWait;
		/*0x2CD8*/     ULONG32      CcCopyReadNoWaitMiss;
		...
		/*0x2D00*/     LONG32       PacketBarrier;
		/*0x2D04*/     LONG32       TargetCount;
		/*0x2D08*/     ULONG32      IpiFrozen;
		/*0x2D0C*/     UINT8        _PADDING2_[0x4];
		/*0x2D10*/     VOID* IsrDpcStats;
		/*0x2D18*/     ULONG32      DeviceInterrupts;
		/*0x2D1C*/     LONG32       LookasideIrpFloat;
		/*0x2D20*/     ULONG32      InterruptLastCount;
		/*0x2D24*/     ULONG32      InterruptRate;
		/*0x2D28*/     ULONG32      PrcbPad41[22];
		/*0x2D80*/     struct _KDPC_DATA DpcData[2];
		/*0x2DD0*/     VOID* DpcStack;
		/*0x2DD8*/     LONG32       MaximumDpcQueueDepth;
		/*0x2DDC*/     ULONG32      DpcRequestRate;
		/*0x2DE0*/     ULONG32      MinimumDpcRate;
		/*0x2DE4*/     ULONG32      DpcLastCount;
		/*0x2DE8*/     UINT8        ThreadDpcEnable;
		/*0x2DE9*/     UINT8        QuantumEnd;
		/*0x2DEA*/     UINT8        DpcRoutineActive;
		/*0x2DEB*/     UINT8        IdleSchedule;
		union                                                                // 4 elements, 0x4 bytes (sizeof)
		{
			/*0x2DEC*/         LONG32       DpcRequestSummary;
			/*0x2DEC*/         INT16        DpcRequestSlot[2];
			struct                                                           // 2 elements, 0x4 bytes (sizeof)
			{
				/*0x2DEC*/             INT16        NormalDpcState;
				/*0x2DEE*/             INT16        ThreadDpcState;
			};
			struct                                                           // 10 elements, 0x4 bytes (sizeof)
			{
				/*0x2DEC*/             ULONG32      DpcNormalProcessingActive : 1;                  // 0 BitPosition
				/*0x2DEC*/             ULONG32      DpcNormalProcessingRequested : 1;               // 1 BitPosition
				/*0x2DEC*/             ULONG32      DpcNormalThreadSignal : 1;                      // 2 BitPosition
				/*0x2DEC*/             ULONG32      DpcNormalTimerExpiration : 1;                   // 3 BitPosition
				/*0x2DEC*/             ULONG32      DpcNormalDpcPresent : 1;                        // 4 BitPosition
				/*0x2DEC*/             ULONG32      DpcNormalLocalInterrupt : 1;                    // 5 BitPosition
				/*0x2DEC*/             ULONG32      DpcNormalSpare : 10;                            // 6 BitPosition
				/*0x2DEC*/             ULONG32      DpcThreadActive : 1;                            // 16 BitPosition
				/*0x2DEC*/             ULONG32      DpcThreadRequested : 1;                         // 17 BitPosition
				/*0x2DEC*/             ULONG32      DpcThreadSpare : 14;                            // 18 BitPosition
			};
		};
		/*0x2DF0*/     ULONG32      LastTimerHand;
		/*0x2DF4*/     ULONG32      LastTick;
		/*0x2DF8*/     ULONG32      ClockInterrupts;
		/*0x2DFC*/     ULONG32      ReadyScanTick;
		...
		/*0x5020*/     struct _KDPC CallDpc;                                                // 11 elements, 0x40 bytes (sizeof)
		...
		/*0x509C*/     LONG32       AffinitizedSelectionMask;
		/*0x50A0*/     ULONG32      QueueIndex;
		/*0x50A4*/     ULONG32      PrcbPad75[3];
		/*0x50B0*/     struct _KDPC TimerExpirationDpc;                                     // 11 elements, 0x40 bytes (sizeof)
		/*0x50F0*/     struct _RTL_RB_TREE ScbQueue;                                        // 2 elements, 0x10 bytes (sizeof)
		...
		/*0x531A*/     UINT8        DeepSleep;
		/*0x531B*/     UINT8        PrcbPad80[1];
		/*0x531C*/     ULONG32      ScbOffset;
		...
		/*0x5338*/     UINT64       StartCycles;
		/*0x5340*/     UINT64       GenerationTarget;
		/*0x5348*/     UINT64       AffinitizedCycles;
		/*0x5350*/     UINT64       PrcbPad81[2];
		...
		/*0x5400*/     struct _PROCESSOR_POWER_STATE PowerState;                            // 31 elements, 0x1E0 bytes (sizeof)
		/*0x55E0*/     struct _LIST_ENTRY ScbList;                                          // 2 elements, 0x10 bytes (sizeof)
		/*0x55F0*/     ULONG32      PrcbPad92[19];
		/*0x563C*/     ULONG32      KeAlignmentFixupCount;
		/*0x5640*/     struct _KDPC DpcWatchdogDpc;                                         // 11 elements, 0x40 bytes (sizeof)
		/*0x5680*/     struct _KTIMER DpcWatchdogTimer;                                     // 6 elements, 0x40 bytes (sizeof)
		/*0x56C0*/     struct _CACHE_DESCRIPTOR Cache[5];
		/*0x56FC*/     ULONG32      CacheCount;
		/*0x5700*/     ULONG32      CachedCommit;
		/*0x5704*/     ULONG32      CachedResidentAvailable;
		/*0x5708*/     VOID* HyperPte;
		/*0x5710*/     VOID* WheaInfo;
		/*0x5718*/     VOID* EtwSupport;
		/*0x5720*/     union _SLIST_HEADER InterruptObjectPool;                             // 3 elements, 0x10 bytes (sizeof)
		/*0x5730*/     union _SLIST_HEADER HypercallPageList;                               // 3 elements, 0x10 bytes (sizeof)
		/*0x5740*/     VOID* HypercallPageVirtual;
		/*0x5748*/     VOID* VirtualApicAssist;
		/*0x5750*/     UINT64* StatisticsPage;
		/*0x5758*/     struct _KAFFINITY_EX PackageProcessorSet;                            // 4 elements, 0xA8 bytes (sizeof)
		/*0x5800*/     UINT64       SharedReadyQueueMask;
		/*0x5808*/     struct _KSHARED_READY_QUEUE* SharedReadyQueue;
		/*0x5810*/     UINT64       CoreProcessorSet;
		/*0x5818*/     UINT64       ScanSiblingMask;
		/*0x5820*/     UINT64       LLCMask;
		/*0x5828*/     UINT64       CacheProcessorMask[5];
		/*0x5850*/     ULONG32      ScanSiblingIndex;
		/*0x5854*/     ULONG32      SharedReadyQueueOffset;
		/*0x5858*/     struct _PROCESSOR_PROFILE_CONTROL_AREA* ProcessorProfileControlArea;
		/*0x5860*/     VOID* ProfileEventIndexAddress;
		/*0x5868*/     UINT64       PrcbPad94[3];
		/*0x5880*/     struct _SYNCH_COUNTERS SynchCounters;                                // 46 elements, 0xB8 bytes (sizeof)
		/*0x5938*/     UINT64       PteBitCache;
		/*0x5940*/     ULONG32      PteBitOffset;
		/*0x5944*/     UINT8        _PADDING3_[0x4];
		/*0x5948*/     struct _FILESYSTEM_DISK_COUNTERS FsCounters;                         // 2 elements, 0x10 bytes (sizeof)
		/*0x5958*/     UINT8        VendorString[13];
		/*0x5965*/     UINT8        PrcbPad10[3];
		/*0x5968*/     UINT64       FeatureBits;
		/*0x5970*/     ULONG32      PrcbPad11;
		/*0x5974*/     UINT8        _PADDING4_[0x4];
		/*0x5978*/     union _LARGE_INTEGER UpdateSignature;                                // 4 elements, 0x8 bytes (sizeof)
		/*0x5980*/     struct _CONTEXT* Context;
		/*0x5988*/     ULONG32      ContextFlagsInit;
		/*0x598C*/     UINT8        _PADDING5_[0x4];
		/*0x5990*/     struct _XSAVE_AREA* ExtendedState;
		/*0x5998*/     VOID* IsrStack;
		/*0x59A0*/     struct _KENTROPY_TIMING_STATE EntropyTimingState;                    // 4 elements, 0x150 bytes (sizeof)
		/*0x5AF0*/     struct _SINGLE_LIST_ENTRY AbSelfIoBoostsList;                        // 1 elements, 0x8 bytes (sizeof)
		/*0x5AF8*/     struct _SINGLE_LIST_ENTRY AbPropagateBoostsList;                     // 1 elements, 0x8 bytes (sizeof)
		/*0x5B00*/     struct _KDPC AbDpc;                                                  // 11 elements, 0x40 bytes (sizeof)
		/*0x5B40*/     struct _IOP_IRP_STACK_PROFILER IoIrpStackProfilerCurrent;            // 2 elements, 0x54 bytes (sizeof)
		/*0x5B94*/     struct _IOP_IRP_STACK_PROFILER IoIrpStackProfilerPrevious;           // 2 elements, 0x54 bytes (sizeof)
		/*0x5BE8*/     struct _KTIMER_EXPIRATION_TRACE TimerExpirationTrace[16];
		/*0x5CE8*/     ULONG32      TimerExpirationTraceCount;
		/*0x5CEC*/     UINT8        _PADDING6_[0x14];
		/*0x5D00*/     struct _REQUEST_MAILBOX* Mailbox;
		/*0x5D08*/     UINT8        _PADDING7_[0x38];
		/*0x5D40*/     struct _REQUEST_MAILBOX RequestMailbox[1];
	}KPRCB, * PKPRCB;

	typedef struct _KPCR                             // 27 elements, 0x5F00 bytes (sizeof)
	{
		union                                        // 2 elements, 0x38 bytes (sizeof)
		{
		...
		/*0x180*/     struct _KPRCB Prcb;                          // 243 elements, 0x5D80 bytes (sizeof)
	}KPCR, * PKPCR;
	...
	typedef struct _RTL_AVL_TABLE                         // 11 elements, 0x68 bytes (sizeof)
	{
		...
		/*0x044*/     UINT8        _PADDING1_[0x4];
		/*0x048*/     FUNCT_2681_2680_CompareRoutine* CompareRoutine;
		/*0x050*/     FUNCT_00C0_268A_AllocateRoutine* AllocateRoutine;
		/*0x058*/     FUNCT_00BD_268E_FreeRoutine* FreeRoutine;
	...
	typedef struct _KRESOURCEMANAGER                                   // 20 elements, 0x250 bytes (sizeof)
	{
		...
		/*0x128*/     FUNCT_0073_263B_NotificationRoutine* NotificationRoutine;
		/*0x130*/     VOID* Key;
	...
	typedef struct _KSCB                      // 19 elements, 0x170 bytes (sizeof)
	{
		...
		/*0x030*/     UINT64       ReadyTime;
		/*0x038*/     UINT64       InsertTime;
		/*0x040*/     struct _LIST_ENTRY PerProcessorList;  // 2 elements, 0x10 bytes (sizeof)
		/*0x050*/     struct _RTL_BALANCED_NODE QueueNode;  // 6 elements, 0x18 bytes (sizeof)
		struct                                // 5 elements, 0x1 bytes (sizeof)
		{
			/*0x068*/         UINT8        Inserted : 1;        // 0 BitPosition
			/*0x068*/         UINT8        OverQuota : 1;       // 1 BitPosition
			/*0x068*/         UINT8        HardCap : 1;         // 2 BitPosition
			/*0x068*/         UINT8        RankBias : 1;        // 3 BitPosition
			/*0x068*/         UINT8        Spare1 : 4;          // 4 BitPosition
		};
		/*0x069*/     UINT8        Spare2;
		/*0x06A*/     UINT16       ReadySummary;
		/*0x06C*/     ULONG32      Rank;
		/*0x070*/     struct _LIST_ENTRY ReadyListHead[16];
	}KSCB, * PKSCB;
	...
	typedef struct _KSHARED_READY_QUEUE       // 9 elements, 0x268 bytes (sizeof)
	{
		/*0x000*/     UINT64       Lock;
		...
		/*0x250*/     ULONG32      Span;
		/*0x254*/     ULONG32      LowProcIndex;
		/*0x258*/     ULONG32      QueueIndex;
		/*0x25C*/     ULONG32      ProcCount;
		/*0x260*/     UINT64       Affinity;
	...
	{
		/*0x000*/     enum ___2016091401173703558D3DC3DCBBB5273_RecordType RecordType;
	...
	typedef struct _XSTATE_CONFIGURATION      // 5 elements, 0x218 bytes (sizeof)
	{
	...
	typedef struct _KUSER_SHARED_DATA                                // 93 elements, 0x5F0 bytes (sizeof)
	{
		...
		union                                                        // 2 elements, 0x4 bytes (sizeof)
		{
			...
			struct                                                   // 9 elements, 0x4 bytes (sizeof)
			{
				...
				/*0x2F0*/             ULONG32      SpareBits : 24;                         // 8 BitPosition
			};
		};
		...
		/*0x368*/     ULONG32      QpcSystemTimeIncrement32;
		/*0x36C*/     ULONG32      QpcInterruptTimeIncrement32;
		/*0x370*/     UINT8        QpcSystemTimeIncrementShift;
		/*0x371*/     UINT8        QpcInterruptTimeIncrementShift;
		/*0x372*/     UINT16       UnparkedProcessorCount;
		/*0x374*/     UINT8        Reserved8[12];
		...
		/*0x3D8*/     struct _XSTATE_CONFIGURATION XState;                         // 5 elements, 0x218 bytes (sizeof)
	...
	typedef struct _LDR_DATA_TABLE_ENTRY                         // 56 elements, 0x118 bytes (sizeof)
	{
	...
	typedef struct _LOCK_HEADER        // 4 elements, 0x20 bytes (sizeof)
	{
	...
	typedef struct _LOCK_TRACKER                   // 10 elements, 0x90 bytes (sizeof)
	{
	...
	typedef struct _LOG_HANDLE_CONTEXT                                        // 12 elements, 0x98 bytes (sizeof)
	{
		...
		/*0x008*/     FUNCT_00BD_1CF5_FlushToLsnRoutine* FlushToLsnRoutine;
		/*0x010*/     FUNCT_00BD_1CF9_QueryLogHandleInfoRoutine* QueryLogHandleInfoRoutine;
	...
	typedef struct _SEGMENT_FLAGS                        // 17 elements, 0x4 bytes (sizeof)
	{
		union                                            // 2 elements, 0x2 bytes (sizeof)
		{
			struct                                       // 7 elements, 0x2 bytes (sizeof)
			{
				/*0x000*/             UINT16       TotalNumberOfPtes4132 : 10; // 0 BitPosition
				/*0x000*/             UINT16       Spare0 : 1;                 // 10 BitPosition
				/*0x000*/             UINT16       LargePages : 1;             // 11 BitPosition
				/*0x000*/             UINT16       LockedPages : 1;            // 12 BitPosition
		...
		union                                            // 2 elements, 0x1 bytes (sizeof)
		{
			struct                                       // 4 elements, 0x1 bytes (sizeof)
			{
				/*0x002*/             UINT8        FloppyMedia : 1;            // 0 BitPosition
		...
		union                                            // 2 elements, 0x1 bytes (sizeof)
		{
			struct                                       // 3 elements, 0x1 bytes (sizeof)
			{
				/*0x003*/             UINT8        ILOnly : 1;                 // 0 BitPosition
	...
	typedef struct _MAPPED_FILE_SEGMENT        // 8 elements, 0x30 bytes (sizeof)
	{
		...
		/*0x00C*/     struct _SEGMENT_FLAGS SegmentFlags;    // 17 elements, 0x4 bytes (sizeof)
	...
	typedef struct _MI_ACTIVE_WSLE_LISTHEAD // 2 elements, 0x10 bytes (sizeof)
	{
		/*0x000*/     UINT64       Flink;
		/*0x008*/     UINT64       Blink;
	...
	typedef struct _MI_CFG_BITMAP_INFO // 4 elements, 0x20 bytes (sizeof)
	{
		/*0x000*/     VOID* BaseAddress;
		/*0x008*/     UINT64       RegionSize;
		/*0x010*/     VOID* VadBaseAddress;
		/*0x018*/     struct _MMVAD* BitmapVad;
	...
	typedef struct _MI_IMAGE_SECURITY_REFERENCE         // 2 elements, 0x10 bytes (sizeof)
	{
		/*0x000*/     struct _IMAGE_SECURITY_CONTEXT SecurityContext; // 5 elements, 0x8 bytes (sizeof)
		/*0x008*/     VOID* DynamicRelocations;
	}MI_IMAGE_SECURITY_REFERENCE, * PMI_IMAGE_SECURITY_REFERENCE;

	typedef struct _MI_LARGEPAGE_MEMORY_INFO            // 4 elements, 0x28 bytes (sizeof)
	{
		...
		/*0x01C*/     UINT8        _PADDING0_[0x4];
		/*0x020*/     UINT64       ActualImageViewSize;
	...
	typedef struct _MMPTE_SOFTWARE              // 11 elements, 0x8 bytes (sizeof)
	{
		...
		/*0x000*/     UINT64       PageFileReserved : 1;      // 13 BitPosition
		/*0x000*/     UINT64       PageFileAllocated : 1;     // 14 BitPosition
		/*0x000*/     UINT64       UsedPageTableEntries : 10; // 15 BitPosition
		/*0x000*/     UINT64       Unused : 7;                // 25 BitPosition
	...
	typedef struct _MI_REVERSE_VIEW_MAP      // 8 elements, 0x28 bytes (sizeof)
	{
	...
	typedef struct _SECTION_IMAGE_INFORMATION               // 23 elements, 0x40 bytes (sizeof)
	{
		...
		union                                               // 2 elements, 0x1 bytes (sizeof)
		{
			...
			struct                                          // 6 elements, 0x1 bytes (sizeof)
			{
				...
				/*0x033*/             UINT8        Reserved : 3;                  // 5 BitPosition
			};
		};
	...
	{
		/*0x000*/     struct _SECTION_IMAGE_INFORMATION ExportedImageInformation;  // 23 elements, 0x40 bytes (sizeof)
	...
	typedef struct _MI_SESSION_DRIVER_UNLOAD                 // 2 elements, 0x8 bytes (sizeof)
	{
		union                                                // 2 elements, 0x8 bytes (sizeof)
		{
			/*0x000*/         FUNCT_00BD_13C7_DriverUnload_Function* Function;
	...
	typedef struct _MI_SYSTEM_PTE_TYPE       // 14 elements, 0x68 bytes (sizeof)
	{
		...
		union                                // 2 elements, 0x8 bytes (sizeof)
		{
			...
			/*0x030*/         struct _FAST_MUTEX* GlobalMutex;
		};
		/*0x038*/     struct _MMSUPPORT* Vm;
		/*0x040*/     UINT64       TotalSystemPtes;
		/*0x048*/     UINT64       Hint;
		/*0x050*/     struct _MI_CACHED_PTE* CachedPtes;
		/*0x058*/     UINT64       TotalFreeSystemPtes;
		/*0x060*/     LONG32       CachedPteCount;
		/*0x064*/     UINT8        _PADDING1_[0x4];
	}MI_SYSTEM_PTE_TYPE, * PMI_SYSTEM_PTE_TYPE;

	typedef struct _MI_TRIAGE_DUMP_DATA                 // 7 elements, 0x28 bytes (sizeof)
	{
		...
		/*0x018*/     UINT64       FeatureBits;
		/*0x020*/     ULONG32      TimeZoneId;
		/*0x024*/     UINT8        _PADDING0_[0x4];
	}MI_TRIAGE_DUMP_DATA, * PMI_TRIAGE_DUMP_DATA;

	typedef struct _MI_USER_VA_INFO                          // 22 elements, 0x128 bytes (sizeof)
	{
		...
		/*0x01C*/     ULONG32      VadBitMapCommitment;
		/*0x020*/     ULONG32      MaximumLastVadBit;
		/*0x024*/     LONG32       VadsBeingDeleted;
		/*0x028*/     struct _KEVENT* LastVadDeletionEvent;
		/*0x030*/     ULONG32* VadBitBuffer;
		/*0x038*/     VOID* LowestBottomUpAllocationAddress;
		/*0x040*/     VOID* HighestTopDownAllocationAddress;
		/*0x048*/     VOID* FreeTebHint;
		/*0x050*/     UINT8        NumaAware;
		/*0x051*/     UINT8        _PADDING0_[0x7];
		/*0x058*/     UINT64       PrivateFixupVadCount;
		/*0x060*/     struct _MI_CFG_BITMAP_INFO CfgBitMap[3];
		/*0x0C0*/     ULONG32      CommittedPageTableBufferForTopLevel[8];
		/*0x0E0*/     struct _RTL_BITMAP CommittedPageTableBitmaps[3];
		/*0x110*/     ULONG32      PageTableBitmapPages[3];
		/*0x11C*/     UINT8        _PADDING1_[0x4];
		/*0x120*/     VOID* FreeUmsTebHint;
	}MI_USER_VA_INFO, * PMI_USER_VA_INFO;

	typedef struct _MMSECURE_FLAGS            // 7 elements, 0x4 bytes (sizeof)
	{
		...
		/*0x000*/     ULONG32      Spare : 6;               // 6 BitPosition
	...
	typedef struct _MMADDRESS_LIST        // 2 elements, 0x10 bytes (sizeof)
	{
		union                             // 3 elements, 0x8 bytes (sizeof)
		{
			/*0x000*/         struct _MMSECURE_FLAGS Flags; // 7 elements, 0x4 bytes (sizeof)
	...
	typedef struct _MI_VAD_EVENT_BLOCK                   // 8 elements, 0x28 bytes (sizeof)
	{
		/*0x000*/     struct _MI_VAD_EVENT_BLOCK* Next;
		/*0x008*/     ULONG32      WaitReason;
		/*0x00C*/     UINT8        _PADDING0_[0x4];
		union                                            // 6 elements, 0x18 bytes (sizeof)
		{
			/*0x010*/         struct _KGATE Gate;                          // 1 elements, 0x18 bytes (sizeof)
			/*0x010*/         struct _MMADDRESS_LIST SecureInfo;           // 2 elements, 0x10 bytes (sizeof)
			/*0x010*/         struct _RTL_BITMAP_EX BitMap;                // 2 elements, 0x10 bytes (sizeof)
			/*0x010*/         struct _MMINPAGE_SUPPORT* InPageSupport;
			/*0x010*/         struct _MI_PHYSMEM_BLOCK PhysicalMemory;     // 1 elements, 0x8 bytes (sizeof)
			/*0x010*/         struct _MI_LARGEPAGE_MEMORY_INFO* LargePage;
		};
	...
	typedef struct _MM_PAGED_POOL_INFO                // 6 elements, 0x68 bytes (sizeof)
	{
		...
		/*0x038*/     struct _RTL_BITMAP_EX PagedPoolAllocationMap; // 2 elements, 0x10 bytes (sizeof)
		/*0x048*/     struct _MMPTE* FirstPteForPagedPool;
		/*0x050*/     UINT64       MaximumSize;
		/*0x058*/     UINT64       PagedPoolHint;
		/*0x060*/     UINT64       AllocatedPagedPool;
	}MM_PAGED_POOL_INFO, * PMM_PAGED_POOL_INFO;

	typedef struct _MM_SESSION_SPACE_FLAGS       // 9 elements, 0x4 bytes (sizeof)
	{
		...
		/*0x000*/     ULONG32      Filler : 24;                // 8 BitPosition
	...
	typedef struct _MM_SESSION_SPACE                   // 43 elements, 0x2000 bytes (sizeof)
	{
		/*0x000*/      LONG32       ReferenceCount;
		union                                          // 2 elements, 0x4 bytes (sizeof)
		{
			/*0x004*/          ULONG32      LongFlags;
			/*0x004*/          struct _MM_SESSION_SPACE_FLAGS Flags;      // 9 elements, 0x4 bytes (sizeof)
		}u;
		/*0x008*/      ULONG32      SessionId;
		...
		/*0xC00*/      struct _MMSUPPORT Vm;                          // 24 elements, 0xE8 bytes (sizeof)
		/*0xCE8*/      struct _MMWSLE* Wsle;
		/*0xCF0*/      struct _MI_SESSION_DRIVER_UNLOAD DriverUnload; // 2 elements, 0x8 bytes (sizeof)
		/*0xCF8*/      UINT8        _PADDING1_[0x8];
		/*0xD00*/      struct _POOL_DESCRIPTOR PagedPool;             // 13 elements, 0x1140 bytes (sizeof)
		/*0x1E40*/     struct _MMPTE PageDirectory;                   // 1 elements, 0x8 bytes (sizeof)
		/*0x1E48*/     struct _FAST_MUTEX SessionVaLock;              // 5 elements, 0x38 bytes (sizeof)
		/*0x1E80*/     struct _RTL_BITMAP DynamicVaBitMap;            // 2 elements, 0x10 bytes (sizeof)
		/*0x1E90*/     ULONG32      DynamicVaHint;
		/*0x1E94*/     UINT8        _PADDING2_[0x4];
		/*0x1E98*/     struct _MI_SPECIAL_POOL SpecialPool;           // 5 elements, 0x50 bytes (sizeof)
		/*0x1EE8*/     struct _FAST_MUTEX SessionPteLock;             // 5 elements, 0x38 bytes (sizeof)
		/*0x1F20*/     LONG32       PoolBigEntriesInUse;
		/*0x1F24*/     ULONG32      PagedPoolPdeCount;
		/*0x1F28*/     ULONG32      SpecialPoolPdeCount;
		/*0x1F2C*/     ULONG32      DynamicSessionPdeCount;
		/*0x1F30*/     struct _MI_SYSTEM_PTE_TYPE SystemPteInfo;      // 14 elements, 0x68 bytes (sizeof)
		/*0x1F98*/     VOID* PoolTrackTableExpansion;
		/*0x1FA0*/     UINT64       PoolTrackTableExpansionSize;
		/*0x1FA8*/     VOID* PoolTrackBigPages;
		/*0x1FB0*/     UINT64       PoolTrackBigPagesSize;
		/*0x1FB8*/     enum _IO_SESSION_STATE IoState;
		/*0x1FBC*/     ULONG32      IoStateSequence;
		/*0x1FC0*/     struct _KEVENT IoNotificationEvent;            // 1 elements, 0x18 bytes (sizeof)
		/*0x1FD8*/     UINT8        _PADDING3_[0x28];
	...
	typedef struct _MMINPAGE_FLAGS                    // 21 elements, 0x4 bytes (sizeof)
	{
		struct                                        // 2 elements, 0x1 bytes (sizeof)
		{
		...
		struct                                        // 8 elements, 0x1 bytes (sizeof)
		{
			...
			/*0x003*/         UINT8        PteChanged : 1;              // 4 BitPosition
			/*0x003*/         UINT8        PageFileFault : 1;           // 5 BitPosition
			/*0x003*/         UINT8        PageFilePageHashActive : 1;  // 6 BitPosition
			/*0x003*/         UINT8        CoalescedIo : 1;             // 7 BitPosition
		};
	}MMINPAGE_FLAGS, * PMMINPAGE_FLAGS;

	typedef struct _MMINPAGE_SUPPORT       // 23 elements, 0x180 bytes (sizeof)
	{
		/*0x000*/     struct _LIST_ENTRY ListEntry;      // 2 elements, 0x10 bytes (sizeof)
		...
		/*0x070*/     struct _ETHREAD* Thread;
		/*0x078*/     struct _MMPFN* LockedProtoPfn;
		/*0x080*/     LONG32       WaitCount;
		/*0x084*/     ULONG32      ByteCount;
		union                              // 2 elements, 0x4 bytes (sizeof)
		{
			/*0x088*/         ULONG32      ImagePteOffset;
			/*0x088*/         ULONG32      TossPage;
		}u3;
		union                              // 2 elements, 0x4 bytes (sizeof)
		{
			/*0x08C*/         struct _MMINPAGE_FLAGS e1;     // 21 elements, 0x4 bytes (sizeof)
			/*0x08C*/         ULONG32      LongFlags;
		}u1;
		/*0x090*/     struct _FILE_OBJECT* FilePointer;
		/*0x098*/     struct _CONTROL_AREA* ControlArea;
		/*0x0A0*/     VOID* Autoboost;
		/*0x0A8*/     VOID* FaultingAddress;
		/*0x0B0*/     struct _MMPTE* PointerPte;
		/*0x0B8*/     struct _MMPTE* BasePte;
		/*0x0C0*/     struct _MMPFN* Pfn;
		/*0x0C8*/     struct _MDL* PrefetchMdl;
		/*0x0D0*/     struct _MDL  Mdl;                  // 10 elements, 0x30 bytes (sizeof)
		/*0x100*/     UINT64       Page[16];
	...
	typedef struct _MMMOD_WRITER_MDL_ENTRY    // 16 elements, 0x100 bytes (sizeof)
	{
		/*0x000*/     struct _LIST_ENTRY Links;             // 2 elements, 0x10 bytes (sizeof)
		union                                 // 1 elements, 0x10 bytes (sizeof)
		{
		...
		/*0x0C0*/     struct _MDL* PointerMdl;
		/*0x0C8*/     struct _MDL  Mdl;                     // 10 elements, 0x30 bytes (sizeof)
		/*0x0F8*/     UINT64       Page[1];
	}MMMOD_WRITER_MDL_ENTRY, * PMMMOD_WRITER_MDL_ENTRY;

	typedef struct _MMPAGING_FILE                      // 35 elements, 0xE0 bytes (sizeof)
	{
		/*0x000*/     UINT64       Size;
		...
		/*0x060*/     union _SLIST_HEADER PfnsToFree;                // 3 elements, 0x10 bytes (sizeof)
		/*0x070*/     struct _UNICODE_STRING PageFileName;           // 3 elements, 0x10 bytes (sizeof)
		/*0x080*/     struct _MI_PAGING_FILE_SPACE_BITMAPS* Bitmaps;
		/*0x088*/     ULONG32      AllocationBitmapHint;
		/*0x08C*/     ULONG32      ReservationBitmapHint;
		/*0x090*/     ULONG32      LargestNonReservedClusterSize;
		/*0x094*/     ULONG32      RefreshClusterSize;
		/*0x098*/     ULONG32      LastRefreshClusterSize;
		/*0x09C*/     ULONG32      ReservedClusterSizeAggregate;
		/*0x0A0*/     ULONG32      ToBeEvictedCount;
		/*0x0A4*/     ULONG32      HybridPriority;
		struct                                         // 5 elements, 0x2 bytes (sizeof)
		{
			/*0x0A8*/         UINT16       PageFileNumber : 4;           // 0 BitPosition
			/*0x0A8*/         UINT16       BootPartition : 1;            // 4 BitPosition
			/*0x0A8*/         UINT16       WsSwapPagefile : 1;           // 5 BitPosition
			/*0x0A8*/         UINT16       NoReservations : 1;           // 6 BitPosition
			/*0x0A8*/         UINT16       Spare0 : 9;                   // 7 BitPosition
		};
		struct                                         // 2 elements, 0x1 bytes (sizeof)
		{
			/*0x0AA*/         UINT8        AdriftMdls : 1;               // 0 BitPosition
			/*0x0AA*/         UINT8        Spare1 : 7;                   // 1 BitPosition
		};
		/*0x0AB*/     UINT8        Spare2 : 8;                       // 0 BitPosition
		/*0x0AC*/     ULONG32      PageHashPages;
		/*0x0B0*/     ULONG32      PageHashPagesPeak;
		/*0x0B4*/     UINT8        _PADDING1_[0x4];
		/*0x0B8*/     ULONG32* PageHash;
		/*0x0C0*/     VOID* FileHandle;
		/*0x0C8*/     UINT64       Lock;
		/*0x0D0*/     struct _ETHREAD* LockOwner;
		/*0x0D8*/     UINT8        _PADDING2_[0x8];
	...
	typedef struct _MMPFNENTRY                   // 11 elements, 0x2 bytes (sizeof)
	{
		...
		struct                                   // 6 elements, 0x1 bytes (sizeof)
		{
			...
			/*0x001*/         UINT8        Spare : 1;              // 5 BitPosition
	...
	typedef struct _MMPFN                                // 14 elements, 0x30 bytes (sizeof)
	{
		...
		union                                            // 6 elements, 0x8 bytes (sizeof)
		{
			struct                                       // 4 elements, 0x8 bytes (sizeof)
			{
				/*0x008*/             UINT64       Blink : 36;                 // 0 BitPosition
				/*0x008*/             UINT64       NodeBlinkHigh : 20;         // 36 BitPosition
				/*0x008*/             UINT64       TbFlushStamp : 4;           // 56 BitPosition
				/*0x008*/             UINT64       SpareBlink : 4;             // 60 BitPosition
			};
		...
		union                                            // 3 elements, 0x4 bytes (sizeof)
		{
			...
			struct                                       // 4 elements, 0x4 bytes (sizeof)
			{
				...
				union                                    // 2 elements, 0x2 bytes (sizeof)
				{
					...
					/*0x01A*/                 UINT16       VolatileShortFlags;
				};
			}e2;
		}u3;
		/*0x01C*/     UINT16       NodeBlinkLow;
		struct                                           // 2 elements, 0x1 bytes (sizeof)
		{
			/*0x01E*/         UINT8        Unused : 4;                     // 0 BitPosition
			/*0x01E*/         UINT8        VaType : 4;                     // 4 BitPosition
		};
		union                                            // 2 elements, 0x1 bytes (sizeof)
		{
			/*0x01F*/         UINT8        ViewCount;
			/*0x01F*/         UINT8        NodeFlinkLow;
		};
		...
		union                                            // 10 elements, 0x8 bytes (sizeof)
		{
			struct                                       // 9 elements, 0x8 bytes (sizeof)
			{
				...
				/*0x028*/             UINT64       Unused3 : 13;               // 40 BitPosition
	...
	typedef struct _MMVAD_FLAGS            // 9 elements, 0x4 bytes (sizeof)
	{
		...
		/*0x000*/     ULONG32      NoChange : 1;         // 14 BitPosition
		/*0x000*/     ULONG32      PrivateMemory : 1;    // 15 BitPosition
		/*0x000*/     ULONG32      Teb : 1;              // 16 BitPosition
		/*0x000*/     ULONG32      PrivateFixup : 1;     // 17 BitPosition
		/*0x000*/     ULONG32      Spare : 13;           // 18 BitPosition
		/*0x000*/     ULONG32      DeleteInProgress : 1; // 31 BitPosition
	...
	typedef struct _MMVAD_SHORT                // 13 elements, 0x40 bytes (sizeof)
	{
		union                                  // 2 elements, 0x18 bytes (sizeof)
		{
	...
	typedef struct _MMVAD_FLAGS2             // 7 elements, 0x4 bytes (sizeof)
	{
		...
		/*0x000*/     ULONG32      CopyOnWrite : 1;        // 27 BitPosition
		/*0x000*/     ULONG32      NoValidationNeeded : 1; // 28 BitPosition
		/*0x000*/     ULONG32      Spare : 3;              // 29 BitPosition
	}MMVAD_FLAGS2, * PMMVAD_FLAGS2;

	typedef struct _MMVAD                                // 8 elements, 0x80 bytes (sizeof)
	{
		/*0x000*/     struct _MMVAD_SHORT Core;                        // 13 elements, 0x40 bytes (sizeof)
		union                                            // 2 elements, 0x4 bytes (sizeof)
		{
	...
	typedef union _MMVIEW_CONTROL_AREA                 // 5 elements, 0x8 bytes (sizeof)
	{
		/*0x000*/     struct _CONTROL_AREA* ControlArea;
		struct                                         // 4 elements, 0x8 bytes (sizeof)
		{
			/*0x000*/         UINT64       Writable : 1;                 // 0 BitPosition
			/*0x000*/         UINT64       ExceptionForInPageErrors : 1; // 1 BitPosition
			/*0x000*/         UINT64       Unused : 1;                   // 2 BitPosition
			/*0x000*/         UINT64       UsedForControlArea : 61;      // 3 BitPosition
		};
	}MMVIEW_CONTROL_AREA, * PMMVIEW_CONTROL_AREA;

	typedef struct _MMVIEW                          // 7 elements, 0x38 bytes (sizeof)
	{
		/*0x000*/     UINT64       PteOffset;
		/*0x008*/     UINT64       Entry;
		/*0x010*/     union _MMVIEW_CONTROL_AREA u1;              // 5 elements, 0x8 bytes (sizeof)
		/*0x018*/     struct _LIST_ENTRY ViewLinks;               // 2 elements, 0x10 bytes (sizeof)
		/*0x028*/     VOID* SessionViewVa;
		/*0x030*/     ULONG32      SessionId;
		/*0x034*/     ULONG32      SessionIdForGlobalSubsections;
	}MMVIEW, * PMMVIEW;

	typedef struct _MMWSL                                 // 19 elements, 0x320 bytes (sizeof)
	{
		/*0x000*/     UINT64       FirstFree;
		/*0x008*/     UINT64       FirstDynamic;
		/*0x010*/     UINT64       LastEntry;
		/*0x018*/     UINT64       NextSlot;
		/*0x020*/     UINT64       LastInitializedWsle;
		/*0x028*/     UINT64       NextAgingSlot;
		/*0x030*/     UINT64       NextAccessClearingSlot;
		/*0x038*/     ULONG32      LastAccessClearingRemainder;
		/*0x03C*/     ULONG32      LastAgingRemainder;
		/*0x040*/     ULONG32      WsleSize;
		/*0x044*/     UINT8        _PADDING0_[0x4];
		/*0x048*/     UINT64       NonDirectCount;
		/*0x050*/     VOID* LowestPagableAddress;
		/*0x058*/     struct _MMWSLE_NONDIRECT_HASH* NonDirectHash;
		/*0x060*/     struct _MMWSLE_HASH* HashTableStart;
		/*0x068*/     struct _MMWSLE_HASH* HighestPermittedHashAddress;
		/*0x070*/     UINT64       ActiveWsleCounts[16];
		/*0x0F0*/     struct _MI_ACTIVE_WSLE_LISTHEAD ActiveWsles[16];
		/*0x1F0*/     struct _MMWSLE* Wsle;
		/*0x1F8*/     struct _MI_USER_VA_INFO UserVaInfo;               // 22 elements, 0x128 bytes (sizeof)
	}MMWSL, * PMMWSL;

	typedef struct _MMWSLENTRY               // 10 elements, 0x8 bytes (sizeof)
	{
		/*0x000*/     UINT64       Valid : 1;              // 0 BitPosition
		...
		/*0x000*/     UINT64       VirtualPageNumber : 36; // 12 BitPosition
		/*0x000*/     UINT64       HighActiveFlink : 4;    // 48 BitPosition
		/*0x000*/     UINT64       HighActiveBlink : 4;    // 52 BitPosition
		/*0x000*/     UINT64       Unused : 8;             // 56 BitPosition
	}MMWSLENTRY, * PMMWSLENTRY;

	typedef struct _MMWSLE_FREE_ENTRY   // 3 elements, 0x8 bytes (sizeof)
	{
		/*0x000*/     UINT64       MustBeZero : 1;    // 0 BitPosition
		/*0x000*/     UINT64       PreviousFree : 27; // 1 BitPosition
		/*0x000*/     UINT64       NextFree : 36;     // 28 BitPosition
	...
	typedef struct _MMWSLE                // 1 elements, 0x8 bytes (sizeof)
	{
		union                             // 4 elements, 0x8 bytes (sizeof)
		{
			/*0x000*/         VOID* VirtualAddress;
			/*0x000*/         UINT64       Long;
			/*0x000*/         struct _MMWSLENTRY e1;        // 10 elements, 0x8 bytes (sizeof)
			/*0x000*/         struct _MMWSLE_FREE_ENTRY e2; // 3 elements, 0x8 bytes (sizeof)
		}u1;
	}MMWSLE, * PMMWSLE;

	typedef struct _MMWSLE_HASH // 1 elements, 0x8 bytes (sizeof)
	{
		/*0x000*/     UINT64       Index;
	...
	typedef struct _OBJECT_DIRECTORY                     // 7 elements, 0x150 bytes (sizeof)
	{
		...
		union                                            // 2 elements, 0x8 bytes (sizeof)
		{
			...
			/*0x130*/         struct _OBJECT_DIRECTORY* ShadowDirectory;
		};
	...
	typedef struct _OBJECT_TYPE_INITIALIZER                                                                                                                                                                                                    // 29 elements, 0x78 bytes (sizeof)
	{
		...
		/*0x030*/     FUNCT_00BD_1494_DumpProcedure* DumpProcedure;
		/*0x038*/     FUNCT_0073_149C_OpenProcedure* OpenProcedure;
		/*0x040*/     FUNCT_00BD_14AA_CloseProcedure* CloseProcedure;
		/*0x048*/     FUNCT_00BD_07E0_Free_IdleComplete_WorkerRoutine_DeleteCallback_InterfaceReference_InterfaceDereference_DeleteProcedure_DevicePowerRequired_DevicePowerNotRequired_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead* DeleteProcedure;
		/*0x050*/     FUNCT_0073_14B0_ParseProcedure* ParseProcedure;
		/*0x058*/     FUNCT_0073_14BC_SecurityProcedure* SecurityProcedure;
		/*0x060*/     FUNCT_0073_14CD_QueryNameProcedure* QueryNameProcedure;
		/*0x068*/     FUNCT_007C_14D5_OkayToCloseProcedure* OkayToCloseProcedure;
	...
	typedef struct _OBJECT_TYPE                   // 12 elements, 0xD8 bytes (sizeof)
	{
		...
		/*0x03C*/     UINT8        _PADDING1_[0x4];
		/*0x040*/     struct _OBJECT_TYPE_INITIALIZER TypeInfo; // 29 elements, 0x78 bytes (sizeof)
	...
	typedef struct _PCW_PROCESSOR_INFO       // 28 elements, 0xB8 bytes (sizeof)
	{
		...
		/*0x0B0*/     ULONG32      PerformanceLimit;
		/*0x0B4*/     ULONG32      PerformanceLimitFlags;
	...
	typedef struct _PCW_REGISTRATION_INFORMATION  // 6 elements, 0x30 bytes (sizeof)
	{
		...
		/*0x020*/     FUNCT_0073_1805_Callback* Callback;
	...
	typedef struct _PEB                                                                               // 102 elements, 0x388 bytes (sizeof)
	{
		...
		/*0x230*/     FUNCT_00BD_028D_PostProcessInitRoutine_DispatchAddress_FinishRoutine* PostProcessInitRoutine;
	...
	typedef struct _PEB64                                      // 102 elements, 0x388 bytes (sizeof)
	{
		/*0x000*/     UINT8        InheritedAddressSpace;
		/*0x001*/     UINT8        ReadImageFileExecOptions;
		/*0x002*/     UINT8        BeingDebugged;
	...
	typedef struct _PNP_DEVICE_EVENT_ENTRY                                                                                                                                                                                              // 12 elements, 0xA8 bytes (sizeof)
	{
		...
		/*0x020*/     FUNCT_00BD_07E0_Free_IdleComplete_WorkerRoutine_DeleteCallback_InterfaceReference_InterfaceDereference_DeleteProcedure_DevicePowerRequired_DevicePowerNotRequired_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead* Callback;
		/*0x028*/     VOID* Context;
		/*0x030*/     enum _PNP_VETO_TYPE* VetoType;
	...
	typedef struct _PO_DEVICE_NOTIFY_ORDER           // 3 elements, 0x178 bytes (sizeof)
	{
		/*0x000*/     UINT8        Locked;
	...
	typedef struct _PO_HIBER_PERF                           // 56 elements, 0x1A8 bytes (sizeof)
	{
		...
		/*0x030*/     union _LARGE_INTEGER TotalHibernateTime;            // 4 elements, 0x8 bytes (sizeof)
		/*0x038*/     ULONG32      POSTTime;
		/*0x03C*/     ULONG32      ResumeBootMgrTime;
		/*0x040*/     ULONG32      BootmgrUserInputTime;
		/*0x044*/     UINT8        _PADDING0_[0x4];
		/*0x048*/     UINT64       ResumeAppTicks;
		/*0x050*/     UINT64       ResumeAppStartTimestamp;
		/*0x058*/     UINT64       ResumeLibraryInitTicks;
		/*0x060*/     UINT64       ResumeInitTicks;
		/*0x068*/     UINT64       ResumeRestoreImageStartTimestamp;
		/*0x070*/     UINT64       ResumeHiberFileTicks;
		/*0x078*/     UINT64       ResumeIoTicks;
		/*0x080*/     UINT64       ResumeDecompressTicks;
		/*0x088*/     UINT64       ResumeAllocateTicks;
		/*0x090*/     UINT64       ResumeUserInOutTicks;
		/*0x098*/     UINT64       ResumeMapTicks;
		/*0x0A0*/     UINT64       ResumeUnmapTicks;
		/*0x0A8*/     UINT64       ResumeKernelSwitchTimestamp;
		/*0x0B0*/     UINT64       WriteLogDataTimestamp;
		/*0x0B8*/     UINT64       KernelReturnFromHandler;
		/*0x0C0*/     UINT64       TimeStampCounterAtSwitchTime;
		/*0x0C8*/     UINT64       HalTscOffset;
		/*0x0D0*/     UINT64       HvlTscOffset;
		/*0x0D8*/     UINT64       SleeperThreadEnd;
		/*0x0E0*/     UINT64       KernelReturnSystemPowerStateTimestamp;
		/*0x0E8*/     UINT64       IoBoundedness;
		/*0x0F0*/     UINT64       KernelDecompressTicks;
		/*0x0F8*/     UINT64       KernelIoTicks;
		/*0x100*/     UINT64       KernelCopyTicks;
		/*0x108*/     UINT64       ReadCheckCount;
		/*0x110*/     UINT64       KernelInitTicks;
		/*0x118*/     UINT64       KernelResumeHiberFileTicks;
		/*0x120*/     UINT64       KernelIoCpuTicks;
		/*0x128*/     UINT64       KernelSharedBufferTicks;
		/*0x130*/     UINT64       KernelAnimationTicks;
		/*0x138*/     union _LARGE_INTEGER AnimationStart;                // 4 elements, 0x8 bytes (sizeof)
		/*0x140*/     union _LARGE_INTEGER AnimationStop;                 // 4 elements, 0x8 bytes (sizeof)
		/*0x148*/     ULONG32      DeviceResumeTime;
		/*0x14C*/     UINT8        _PADDING1_[0x4];
		/*0x150*/     UINT64       BootPagesProcessed;
		/*0x158*/     UINT64       KernelPagesProcessed;
		/*0x160*/     UINT64       BootBytesWritten;
		/*0x168*/     UINT64       KernelBytesWritten;
		/*0x170*/     UINT64       BootPagesWritten;
		/*0x178*/     UINT64       KernelPagesWritten;
		/*0x180*/     UINT64       BytesWritten;
		/*0x188*/     ULONG32      PagesWritten;
		/*0x18C*/     ULONG32      FileRuns;
		/*0x190*/     ULONG32      NoMultiStageResumeReason;
		/*0x194*/     ULONG32      MaxHuffRatio;
		/*0x198*/     UINT64       AdjustedTotalResumeTime;
		/*0x1A0*/     UINT64       ResumeCompleteTimestamp;
	...
	typedef struct _POP_DEVICE_SYS_STATE       // 16 elements, 0x1D0 bytes (sizeof)
	{
		...
		/*0x030*/     struct _PO_DEVICE_NOTIFY_ORDER Order;  // 3 elements, 0x178 bytes (sizeof)
		/*0x1A8*/     struct _LIST_ENTRY Pending;            // 2 elements, 0x10 bytes (sizeof)
		/*0x1B8*/     LONG32       Status;
		/*0x1BC*/     UINT8        _PADDING1_[0x4];
		/*0x1C0*/     struct _DEVICE_OBJECT* FailedDevice;
		/*0x1C8*/     UINT8        Waking;
		/*0x1C9*/     UINT8        Cancelled;
		/*0x1CA*/     UINT8        IgnoreErrors;
		/*0x1CB*/     UINT8        IgnoreNotImplemented;
		/*0x1CC*/     UINT8        TimeRefreshLockAcquired;
		/*0x1CD*/     UINT8        _PADDING2_[0x3];
	}POP_DEVICE_SYS_STATE, * PPOP_DEVICE_SYS_STATE;

	typedef struct _POP_FX_ACCOUNTING    // 7 elements, 0x30 bytes (sizeof)
	{
		/*0x000*/     UINT64       Lock;
		/*0x008*/     UINT8        Active;
		/*0x009*/     UINT8        _PADDING0_[0x3];
		...
		/*0x020*/     UINT64       CsActiveTime;
		/*0x028*/     INT64        CriticalActiveTime;
	...
	typedef union _POP_FX_COMPONENT_FLAGS                  // 9 elements, 0x8 bytes (sizeof)
	{
		struct                                             // 2 elements, 0x8 bytes (sizeof)
		{
			/*0x000*/         LONG32       Value;
		...
		struct                                             // 1 elements, 0x8 bytes (sizeof)
		{
			...
			struct                                         // 4 elements, 0x4 bytes (sizeof)
			{
				...
				/*0x004*/             ULONG32      CompleteIdleStatePending : 1; // 2 BitPosition
				/*0x004*/             ULONG32      Reserved : 29;                // 3 BitPosition
			};
		};
	}POP_FX_COMPONENT_FLAGS, * PPOP_FX_COMPONENT_FLAGS;

	typedef struct _POP_FX_COMPONENT           // 21 elements, 0xF8 bytes (sizeof)
	{
		...
		/*0x058*/     union _POP_FX_COMPONENT_FLAGS Flags;   // 9 elements, 0x8 bytes (sizeof)
		...
		/*0x0C8*/     struct _POP_FX_ACCOUNTING Accounting;  // 7 elements, 0x30 bytes (sizeof)
	...
	typedef union _POP_FX_DEVICE_STATUS           // 10 elements, 0x4 bytes (sizeof)
	{
		/*0x000*/     LONG32       Value;
		struct                                    // 9 elements, 0x4 bytes (sizeof)
		{
	...
	typedef struct _POP_FX_DRIVER_CALLBACKS                                                                                                                                                                                                           // 7 elements, 0x38 bytes (sizeof)
	{
		/*0x000*/     FUNCT_00BD_086C_IdleCancel_Free_ComponentActive_ComponentIdle* ComponentActive;
		/*0x008*/     FUNCT_00BD_086C_IdleCancel_Free_ComponentActive_ComponentIdle* ComponentIdle;
		/*0x010*/     FUNCT_00BD_19F0_ComponentIdleState* ComponentIdleState;
		/*0x018*/     FUNCT_00BD_07E0_Free_IdleComplete_WorkerRoutine_DeleteCallback_InterfaceReference_InterfaceDereference_DeleteProcedure_DevicePowerRequired_DevicePowerNotRequired_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead* DevicePowerRequired;
		/*0x020*/     FUNCT_00BD_07E0_Free_IdleComplete_WorkerRoutine_DeleteCallback_InterfaceReference_InterfaceDereference_DeleteProcedure_DevicePowerRequired_DevicePowerNotRequired_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead* DevicePowerNotRequired;
		/*0x028*/     FUNCT_0073_19F2_PowerControl* PowerControl;
		/*0x030*/     FUNCT_00BD_19FB_ComponentCriticalTransition* ComponentCriticalTransition;
	}POP_FX_DRIVER_CALLBACKS, * PPOP_FX_DRIVER_CALLBACKS;

	typedef struct _POP_FX_DEVICE                                                          // 31 elements, 0x218 bytes (sizeof)
	{
		/*0x000*/     struct _LIST_ENTRY Link;                                                           // 2 elements, 0x10 bytes (sizeof)
		/*0x010*/     struct _IRP* Irp;
		/*0x018*/     struct _POP_IRP_DATA* IrpData;
		/*0x020*/     union _POP_FX_DEVICE_STATUS Status;                                                // 10 elements, 0x4 bytes (sizeof)
		/*0x024*/     LONG32       PowerReqCall;
		/*0x028*/     LONG32       PowerNotReqCall;
		/*0x02C*/     UINT8        _PADDING0_[0x4];
		/*0x030*/     struct _POP_FX_PLUGIN* Plugin;
		/*0x038*/     struct _PEPHANDLE__* PluginHandle;
		/*0x040*/     struct _POP_FX_PLUGIN* MiniPlugin;
		/*0x048*/     struct _PEPHANDLE__* MiniPluginHandle;
		/*0x050*/     struct _DEVICE_NODE* DevNode;
		/*0x058*/     struct _DEVICE_OBJECT* DeviceObject;
		/*0x060*/     struct _DEVICE_OBJECT* TargetDevice;
		/*0x068*/     struct _POP_FX_DRIVER_CALLBACKS Callbacks;                                         // 7 elements, 0x38 bytes (sizeof)
		/*0x0A0*/     VOID* DriverContext;
		/*0x0A8*/     struct _IO_REMOVE_LOCK RemoveLock;                                                 // 1 elements, 0x20 bytes (sizeof)
		/*0x0C8*/     struct _POP_FX_WORK_ORDER WorkOrder;                                               // 4 elements, 0x38 bytes (sizeof)
		/*0x100*/     UINT64       IdleLock;
		/*0x108*/     struct _KTIMER IdleTimer;                                                          // 6 elements, 0x40 bytes (sizeof)
		/*0x148*/     struct _KDPC IdleDpc;                                                              // 11 elements, 0x40 bytes (sizeof)
		/*0x188*/     UINT64       IdleTimeout;
		/*0x190*/     UINT64       IdleStamp;
		/*0x198*/     struct _DEVICE_OBJECT* NextIrpDeviceObject;
		/*0x1A0*/     union _POWER_STATE NextIrpPowerState;                                              // 2 elements, 0x4 bytes (sizeof)
		/*0x1A4*/     UINT8        _PADDING1_[0x4];
		/*0x1A8*/     FUNCT_00BD_19A3_NextIrpCallerCompletion_CallerCompletion* NextIrpCallerCompletion;
		/*0x1B0*/     VOID* NextIrpCallerContext;
		/*0x1B8*/     struct _KEVENT IrpCompleteEvent;                                                   // 1 elements, 0x18 bytes (sizeof)
		/*0x1D0*/     FUNCT_007C_1A07_PowerOnDumpDeviceCallback* PowerOnDumpDeviceCallback;
		/*0x1D8*/     struct _POP_FX_ACCOUNTING Accounting;                                              // 7 elements, 0x30 bytes (sizeof)
		/*0x208*/     ULONG32      ComponentCount;
		/*0x20C*/     UINT8        _PADDING2_[0x4];
		/*0x210*/     struct _POP_FX_COMPONENT* Components[1];
	...
	typedef struct _POP_FX_PLUGIN                                                 // 8 elements, 0xB0 bytes (sizeof)
	{
		/*0x000*/     struct _LIST_ENTRY Link;                                                  // 2 elements, 0x10 bytes (sizeof)
		/*0x010*/     ULONG32      Version;
		/*0x014*/     UINT8        _PADDING0_[0x4];
		...
		/*0x060*/     FUNCT_007C_19D0_AcceptDeviceNotification* AcceptDeviceNotification;
		/*0x068*/     FUNCT_007C_19D4_AcceptProcessorNotification* AcceptProcessorNotification;
		/*0x070*/     ULONG32      WorkOrderCount;
		/*0x074*/     UINT8        _PADDING1_[0x4];
		/*0x078*/     struct _POP_FX_WORK_ORDER WorkOrders[1];
	...
	typedef struct _POP_FX_WORK_ORDER_WATCHDOG_INFO // 3 elements, 0x88 bytes (sizeof)
	{
		/*0x000*/     struct _KTIMER Timer;                       // 6 elements, 0x40 bytes (sizeof)
		/*0x040*/     struct _KDPC Dpc;                           // 11 elements, 0x40 bytes (sizeof)
		/*0x080*/     struct _POP_FX_WORK_ORDER* WorkOrder;
	...
	typedef struct _POP_HIBER_CONTEXT                        // 49 elements, 0x1A0 bytes (sizeof)
	{
		/*0x000*/     UINT8        Reset;
		...
		/*0x130*/     UINT64       BitlockerKeyPFN;
		/*0x138*/     struct _POP_IO_INFO IoInfo;                          // 12 elements, 0x60 bytes (sizeof)
		/*0x198*/     ULONG32      HardwareConfigurationSignature;
		/*0x19C*/     UINT8        _PADDING6_[0x4];
	}POP_HIBER_CONTEXT, * PPOP_HIBER_CONTEXT;

	typedef struct _POP_IRP_DATA                                                            // 17 elements, 0xF8 bytes (sizeof)
	{
		/*0x000*/     struct _LIST_ENTRY Link;                                                            // 2 elements, 0x10 bytes (sizeof)
		/*0x010*/     struct _IRP* Irp;
		...
		/*0x0D2*/     UINT8        _PADDING2_[0x6];
		union                                                                               // 2 elements, 0x20 bytes (sizeof)
		{
			struct                                                                          // 4 elements, 0x20 bytes (sizeof)
			{
				/*0x0D8*/             FUNCT_00BD_19A3_NextIrpCallerCompletion_CallerCompletion* CallerCompletion;
	...
	typedef struct __2016091401173703C88D3DC3DCBCCDEE4_WakeAlarm // 2 elements, 0x10 bytes (sizeof)
	{
		/*0x000*/     UINT64       ProgrammedTime;
		/*0x008*/     struct _DIAGNOSTIC_BUFFER* TimerInfo;
	}_2016091401173703C88D3DC3DCBCCDEE4_WakeAlarm, * P_2016091401173703C88D3DC3DCBCCDEE4_WakeAlarm;
	...
	typedef struct _POP_POWER_ACTION                                       // 23 elements, 0xE0 bytes (sizeof)
	{
		...
		/*0x05C*/     UINT8        _PADDING2_[0x4];
		/*0x060*/     struct __2016091401173703C88D3DC3DCBCCDEE4_WakeAlarm WakeAlarm[3];
	...
	typedef struct _THERMAL_INFORMATION_EX  // 11 elements, 0x50 bytes (sizeof)
	{
		...
		/*0x018*/     ULONG32      CriticalTripPoint;
		/*0x01C*/     UINT8        ActiveTripPointCount;
		/*0x01D*/     UINT8        _PADDING0_[0x3];
		/*0x020*/     ULONG32      ActiveTripPoint[10];
		/*0x048*/     ULONG32      S4TransitionTripPoint;
		/*0x04C*/     ULONG32      MinimumThrottle;
	}THERMAL_INFORMATION_EX, * PTHERMAL_INFORMATION_EX;

	typedef struct _THERMAL_POLICY      // 7 elements, 0x14 bytes (sizeof)
	{
		/*0x000*/     ULONG32      Version;
	...
	typedef struct _POP_THERMAL_ZONE_METRICS          // 7 elements, 0x30 bytes (sizeof)
	{
		/*0x000*/     ULONG32      ActiveCount;
		/*0x004*/     ULONG32      PassiveCount;
		/*0x008*/     UINT64       LastActiveStartTime;
		/*0x010*/     UINT64       AverageActiveTime;
		/*0x018*/     UINT64       LastPassiveStartTime;
		/*0x020*/     UINT64       AveragePassiveTime;
		/*0x028*/     union _LARGE_INTEGER StartTickSinceLastReset; // 4 elements, 0x8 bytes (sizeof)
	}POP_THERMAL_ZONE_METRICS, * PPOP_THERMAL_ZONE_METRICS;

	typedef struct _POP_THERMAL_ZONE                       // 34 elements, 0x1F0 bytes (sizeof)
	{
		union                                              // 2 elements, 0x40 bytes (sizeof)
		{
		...
		/*0x048*/     LONG32       HighPrecisionThrottle;
		/*0x04C*/     LONG32       Throttle;
		/*0x050*/     LONG32       PendingThrottle;
		/*0x054*/     ULONG32      ThrottleReasons;
		/*0x058*/     UINT64       LastTime;
		/*0x060*/     ULONG32      SampleRate;
		/*0x064*/     ULONG32      LastTemp;
		/*0x068*/     struct _KTIMER PassiveTimer;                       // 6 elements, 0x40 bytes (sizeof)
		/*0x0A8*/     struct _KDPC PassiveDpc;                           // 11 elements, 0x40 bytes (sizeof)
		/*0x0E8*/     struct _THERMAL_INFORMATION_EX Info;               // 11 elements, 0x50 bytes (sizeof)
		/*0x138*/     union _LARGE_INTEGER InfoLastUpdateTime;           // 4 elements, 0x8 bytes (sizeof)
		/*0x140*/     struct _THERMAL_POLICY Policy;                     // 7 elements, 0x14 bytes (sizeof)
		/*0x154*/     UINT8        PolicyDriver;
		/*0x155*/     UINT8        _PADDING1_[0x3];
		/*0x158*/     struct _POP_THERMAL_ZONE_METRICS Metrics;          // 7 elements, 0x30 bytes (sizeof)
		/*0x188*/     struct _WORK_QUEUE_ITEM WorkItem;                  // 3 elements, 0x20 bytes (sizeof)
		/*0x1A8*/     struct _POP_RW_LOCK Lock;                          // 2 elements, 0x10 bytes (sizeof)
		/*0x1B8*/     struct _KEVENT ZoneStopped;                        // 1 elements, 0x18 bytes (sizeof)
		/*0x1D0*/     struct _KEVENT TemperatureUpdated;                 // 1 elements, 0x18 bytes (sizeof)
		/*0x1E8*/     ULONG32      InstanceId;
		/*0x1EC*/     UINT8        _PADDING2_[0x4];
	...
	typedef struct _PPM_VETO_ACCOUNTING  // 2 elements, 0x18 bytes (sizeof)
	{
	...
	typedef struct _PPM_IDLE_STATE                  // 14 elements, 0xD8 bytes (sizeof)
	{
		/*0x000*/     struct _KAFFINITY_EX DomainMembers;         // 4 elements, 0xA8 bytes (sizeof)
		/*0x0A8*/     ULONG32      Latency;
		/*0x0AC*/     ULONG32      BreakEvenDuration;
		/*0x0B0*/     ULONG32      Power;
		/*0x0B4*/     ULONG32      StateFlags;
		/*0x0B8*/     struct _PPM_VETO_ACCOUNTING VetoAccounting; // 2 elements, 0x18 bytes (sizeof)
		/*0x0D0*/     UINT8        StateType;
		/*0x0D1*/     UINT8        InterruptsEnabled;
		/*0x0D2*/     UINT8        Interruptible;
		/*0x0D3*/     UINT8        ContextRetained;
		/*0x0D4*/     UINT8        CacheCoherent;
		/*0x0D5*/     UINT8        WakesSpuriously;
		/*0x0D6*/     UINT8        PlatformOnly;
		/*0x0D7*/     UINT8        NoCState;
	}PPM_IDLE_STATE, * PPPM_IDLE_STATE;

	typedef struct _PROCESSOR_IDLE_CONSTRAINTS // 14 elements, 0x40 bytes (sizeof)
	{
		...
		/*0x030*/     ULONG32      IRHints;
		/*0x034*/     ULONG32      IRTruncatedHints;
		/*0x038*/     UINT8        ExpectedWakeReason;
		/*0x039*/     UINT8        _PADDING1_[0x7];
	}PROCESSOR_IDLE_CONSTRAINTS, * PPROCESSOR_IDLE_CONSTRAINTS;

	typedef struct _PROCESSOR_IDLE_PREPARE_INFO             // 8 elements, 0x68 bytes (sizeof)
	{
		/*0x000*/     VOID* Context;
		/*0x008*/     struct _PROCESSOR_IDLE_CONSTRAINTS Constraints;     // 14 elements, 0x40 bytes (sizeof)
		/*0x048*/     ULONG32      DependencyCount;
		/*0x04C*/     ULONG32      DependencyUsed;
		/*0x050*/     struct _PROCESSOR_IDLE_DEPENDENCY* DependencyArray;
		/*0x058*/     ULONG32      PlatformIdleStateIndex;
		/*0x05C*/     ULONG32      ProcessorIdleStateIndex;
		/*0x060*/     ULONG32      IdleSelectFailureMask;
		/*0x064*/     UINT8        _PADDING0_[0x4];
	}PROCESSOR_IDLE_PREPARE_INFO, * PPROCESSOR_IDLE_PREPARE_INFO;

	typedef struct _PPM_IDLE_STATES                                                                                                                                                                                                         // 30 elements, 0x318 bytes (sizeof)
	{
		...
		/*0x038*/     struct _KAFFINITY_EX PrimaryProcessorMask;                                                                                                                                                                                          // 4 elements, 0xA8 bytes (sizeof)
		/*0x0E0*/     struct _KAFFINITY_EX SecondaryProcessorMask;                                                                                                                                                                                        // 4 elements, 0xA8 bytes (sizeof)
		/*0x188*/     FUNCT_00BD_083E_IdlePrepare* IdlePrepare;
		/*0x190*/     FUNCT_0073_0860_IdleExecute* IdleExecute;
		/*0x198*/     FUNCT_0009_0865_IdlePreselect* IdlePreselect;
		/*0x1A0*/     FUNCT_0009_086A_IdleTest* IdleTest;
		/*0x1A8*/     FUNCT_00BD_07E0_Free_IdleComplete_WorkerRoutine_DeleteCallback_InterfaceReference_InterfaceDereference_DeleteProcedure_DevicePowerRequired_DevicePowerNotRequired_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead* IdleComplete;
		/*0x1B0*/     FUNCT_00BD_086C_IdleCancel_Free_ComponentActive_ComponentIdle* IdleCancel;
		/*0x1B8*/     FUNCT_007C_0870_IdleIsHalted_IdleInitiateWake* IdleIsHalted;
		/*0x1C0*/     FUNCT_007C_0870_IdleIsHalted_IdleInitiateWake* IdleInitiateWake;
		/*0x1C8*/     FUNCT_0073_0872_QueryPlatformStateResidency* QueryPlatformStateResidency;
		/*0x1D0*/     struct _PROCESSOR_IDLE_PREPARE_INFO PrepareInfo;                                                                                                                                                                                    // 8 elements, 0x68 bytes (sizeof)
		/*0x238*/     struct _PERFINFO_PPM_STATE_SELECTION* Tracing;
		/*0x240*/     struct _PPM_IDLE_STATE State[1];
	}PPM_IDLE_STATES, * PPPM_IDLE_STATES;

	typedef struct _PPM_SELECTION_STATISTICS   // 13 elements, 0x68 bytes (sizeof)
	{
		/*0x000*/     UINT64       PlatformOnlyCount;
		/*0x008*/     UINT64       PreVetoCount;
		/*0x010*/     UINT64       VetoCount;
		/*0x018*/     UINT64       IdleDurationCount;
		/*0x020*/     UINT64       LatencyCount;
		/*0x028*/     UINT64       InterruptibleCount;
		/*0x030*/     UINT64       DeviceDependencyCount;
		/*0x038*/     UINT64       ProcessorDependencyCount;
		/*0x040*/     UINT64       WrongProcessorCount;
		/*0x048*/     UINT64       LegacyOverrideCount;
		/*0x050*/     UINT64       CstateCheckCount;
		/*0x058*/     UINT64       NoCStateCount;
		/*0x060*/     UINT64       SelectedCount;
	...
	typedef struct _PROC_FEEDBACK_COUNTER                         // 9 elements, 0x30 bytes (sizeof)
	{
		union                                                     // 2 elements, 0x8 bytes (sizeof)
		{
			/*0x000*/         FUNCT_00BD_08E7_InstantaneousRead* InstantaneousRead;
			/*0x000*/         FUNCT_00BD_08EB_DifferentialRead* DifferentialRead;
		};
	...
	typedef struct _PROC_IDLE_STATE_ACCOUNTING                // 9 elements, 0x3D0 bytes (sizeof)
	{
		/*0x000*/     UINT64       TotalTime;
		...
		/*0x028*/     struct _PPM_SELECTION_STATISTICS SelectionStatistics; // 13 elements, 0x68 bytes (sizeof)
		/*0x090*/     struct _PROC_IDLE_STATE_BUCKET IdleTimeBuckets[26];
	}PROC_IDLE_STATE_ACCOUNTING, * PPROC_IDLE_STATE_ACCOUNTING;

	typedef struct _PROC_IDLE_ACCOUNTING             // 8 elements, 0x3F8 bytes (sizeof)
	{
	...
	typedef struct _PROC_PERF_CONSTRAINT     // 15 elements, 0x58 bytes (sizeof)
	{
		...
		/*0x02C*/     ULONG32      DesiredPercent;
		/*0x030*/     ULONG32      SelectedPercent;
		/*0x034*/     ULONG32      SelectedFrequency;
		/*0x038*/     ULONG32      PreviousFrequency;
		/*0x03C*/     ULONG32      PreviousPercent;
		/*0x040*/     ULONG32      LatestFrequencyPercent;
		/*0x044*/     UINT8        _PADDING1_[0x4];
		/*0x048*/     UINT64       SelectedState;
		/*0x050*/     UINT8        Force;
		/*0x051*/     UINT8        _PADDING2_[0x7];
	}PROC_PERF_CONSTRAINT, * PPROC_PERF_CONSTRAINT;

	typedef struct _PROC_PERF_DOMAIN                                                          // 31 elements, 0x158 bytes (sizeof)
	{
		/*0x000*/     struct _LIST_ENTRY Link;                                                              // 2 elements, 0x10 bytes (sizeof)
		/*0x010*/     struct _KPRCB* Master;
		/*0x018*/     struct _KAFFINITY_EX Members;                                                         // 4 elements, 0xA8 bytes (sizeof)
		/*0x0C0*/     ULONG32      ProcessorCount;
		/*0x0C4*/     UINT8        _PADDING0_[0x4];
		/*0x0C8*/     struct _PROC_PERF_CONSTRAINT* Processors;
		/*0x0D0*/     FUNCT_00BD_093A_GetFFHThrottleState* GetFFHThrottleState;
		/*0x0D8*/     FUNCT_00BD_093D_BoostPolicyHandler_BoostModeHandler_StallRoutine* BoostPolicyHandler;
		/*0x0E0*/     FUNCT_00BD_093D_BoostPolicyHandler_BoostModeHandler_StallRoutine* BoostModeHandler;
		/*0x0E8*/     FUNCT_0009_0940_PerfSelectionHandler* PerfSelectionHandler;
		/*0x0F0*/     FUNCT_00BD_0949_PerfControlHandler* PerfControlHandler;
		/*0x0F8*/     ULONG32      MaxFrequency;
		/*0x0FC*/     ULONG32      NominalFrequency;
		/*0x100*/     ULONG32      MaxPercent;
		/*0x104*/     ULONG32      MinPerfPercent;
		/*0x108*/     ULONG32      MinThrottlePercent;
		/*0x10C*/     UINT8        Coordination;
		/*0x10D*/     UINT8        HardPlatformCap;
		/*0x10E*/     UINT8        AffinitizeControl;
		/*0x10F*/     UINT8        _PADDING1_[0x1];
		/*0x110*/     ULONG32      SelectedPercent;
		/*0x114*/     ULONG32      SelectedFrequency;
		/*0x118*/     ULONG32      DesiredPercent;
		/*0x11C*/     ULONG32      MaxPolicyPercent;
		/*0x120*/     ULONG32      MinPolicyPercent;
		/*0x124*/     ULONG32      ConstrainedMaxPercent;
		/*0x128*/     ULONG32      ConstrainedMinPercent;
		/*0x12C*/     ULONG32      GuaranteedPercent;
		/*0x130*/     ULONG32      TolerancePercent;
		/*0x134*/     UINT8        _PADDING2_[0x4];
		/*0x138*/     UINT64       SelectedState;
		/*0x140*/     UINT8        Force;
		/*0x141*/     UINT8        _PADDING3_[0x7];
		/*0x148*/     UINT64       PerfChangeTime;
		/*0x150*/     ULONG32      PerfChangeIntervalCount;
	...
	typedef struct _PROC_PERF_HISTORY                   // 3 elements, 0x10 bytes (sizeof)
	{
		/*0x000*/     ULONG32      Count;
		/*0x004*/     ULONG32      Slot;
		/*0x008*/     struct _PROC_PERF_HISTORY_ENTRY HistoryList[1];
	...
	typedef struct _PROVIDER_BINARY_ENTRY // 5 elements, 0x38 bytes (sizeof)
	{
		/*0x000*/     struct _LIST_ENTRY ListEntry;     // 2 elements, 0x10 bytes (sizeof)
	...
	typedef struct _RELATION_LIST_ENTRY              // 3 elements, 0x18 bytes (sizeof)
	{
		/*0x000*/     ULONG32      Count;
		/*0x004*/     ULONG32      MaxCount;
		/*0x008*/     struct _DEVICE_OBJECT_LIST_ENTRY Devices[1];
	...
	typedef struct _RTL_USER_PROCESS_PARAMETERS                // 32 elements, 0x410 bytes (sizeof)
	{
	...
	typedef struct _SEP_LOGON_SESSION_REFERENCES                               // 13 elements, 0x80 bytes (sizeof)
	{
		...
		/*0x058*/     struct _SEP_LOWBOX_HANDLES_TABLE LowBoxHandlesTable;                   // 2 elements, 0x10 bytes (sizeof)
	...
	typedef struct _SUBSECTION                          // 9 elements, 0x38 bytes (sizeof)
	{
		...
		union                                           // 2 elements, 0x8 bytes (sizeof)
		{
			...
			/*0x020*/         struct _RTL_AVL_TREE GlobalPerSessionHead;  // 1 elements, 0x8 bytes (sizeof)
		};
		union                                           // 2 elements, 0x4 bytes (sizeof)
		{
	...
	typedef struct _tagSWITCH_CONTEXT_DATA  // 7 elements, 0x48 bytes (sizeof)
	{
		/*0x000*/     UINT64       ullOsMaxVersionTested;
		/*0x008*/     UINT64       ullContextMinimum;
		/*0x010*/     struct _GUID guPlatform;            // 4 elements, 0x10 bytes (sizeof)
		/*0x020*/     struct _GUID guMinPlatform;         // 4 elements, 0x10 bytes (sizeof)
		/*0x030*/     ULONG32      ulContextSource;
		/*0x034*/     ULONG32      ulElementCount;
		/*0x038*/     struct _GUID guElements[1];
	}tagSWITCH_CONTEXT_DATA, * PtagSWITCH_CONTEXT_DATA;

	typedef struct _tagSWITCH_CONTEXT                  // 2 elements, 0x60 bytes (sizeof)
	{
		/*0x000*/     struct _tagSWITCH_CONTEXT_ATTRIBUTE Attribute; // 4 elements, 0x18 bytes (sizeof)
		/*0x018*/     struct _tagSWITCH_CONTEXT_DATA Data;           // 7 elements, 0x48 bytes (sizeof)
	...
	typedef struct _TEB                                                  // 112 elements, 0x1820 bytes (sizeof)
	{
		...
		union                                                            // 2 elements, 0x2 bytes (sizeof)
		{
			...
			struct                                                       // 13 elements, 0x2 bytes (sizeof)
			{
				...
				/*0x17EE*/             UINT16       SpareSameTebBits : 4;                       // 12 BitPosition
			};
		};
	...
	typedef struct _TEB32                                   // 102 elements, 0xFE8 bytes (sizeof)
	{
		...
		union                                               // 2 elements, 0x2 bytes (sizeof)
		{
			...
			struct                                          // 13 elements, 0x2 bytes (sizeof)
			{
				...
				/*0xFCA*/             UINT16       SpareSameTebBits : 4;          // 12 BitPosition
			};
		};
	...
	typedef struct _TEB64                                   // 112 elements, 0x1820 bytes (sizeof)
	{
	...
	typedef struct _THERMAL_ZONE_COUNTERS // 3 elements, 0xC bytes (sizeof)
	{
	...
	typedef struct _TOKEN                                                        // 44 elements, 0x478 bytes (sizeof)
	{
	...
	typedef struct _TP_CALLBACK_ENVIRON_V3                                                                          // 10 elements, 0x48 bytes (sizeof)
	{
		...
		/*0x018*/     FUNCT_00BD_00BC_CleanupGroupCancelCallback_DeRefSecurityDescriptor_PostRoutine* CleanupGroupCancelCallback;
		/*0x020*/     VOID* RaceDll;
		/*0x028*/     struct _ACTIVATION_CONTEXT* ActivationContext;
		/*0x030*/     FUNCT_00BD_00C4_FinalizationCallback* FinalizationCallback;
		union                                                                                                       // 2 elements, 0x4 bytes (sizeof)
		{
			/*0x038*/         ULONG32      Flags;
			struct                                                                                                  // 3 elements, 0x4 bytes (sizeof)
	...
	typedef struct _VF_AVL_TREE        // 5 elements, 0x20 bytes (sizeof)
	{
		...
		union                          // 2 elements, 0x4 bytes (sizeof)
		{
			/*0x01C*/         ULONG32      NodeSize;
			/*0x01C*/         ULONG32      UseLookaside;
		}u1;
	...
	typedef struct _VF_TARGET_VERIFIED_DRIVER_DATA           // 32 elements, 0x100 bytes (sizeof)
	{
		...
		/*0x030*/     union _SLIST_HEADER PoolPageHeaders;                 // 3 elements, 0x10 bytes (sizeof)
		/*0x040*/     union _SLIST_HEADER PoolTrackers;                    // 3 elements, 0x10 bytes (sizeof)
	...
	typedef struct _WAITING_IRP                               // 7 elements, 0x38 bytes (sizeof)
	{
		/*0x000*/     struct _LIST_ENTRY Links;                             // 2 elements, 0x10 bytes (sizeof)
		/*0x010*/     struct _IRP* Irp;
		/*0x018*/     FUNCT_00BD_2CD6_CompletionRoutine* CompletionRoutine;
		/*0x020*/     VOID* Context;
		/*0x028*/     struct _KEVENT* Event;
	...
	typedef struct _WHEA_ERROR_SOURCE_DESCRIPTOR                        // 11 elements, 0x3CC bytes (sizeof)
	{
		...
		/*0x024*/     ULONG32      Flags;
		union                                                           // 10 elements, 0x3A4 bytes (sizeof)
		{
	...
	typedef struct _WHEAP_WORK_QUEUE              // 6 elements, 0x88 bytes (sizeof)
	{
		...
		/*0x080*/     FUNCT_00BD_2307_WorkRoutine* WorkRoutine;
	...
	typedef struct _WMI_LOGGER_CONTEXT                         // 109 elements, 0x378 bytes (sizeof)
	{
		/*0x000*/     ULONG32      LoggerId;
		...
		/*0x024*/     UINT8        _PADDING0_[0x4];
		/*0x028*/     FUNCT_008D_21A7_GetCpuClock* GetCpuClock;
		...
		/*0x080*/     struct _LIST_ENTRY ProviderBinaryList;                 // 2 elements, 0x10 bytes (sizeof)
		union                                                  // 2 elements, 0x8 bytes (sizeof)
		{
		...
		/*0x318*/     struct _EX_FAST_REF SecurityDescriptor;                // 3 elements, 0x8 bytes (sizeof)
		/*0x320*/     union _LARGE_INTEGER StartTime;                        // 4 elements, 0x8 bytes (sizeof)
		/*0x328*/     VOID* LogFileHandle;
		...
		union                                                  // 2 elements, 0x4 bytes (sizeof)
		{
			...
			{
				/*0x338*/             ULONG32      Persistent : 1;                   // 0 BitPosition
				/*0x338*/             ULONG32      AutoLogger : 1;                   // 1 BitPosition
				/*0x338*/             ULONG32      FsReady : 1;                      // 2 BitPosition
				/*0x338*/             ULONG32      RealTime : 1;                     // 3 BitPosition
				/*0x338*/             ULONG32      Wow : 1;                          // 4 BitPosition
				/*0x338*/             ULONG32      KernelTrace : 1;                  // 5 BitPosition
				/*0x338*/             ULONG32      NoMoreEnable : 1;                 // 6 BitPosition
				/*0x338*/             ULONG32      StackTracing : 1;                 // 7 BitPosition
				/*0x338*/             ULONG32      ErrorLogged : 1;                  // 8 BitPosition
				/*0x338*/             ULONG32      RealtimeLoggerContextFreed : 1;   // 9 BitPosition
				/*0x338*/             ULONG32      PebsTracing : 1;                  // 10 BitPosition
				/*0x338*/             ULONG32      PmcCounters : 1;                  // 11 BitPosition
				/*0x338*/             ULONG32      PageAlignBuffers : 1;             // 12 BitPosition
				/*0x338*/             ULONG32      SpareFlags1 : 3;                  // 13 BitPosition
				/*0x338*/             ULONG32      SystemLoggerIndex : 8;            // 16 BitPosition
				/*0x338*/             ULONG32      StackCaching : 1;                 // 24 BitPosition
				/*0x338*/             ULONG32      SpareFlags2 : 7;                  // 25 BitPosition
			};
		};
		union                                                  // 2 elements, 0x4 bytes (sizeof)
		{
			/*0x33C*/         ULONG32      RequestFlag;
			struct                                             // 13 elements, 0x4 bytes (sizeof)
			{
				/*0x33C*/             ULONG32      DbgRequestNewFie : 1;             // 0 BitPosition
				/*0x33C*/             ULONG32      DbgRequestUpdateFile : 1;         // 1 BitPosition
				/*0x33C*/             ULONG32      DbgRequestFlush : 1;              // 2 BitPosition
				/*0x33C*/             ULONG32      DbgRequestDisableRealtime : 1;    // 3 BitPosition
				/*0x33C*/             ULONG32      DbgRequestDisconnectConsumer : 1; // 4 BitPosition
				/*0x33C*/             ULONG32      DbgRequestConnectConsumer : 1;    // 5 BitPosition
				/*0x33C*/             ULONG32      DbgRequestNotifyConsumer : 1;     // 6 BitPosition
				/*0x33C*/             ULONG32      DbgRequestUpdateHeader : 1;       // 7 BitPosition
				/*0x33C*/             ULONG32      DbgRequestDefferdFlush : 1;       // 8 BitPosition
				/*0x33C*/             ULONG32      DbgRequestDefferdFlushTimer : 1;  // 9 BitPosition
				/*0x33C*/             ULONG32      DbgRequestFlushTimer : 1;         // 10 BitPosition
				/*0x33C*/             ULONG32      DbgRequestUpdateDebugger : 1;     // 11 BitPosition
				/*0x33C*/             ULONG32      DbgSpareRequestFlags : 20;        // 12 BitPosition
			};
		};
		/*0x340*/     struct _RTL_BITMAP HookIdMap;                          // 2 elements, 0x10 bytes (sizeof)
		/*0x350*/     struct _ETW_STACK_CACHE* StackCache;
		/*0x358*/     struct _ETW_PMC_SUPPORT* PmcData;
		/*0x360*/     struct _LIST_ENTRY WinRtProviderBinaryList;            // 2 elements, 0x10 bytes (sizeof)
		/*0x370*/     struct _WMI_BUFFER_HEADER** ScratchArray;
	}WMI_LOGGER_CONTEXT, * PWMI_LOGGER_CONTEXT;

	typedef struct _WORK_QUEUE_ENTRY                      // 3 elements, 0x48 bytes (sizeof)
	{
