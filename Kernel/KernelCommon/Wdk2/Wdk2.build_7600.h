...
//////////////////
	...
	typedef enum ___20151101013B2701E68D2E2601A1323B4_RecordType  // 2 elements, 0x4 bytes
	{
		KTMOH_CommitTransaction_Result = 1 /*0x1*/,
		KTMOH_RollbackTransaction_Result = 2 /*0x2*/
	}__20151101013B2701E68D2E2601A1323B4_RecordType, * P__20151101013B2701E68D2E2601A1323B4_RecordType;
	...
	typedef VOID(NEAR CDECL FUNCT_00A3_0583_DeferredRoutine) (struct _KDPC*, VOID*, VOID*, VOID*);
	typedef VOID(NEAR CDECL FUNCT_00A3_0661_NormalRoutine) (VOID*, VOID*, VOID*);
	typedef VOID(NEAR CDECL FUNCT_00A3_0658_KernelRoutine) (struct _KAPC*, FUNCT_00A3_0661_NormalRoutine**, VOID**, VOID**, VOID**);
	typedef VOID(NEAR CDECL FUNCT_00A3_0661_NormalRoutine) (VOID*, VOID*, VOID*);
	typedef VOID(NEAR CDECL FUNCT_00A3_0666_RundownRoutine) (struct _KAPC*);
	typedef VOID* (NEAR CDECL FUNCT_00A6_0715_AllocateEx) (enum _POOL_TYPE, UINT64, ULONG32, struct _LOOKASIDE_LIST_EX*);
	typedef VOID* (NEAR CDECL FUNCT_00A6_071F_Allocate) (enum _POOL_TYPE, UINT64, ULONG32);
	typedef VOID(NEAR CDECL FUNCT_00A3_0724_FreeEx) (VOID*, struct _LOOKASIDE_LIST_EX*);
	typedef VOID(NEAR CDECL FUNCT_00A3_0728_Free_IdleHandler_InterfaceReference_InterfaceDereference_DeleteProcedure_WorkerRoutine_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead) (VOID*);
	typedef LONG32(NEAR CDECL FUNCT_005B_079E_IdleCheck_DestroyProcedure) (VOID*);
	typedef UINT8(NEAR CDECL FUNCT_0065_07E1_FeedbackHandler) (ULONG32*, UINT64, UINT8);
	typedef VOID(NEAR CDECL FUNCT_00A3_07E6_GetFFHThrottleState) (UINT64*);
	typedef VOID(NEAR CDECL FUNCT_00A3_07EA_BoostPolicyHandler_StallRoutine) (ULONG32);
	typedef ULONG32(NEAR CDECL FUNCT_0009_07ED_PerfSelectionHandler) (UINT64, ULONG32, ULONG32, ULONG32, ULONG32, ULONG32*, ULONG32*);
	typedef VOID(NEAR CDECL FUNCT_00A3_07F6_PerfHandler) (UINT64, ULONG32);
	typedef VOID(NEAR CDECL FUNCT_00A3_0827_WorkerRoutine) (VOID*, VOID*, VOID*, VOID*);
	typedef LONG32(NEAR CDECL FUNCT_005B_093F_AddDevice) (struct _DRIVER_OBJECT*, struct _DEVICE_OBJECT*);
	typedef LONG32(NEAR CDECL FUNCT_005B_0957_PreAcquireForSectionSynchronization_PreReleaseForSectionSynchronization_PreAcquireForCcFlush_PreReleaseForCcFlush_PreAcquireForModifiedPageWriter_PreReleaseForModifiedPageWriter) (struct _FS_FILTER_CALLBACK_DATA*, VOID**);
	typedef VOID(NEAR CDECL FUNCT_00A3_09D0_PostAcquireForSectionSynchronization_PostReleaseForSectionSynchronization_PostAcquireForCcFlush_PostReleaseForCcFlush_PostAcquireForModifiedPageWriter_PostReleaseForModifiedPageWriter) (struct _FS_FILTER_CALLBACK_DATA*, LONG32, VOID*);
	typedef UINT8(NEAR CDECL FUNCT_0065_09F4_FastIoCheckIfPossible) (struct _FILE_OBJECT*, union _LARGE_INTEGER*, ULONG32, UINT8, ULONG32, UINT8, struct _IO_STATUS_BLOCK*, struct _DEVICE_OBJECT*);
	typedef UINT8(NEAR CDECL FUNCT_0065_09FE_FastIoRead_FastIoWrite) (struct _FILE_OBJECT*, union _LARGE_INTEGER*, ULONG32, UINT8, ULONG32, VOID*, struct _IO_STATUS_BLOCK*, struct _DEVICE_OBJECT*);
	typedef UINT8(NEAR CDECL FUNCT_0065_0A08_FastIoQueryBasicInfo) (struct _FILE_OBJECT*, UINT8, struct _FILE_BASIC_INFORMATION*, struct _IO_STATUS_BLOCK*, struct _DEVICE_OBJECT*);
	typedef UINT8(NEAR CDECL FUNCT_0065_0A16_FastIoQueryStandardInfo) (struct _FILE_OBJECT*, UINT8, struct _FILE_STANDARD_INFORMATION*, struct _IO_STATUS_BLOCK*, struct _DEVICE_OBJECT*);
	typedef UINT8(NEAR CDECL FUNCT_0065_0A24_FastIoLock) (struct _FILE_OBJECT*, union _LARGE_INTEGER*, union _LARGE_INTEGER*, struct _EPROCESS*, ULONG32, UINT8, UINT8, struct _IO_STATUS_BLOCK*, struct _DEVICE_OBJECT*);
	typedef UINT8(NEAR CDECL FUNCT_0065_0BC6_FastIoUnlockSingle) (struct _FILE_OBJECT*, union _LARGE_INTEGER*, union _LARGE_INTEGER*, struct _EPROCESS*, ULONG32, struct _IO_STATUS_BLOCK*, struct _DEVICE_OBJECT*);
	typedef UINT8(NEAR CDECL FUNCT_0065_0BCF_FastIoUnlockAll) (struct _FILE_OBJECT*, struct _EPROCESS*, struct _IO_STATUS_BLOCK*, struct _DEVICE_OBJECT*);
	typedef UINT8(NEAR CDECL FUNCT_0065_0BD5_FastIoUnlockAllByKey) (struct _FILE_OBJECT*, VOID*, ULONG32, struct _IO_STATUS_BLOCK*, struct _DEVICE_OBJECT*);
	typedef UINT8(NEAR CDECL FUNCT_0065_0BDC_FastIoDeviceControl) (struct _FILE_OBJECT*, UINT8, VOID*, ULONG32, VOID*, ULONG32, ULONG32, struct _IO_STATUS_BLOCK*, struct _DEVICE_OBJECT*);
	typedef VOID(NEAR CDECL FUNCT_00A3_0BE7_AcquireFileForNtCreateSection_ReleaseFileForNtCreateSection) (struct _FILE_OBJECT*);
	typedef VOID(NEAR CDECL FUNCT_00A3_0BEA_FastIoDetachDevice) (struct _DEVICE_OBJECT*, struct _DEVICE_OBJECT*);
	typedef UINT8(NEAR CDECL FUNCT_0065_0BEE_FastIoQueryNetworkOpenInfo) (struct _FILE_OBJECT*, UINT8, struct _FILE_NETWORK_OPEN_INFORMATION*, struct _IO_STATUS_BLOCK*, struct _DEVICE_OBJECT*);
	typedef LONG32(NEAR CDECL FUNCT_005B_0BFE_AcquireForModWrite) (struct _FILE_OBJECT*, union _LARGE_INTEGER*, struct _ERESOURCE**, struct _DEVICE_OBJECT*);
	typedef UINT8(NEAR CDECL FUNCT_0065_0C04_MdlRead_PrepareMdlWrite) (struct _FILE_OBJECT*, union _LARGE_INTEGER*, ULONG32, ULONG32, struct _MDL**, struct _IO_STATUS_BLOCK*, struct _DEVICE_OBJECT*);
	typedef UINT8(NEAR CDECL FUNCT_0065_0C18_MdlReadComplete_MdlReadCompleteCompressed) (struct _FILE_OBJECT*, struct _MDL*, struct _DEVICE_OBJECT*);
	typedef UINT8(NEAR CDECL FUNCT_0065_0C1D_MdlWriteComplete_MdlWriteCompleteCompressed) (struct _FILE_OBJECT*, union _LARGE_INTEGER*, struct _MDL*, struct _DEVICE_OBJECT*);
	typedef UINT8(NEAR CDECL FUNCT_0065_0C23_FastIoReadCompressed_FastIoWriteCompressed) (struct _FILE_OBJECT*, union _LARGE_INTEGER*, ULONG32, ULONG32, VOID*, struct _MDL**, struct _IO_STATUS_BLOCK*, struct _COMPRESSED_DATA_INFO*, ULONG32, struct _DEVICE_OBJECT*);
	typedef UINT8(NEAR CDECL FUNCT_0065_0C38_FastIoQueryOpen) (struct _IRP*, struct _FILE_NETWORK_OPEN_INFORMATION*, struct _DEVICE_OBJECT*);
	typedef VOID(NEAR CDECL FUNCT_00A3_0C5F_UserApcRoutine) (VOID*, struct _IO_STATUS_BLOCK*, ULONG32);
	typedef VOID(NEAR CDECL FUNCT_00A3_0C64_DriverStartIo_CancelRoutine) (struct _DEVICE_OBJECT*, struct _IRP*);
	typedef LONG32(NEAR CDECL FUNCT_005B_0EE6_CompletionRoutine) (struct _DEVICE_OBJECT*, struct _IRP*, VOID*);
	typedef LONG32(NEAR CDECL FUNCT_005B_0EEB_ReleaseForModWrite) (struct _FILE_OBJECT*, struct _ERESOURCE*, struct _DEVICE_OBJECT*);
	typedef LONG32(NEAR CDECL FUNCT_005B_0EF0_AcquireForCcFlush_ReleaseForCcFlush) (struct _FILE_OBJECT*, struct _DEVICE_OBJECT*);
	typedef LONG32(NEAR CDECL FUNCT_005B_0EF4_DriverInit) (struct _DRIVER_OBJECT*, struct _UNICODE_STRING*);
	typedef VOID(NEAR CDECL FUNCT_00A3_0EF8_DriverUnload) (struct _DRIVER_OBJECT*);
	typedef LONG32(NEAR CDECL FUNCT_005B_0EFC_MajorFunction) (struct _DEVICE_OBJECT*, struct _IRP*);
	typedef VOID(NEAR CDECL FUNCT_00A3_0F06_TimerRoutine) (struct _DEVICE_OBJECT*, VOID*);
	typedef enum _IO_ALLOCATION_ACTION(NEAR CDECL FUNCT_0F16_0F15_DeviceRoutine) (struct _DEVICE_OBJECT*, struct _IRP*, VOID*, VOID*);
	typedef VOID(NEAR CDECL FUNCT_00A3_0FB1_DumpProcedure) (VOID*, struct _OBJECT_DUMP_CONTROL*);
	typedef LONG32(NEAR CDECL FUNCT_005B_0FB9_OpenProcedure) (enum _OB_OPEN_REASON, CHAR, struct _EPROCESS*, VOID*, ULONG32*, ULONG32);
	typedef VOID(NEAR CDECL FUNCT_00A3_0FC7_CloseProcedure) (struct _EPROCESS*, VOID*, UINT64, UINT64);
	typedef LONG32(NEAR CDECL FUNCT_005B_0FCD_ParseProcedure) (VOID*, VOID*, struct _ACCESS_STATE*, CHAR, ULONG32, struct _UNICODE_STRING*, struct _UNICODE_STRING*, VOID*, struct _SECURITY_QUALITY_OF_SERVICE*, VOID**);
	typedef LONG32(NEAR CDECL FUNCT_005B_0FD9_SecurityProcedure) (VOID*, enum _SECURITY_OPERATION_CODE, ULONG32*, VOID*, ULONG32*, VOID**, enum _POOL_TYPE, struct _GENERIC_MAPPING*, CHAR);
	typedef LONG32(NEAR CDECL FUNCT_005B_0FEA_QueryNameProcedure) (VOID*, UINT8, struct _OBJECT_NAME_INFORMATION*, ULONG32, ULONG32*, CHAR);
	typedef UINT8(NEAR CDECL FUNCT_0065_0FF2_OkayToCloseProcedure) (struct _EPROCESS*, VOID*, VOID*, CHAR);
	typedef struct _CELL_DATA* (NEAR CDECL FUNCT_1420_141F_GetCellRoutine) (struct _HHIVE*, ULONG32);
	typedef VOID(NEAR CDECL FUNCT_00A3_146E_ReleaseCellRoutine) (struct _HHIVE*, ULONG32);
	typedef VOID* (NEAR CDECL FUNCT_00A6_1470_Allocate) (ULONG32, UINT8, ULONG32);
	typedef VOID(NEAR CDECL FUNCT_00A3_1475_Free) (VOID*, ULONG32);
	typedef UINT8(NEAR CDECL FUNCT_0065_1479_FileSetSize) (struct _HHIVE*, ULONG32, ULONG32, ULONG32);
	typedef UINT8(NEAR CDECL FUNCT_0065_147F_FileWrite) (struct _HHIVE*, ULONG32, struct _CMP_OFFSET_ARRAY*, ULONG32, ULONG32*);
	typedef UINT8(NEAR CDECL FUNCT_0065_148B_FileRead) (struct _HHIVE*, ULONG32, ULONG32*, VOID*, ULONG32);
	typedef UINT8(NEAR CDECL FUNCT_0065_1492_FileFlush) (struct _HHIVE*, ULONG32, union _LARGE_INTEGER*, ULONG32);
	typedef LONG32(NEAR CDECL FUNCT_005B_15F7_NotificationRoutine) (struct _KENLISTMENT*, VOID*, VOID*, ULONG32, union _LARGE_INTEGER*, ULONG32, VOID*);
	typedef enum _RTL_GENERIC_COMPARE_RESULTS(NEAR CDECL FUNCT_163D_163C_CompareRoutine) (struct _RTL_AVL_TABLE*, VOID*, VOID*);
	typedef VOID* (NEAR CDECL FUNCT_00A6_1646_AllocateRoutine) (struct _RTL_AVL_TABLE*, ULONG32);
	typedef VOID(NEAR CDECL FUNCT_00A3_164A_FreeRoutine) (struct _RTL_AVL_TABLE*, VOID*);
	typedef LONG32(NEAR CDECL FUNCT_005B_177F_Callback) (enum _PCW_CALLBACK_TYPE, union _PCW_CALLBACK_INFORMATION*, VOID*);
	typedef ULONG32(NEAR CDECL FUNCT_0009_18C6_ProfileDepartureSetMode) (VOID*, enum _PROFILE_DEPARTURE_STYLE);
	typedef ULONG32(NEAR CDECL FUNCT_0009_18CF_ProfileDepartureUpdate) (VOID*);
	typedef UINT8(NEAR CDECL FUNCT_0065_1A77_AcquireForLazyWrite_AcquireForReadAhead) (VOID*, UINT8);
	typedef VOID(NEAR CDECL FUNCT_00A3_1A7B_FlushToLsnRoutine) (VOID*, union _LARGE_INTEGER);
	typedef LONG32(NEAR CDECL FUNCT_005B_1B29_CommitRoutine) (VOID*, VOID**, UINT64*);
	typedef VOID(NEAR CDECL FUNCT_00A3_1C59_MiniPacketCallback) (struct _IO_MINI_COMPLETION_PACKET_USER*, VOID*);
	typedef INT64(NEAR CDECL FUNCT_0075_1E6E_GetCpuClock) ();
	typedef VOID(NEAR CDECL FUNCT_00A3_1E93_BufferCallback) (struct _WMI_BUFFER_HEADER*, VOID*);
	typedef VOID(NEAR CDECL FUNCT_00A3_2054_BankedRoutine) (ULONG32, ULONG32, VOID*);
	typedef UINT8(NEAR CDECL FUNCT_0065_20AD_ServiceRoutine) (struct _KINTERRUPT*, VOID*);
	typedef UINT8(NEAR CDECL FUNCT_0065_20B2_MessageServiceRoutine) (struct _KINTERRUPT*, VOID*, ULONG32);
	typedef VOID(NEAR CDECL FUNCT_00A3_210B_Routine) (VOID*, VOID*, struct _IO_WORKITEM*);
	typedef LONG32(NEAR CDECL FUNCT_005B_237C_ArbiterHandler) (VOID*, enum _ARBITER_ACTION, struct _ARBITER_PARAMETERS*);
	typedef LONG32(NEAR CDECL FUNCT_005B_23DE_UnpackRequirement) (struct _IO_RESOURCE_DESCRIPTOR*, UINT64*, UINT64*, UINT64*, UINT64*);
	typedef LONG32(NEAR CDECL FUNCT_005B_23E5_PackResource) (struct _IO_RESOURCE_DESCRIPTOR*, UINT64, struct _CM_PARTIAL_RESOURCE_DESCRIPTOR*);
	typedef LONG32(NEAR CDECL FUNCT_005B_23EA_UnpackResource) (struct _CM_PARTIAL_RESOURCE_DESCRIPTOR*, UINT64*, UINT64*);
	typedef LONG32(NEAR CDECL FUNCT_005B_23EF_ScoreRequirement) (struct _IO_RESOURCE_DESCRIPTOR*);
	typedef LONG32(NEAR CDECL FUNCT_005B_23F2_TestAllocation) (struct _ARBITER_INSTANCE*, struct _ARBITER_TEST_ALLOCATION_PARAMETERS*);
	typedef LONG32(NEAR CDECL FUNCT_005B_23F8_RetestAllocation) (struct _ARBITER_INSTANCE*, struct _ARBITER_RETEST_ALLOCATION_PARAMETERS*);
	typedef LONG32(NEAR CDECL FUNCT_005B_23FD_CommitAllocation_RollbackAllocation) (struct _ARBITER_INSTANCE*);
	typedef LONG32(NEAR CDECL FUNCT_005B_2400_BootAllocation) (struct _ARBITER_INSTANCE*, struct _ARBITER_BOOT_ALLOCATION_PARAMETERS*);
	typedef LONG32(NEAR CDECL FUNCT_005B_2405_QueryArbitrate) (struct _ARBITER_INSTANCE*, struct _ARBITER_QUERY_ARBITRATE_PARAMETERS*);
	typedef LONG32(NEAR CDECL FUNCT_005B_240A_QueryConflict) (struct _ARBITER_INSTANCE*, struct _ARBITER_QUERY_CONFLICT_PARAMETERS*);
	typedef LONG32(NEAR CDECL FUNCT_005B_240F_AddReserved) (struct _ARBITER_INSTANCE*, struct _ARBITER_ADD_RESERVED_PARAMETERS*);
	typedef LONG32(NEAR CDECL FUNCT_005B_2414_StartArbiter) (struct _ARBITER_INSTANCE*, struct _CM_RESOURCE_LIST*);
	typedef LONG32(NEAR CDECL FUNCT_005B_2418_PreprocessEntry_AllocateEntry) (struct _ARBITER_INSTANCE*, struct _ARBITER_ALLOCATION_STATE*);
	typedef UINT8(NEAR CDECL FUNCT_0065_241C_GetNextAllocationRange_FindSuitableRange_OverrideConflict) (struct _ARBITER_INSTANCE*, struct _ARBITER_ALLOCATION_STATE*);
	typedef VOID(NEAR CDECL FUNCT_00A3_241E_AddAllocation_BacktrackAllocation) (struct _ARBITER_INSTANCE*, struct _ARBITER_ALLOCATION_STATE*);
	typedef LONG32(NEAR CDECL FUNCT_005B_2420_InitializeRangeList) (struct _ARBITER_INSTANCE*, ULONG32, struct _CM_PARTIAL_RESOURCE_DESCRIPTOR*, struct _RTL_RANGE_LIST*);
	typedef UINT8(NEAR CDECL FUNCT_0065_2426_ConflictCallback) (VOID*, struct _RTL_RANGE*);
	typedef LONG32(NEAR CDECL FUNCT_005B_2616_HeapLeakEnumerationRoutine) (LONG32, VOID*, VOID*, UINT64, ULONG32, VOID*);
	typedef LONG32(NEAR CDECL FUNCT_005B_2669_PStateHandler_TStateHandler) (UINT64, UINT64, UINT64);
	typedef UINT8(NEAR CDECL FUNCT_0065_2739_OpenRoutine) (union _LARGE_INTEGER);
	typedef LONG32(NEAR CDECL FUNCT_005B_273C_WriteRoutine) (union _LARGE_INTEGER*, struct _MDL*);
	typedef LONG32(NEAR CDECL FUNCT_005B_2742_WritePendingRoutine) (LONG32, union _LARGE_INTEGER*, struct _MDL*, VOID*);
	...
	typedef struct _ARBITER_INSTANCE                                                                       // 43 elements, 0x698 bytes (sizeof)
	{
		...
		/*0x078*/     FUNCT_005B_23DE_UnpackRequirement* UnpackRequirement;
		/*0x080*/     FUNCT_005B_23E5_PackResource* PackResource;
		/*0x088*/     FUNCT_005B_23EA_UnpackResource* UnpackResource;
		/*0x090*/     FUNCT_005B_23EF_ScoreRequirement* ScoreRequirement;
		/*0x098*/     FUNCT_005B_23F2_TestAllocation* TestAllocation;
		/*0x0A0*/     FUNCT_005B_23F8_RetestAllocation* RetestAllocation;
		/*0x0A8*/     FUNCT_005B_23FD_CommitAllocation_RollbackAllocation* CommitAllocation;
		/*0x0B0*/     FUNCT_005B_23FD_CommitAllocation_RollbackAllocation* RollbackAllocation;
		/*0x0B8*/     FUNCT_005B_2400_BootAllocation* BootAllocation;
		/*0x0C0*/     FUNCT_005B_2405_QueryArbitrate* QueryArbitrate;
		/*0x0C8*/     FUNCT_005B_240A_QueryConflict* QueryConflict;
		/*0x0D0*/     FUNCT_005B_240F_AddReserved* AddReserved;
		/*0x0D8*/     FUNCT_005B_2414_StartArbiter* StartArbiter;
		/*0x0E0*/     FUNCT_005B_2418_PreprocessEntry_AllocateEntry* PreprocessEntry;
		/*0x0E8*/     FUNCT_005B_2418_PreprocessEntry_AllocateEntry* AllocateEntry;
		/*0x0F0*/     FUNCT_0065_241C_GetNextAllocationRange_FindSuitableRange_OverrideConflict* GetNextAllocationRange;
		/*0x0F8*/     FUNCT_0065_241C_GetNextAllocationRange_FindSuitableRange_OverrideConflict* FindSuitableRange;
		/*0x100*/     FUNCT_00A3_241E_AddAllocation_BacktrackAllocation* AddAllocation;
		/*0x108*/     FUNCT_00A3_241E_AddAllocation_BacktrackAllocation* BacktrackAllocation;
		/*0x110*/     FUNCT_0065_241C_GetNextAllocationRange_FindSuitableRange_OverrideConflict* OverrideConflict;
		/*0x118*/     FUNCT_005B_2420_InitializeRangeList* InitializeRangeList;
		...
		/*0x148*/     FUNCT_0065_2426_ConflictCallback* ConflictCallback;
	...
	typedef struct _ARBITER_INTERFACE                                                                                                                                                    // 7 elements, 0x30 bytes (sizeof)
	{
		...
		/*0x004*/     UINT8        _PADDING0_[0x4];
		/*0x008*/     VOID* Context;
		/*0x010*/     FUNCT_00A3_0728_Free_IdleHandler_InterfaceReference_InterfaceDereference_DeleteProcedure_WorkerRoutine_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead* InterfaceReference;
		/*0x018*/     FUNCT_00A3_0728_Free_IdleHandler_InterfaceReference_InterfaceDereference_DeleteProcedure_WorkerRoutine_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead* InterfaceDereference;
		/*0x020*/     FUNCT_005B_237C_ArbiterHandler* ArbiterHandler;
		/*0x028*/     ULONG32      Flags;
	...
	typedef struct _BLOB_TYPE                                                                                                                                                       // 9 elements, 0x38 bytes (sizeof)
	{
		...
		/*0x014*/     UINT8        _PADDING0_[0x4];
		/*0x018*/     FUNCT_00A3_0728_Free_IdleHandler_InterfaceReference_InterfaceDereference_DeleteProcedure_WorkerRoutine_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead* DeleteProcedure;
		/*0x020*/     FUNCT_005B_079E_IdleCheck_DestroyProcedure* DestroyProcedure;
	...
	{
		/*0x000*/     FUNCT_0065_1A77_AcquireForLazyWrite_AcquireForReadAhead* AcquireForLazyWrite;
		/*0x008*/     FUNCT_00A3_0728_Free_IdleHandler_InterfaceReference_InterfaceDereference_DeleteProcedure_WorkerRoutine_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead* ReleaseFromLazyWrite;
		/*0x010*/     FUNCT_0065_1A77_AcquireForLazyWrite_AcquireForReadAhead* AcquireForReadAhead;
		/*0x018*/     FUNCT_00A3_0728_Free_IdleHandler_InterfaceReference_InterfaceDereference_DeleteProcedure_WorkerRoutine_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead* ReleaseFromReadAhead;
	...
	typedef struct _CM_WORKITEM                                                                                                                                                   // 4 elements, 0x28 bytes (sizeof)
	{
		...
		/*0x014*/     UINT8        _PADDING0_[0x4];
		/*0x018*/     FUNCT_00A3_0728_Free_IdleHandler_InterfaceReference_InterfaceDereference_DeleteProcedure_WorkerRoutine_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead* WorkerRoutine;
	...
	typedef struct _HHIVE                                       // 30 elements, 0x598 bytes (sizeof)
	{
		/*0x000*/     ULONG32      Signature;
		/*0x004*/     UINT8        _PADDING0_[0x4];
		/*0x008*/     FUNCT_1420_141F_GetCellRoutine* GetCellRoutine;
		/*0x010*/     FUNCT_00A3_146E_ReleaseCellRoutine* ReleaseCellRoutine;
		/*0x018*/     FUNCT_00A6_1470_Allocate* Allocate;
		/*0x020*/     FUNCT_00A3_1475_Free* Free;
		/*0x028*/     FUNCT_0065_1479_FileSetSize* FileSetSize;
		/*0x030*/     FUNCT_0065_147F_FileWrite* FileWrite;
		/*0x038*/     FUNCT_0065_148B_FileRead* FileRead;
		/*0x040*/     FUNCT_0065_1492_FileFlush* FileFlush;
	...
	typedef struct _WAIT_CONTEXT_BLOCK                // 7 elements, 0x48 bytes (sizeof)
	{
		...
		/*0x018*/     FUNCT_0F16_0F15_DeviceRoutine* DeviceRoutine;
	...
	typedef struct _KDPC                                  // 9 elements, 0x40 bytes (sizeof)
	{
		...
		/*0x018*/     FUNCT_00A3_0583_DeferredRoutine* DeferredRoutine;
	...
	typedef struct _DOCK_INTERFACE                                                                                                                                                       // 7 elements, 0x30 bytes (sizeof)
	{
		...
		/*0x010*/     FUNCT_00A3_0728_Free_IdleHandler_InterfaceReference_InterfaceDereference_DeleteProcedure_WorkerRoutine_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead* InterfaceReference;
		/*0x018*/     FUNCT_00A3_0728_Free_IdleHandler_InterfaceReference_InterfaceDereference_DeleteProcedure_WorkerRoutine_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead* InterfaceDereference;
		/*0x020*/     FUNCT_0009_18C6_ProfileDepartureSetMode* ProfileDepartureSetMode;
		/*0x028*/     FUNCT_0009_18CF_ProfileDepartureUpdate* ProfileDepartureUpdate;
	...
	typedef struct _DRIVER_EXTENSION                        // 6 elements, 0x38 bytes (sizeof)
	{
		...
		/*0x008*/     FUNCT_005B_093F_AddDevice* AddDevice;
		/*0x010*/     ULONG32      Count;
		/*0x014*/     UINT8        _PADDING0_[0x4];
	...
	typedef struct _DRIVER_OBJECT                                   // 15 elements, 0x150 bytes (sizeof)
	{
		...
		/*0x058*/     FUNCT_005B_0EF4_DriverInit* DriverInit;
		/*0x060*/     FUNCT_00A3_0C64_DriverStartIo_CancelRoutine* DriverStartIo;
		/*0x068*/     FUNCT_00A3_0EF8_DriverUnload* DriverUnload;
		/*0x070*/     FUNCT_005B_0EFC_MajorFunction* MajorFunction[28];
	...
	typedef struct _DUMP_INITIALIZATION_CONTEXT                                              // 19 elements, 0xA0 bytes (sizeof)
	{
		...
		/*0x030*/     FUNCT_00A3_07EA_BoostPolicyHandler_StallRoutine* StallRoutine;
		/*0x038*/     FUNCT_0065_2739_OpenRoutine* OpenRoutine;
		/*0x040*/     FUNCT_005B_273C_WriteRoutine* WriteRoutine;
		...
		/*0x080*/     FUNCT_005B_2742_WritePendingRoutine* WritePendingRoutine;
	...
	typedef struct _KAPC                                // 16 elements, 0x58 bytes (sizeof)
	{
		...
		/*0x020*/     FUNCT_00A3_0658_KernelRoutine* KernelRoutine;
		/*0x028*/     FUNCT_00A3_0666_RundownRoutine* RundownRoutine;
		/*0x030*/     FUNCT_00A3_0661_NormalRoutine* NormalRoutine;
	...
	typedef struct _FAST_IO_DISPATCH                                                                                // 28 elements, 0xE0 bytes (sizeof)
	{
		...
		/*0x004*/     UINT8        _PADDING0_[0x4];
		/*0x008*/     FUNCT_0065_09F4_FastIoCheckIfPossible* FastIoCheckIfPossible;
		/*0x010*/     FUNCT_0065_09FE_FastIoRead_FastIoWrite* FastIoRead;
		/*0x018*/     FUNCT_0065_09FE_FastIoRead_FastIoWrite* FastIoWrite;
		/*0x020*/     FUNCT_0065_0A08_FastIoQueryBasicInfo* FastIoQueryBasicInfo;
		/*0x028*/     FUNCT_0065_0A16_FastIoQueryStandardInfo* FastIoQueryStandardInfo;
		/*0x030*/     FUNCT_0065_0A24_FastIoLock* FastIoLock;
		/*0x038*/     FUNCT_0065_0BC6_FastIoUnlockSingle* FastIoUnlockSingle;
		/*0x040*/     FUNCT_0065_0BCF_FastIoUnlockAll* FastIoUnlockAll;
		/*0x048*/     FUNCT_0065_0BD5_FastIoUnlockAllByKey* FastIoUnlockAllByKey;
		/*0x050*/     FUNCT_0065_0BDC_FastIoDeviceControl* FastIoDeviceControl;
		/*0x058*/     FUNCT_00A3_0BE7_AcquireFileForNtCreateSection_ReleaseFileForNtCreateSection* AcquireFileForNtCreateSection;
		/*0x060*/     FUNCT_00A3_0BE7_AcquireFileForNtCreateSection_ReleaseFileForNtCreateSection* ReleaseFileForNtCreateSection;
		/*0x068*/     FUNCT_00A3_0BEA_FastIoDetachDevice* FastIoDetachDevice;
		/*0x070*/     FUNCT_0065_0BEE_FastIoQueryNetworkOpenInfo* FastIoQueryNetworkOpenInfo;
		/*0x078*/     FUNCT_005B_0BFE_AcquireForModWrite* AcquireForModWrite;
		/*0x080*/     FUNCT_0065_0C04_MdlRead_PrepareMdlWrite* MdlRead;
		/*0x088*/     FUNCT_0065_0C18_MdlReadComplete_MdlReadCompleteCompressed* MdlReadComplete;
		/*0x090*/     FUNCT_0065_0C04_MdlRead_PrepareMdlWrite* PrepareMdlWrite;
		/*0x098*/     FUNCT_0065_0C1D_MdlWriteComplete_MdlWriteCompleteCompressed* MdlWriteComplete;
		/*0x0A0*/     FUNCT_0065_0C23_FastIoReadCompressed_FastIoWriteCompressed* FastIoReadCompressed;
		/*0x0A8*/     FUNCT_0065_0C23_FastIoReadCompressed_FastIoWriteCompressed* FastIoWriteCompressed;
		/*0x0B0*/     FUNCT_0065_0C18_MdlReadComplete_MdlReadCompleteCompressed* MdlReadCompleteCompressed;
		/*0x0B8*/     FUNCT_0065_0C1D_MdlWriteComplete_MdlWriteCompleteCompressed* MdlWriteCompleteCompressed;
		/*0x0C0*/     FUNCT_0065_0C38_FastIoQueryOpen* FastIoQueryOpen;
		/*0x0C8*/     FUNCT_005B_0EEB_ReleaseForModWrite* ReleaseForModWrite;
		/*0x0D0*/     FUNCT_005B_0EF0_AcquireForCcFlush_ReleaseForCcFlush* AcquireForCcFlush;
		/*0x0D8*/     FUNCT_005B_0EF0_AcquireForCcFlush_ReleaseForCcFlush* ReleaseForCcFlush;
	...
	typedef struct _FS_FILTER_CALLBACKS                                                                                                                                                                                                                // 14 elements, 0x68 bytes (sizeof)
	{
		...
		/*0x004*/     ULONG32      Reserved;
		/*0x008*/     FUNCT_005B_0957_PreAcquireForSectionSynchronization_PreReleaseForSectionSynchronization_PreAcquireForCcFlush_PreReleaseForCcFlush_PreAcquireForModifiedPageWriter_PreReleaseForModifiedPageWriter* PreAcquireForSectionSynchronization;
		/*0x010*/     FUNCT_00A3_09D0_PostAcquireForSectionSynchronization_PostReleaseForSectionSynchronization_PostAcquireForCcFlush_PostReleaseForCcFlush_PostAcquireForModifiedPageWriter_PostReleaseForModifiedPageWriter* PostAcquireForSectionSynchronization;
		/*0x018*/     FUNCT_005B_0957_PreAcquireForSectionSynchronization_PreReleaseForSectionSynchronization_PreAcquireForCcFlush_PreReleaseForCcFlush_PreAcquireForModifiedPageWriter_PreReleaseForModifiedPageWriter* PreReleaseForSectionSynchronization;
		/*0x020*/     FUNCT_00A3_09D0_PostAcquireForSectionSynchronization_PostReleaseForSectionSynchronization_PostAcquireForCcFlush_PostReleaseForCcFlush_PostAcquireForModifiedPageWriter_PostReleaseForModifiedPageWriter* PostReleaseForSectionSynchronization;
		/*0x028*/     FUNCT_005B_0957_PreAcquireForSectionSynchronization_PreReleaseForSectionSynchronization_PreAcquireForCcFlush_PreReleaseForCcFlush_PreAcquireForModifiedPageWriter_PreReleaseForModifiedPageWriter* PreAcquireForCcFlush;
		/*0x030*/     FUNCT_00A3_09D0_PostAcquireForSectionSynchronization_PostReleaseForSectionSynchronization_PostAcquireForCcFlush_PostReleaseForCcFlush_PostAcquireForModifiedPageWriter_PostReleaseForModifiedPageWriter* PostAcquireForCcFlush;
		/*0x038*/     FUNCT_005B_0957_PreAcquireForSectionSynchronization_PreReleaseForSectionSynchronization_PreAcquireForCcFlush_PreReleaseForCcFlush_PreAcquireForModifiedPageWriter_PreReleaseForModifiedPageWriter* PreReleaseForCcFlush;
		/*0x040*/     FUNCT_00A3_09D0_PostAcquireForSectionSynchronization_PostReleaseForSectionSynchronization_PostAcquireForCcFlush_PostReleaseForCcFlush_PostAcquireForModifiedPageWriter_PostReleaseForModifiedPageWriter* PostReleaseForCcFlush;
		/*0x048*/     FUNCT_005B_0957_PreAcquireForSectionSynchronization_PreReleaseForSectionSynchronization_PreAcquireForCcFlush_PreReleaseForCcFlush_PreAcquireForModifiedPageWriter_PreReleaseForModifiedPageWriter* PreAcquireForModifiedPageWriter;
		/*0x050*/     FUNCT_00A3_09D0_PostAcquireForSectionSynchronization_PostReleaseForSectionSynchronization_PostAcquireForCcFlush_PostReleaseForCcFlush_PostAcquireForModifiedPageWriter_PostReleaseForModifiedPageWriter* PostAcquireForModifiedPageWriter;
		/*0x058*/     FUNCT_005B_0957_PreAcquireForSectionSynchronization_PreReleaseForSectionSynchronization_PreAcquireForCcFlush_PreReleaseForCcFlush_PreAcquireForModifiedPageWriter_PreReleaseForModifiedPageWriter* PreReleaseForModifiedPageWriter;
		/*0x060*/     FUNCT_00A3_09D0_PostAcquireForSectionSynchronization_PostReleaseForSectionSynchronization_PostAcquireForCcFlush_PostReleaseForCcFlush_PostAcquireForModifiedPageWriter_PostReleaseForModifiedPageWriter* PostReleaseForModifiedPageWriter;
	...
	typedef struct _GENERAL_LOOKASIDE                                                                                                                                        // 22 elements, 0x80 bytes (sizeof)
	{
		...
		union                                                                                                                                                                // 2 elements, 0x8 bytes (sizeof)
		{
			/*0x030*/         FUNCT_00A6_0715_AllocateEx* AllocateEx;
			/*0x030*/         FUNCT_00A6_071F_Allocate* Allocate;
		};
		union                                                                                                                                                                // 2 elements, 0x8 bytes (sizeof)
		{
			/*0x038*/         FUNCT_00A3_0724_FreeEx* FreeEx;
			/*0x038*/         FUNCT_00A3_0728_Free_IdleHandler_InterfaceReference_InterfaceDereference_DeleteProcedure_WorkerRoutine_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead* Free;
		};
	...
	typedef struct _HEAP                                 // 53 elements, 0x208 bytes (sizeof)
	{
		...
		/*0x170*/     FUNCT_005B_1B29_CommitRoutine* CommitRoutine;
	...
	typedef struct _HEAP_DEBUGGING_INFORMATION                                  // 7 elements, 0x30 bytes (sizeof)
	{
		...
		/*0x028*/     FUNCT_005B_2616_HeapLeakEnumerationRoutine* HeapLeakEnumerationRoutine;
	...
	typedef struct __20151101013B2701EC8D2E2601A140E18_Locations_RecoverableLocations // 3 elements, 0xC bytes (sizeof)
	{
		/*0x000*/     enum _CM_LOAD_FAILURE_TYPE Failure;
		/*0x004*/     LONG32       Status;
		/*0x008*/     ULONG32      Point;
	}_20151101013B2701EC8D2E2601A140E18_Locations_RecoverableLocations, * P_20151101013B2701EC8D2E2601A140E18_Locations_RecoverableLocations;
	...
	typedef struct _HIVE_LOAD_FAILURE                                                                      // 13 elements, 0x160 bytes (sizeof)
	{
		...
		/*0x010*/     struct __20151101013B2701EC8D2E2601A140E18_Locations_RecoverableLocations Locations[8];
		/*0x070*/     struct __20151101013B2701EC8D2E2601A140E18_Locations_RecoverableLocations RecoverableLocations[8];
	...
	typedef struct _IO_MINI_COMPLETION_PACKET_USER              // 9 elements, 0x50 bytes (sizeof)
	{
		...
		/*0x038*/     FUNCT_00A3_1C59_MiniPacketCallback* MiniPacketCallback;
		/*0x040*/     VOID* Context;
	...
	typedef struct _IO_STACK_LOCATION                                             // 9 elements, 0x48 bytes (sizeof)
	{
		...
		/*0x038*/     FUNCT_005B_0EE6_CompletionRoutine* CompletionRoutine;
		/*0x040*/     VOID* Context;
	...
	typedef struct _IO_TIMER                        // 6 elements, 0x30 bytes (sizeof)
	{
		...
		/*0x018*/     FUNCT_00A3_0F06_TimerRoutine* TimerRoutine;
		/*0x020*/     VOID* Context;
		/*0x028*/     struct _DEVICE_OBJECT* DeviceObject;
	}IO_TIMER, * PIO_TIMER;
	...
	typedef struct _WORK_QUEUE_ITEM                                                                                                                                               // 3 elements, 0x20 bytes (sizeof)
	{
		...
		/*0x010*/     FUNCT_00A3_0728_Free_IdleHandler_InterfaceReference_InterfaceDereference_DeleteProcedure_WorkerRoutine_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead* WorkerRoutine;
	...
	typedef struct _IO_WORKITEM           // 5 elements, 0x40 bytes (sizeof)
	{
		...
		/*0x020*/     FUNCT_00A3_210B_Routine* Routine;
		/*0x028*/     VOID* IoObject;
		/*0x030*/     VOID* Context;
		/*0x038*/     ULONG32      Type;
		/*0x03C*/     UINT8        _PADDING0_[0x4];
	...
	typedef struct _IRP                                              // 21 elements, 0xD0 bytes (sizeof)
	{
		...
		union                                                        // 2 elements, 0x10 bytes (sizeof)
		{
			struct                                                   // 3 elements, 0x10 bytes (sizeof)
			{
				union                                                // 2 elements, 0x8 bytes (sizeof)
				{
					/*0x058*/                 FUNCT_00A3_0C5F_UserApcRoutine* UserApcRoutine;
		...
		/*0x068*/     FUNCT_00A3_0C64_DriverStartIo_CancelRoutine* CancelRoutine;
	...
	typedef struct _KINTERRUPT                                                                 // 27 elements, 0xA0 bytes (sizeof)
	{
		...
		/*0x018*/     FUNCT_0065_20AD_ServiceRoutine* ServiceRoutine;
		/*0x020*/     FUNCT_0065_20B2_MessageServiceRoutine* MessageServiceRoutine;
	...
	typedef struct _KREQUEST_PACKET                   // 2 elements, 0x20 bytes (sizeof)
	{
		...
		/*0x018*/     FUNCT_00A3_0827_WorkerRoutine* WorkerRoutine;
	...
	typedef struct _RTL_AVL_TABLE                         // 11 elements, 0x68 bytes (sizeof)
	{
		...
		/*0x044*/     UINT8        _PADDING1_[0x4];
		/*0x048*/     FUNCT_163D_163C_CompareRoutine* CompareRoutine;
		/*0x050*/     FUNCT_00A6_1646_AllocateRoutine* AllocateRoutine;
		/*0x058*/     FUNCT_00A3_164A_FreeRoutine* FreeRoutine;
	...
	typedef struct _KRESOURCEMANAGER                                   // 20 elements, 0x250 bytes (sizeof)
	{
		...
		/*0x128*/     FUNCT_005B_15F7_NotificationRoutine* NotificationRoutine;
		/*0x130*/     VOID* Key;
	...
	{
		/*0x000*/     enum ___20151101013B2701E68D2E2601A1323B4_RecordType RecordType;
	...
	typedef struct _MM_SESSION_SPACE                    // 46 elements, 0x1F80 bytes (sizeof)
	{
		...
		/*0xC90*/      FUNCT_00A3_0EF8_DriverUnload* DriverUnload;
	...
	typedef struct _MMBANKED_SECTION                  // 8 elements, 0x38 bytes (sizeof)
	{
		...
		/*0x018*/     FUNCT_00A3_2054_BankedRoutine* BankedRoutine;
		/*0x020*/     VOID* Context;
	...
	typedef struct _OBJECT_REF_INFO                 // 6 elements, 0x28 bytes (sizeof)
	{
		...
		///*0x024*/     struct _OBJECT_REF_STACK_INFO StackInfo[1];
		/*0x024*/     UINT8        _PADDING0_[0x4];
	...
	typedef struct _OBJECT_TYPE_INITIALIZER                                                                                                                                         // 25 elements, 0x70 bytes (sizeof)
	{
		...
		/*0x030*/     FUNCT_00A3_0FB1_DumpProcedure* DumpProcedure;
		/*0x038*/     FUNCT_005B_0FB9_OpenProcedure* OpenProcedure;
		/*0x040*/     FUNCT_00A3_0FC7_CloseProcedure* CloseProcedure;
		/*0x048*/     FUNCT_00A3_0728_Free_IdleHandler_InterfaceReference_InterfaceDereference_DeleteProcedure_WorkerRoutine_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead* DeleteProcedure;
		/*0x050*/     FUNCT_005B_0FCD_ParseProcedure* ParseProcedure;
		/*0x058*/     FUNCT_005B_0FD9_SecurityProcedure* SecurityProcedure;
		/*0x060*/     FUNCT_005B_0FEA_QueryNameProcedure* QueryNameProcedure;
		/*0x068*/     FUNCT_0065_0FF2_OkayToCloseProcedure* OkayToCloseProcedure;
	...
	typedef struct _PCW_REGISTRATION_INFORMATION  // 6 elements, 0x30 bytes (sizeof)
	{
		...
		/*0x020*/     FUNCT_005B_177F_Callback* Callback;
	...
	typedef struct _PNP_DEVICE_EVENT_ENTRY                                                                                                                                   // 8 elements, 0x90 bytes (sizeof)
	{
		...
		/*0x020*/     FUNCT_00A3_0728_Free_IdleHandler_InterfaceReference_InterfaceDereference_DeleteProcedure_WorkerRoutine_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead* Callback;
		/*0x028*/     VOID* Context;
		/*0x030*/     enum _PNP_VETO_TYPE* VetoType;
	...
	typedef struct _PPM_IDLE_STATE                                                                                                                                              // 14 elements, 0x60 bytes (sizeof)
	{
		...
		/*0x028*/     FUNCT_005B_079E_IdleCheck_DestroyProcedure* IdleCheck;
		/*0x030*/     FUNCT_00A3_0728_Free_IdleHandler_InterfaceReference_InterfaceDereference_DeleteProcedure_WorkerRoutine_Callback_ReleaseFromLazyWrite_ReleaseFromReadAhead* IdleHandler;
	...
	typedef struct _PPM_PERF_STATES                                 // 23 elements, 0xB0 bytes (sizeof)
	{
		...
		/*0x058*/     FUNCT_005B_2669_PStateHandler_TStateHandler* PStateHandler;
		/*0x060*/     UINT64       PStateContext;
		/*0x068*/     FUNCT_005B_2669_PStateHandler_TStateHandler* TStateHandler;
		/*0x070*/     UINT64       TStateContext;
		/*0x078*/     FUNCT_0065_07E1_FeedbackHandler* FeedbackHandler;
		/*0x080*/     FUNCT_00A3_07E6_GetFFHThrottleState* GetFFHThrottleState;
	...
	typedef struct _PROC_PERF_DOMAIN                                         // 26 elements, 0xB8 bytes (sizeof)
	{
		...
		/*0x040*/     FUNCT_0065_07E1_FeedbackHandler* FeedbackHandler;
		/*0x048*/     FUNCT_00A3_07E6_GetFFHThrottleState* GetFFHThrottleState;
		/*0x050*/     FUNCT_00A3_07EA_BoostPolicyHandler_StallRoutine* BoostPolicyHandler;
		/*0x058*/     FUNCT_0009_07ED_PerfSelectionHandler* PerfSelectionHandler;
		/*0x060*/     FUNCT_00A3_07F6_PerfHandler* PerfHandler;
	...
	typedef struct _SHARED_CACHE_MAP                          // 40 elements, 0x1F0 bytes (sizeof)
	{
		...
		/*0x0F8*/     FUNCT_00A3_1A7B_FlushToLsnRoutine* FlushToLsnRoutine;
	...
	typedef struct _WMI_LOGGER_CONTEXT                         // 86 elements, 0x330 bytes (sizeof)
	{
		...
		/*0x018*/     FUNCT_0075_1E6E_GetCpuClock* GetCpuClock;
		...
		/*0x120*/     FUNCT_00A3_1E93_BufferCallback* BufferCallback;
