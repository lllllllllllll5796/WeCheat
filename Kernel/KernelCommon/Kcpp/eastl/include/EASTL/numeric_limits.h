...
// 	};
	...
	struct numeric_limits<float>
	{
		...
		static EA_CONSTEXPR_OR_CONST bool               is_iec559         = has_infinity && has_quiet_NaN && (has_denorm == denorm_present);
			...
			static value_type infinity() 
				{ return _CSTD _FInf_C._Float; }

			static value_type quiet_NaN() 
				{ return _CSTD _FNan_C._Float; }

			static value_type signaling_NaN()
				{ return _CSTD _FSnan_C._Float; } 

			static value_type denorm_min() 
				{ return _CSTD _FDenorm_C._Float; }
	...
	struct numeric_limits<double>
	{
		...
		static EA_CONSTEXPR_OR_CONST bool               is_iec559         = has_infinity && has_quiet_NaN && (has_denorm == denorm_present);
			...
			static value_type infinity() 
				{ return _CSTD _Inf_C._Double; }

			static value_type quiet_NaN() 
				{ return _CSTD _Nan_C._Double; }

			static value_type signaling_NaN()
				{ return _CSTD _Snan_C._Double; } 

			static value_type denorm_min() 
				{ return _CSTD _Denorm_C._Double; }
	...
	struct numeric_limits<long double>
	{
		...
		static EA_CONSTEXPR_OR_CONST bool               is_iec559         = has_infinity && has_quiet_NaN && (has_denorm == denorm_present);
			...
			static value_type infinity() 
				{ return _CSTD _LInf_C._Long_double; }

			static value_type quiet_NaN() 
				{ return _CSTD _LNan_C._Long_double; }

			static value_type signaling_NaN()
				{ return _CSTD _LSnan_C._Long_double; } 

			static value_type denorm_min() 
				{ return _CSTD _LDenorm_C._Long_double; }
