...
// eastl::experimental::scope::scope_resource  == eastl::experimental::unique_resource
// eastl::experimental::scope::scope_exit      == eastl::experimental::scope_exit
...
namespace eastl
{
    namespace experimental
    {
        namespace scope
        {
			...
			{
			public:
				scope_exit(T&& Callable) : m_Callable(eastl::move(Callable)) {}
