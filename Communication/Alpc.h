...
#else
#ifndef _KERNEL_MODE
		typedef ntdll::CLIENT_ID LPC_CLIENT_ID, * PLPC_CLIENT_ID;
#else
...
#define PORT_TOTAL_MAXIMUM_MESSAGE_LENGTH 0xFFFF
		...
		NTSYSCALLAPI
			...
			NtCreatePort(
				...
				_In_opt_ ntdll::POBJECT_ATTRIBUTES ObjectAttributes,
...
// 			NtConnectPort(
// 				_Out_ PHANDLE PortHandle,
// 				_In_ ntdll::PUNICODE_STRING PortName,
...
// 			);
		...
		NTSYSCALLAPI
			...
			NtSecureConnectPort(
				...
				_In_ PSECURITY_QUALITY_OF_SERVICE SecurityQos,
				_Inout_opt_ PPORT_VIEW ClientView,
				_In_opt_ wdk::PSID RequiredServerSid,
				_Inout_opt_ PREMOTE_PORT_VIEW ServerView,
				_Out_opt_ PULONG MaxMessageLength,
				_Inout_updates_bytes_to_opt_(*ConnectionInformationLength, *ConnectionInformationLength) PVOID ConnectionInformation,
				_Inout_opt_ PULONG ConnectionInformationLength
...
// 			);
		...
		NTSYSCALLAPI
			...
			NtRequestPort(
				_In_ HANDLE PortHandle,
				_In_reads_bytes_(RequestMessage->u1.s1.TotalLength) PALPC_PORT_MESSAGE RequestMessage
			);
		...
		NTSYSCALLAPI
			...
			NtAcceptConnectPort(
				...
				_In_ PALPC_PORT_MESSAGE ConnectionRequest,
		...
		NTSYSCALLAPI
			...
			NtListenPort(
				_In_ HANDLE PortHandle,
				_Out_ PALPC_PORT_MESSAGE ConnectionRequest
			);
// 
// 		_IRQL_requires_max_(PASSIVE_LEVEL)
// 			NTSYSAPI
...
// 			);
		...
		NTSYSCALLAPI
			...
			NtRequestWaitReplyPort(
				_In_ HANDLE PortHandle,
				_In_reads_bytes_(RequestMessage->u1.s1.TotalLength) PALPC_PORT_MESSAGE RequestMessage,
				_Out_ PALPC_PORT_MESSAGE ReplyMessage
			);
...
// 			NtReplyPort(
// 				_In_ HANDLE PortHandle,
// 				_In_reads_bytes_(ReplyMessage->u1.s1.TotalLength) PALPC_PORT_MESSAGE ReplyMessage
// 			);
#endif
...
// 				_In_ HANDLE PortHandle,
// 				_Inout_ PALPC_PORT_MESSAGE ReplyMessage
// 			);
		...
		_IRQL_requires_max_(PASSIVE_LEVEL)
			...
			LpcReplyWaitReplyPort(
				_In_ PVOID PortAddress,
				_In_reads_bytes_(ReplyMessage->u1.s1.TotalLength) _Out_ PALPC_PORT_MESSAGE ReplyMessage
			);
#endif
...
// 				_In_reads_bytes_opt_(ReplyMessage->u1.s1.TotalLength) PALPC_PORT_MESSAGE ReplyMessage,
// 				_Out_ PALPC_PORT_MESSAGE ReceiveMessage
// 			);
...
// 				_In_ HANDLE PortHandle,
// 				_In_ PALPC_PORT_MESSAGE Message
// 			);
...
#ifndef _KERNEL_MODE
					ntdll::UNICODE_STRING ConnectionPortName;
#else
...
// 				_In_ HANDLE PortHandle,
// 				_In_ PALPC_PORT_MESSAGE PortMessage,
...
// 				_In_ ULONG Flags,
// 				_In_opt_ PSID RequiredServerSid,
// 				_Inout_updates_bytes_to_opt_(*BufferLength, *BufferLength) PALPC_PORT_MESSAGE ConnectionMessage,
...
// 				_In_opt_ PALPC_PORT_ATTRIBUTES PortAttributes,
// 				_In_opt_ PVOID PortContext,
// 				_In_reads_bytes_(ConnectionRequest->u1.s1.TotalLength) PALPC_PORT_MESSAGE ConnectionRequest,
...
// 				_In_ HANDLE PortHandle,
// 				_In_ ULONG Flags,
// 				_In_reads_bytes_opt_(SendMessage->u1.s1.TotalLength) PALPC_PORT_MESSAGE SendMessage,
// 				_Inout_opt_ PALPC_MESSAGE_ATTRIBUTES SendMessageAttributes,
// 				_Out_writes_bytes_to_opt_(*BufferLength, *BufferLength) PALPC_PORT_MESSAGE ReceiveMessage,
// 				_Inout_opt_ PSIZE_T BufferLength,
...
// 			);
		...
		_IRQL_requires_max_(PASSIVE_LEVEL)
			...
			LpcSendWaitReceivePort( // Can only be used for synchronous send and receive. Both messages are required
				...
				_In_reads_bytes_(SendMessage->u1.s1.TotalLength) PALPC_PORT_MESSAGE SendMessage,
				_Inout_opt_ PALPC_MESSAGE_ATTRIBUTES SendMessageAttributes,
				_Out_writes_bytes_to_(*BufferLength, *BufferLength) PALPC_PORT_MESSAGE ReceiveMessage,
				_Inout_opt_ PSIZE_T BufferLength,
				_Inout_opt_ PALPC_MESSAGE_ATTRIBUTES ReceiveMessageAttributes,
				_In_opt_ PLARGE_INTEGER Timeout
			);
